...
(assert (is-zero zero))
(assert (is-null null))
(assert (and (= contrived_variable0 x7) (not (is-cons null))))
(assert
 (or
  (and (is-cons x5) (and (= (car x5) contrived_variable0)
   (= (cons contrived_variable1 contrived_variable2) x5)
   (= (car x5) contrived_variable1) (= (cdr x5) contrived_variable2)))
  (and (not (is-cons x5)) (and (= (leaf zero) contrived_variable0)
