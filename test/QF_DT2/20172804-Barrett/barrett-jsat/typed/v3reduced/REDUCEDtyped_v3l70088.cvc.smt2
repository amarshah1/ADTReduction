...
(assert (is-null null))
(assert
 (and (and (and (and (and (and (is-leaf contrived_variable0)
  (not (= x9 x8))) (is-leaf x7)) (not ((_ is succ) x1))) (= x4 x6))
  (= contrived_variable1 x1)) (not (= x4 contrived_variable4))))
(assert
 (and (= (leaf zero) contrived_variable3) (is-leaf contrived_variable3)
  (= (data contrived_variable3) zero)))
(assert
 (and (= (leaf zero) contrived_variable2) (is-leaf contrived_variable2)
...
(assert
 (or
  (and (is-cons x6) (and (= (car x6) contrived_variable0)
   (= (cons contrived_variable6 contrived_variable7) x6)
   (= (car x6) contrived_variable6) (= (cdr x6) contrived_variable7)))
  (and (not (is-cons x6)) (and (= (leaf zero) contrived_variable0)
   (is-leaf contrived_variable0) (= (data contrived_variable0) zero)))))
(assert
 (or
  (and (is-cons x6) (and (= (cdr x6) contrived_variable4)
   (= (cons contrived_variable8 contrived_variable9) x6)
   (= (car x6) contrived_variable8) (= (cdr x6) contrived_variable9)))
  (and (not (is-cons x6)) (= contrived_variable4 null))))
(assert
...
(assert
 (not
  (=
   (pred (data (car (cdr (cdr (children (car (children
    contrived_variable6))))))))
   (data (car (cdr (cdr (children (car (children contrived_variable6))))))))))
(assert
 (not
...
(assert
 (not
  (=
   (pred (data (car (cdr (children (car (cdr (children
    contrived_variable6))))))))
   (data (car (cdr (children (car (cdr (children contrived_variable6))))))))))
(assert
 (not
...
(assert
 (not
  (=
   (pred (data (car (children (car (cdr (cdr (children
    contrived_variable6))))))))
   (data (car (children (car (cdr (cdr (children contrived_variable6))))))))))
(assert
 (not
...
(assert
 (not
  (=
   (pred (pred (data (car (cdr (cdr (cdr (children contrived_variable6))))))))
   (pred (data (car (cdr (cdr (cdr (children contrived_variable6))))))))))
(assert
 (not
  (=
...
(assert
 (not
  (=
   (pred (data (car (cdr (cdr (cdr (cdr (children contrived_variable6))))))))
   (data (car (cdr (cdr (cdr (cdr (children contrived_variable6))))))))))
(assert
 (not
...
(assert
 (not
  (= (car (cdr (cdr (cdr (cdr (cdr (cdr (children contrived_variable6))))))))
   contrived_variable6)))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr (children contrived_variable6))))))))
   (cdr (cdr (cdr (cdr (cdr (cdr (children contrived_variable6))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr (children contrived_variable6))))))))
...
(assert
 (not
  (=
   (pred (pred (pred (pred (pred (pred (pred (data contrived_variable6))))))))
   (pred (pred (pred (pred (pred (pred (data contrived_variable6))))))))))
(assert
 (not
  (=
