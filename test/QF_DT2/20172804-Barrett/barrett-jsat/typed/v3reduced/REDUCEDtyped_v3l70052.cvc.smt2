...
(assert (is-null null))
(assert
 (and (and (and (and (and (and (= x5 null) ((_ is zero) zero))
  ((_ is node) x9)) ((_ is zero) x2)) (= x9 contrived_variable0))
  (not (= contrived_variable3 contrived_variable2)))
  (= zero contrived_variable4)))
(assert
 (and (= (leaf contrived_variable1) contrived_variable0)
  (is-leaf contrived_variable0)
  (= (data contrived_variable0) contrived_variable1)))
(assert
 (and (= (node x5) contrived_variable3) (is-node contrived_variable3)
  (= (children contrived_variable3) x5)))
(assert
 (and (= (leaf zero) contrived_variable2) (is-leaf contrived_variable2)
  (= (data contrived_variable2) zero)))
(assert
 (or
  (and (is-leaf x8) (and (= (data x8) contrived_variable1)
   (= (leaf contrived_variable5) x8) (= (data x8) contrived_variable5)))
  (and (not (is-leaf x8)) (= contrived_variable1 zero))))
(assert
 (or
  (and (is-leaf x8) (and (= (data x8) contrived_variable4)
   (= (leaf contrived_variable6) x8) (= (data x8) contrived_variable6)))
  (and (not (is-leaf x8)) (= contrived_variable4 zero))))
(assert
