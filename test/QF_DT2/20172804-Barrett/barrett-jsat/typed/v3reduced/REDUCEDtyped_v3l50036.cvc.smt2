...
(assert (is-null null))
(assert
 (and (and (and (and (not (= x3 contrived_variable0))
  (= x9 contrived_variable1)) (not ((_ is succ) contrived_variable4)))
  (not ((_ is node) x9))) (not (is-leaf x7))))
(assert
 (and (= (succ x2) contrived_variable6) (is-succ contrived_variable6)
  (= (pred contrived_variable6) x2)))
(assert
...
(assert
 (and (= (cons contrived_variable3 x6) contrived_variable2)
  (is-cons contrived_variable2)
  (= (car contrived_variable2) contrived_variable3)
  (= (cdr contrived_variable2) x6)))
(assert
 (or
  (and (is-leaf x8) (and (= (data x8) contrived_variable0)
   (= (leaf contrived_variable7) x8) (= (data x8) contrived_variable7)))
  (and (not (is-leaf x8)) (= contrived_variable0 zero))))
(assert
 (or
  (and ((_ is succ) contrived_variable6) (and
   (= (pred contrived_variable5) contrived_variable4)
   (= (succ contrived_variable8) contrived_variable5)
   (= (pred contrived_variable5) contrived_variable8)))
