...
(assert (is-null null))
(assert
 (and (and (and (and (and (not (= contrived_variable0 x4)) ((_ is node) x8))
  (not ((_ is zero) zero))) ((_ is zero) x1))
  (not (= x1 contrived_variable1))) (is-leaf x9)))
(assert
 (and (= (node x4) contrived_variable3) (is-node contrived_variable3)
  (= (children contrived_variable3) x4)))
(assert
