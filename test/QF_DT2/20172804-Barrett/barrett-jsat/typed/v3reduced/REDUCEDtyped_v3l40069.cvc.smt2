...
(assert (is-null null))
(assert
 (and (and (and (is-leaf x9) (not ((_ is node) contrived_variable0)))
  (= contrived_variable4 x6)) ((_ is node) contrived_variable5)))
(assert
 (and (= (leaf contrived_variable1) contrived_variable0)
  (is-leaf contrived_variable0)
  (= (data contrived_variable0) contrived_variable1)))
(assert
 (and (= (leaf x3) contrived_variable3) (is-leaf contrived_variable3)
...
(assert
 (or
  (and ((_ is succ) contrived_variable8) (and
   (= (pred contrived_variable7) contrived_variable6)
   (= (succ contrived_variable9) contrived_variable7)
   (= (pred contrived_variable7) contrived_variable9)))
  (and (not ((_ is succ) contrived_variable8)) (= contrived_variable6 zero))))
(assert
 (or
...
(assert
 (or
  (and ((_ is succ) x2) (and (= (pred x2) contrived_variable7)
   (= (succ contrived_variable11) x2) (= (pred x2) contrived_variable11)))
  (and (not ((_ is succ) x2)) (= contrived_variable7 zero))))
(assert
 (or
  (and (is-cons x5) (and (= (cdr x5) contrived_variable4)
   (= (cons contrived_variable12 contrived_variable13) x5)
   (= (car x5) contrived_variable12) (= (cdr x5) contrived_variable13)))
  (and (not (is-cons x5)) (= contrived_variable4 null))))
(assert
 (or
  (and ((_ is succ) x2) (and (= (pred x2) contrived_variable8)
   (= (succ contrived_variable14) x2) (= (pred x2) contrived_variable14)))
  (and (not ((_ is succ) x2)) (= contrived_variable8 zero))))
(assert
 (or
