...
(assert (is-null null))
(assert
 (and (and (= x3 zero) (not (= contrived_variable0 x5)))
  (= contrived_variable1 x2)))
(assert
 (or
...
(assert
 (or
  (and (is-cons x6) (and (= (cdr x6) contrived_variable0)
   (= (cons contrived_variable3 contrived_variable4) x6)
   (= (car x6) contrived_variable3) (= (cdr x6) contrived_variable4)))
