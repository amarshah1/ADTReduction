...
(assert (is-null null))
(assert
 (and (and (not ((_ is zero) contrived_variable0)) (not ((_ is zero) x2)))
  (not (= x3 contrived_variable1))))
(assert
 (and (= (succ zero) contrived_variable0) (is-succ contrived_variable0)
  (= (pred contrived_variable0) zero)))
(assert
...
(assert
 (or
  (and (is-leaf contrived_variable4) (and
   ...
   (= (leaf contrived_variable6) contrived_variable2)
   (= (data contrived_variable2) contrived_variable6)))
  (and (not (is-leaf contrived_variable4)) (= contrived_variable1 zero))))
(assert
 (or
  (and (is-cons x4) (and (= (cdr x4) contrived_variable3)
   (= (cons contrived_variable7 contrived_variable8) x4)
   (= (car x4) contrived_variable7) (= (cdr x4) contrived_variable8)))
  (and (not (is-cons x4)) (= contrived_variable3 null))))
(assert
 (or
  (and (is-cons x4) (and (= (cdr x4) contrived_variable5)
   (= (cons contrived_variable9 contrived_variable10) x4)
   (= (car x4) contrived_variable9) (= (cdr x4) contrived_variable10)))
  (and (not (is-cons x4)) (= contrived_variable5 null))))
(assert
 (or
