...
(assert (is-null null))
(assert
 (and (and (and (and (and (not ((_ is zero) contrived_variable0))
  (= x1 zero)) (is-cons x6)) (= contrived_variable3 x2)) (= x6 null))
  (not (= contrived_variable4 x5))))
(assert
...
(assert
 (or
  (and (is-leaf contrived_variable2) (and
   ...
   (= (leaf contrived_variable5) contrived_variable1)
   (= (data contrived_variable1) contrived_variable5)))
...
(assert
 (or
  (and (is-leaf x8) (and (= (data x8) contrived_variable3)
   (= (leaf contrived_variable8) x8) (= (data x8) contrived_variable8)))
  (and (not (is-leaf x8)) (= contrived_variable3 zero))))
(assert
