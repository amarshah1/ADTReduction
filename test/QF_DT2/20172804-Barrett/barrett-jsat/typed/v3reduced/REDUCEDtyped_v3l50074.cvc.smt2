...
(assert (is-null null))
(assert
 (and (and (and (and ((_ is null) x5) ((_ is zero) contrived_variable0))
  (= x1 x3)) (not ((_ is node) x8))) (not (= contrived_variable1 null))))
(assert
 (and (= (cons x8 contrived_variable2) contrived_variable1)
  (is-cons contrived_variable1) (= (car contrived_variable1) x8)
  (= (cdr contrived_variable1) contrived_variable2)))
(assert
 (or
  (and (is-leaf x7) (and (= (data x7) contrived_variable0)
   (= (leaf contrived_variable3) x7) (= (data x7) contrived_variable3)))
  (and (not (is-leaf x7)) (= contrived_variable0 zero))))
(assert
 (or
  (and ((_ is node) x7) (and (= (children x7) contrived_variable2)
   (= (node contrived_variable4) x7) (= (children x7) contrived_variable4)))
  (and (not ((_ is node) x7)) (= contrived_variable2 null))))
(assert
