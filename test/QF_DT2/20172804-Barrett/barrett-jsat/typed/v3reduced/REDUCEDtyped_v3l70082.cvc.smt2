...
(assert (is-null null))
(assert
 (and (and (and (and (and (and (= x5 x4) (not (= contrived_variable0 x7)))
  (= x2 contrived_variable1)) (not ((_ is null) x6)))
  ((_ is node) contrived_variable2)) (not (= x6 x4))) (not (is-cons x4))))
(assert
 (and (= (leaf x2) contrived_variable2) (is-leaf contrived_variable2)
  (= (data contrived_variable2) x2)))
(assert
 (or
  (and ((_ is succ) zero) (and (= (pred zero) contrived_variable1)
   (= (succ contrived_variable3) zero) (= (pred zero) contrived_variable3)))
  (and (not ((_ is succ) zero)) (= contrived_variable1 zero))))
(assert
 (or
  (and (is-cons x5) (and (= (car x5) contrived_variable0)
   (= (cons contrived_variable4 contrived_variable5) x5)
   (= (car x5) contrived_variable4) (= (cdr x5) contrived_variable5)))
