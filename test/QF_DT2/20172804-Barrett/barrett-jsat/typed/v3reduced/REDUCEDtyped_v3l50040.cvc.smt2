...
(assert (is-null null))
(assert
 (and (and (and (and (= x9 contrived_variable0)
  ((_ is succ) contrived_variable2)) (not ((_ is node) contrived_variable3)))
  ((_ is zero) x2)) (= x3 contrived_variable4)))
(assert
...
(assert
 (or
  (and ((_ is succ) x3) (and (= (pred x3) contrived_variable1)
   (= (succ contrived_variable5) x3) (= (pred x3) contrived_variable5)))
...
(assert
 (or
  (and (is-leaf x8) (and (= (data x8) contrived_variable2)
   (= (leaf contrived_variable7) x8) (= (data x8) contrived_variable7)))
  (and (not (is-leaf x8)) (= contrived_variable2 zero))))
(assert
