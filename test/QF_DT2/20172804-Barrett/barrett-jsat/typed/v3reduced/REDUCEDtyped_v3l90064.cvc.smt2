...
(assert (is-null null))
(assert
 (and (and (and (and (and (and (and (and (not (= x1 x3))
  (not ((_ is succ) contrived_variable0)))
  (not (is-cons contrived_variable1))) (= contrived_variable2 x7))
  (not (= x1 contrived_variable3))) ((_ is node) x9)) (= x7 x7))
  (not (= x3 x3))) (not ((_ is null) x5))))
(assert
...
(assert
 (or
  (and (is-cons x6) (and (= (cdr x6) contrived_variable1)
   (= (cons contrived_variable4 contrived_variable5) x6)
   (= (car x6) contrived_variable4) (= (cdr x6) contrived_variable5)))
  (and (not (is-cons x6)) (= contrived_variable1 null))))
(assert
 (or
