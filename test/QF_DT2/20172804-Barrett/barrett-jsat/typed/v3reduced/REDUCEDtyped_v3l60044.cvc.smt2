...
(assert (is-null null))
(assert
 (and (and (and (and (and (not (= contrived_variable0 x4))
  (not (= contrived_variable2 contrived_variable1)))
  (= contrived_variable3 x1)) ((_ is zero) contrived_variable4))
  (not (= x5 null))) (= x4 x5)))
(assert
 (and (= (leaf x3) contrived_variable1) (is-leaf contrived_variable1)
  (= (data contrived_variable1) x3)))
(assert
 (and (= (cons x9 x5) contrived_variable0) (is-cons contrived_variable0)
  (= (car contrived_variable0) x9) (= (cdr contrived_variable0) x5)))
(assert
