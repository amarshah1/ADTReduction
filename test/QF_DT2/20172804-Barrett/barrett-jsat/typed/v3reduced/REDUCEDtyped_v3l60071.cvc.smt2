...
(assert (is-null null))
(assert
 (and (and (and (and (and (= contrived_variable0 x9) ((_ is null) x4))
  (is-cons contrived_variable1)) (not (is-cons contrived_variable2)))
  (= contrived_variable3 zero)) (not ((_ is succ) zero))))
(assert
 (and (= (leaf x3) contrived_variable0) (is-leaf contrived_variable0)
  (= (data contrived_variable0) x3)))
(assert
 (and (= (leaf zero) contrived_variable4) (is-leaf contrived_variable4)
  (= (data contrived_variable4) zero)))
(assert
 (and (= (leaf zero) contrived_variable5) (is-leaf contrived_variable5)
  (= (data contrived_variable5) zero)))
(assert
 (or
  (and ((_ is node) x7) (and (= (children x7) contrived_variable1)
   (= (node contrived_variable6) x7) (= (children x7) contrived_variable6)))
  (and (not ((_ is node) x7)) (= contrived_variable1 null))))
(assert
 (or
