...
(assert (is-null null))
(assert
 (and (and (and (and (and (and (= null x5)
  (not (is-cons contrived_variable0))) (is-leaf contrived_variable1))
  ((_ is null) x5)) ((_ is zero) zero)) (not (= zero x2)))
  (not (= x2 contrived_variable2))))
(assert
 (and (= (leaf x3) contrived_variable1) (is-leaf contrived_variable1)
  (= (data contrived_variable1) x3)))
(assert
 (or
  (and ((_ is node) x8) (and (= (children x8) contrived_variable0)
   (= (node contrived_variable3) x8) (= (children x8) contrived_variable3)))
  (and (not ((_ is node) x8)) (= contrived_variable0 null))))
(assert
 (or
