...
(assert (is-zero zero))
(assert (is-null null))
(assert (and (not (= contrived_variable0 x6)) (not ((_ is zero) x2))))
(assert
...
(assert
 (and (= (cons x5 contrived_variable4) contrived_variable3)
  (is-cons contrived_variable3) (= (car contrived_variable3) x5)
  (= (cdr contrived_variable3) contrived_variable4)))
(assert
...
(assert
 (or
  (and ((_ is node) x5) (and (= (children x5) contrived_variable4)
   (= (node contrived_variable5) x5) (= (children x5) contrived_variable5)))
  (and (not ((_ is node) x5)) (= contrived_variable4 null))))
(assert
