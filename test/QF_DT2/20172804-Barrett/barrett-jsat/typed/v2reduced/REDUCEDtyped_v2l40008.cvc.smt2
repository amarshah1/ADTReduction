...
(assert (is-null null))
(assert
 (and (and (and (not (= contrived_variable0 x1)) (= zero x1))
  (not (= contrived_variable1 x5))) (not (= x1 zero))))
(assert
 (and (= (leaf x1) contrived_variable1) (is-leaf contrived_variable1)
  (= (data contrived_variable1) x1)))
(assert
 (or
  (and (is-leaf x6) (and (= (data x6) contrived_variable0)
   (= (leaf contrived_variable2) x6) (= (data x6) contrived_variable2)))
  (and (not (is-leaf x6)) (= contrived_variable0 zero))))
(assert
