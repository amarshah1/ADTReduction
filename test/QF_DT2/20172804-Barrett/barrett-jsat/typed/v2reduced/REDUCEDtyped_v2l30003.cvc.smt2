...
(assert (is-null null))
(assert
 (and (and (not ((_ is null) contrived_variable0)) (not ((_ is succ) x1)))
  (not (= x5 x6))))
(assert
...
(assert
 (and (= (cons contrived_variable1 x4) contrived_variable0)
  (is-cons contrived_variable0)
  (= (car contrived_variable0) contrived_variable1)
  (= (cdr contrived_variable0) x4)))
(assert
 (or
  (and (is-cons x4) (and (= (cdr x4) contrived_variable2)
   (= (cons contrived_variable3 contrived_variable4) x4)
   (= (car x4) contrived_variable3) (= (cdr x4) contrived_variable4)))
  (and (not (is-cons x4)) (= contrived_variable2 null))))
(assert
