...
(assert (is-null null))
(assert
 (and (and (and (and (and (and (is-cons contrived_variable0)
  (= zero contrived_variable1)) (not ((_ is null) null)))
  ((_ is node) contrived_variable2)) ((_ is node) x5))
  (not (is-leaf contrived_variable3))) ((_ is succ) x1)))
(assert
 (and (= (cons x5 x3) contrived_variable0) (is-cons contrived_variable0)
  (= (car contrived_variable0) x5) (= (cdr contrived_variable0) x3)))
(assert
...
(assert
 (or
  (and ((_ is succ) x2) (and (= (pred x2) contrived_variable1)
   (= (succ contrived_variable4) x2) (= (pred x2) contrived_variable4)))
