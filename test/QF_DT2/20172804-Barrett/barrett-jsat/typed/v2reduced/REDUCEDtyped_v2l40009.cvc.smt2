...
(assert (is-null null))
(assert
 (and (and (and ((_ is zero) zero) ((_ is succ) x2))
  (not (= x6 contrived_variable0))) (= x6 contrived_variable1)))
(assert
 (and (= (leaf x1) contrived_variable0) (is-leaf contrived_variable0)
  (= (data contrived_variable0) x1)))
(assert
 (or
  (and (is-cons null) (and (= (car null) contrived_variable1)
   (= (cons contrived_variable2 contrived_variable3) null)
   (= (car null) contrived_variable2) (= (cdr null) contrived_variable3)))
  (and (not (is-cons null)) (and (= (leaf zero) contrived_variable1)
