...
(assert (is-null null))
(assert
 (and (and (and (and (and (= contrived_variable0 x3)
  (= contrived_variable1 x4)) (not ((_ is node) contrived_variable2)))
  (not ((_ is zero) x2))) (= x4 null)) (is-cons x4)))
(assert
 (or
  (and (is-cons null) (and (= (cdr null) contrived_variable1)
   (= (cons contrived_variable3 contrived_variable4) null)
   (= (car null) contrived_variable3) (= (cdr null) contrived_variable4)))
  (and (not (is-cons null)) (= contrived_variable1 null))))
(assert
 (or
  (and (is-cons x4) (and (= (cdr x4) contrived_variable0)
   (= (cons contrived_variable5 contrived_variable6) x4)
   (= (car x4) contrived_variable5) (= (cdr x4) contrived_variable6)))
  (and (not (is-cons x4)) (= contrived_variable0 null))))
(assert
 (or
  (and (is-cons x4) (and (= (car x4) contrived_variable2)
   (= (cons contrived_variable7 contrived_variable8) x4)
   (= (car x4) contrived_variable7) (= (cdr x4) contrived_variable8)))
  (and (not (is-cons x4)) (and (= (leaf zero) contrived_variable2)
