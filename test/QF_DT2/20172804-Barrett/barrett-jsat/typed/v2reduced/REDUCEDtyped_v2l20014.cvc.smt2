...
(assert (is-null null))
(assert
 (and (not (= contrived_variable1 contrived_variable0))
  ((_ is succ) contrived_variable2)))
(assert
...
(assert
 (and (= (leaf x1) contrived_variable4) (is-leaf contrived_variable4)
  (= (data contrived_variable4) x1)))
(assert
...
(assert
 (or
  (and (is-leaf contrived_variable4) (and
   (= (data contrived_variable3) contrived_variable2)
   (= (leaf contrived_variable5) contrived_variable3)
   (= (data contrived_variable3) contrived_variable5)))
  (and (not (is-leaf contrived_variable4)) (= contrived_variable2 zero))))
(assert
