...
(assert (is-null null))
(assert
 (and (and (and (and (and (and ((_ is zero) x2) (not (is-cons x3)))
  (not (= zero contrived_variable0))) (not (is-leaf x5)))
  ((_ is null) null)) (not ((_ is succ) zero))) (= zero x2)))
(assert
 (or
  (and ((_ is succ) zero) (and (= (pred zero) contrived_variable0)
   (= (succ contrived_variable1) zero) (= (pred zero) contrived_variable1)))
