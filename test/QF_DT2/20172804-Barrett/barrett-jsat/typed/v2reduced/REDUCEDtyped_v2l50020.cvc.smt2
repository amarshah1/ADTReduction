...
(assert (is-null null))
(assert
 (and (and (and (and (leaf x5) (not (= x1 zero))) (null x4)) (leaf x6))
  (node contrived_variable0)))
(assert
 (or
  (and (is-cons null) (and (= (car null) contrived_variable0)
   (= (cons contrived_variable1 contrived_variable2) null)
   (= (car null) contrived_variable1) (= (cdr null) contrived_variable2)))
  (and (not (is-cons null)) (and (= (leaf zero) contrived_variable0)
