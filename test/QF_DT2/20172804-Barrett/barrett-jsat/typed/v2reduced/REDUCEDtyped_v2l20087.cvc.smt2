...
(assert (is-null null))
(assert
 (and (is-cons contrived_variable0) (not (is-leaf contrived_variable3))))
(assert
...
(assert
 (or
  (and ((_ is succ) zero) (and (= (pred zero) contrived_variable6)
   (= (succ contrived_variable7) zero) (= (pred zero) contrived_variable7)))
...
(assert
 (or
  (and ((_ is node) contrived_variable2) (and
   ...
   (= (node contrived_variable8) contrived_variable1)
   (= (children contrived_variable1) contrived_variable8)))
...
(assert
 (or
  (and ((_ is succ) contrived_variable6) (and
   ...
   (= (succ contrived_variable9) contrived_variable5)
   (= (pred contrived_variable5) contrived_variable9)))
