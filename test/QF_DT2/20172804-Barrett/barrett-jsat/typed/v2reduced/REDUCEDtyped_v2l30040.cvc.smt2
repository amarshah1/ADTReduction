...
(assert (is-null null))
(assert
 (and (and (not (= x5 contrived_variable0)) (is-cons null))
  (= x6 contrived_variable2)))
(assert
...
(assert
 (or
  (and (is-leaf x6) (and (= (data x6) contrived_variable1)
   (= (leaf contrived_variable4) x6) (= (data x6) contrived_variable4)))
  (and (not (is-leaf x6)) (= contrived_variable1 zero))))
(assert
