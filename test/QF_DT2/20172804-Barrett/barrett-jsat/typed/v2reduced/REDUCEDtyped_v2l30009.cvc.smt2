...
(assert (is-null null))
(assert
 (and (and (not (= x6 contrived_variable0)) ((_ is zero) x1))
  (= contrived_variable3 contrived_variable2)))
(assert
...
(assert
 (and (= (succ x1) contrived_variable2) (is-succ contrived_variable2)
  (= (pred contrived_variable2) x1)))
(assert
 (or
  (and ((_ is succ) x1) (and (= (pred x1) contrived_variable1)
   (= (succ contrived_variable4) x1) (= (pred x1) contrived_variable4)))
