...
(assert (is-null null))
(assert
 (and (and (and (and (and (and (succ x2) (not (= x2 x2)))
  (not (= contrived_variable0 x3))) (= zero contrived_variable1))
  (not (= x2 x2))) (zero contrived_variable4))
  (not (= contrived_variable6 x5))))
(assert
 (and (= (node contrived_variable7) contrived_variable6)
  (is-node contrived_variable6)
  (= (children contrived_variable6) contrived_variable7)))
(assert
 (and (= (cons x5 contrived_variable8) contrived_variable7)
  (is-cons contrived_variable7) (= (car contrived_variable7) x5)
  (= (cdr contrived_variable7) contrived_variable8)))
(assert
 (and (= (succ contrived_variable5) contrived_variable4)
  (is-succ contrived_variable4)
  (= (pred contrived_variable4) contrived_variable5)))
(assert
 (and (= (cons x5 null) contrived_variable8) (is-cons contrived_variable8)
  (= (car contrived_variable8) x5) (= (cdr contrived_variable8) null)))
(assert
 (and (= (leaf x1) contrived_variable3) (is-leaf contrived_variable3)
  (= (data contrived_variable3) x1)))
(assert
 (and (= (succ x2) contrived_variable5) (is-succ contrived_variable5)
  (= (pred contrived_variable5) x2)))
(assert
 (and (= (leaf x1) contrived_variable2) (is-leaf contrived_variable2)
  (= (data contrived_variable2) x1)))
(assert
 (or
  (and (leaf contrived_variable3) (and
   (= (data contrived_variable2) contrived_variable1)
   (= (leaf contrived_variable9) contrived_variable2)
   (= (data contrived_variable2) contrived_variable9)))
  (and (leaf contrived_variable3) (= contrived_variable1 zero))))
(assert
 (or
  (and (is-cons x4) (and (= (cdr x4) contrived_variable0)
   (= (cons contrived_variable10 contrived_variable11) x4)
   (= (car x4) contrived_variable10) (= (cdr x4) contrived_variable11)))
