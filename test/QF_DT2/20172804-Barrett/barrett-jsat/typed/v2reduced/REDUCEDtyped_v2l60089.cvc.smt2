...
(assert (is-null null))
(assert
 (and (and (and (and (and ((_ is leaf) contrived_variable0) (= null x3))
  ((_ is null) contrived_variable3)) (not (= x5 contrived_variable4)))
  (not (= x4 contrived_variable6))) (= contrived_variable10 x6)))
(assert
 (and (= (cons x6 contrived_variable7) contrived_variable6)
  (is-cons contrived_variable6) (= (car contrived_variable6) x6)
  (= (cdr contrived_variable6) contrived_variable7)))
(assert
 (and (= (succ contrived_variable2) contrived_variable1)
...
(assert
 (and (= (node x4) contrived_variable8) (is-node contrived_variable8)
  (= (children contrived_variable8) x4)))
(assert
 (and (= (node x4) contrived_variable9) (is-node contrived_variable9)
  (= (children contrived_variable9) x4)))
(assert
 (and (= (leaf x1) contrived_variable10) (is-leaf contrived_variable10)
  (= (data contrived_variable10) x1)))
(assert
 (or
  (and ((_ is node) contrived_variable9) (and
   (= (children contrived_variable8) contrived_variable7)
   (= (node contrived_variable11) contrived_variable8)
   (= (children contrived_variable8) contrived_variable11)))
  (and (not ((_ is node) contrived_variable9)) (= contrived_variable7 null))))
(assert
 (or
  (and ((_ is node) x5) (and (= (children x5) contrived_variable3)
   (= (node contrived_variable12) x5) (= (children x5) contrived_variable12)))
  (and (not ((_ is node) x5)) (= contrived_variable3 null))))
(assert
 (or
...
(assert
 (or
  (and ((_ is leaf) x6) (and (= (data x6) contrived_variable2)
   (= (leaf contrived_variable14) x6) (= (data x6) contrived_variable14)))
  (and (not ((_ is leaf) x6)) (= contrived_variable2 zero))))
(assert
 (or
...
(assert
 (or
  ...
  (and (not (is-node contrived_variable10)) (is-leaf contrived_variable10))))
(assert
 ...
 (not
  (=
   (pred (data (car (cdr (children (car (children (car
    contrived_variable12))))))))
   (data (car (cdr (children (car (children (car contrived_variable12))))))))))
(assert
 (not
 ...
 (not
  (=
   (pred (data (car (children (car (cdr (children (car
    contrived_variable12))))))))
   (data (car (children (car (cdr (children (car contrived_variable12))))))))))
(assert
 (not
...
(assert
 (not
  (=
   (pred (data (car (cdr (cdr (cdr (children (car contrived_variable12))))))))
   (data (car (cdr (cdr (cdr (children (car contrived_variable12))))))))))
(assert
 (not
...
(assert
 (not
  (=
   (car (cdr (cdr (cdr (cdr (cdr (children (car contrived_variable12))))))))
   (car contrived_variable12))))
(assert
 (not
  (=
   (cdr (cdr (cdr (cdr (cdr (cdr (children (car contrived_variable12))))))))
   (cdr (cdr (cdr (cdr (cdr (children (car contrived_variable12))))))))))
(assert
 (not
  (=
...
(assert
 (not
  (=
   (pred (pred (pred (pred (pred (pred (data (car contrived_variable12))))))))
   (pred (pred (pred (pred (pred (data (car contrived_variable12))))))))))
(assert
 (not
  (=
 ...
 (not
  (=
   (pred (data (car (children (car (children (car (cdr
    contrived_variable12))))))))
   (data (car (children (car (children (car (cdr contrived_variable12))))))))))
(assert
 (not
...
(assert
 (not
  (=
   (pred (data (car (cdr (cdr (children (car (cdr contrived_variable12))))))))
   (data (car (cdr (cdr (children (car (cdr contrived_variable12))))))))))
(assert
 (not
...
(assert
 (not
  (=
   (car (cdr (cdr (cdr (cdr (children (car (cdr contrived_variable12))))))))
   (car (cdr contrived_variable12)))))
(assert
 (not
  (=
   (cdr (cdr (cdr (cdr (cdr (children (car (cdr contrived_variable12))))))))
   (cdr (cdr (cdr (cdr (children (car (cdr contrived_variable12))))))))))
(assert
 (not
  (=
...
(assert
 (not
  (=
   (pred (pred (pred (pred (pred (data (car (cdr contrived_variable12))))))))
   (pred (pred (pred (pred (data (car (cdr contrived_variable12))))))))))
(assert
 (not
  (=
...
(assert
 (not
  (=
   (pred (data (car (cdr (children (car (cdr (cdr contrived_variable12))))))))
   (data (car (cdr (children (car (cdr (cdr contrived_variable12))))))))))
(assert
 (not
...
(assert
 (not
  (=
   (car (cdr (cdr (cdr (children (car (cdr (cdr contrived_variable12))))))))
   (car (cdr (cdr contrived_variable12))))))
(assert
 (not
  (=
   (cdr (cdr (cdr (cdr (children (car (cdr (cdr contrived_variable12))))))))
   (cdr (cdr (cdr (children (car (cdr (cdr contrived_variable12))))))))))
(assert
 (not
  (=
...
(assert
 (not
  (=
   (pred (pred (pred (pred (data (car (cdr (cdr contrived_variable12))))))))
   (pred (pred (pred (data (car (cdr (cdr contrived_variable12))))))))))
(assert
 (not
  (=
...
(assert
 (not
  (=
   (pred (data (car (children (car (cdr (cdr (cdr contrived_variable12))))))))
   (data (car (children (car (cdr (cdr (cdr contrived_variable12))))))))))
(assert
 (not
...
(assert
 (not
  (=
   (car (cdr (cdr (children (car (cdr (cdr (cdr contrived_variable12))))))))
   (car (cdr (cdr (cdr contrived_variable12)))))))
(assert
 (not
  (=
   (cdr (cdr (cdr (children (car (cdr (cdr (cdr contrived_variable12))))))))
   (cdr (cdr (children (car (cdr (cdr (cdr contrived_variable12))))))))))
(assert
 (not
  (=
...
(assert
 (not
  (= (pred (pred (pred (data (car (cdr (cdr (cdr contrived_variable12))))))))
   (pred (pred (data (car (cdr (cdr (cdr contrived_variable12))))))))))
(assert
 (not
  (= (pred (pred (pred (data (car (cdr (cdr (cdr contrived_variable12))))))))
...
(assert
 (not
  (=
   (car (cdr (children (car (cdr (cdr (cdr (cdr contrived_variable12))))))))
   (car (cdr (cdr (cdr (cdr contrived_variable12))))))))
(assert
 (not
  (=
   (cdr (cdr (children (car (cdr (cdr (cdr (cdr contrived_variable12))))))))
   (cdr (children (car (cdr (cdr (cdr (cdr contrived_variable12))))))))))
(assert
 (not
  (=
...
(assert
 (not
  (= (pred (pred (data (car (cdr (cdr (cdr (cdr contrived_variable12))))))))
   (pred (data (car (cdr (cdr (cdr (cdr contrived_variable12))))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (cdr (cdr (cdr contrived_variable12))))))))
...
(assert
 (not
  (=
   (car (children (car (cdr (cdr (cdr (cdr (cdr contrived_variable12))))))))
   (car (cdr (cdr (cdr (cdr (cdr contrived_variable12)))))))))
(assert
 (not
  (=
   (cdr (children (car (cdr (cdr (cdr (cdr (cdr contrived_variable12))))))))
   (children (car (cdr (cdr (cdr (cdr (cdr contrived_variable12))))))))))
(assert
 (not
  (=
...
(assert
 (not
  (= (pred (data (car (cdr (cdr (cdr (cdr (cdr contrived_variable12))))))))
   (data (car (cdr (cdr (cdr (cdr (cdr contrived_variable12))))))))))
(assert
 (not
...
(assert
 (not
  (=
   (children (car (cdr (cdr (cdr (cdr (cdr (cdr contrived_variable12))))))))
   (cdr (cdr (cdr (cdr (cdr (cdr contrived_variable12)))))))))
(assert
 (not
  (=
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr (cdr contrived_variable12))))))))
   (cdr (cdr (cdr (cdr (cdr (cdr (cdr contrived_variable12))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr (cdr contrived_variable12))))))))
...
(assert
 (not
  (=
   (pred (data (car (cdr (children (car (children (car
    contrived_variable11))))))))
   (data (car (cdr (children (car (children (car contrived_variable11))))))))))
(assert
 (not
...
(assert
 (not
  (=
   (pred (data (car (children (car (cdr (children (car
    contrived_variable11))))))))
   (data (car (children (car (cdr (children (car contrived_variable11))))))))))
(assert
 (not
...
(assert
 (not
  (=
   (pred (data (car (cdr (cdr (cdr (children (car contrived_variable11))))))))
   (data (car (cdr (cdr (cdr (children (car contrived_variable11))))))))))
(assert
 (not
...
(assert
 (not
  (=
   (car (cdr (cdr (cdr (cdr (cdr (children (car contrived_variable11))))))))
   (car contrived_variable11))))
(assert
 (not
  (=
   (cdr (cdr (cdr (cdr (cdr (cdr (children (car contrived_variable11))))))))
   (cdr (cdr (cdr (cdr (cdr (children (car contrived_variable11))))))))))
(assert
 (not
  (=
...
(assert
 (not
  (=
   (pred (pred (pred (pred (pred (pred (data (car contrived_variable11))))))))
   (pred (pred (pred (pred (pred (data (car contrived_variable11))))))))))
(assert
 (not
  (=
...
(assert
 (not
  (=
   (pred (data (car (children (car (children (car (cdr
    contrived_variable11))))))))
   (data (car (children (car (children (car (cdr contrived_variable11))))))))))
(assert
 (not
...
(assert
 (not
  (=
   (pred (data (car (cdr (cdr (children (car (cdr contrived_variable11))))))))
   (data (car (cdr (cdr (children (car (cdr contrived_variable11))))))))))
(assert
 (not
...
(assert
 (not
  (=
   (car (cdr (cdr (cdr (cdr (children (car (cdr contrived_variable11))))))))
   (car (cdr contrived_variable11)))))
(assert
 (not
  (=
   (cdr (cdr (cdr (cdr (cdr (children (car (cdr contrived_variable11))))))))
   (cdr (cdr (cdr (cdr (children (car (cdr contrived_variable11))))))))))
(assert
 (not
  (=
...
(assert
 (not
  (=
   (pred (pred (pred (pred (pred (data (car (cdr contrived_variable11))))))))
   (pred (pred (pred (pred (data (car (cdr contrived_variable11))))))))))
(assert
 (not
  (=
...
(assert
 (not
  (=
   (pred (data (car (cdr (children (car (cdr (cdr contrived_variable11))))))))
   (data (car (cdr (children (car (cdr (cdr contrived_variable11))))))))))
(assert
 (not
...
(assert
 (not
  (=
   (car (cdr (cdr (cdr (children (car (cdr (cdr contrived_variable11))))))))
   (car (cdr (cdr contrived_variable11))))))
(assert
 (not
  (=
   (cdr (cdr (cdr (cdr (children (car (cdr (cdr contrived_variable11))))))))
   (cdr (cdr (cdr (children (car (cdr (cdr contrived_variable11))))))))))
(assert
 (not
  (=
...
(assert
 (not
  (=
   (pred (pred (pred (pred (data (car (cdr (cdr contrived_variable11))))))))
   (pred (pred (pred (data (car (cdr (cdr contrived_variable11))))))))))
(assert
 (not
  (=
...
(assert
 (not
  (=
   (pred (data (car (children (car (cdr (cdr (cdr contrived_variable11))))))))
   (data (car (children (car (cdr (cdr (cdr contrived_variable11))))))))))
(assert
 (not
...
(assert
 (not
  (=
   (car (cdr (cdr (children (car (cdr (cdr (cdr contrived_variable11))))))))
   (car (cdr (cdr (cdr contrived_variable11)))))))
(assert
 (not
  (=
   (cdr (cdr (cdr (children (car (cdr (cdr (cdr contrived_variable11))))))))
   (cdr (cdr (children (car (cdr (cdr (cdr contrived_variable11))))))))))
(assert
 (not
  (=
...
(assert
 (not
  (= (pred (pred (pred (data (car (cdr (cdr (cdr contrived_variable11))))))))
   (pred (pred (data (car (cdr (cdr (cdr contrived_variable11))))))))))
(assert
 (not
  (= (pred (pred (pred (data (car (cdr (cdr (cdr contrived_variable11))))))))
...
(assert
 (not
  (=
   (car (cdr (children (car (cdr (cdr (cdr (cdr contrived_variable11))))))))
   (car (cdr (cdr (cdr (cdr contrived_variable11))))))))
(assert
 (not
  (=
   (cdr (cdr (children (car (cdr (cdr (cdr (cdr contrived_variable11))))))))
   (cdr (children (car (cdr (cdr (cdr (cdr contrived_variable11))))))))))
(assert
 (not
  (=
...
(assert
 (not
  (= (pred (pred (data (car (cdr (cdr (cdr (cdr contrived_variable11))))))))
   (pred (data (car (cdr (cdr (cdr (cdr contrived_variable11))))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (cdr (cdr (cdr contrived_variable11))))))))
...
(assert
 (not
  (=
   (car (children (car (cdr (cdr (cdr (cdr (cdr contrived_variable11))))))))
   (car (cdr (cdr (cdr (cdr (cdr contrived_variable11)))))))))
(assert
 (not
  (=
   (cdr (children (car (cdr (cdr (cdr (cdr (cdr contrived_variable11))))))))
   (children (car (cdr (cdr (cdr (cdr (cdr contrived_variable11))))))))))
(assert
 (not
  (=
...
(assert
 (not
  (= (pred (data (car (cdr (cdr (cdr (cdr (cdr contrived_variable11))))))))
   (data (car (cdr (cdr (cdr (cdr (cdr contrived_variable11))))))))))
(assert
 (not
...
(assert
 (not
  (=
   (children (car (cdr (cdr (cdr (cdr (cdr (cdr contrived_variable11))))))))
   (cdr (cdr (cdr (cdr (cdr (cdr contrived_variable11)))))))))
(assert
 (not
  (=
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr (cdr contrived_variable11))))))))
   (cdr (cdr (cdr (cdr (cdr (cdr (cdr contrived_variable11))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr (cdr contrived_variable11))))))))
...
(assert
 (not
  (= (children (car (children (car (children (car (children (car x3))))))))
   (children (car (children (car (children (car x3)))))))))
(assert
 (not
  (= (children (car (children (car (children (car (children (car x3))))))))
...
(assert
 (not
  (= (car (cdr (children (car (children (car (children (car x3))))))))
   (car (children (car (children (car x3))))))))
(assert
 (not
  (= (car (cdr (children (car (children (car (children (car x3))))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (children (car (children (car x3))))))))
   (cdr (children (car (children (car (children (car x3))))))))))
(assert
 (not
  (= (cdr (cdr (children (car (children (car (children (car x3))))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (children (car (children (car x3)))))))) x3)))
(assert
 (not
...
(assert
 (not
  (= (pred (pred (data (car (children (car (children (car x3))))))))
   (pred (data (car (children (car (children (car x3))))))))))
(assert
 (not
  (= (pred (pred (data (car (children (car (children (car x3))))))))
...
(assert
 (not
  (= (car (children (car (cdr (children (car (children (car x3))))))))
   (car (cdr (children (car (children (car x3)))))))))
(assert
 (not
  (= (car (children (car (cdr (children (car (children (car x3))))))))
...
(assert
 (not
  (= (cdr (children (car (cdr (children (car (children (car x3))))))))
   (children (car (cdr (children (car (children (car x3))))))))))
(assert
 (not
  (= (cdr (children (car (cdr (children (car (children (car x3))))))))
...
(assert
 (not
  (= (cdr (children (car (cdr (children (car (children (car x3)))))))) x3)))
(assert
 (not
  (= (pred (data (car (cdr (children (car (children (car x3))))))))
   (data (car (cdr (children (car (children (car x3))))))))))
(assert
 (not
...
(assert
 (not
  (= (children (car (cdr (cdr (children (car (children (car x3))))))))
   (cdr (cdr (children (car (children (car x3)))))))))
(assert
 (not
  (= (children (car (cdr (cdr (children (car (children (car x3))))))))
...
(assert
 (not
  (= (children (car (cdr (cdr (children (car (children (car x3)))))))) x3)))
(assert
 (not
...
(assert
 (not
  (= (car (cdr (cdr (cdr (children (car (children (car x3))))))))
   (car (children (car x3))))))
(assert
 (not
  (= (car (cdr (cdr (cdr (children (car (children (car x3)))))))) (car x3))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (children (car x3))))))))
   (cdr (cdr (cdr (children (car (children (car x3))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (children (car x3))))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (children (car x3))))))))
   (children (car x3)))))
(assert
 (not (= (cdr (cdr (cdr (cdr (children (car (children (car x3)))))))) x3)))
(assert
 (not
...
(assert
 (not
  (= (pred (pred (pred (pred (data (car (children (car x3))))))))
   (pred (pred (pred (data (car (children (car x3))))))))))
(assert
 (not
  (= (pred (pred (pred (pred (data (car (children (car x3))))))))
...
(assert
 (not
  (= (car (children (car (children (car (cdr (children (car x3))))))))
   (car (children (car (cdr (children (car x3)))))))))
(assert
 (not
  (= (car (children (car (children (car (cdr (children (car x3))))))))
...
(assert
 (not
  (= (cdr (children (car (children (car (cdr (children (car x3))))))))
   (children (car (children (car (cdr (children (car x3))))))))))
(assert
 (not
  (= (cdr (children (car (children (car (cdr (children (car x3))))))))
...
(assert
 (not
  (= (cdr (children (car (children (car (cdr (children (car x3)))))))) x3)))
(assert
 (not
  (= (pred (data (car (children (car (cdr (children (car x3))))))))
   (data (car (children (car (cdr (children (car x3))))))))))
(assert
 (not
...
(assert
 (not
  (= (children (car (cdr (children (car (cdr (children (car x3))))))))
   (cdr (children (car (cdr (children (car x3)))))))))
(assert
 (not
  (= (children (car (cdr (children (car (cdr (children (car x3))))))))
...
(assert
 (not
  (= (children (car (cdr (children (car (cdr (children (car x3)))))))) x3)))
(assert
 (not
...
(assert
 (not
  (= (car (cdr (cdr (children (car (cdr (children (car x3))))))))
   (car (cdr (children (car x3)))))))
(assert
 (not
  (= (car (cdr (cdr (children (car (cdr (children (car x3)))))))) (car x3))))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (children (car x3))))))))
   (cdr (cdr (children (car (cdr (children (car x3))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (children (car x3))))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (children (car x3))))))))
   (children (car x3)))))
(assert
 (not (= (cdr (cdr (cdr (children (car (cdr (children (car x3)))))))) x3)))
(assert
 (not
...
(assert
 (not
  (= (pred (pred (pred (data (car (cdr (children (car x3))))))))
   (pred (pred (data (car (cdr (children (car x3))))))))))
(assert
 (not
  (= (pred (pred (pred (data (car (cdr (children (car x3))))))))
...
(assert
 (not
  (= (children (car (children (car (cdr (cdr (children (car x3))))))))
   (children (car (cdr (cdr (children (car x3)))))))))
(assert
 (not
  (= (children (car (children (car (cdr (cdr (children (car x3))))))))
...
(assert
 (not
  (= (children (car (children (car (cdr (cdr (children (car x3)))))))) x3)))
(assert
 (not
...
(assert
 (not
  (= (car (cdr (children (car (cdr (cdr (children (car x3))))))))
   (car (cdr (cdr (children (car x3))))))))
(assert
 (not
  (= (car (cdr (children (car (cdr (cdr (children (car x3)))))))) (car x3))))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (children (car x3))))))))
   (cdr (children (car (cdr (cdr (children (car x3))))))))))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (children (car x3))))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (children (car x3))))))))
   (children (car x3)))))
(assert
 (not (= (cdr (cdr (children (car (cdr (cdr (children (car x3)))))))) x3)))
(assert
 (not
...
(assert
 (not
  (= (pred (pred (data (car (cdr (cdr (children (car x3))))))))
   (pred (data (car (cdr (cdr (children (car x3))))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (cdr (children (car x3))))))))
...
(assert
 (not
  (= (car (children (car (cdr (cdr (cdr (children (car x3))))))))
   (car (cdr (cdr (cdr (children (car x3)))))))))
(assert
 (not
  (= (car (children (car (cdr (cdr (cdr (children (car x3)))))))) (car x3))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (children (car x3))))))))
   (children (car (cdr (cdr (cdr (children (car x3))))))))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (children (car x3))))))))
...
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (children (car x3))))))))
   (children (car x3)))))
(assert
 (not (= (cdr (children (car (cdr (cdr (cdr (children (car x3)))))))) x3)))
(assert
 (not
  (= (pred (data (car (cdr (cdr (cdr (children (car x3))))))))
   (data (car (cdr (cdr (cdr (children (car x3))))))))))
(assert
 (not
...
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (children (car x3))))))))
   (cdr (cdr (cdr (cdr (children (car x3)))))))))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (children (car x3))))))))
...
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (children (car x3))))))))
   (children (car x3)))))
(assert
 (not (= (children (car (cdr (cdr (cdr (cdr (children (car x3)))))))) x3)))
(assert
 (not
...
(assert
 (not (= (car (cdr (cdr (cdr (cdr (cdr (children (car x3)))))))) (car x3))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (children (car x3))))))))
   (cdr (cdr (cdr (cdr (cdr (children (car x3))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (children (car x3))))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (children (car x3))))))))
   (children (car x3)))))
(assert (not (= (cdr (cdr (cdr (cdr (cdr (cdr (children (car x3)))))))) x3)))
...
(assert
 (not
  (= (pred (pred (pred (pred (pred (pred (data (car x3))))))))
   (pred (pred (pred (pred (pred (data (car x3))))))))))
(assert
 (not
  (= (pred (pred (pred (pred (pred (pred (data (car x3))))))))
...
(assert
 (not
  (= (car (children (car (children (car (children (car (cdr x3))))))))
   (car (children (car (children (car (cdr x3)))))))))
(assert
 (not
  (= (car (children (car (children (car (children (car (cdr x3))))))))
...
(assert
 (not
  (= (cdr (children (car (children (car (children (car (cdr x3))))))))
   (children (car (children (car (children (car (cdr x3))))))))))
(assert
 (not
  (= (cdr (children (car (children (car (children (car (cdr x3))))))))
...
(assert
 (not
  (= (cdr (children (car (children (car (children (car (cdr x3)))))))) x3)))
(assert
 (not
  (= (pred (data (car (children (car (children (car (cdr x3))))))))
   (data (car (children (car (children (car (cdr x3))))))))))
(assert
 (not
...
(assert
 (not
  (= (children (car (cdr (children (car (children (car (cdr x3))))))))
   (cdr (children (car (children (car (cdr x3)))))))))
(assert
 (not
  (= (children (car (cdr (children (car (children (car (cdr x3))))))))
...
(assert
 (not
  (= (children (car (cdr (children (car (children (car (cdr x3)))))))) x3)))
(assert
 (not
...
(assert
 (not
  (= (car (cdr (cdr (children (car (children (car (cdr x3))))))))
   (car (children (car (cdr x3)))))))
(assert
 (not
  (= (car (cdr (cdr (children (car (children (car (cdr x3))))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (children (car (children (car (cdr x3))))))))
   (cdr (cdr (children (car (children (car (cdr x3))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (children (car (cdr x3))))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (children (car (children (car (cdr x3)))))))) (cdr x3))))
(assert
 (not (= (cdr (cdr (cdr (children (car (children (car (cdr x3)))))))) x3)))
(assert
 (not
...
(assert
 (not
  (= (pred (pred (pred (data (car (children (car (cdr x3))))))))
   (pred (pred (data (car (children (car (cdr x3))))))))))
(assert
 (not
  (= (pred (pred (pred (data (car (children (car (cdr x3))))))))
...
(assert
 (not
  (= (children (car (children (car (cdr (children (car (cdr x3))))))))
   (children (car (cdr (children (car (cdr x3)))))))))
(assert
 (not
  (= (children (car (children (car (cdr (children (car (cdr x3))))))))
...
(assert
 (not
  (= (children (car (children (car (cdr (children (car (cdr x3)))))))) x3)))
(assert
 (not
...
(assert
 (not
  (= (car (cdr (children (car (cdr (children (car (cdr x3))))))))
   (car (cdr (children (car (cdr x3))))))))
(assert
 (not
  (= (car (cdr (children (car (cdr (children (car (cdr x3))))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (cdr (children (car (cdr x3))))))))
   (cdr (children (car (cdr (children (car (cdr x3))))))))))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (children (car (cdr x3))))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (cdr (children (car (cdr x3)))))))) (cdr x3))))
(assert
 (not (= (cdr (cdr (children (car (cdr (children (car (cdr x3)))))))) x3)))
(assert
 (not
...
(assert
 (not
  (= (pred (pred (data (car (cdr (children (car (cdr x3))))))))
   (pred (data (car (cdr (children (car (cdr x3))))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (children (car (cdr x3))))))))
...
(assert
 (not
  (= (car (children (car (cdr (cdr (children (car (cdr x3))))))))
   (car (cdr (cdr (children (car (cdr x3)))))))))
(assert
 (not
  (= (car (children (car (cdr (cdr (children (car (cdr x3))))))))
   (car (cdr x3)))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (children (car (cdr x3))))))))
   (children (car (cdr (cdr (children (car (cdr x3))))))))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (children (car (cdr x3))))))))
...
(assert
 (not
  (= (cdr (children (car (cdr (cdr (children (car (cdr x3)))))))) (cdr x3))))
(assert
 (not (= (cdr (children (car (cdr (cdr (children (car (cdr x3)))))))) x3)))
(assert
 (not
  (= (pred (data (car (cdr (cdr (children (car (cdr x3))))))))
   (data (car (cdr (cdr (children (car (cdr x3))))))))))
(assert
 (not
...
(assert
 (not
  (= (children (car (cdr (cdr (cdr (children (car (cdr x3))))))))
   (cdr (cdr (cdr (children (car (cdr x3)))))))))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (children (car (cdr x3))))))))
...
(assert
 (not
  (= (children (car (cdr (cdr (cdr (children (car (cdr x3)))))))) (cdr x3))))
(assert
 (not (= (children (car (cdr (cdr (cdr (children (car (cdr x3)))))))) x3)))
(assert
 (not
...
(assert
 (not
  (= (car (cdr (cdr (cdr (cdr (children (car (cdr x3)))))))) (car (cdr x3)))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (children (car (cdr x3))))))))
   (cdr (cdr (cdr (cdr (children (car (cdr x3))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (children (car (cdr x3))))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (children (car (cdr x3))))))))
   (children (car (cdr x3))))))
(assert
 (not (= (cdr (cdr (cdr (cdr (cdr (children (car (cdr x3)))))))) (cdr x3))))
(assert (not (= (cdr (cdr (cdr (cdr (cdr (children (car (cdr x3)))))))) x3)))
...
(assert
 (not
  (= (pred (pred (pred (pred (pred (data (car (cdr x3))))))))
   (pred (pred (pred (pred (data (car (cdr x3))))))))))
(assert
 (not
  (= (pred (pred (pred (pred (pred (data (car (cdr x3))))))))
...
(assert
 (not
  (= (children (car (children (car (children (car (cdr (cdr x3))))))))
   (children (car (children (car (cdr (cdr x3)))))))))
(assert
 (not
  (= (children (car (children (car (children (car (cdr (cdr x3))))))))
...
(assert
 (not
  (= (children (car (children (car (children (car (cdr (cdr x3)))))))) x3)))
(assert
 (not
...
(assert
 (not
  (= (car (cdr (children (car (children (car (cdr (cdr x3))))))))
   (car (children (car (cdr (cdr x3))))))))
(assert
 (not
  (= (car (cdr (children (car (children (car (cdr (cdr x3))))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (children (car (cdr (cdr x3))))))))
   (cdr (children (car (children (car (cdr (cdr x3))))))))))
(assert
 (not
  (= (cdr (cdr (children (car (children (car (cdr (cdr x3))))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (children (car (cdr (cdr x3)))))))) (cdr x3))))
(assert
 (not (= (cdr (cdr (children (car (children (car (cdr (cdr x3)))))))) x3)))
(assert
 (not
...
(assert
 (not
  (= (pred (pred (data (car (children (car (cdr (cdr x3))))))))
   (pred (data (car (children (car (cdr (cdr x3))))))))))
(assert
 (not
  (= (pred (pred (data (car (children (car (cdr (cdr x3))))))))
...
(assert
 (not
  (= (car (children (car (cdr (children (car (cdr (cdr x3))))))))
   (car (cdr (children (car (cdr (cdr x3)))))))))
(assert
 (not
  (= (car (children (car (cdr (children (car (cdr (cdr x3))))))))
   (car (cdr (cdr x3))))))
(assert
 (not
  (= (cdr (children (car (cdr (children (car (cdr (cdr x3))))))))
   (children (car (cdr (children (car (cdr (cdr x3))))))))))
(assert
 (not
  (= (cdr (children (car (cdr (children (car (cdr (cdr x3))))))))
...
(assert
 (not
  (= (cdr (children (car (cdr (children (car (cdr (cdr x3)))))))) (cdr x3))))
(assert
 (not (= (cdr (children (car (cdr (children (car (cdr (cdr x3)))))))) x3)))
(assert
 (not
  (= (pred (data (car (cdr (children (car (cdr (cdr x3))))))))
   (data (car (cdr (children (car (cdr (cdr x3))))))))))
(assert
 (not
...
(assert
 (not
  (= (children (car (cdr (cdr (children (car (cdr (cdr x3))))))))
   (cdr (cdr (children (car (cdr (cdr x3)))))))))
(assert
 (not
  (= (children (car (cdr (cdr (children (car (cdr (cdr x3))))))))
...
(assert
 (not
  (= (children (car (cdr (cdr (children (car (cdr (cdr x3)))))))) (cdr x3))))
(assert
 (not (= (children (car (cdr (cdr (children (car (cdr (cdr x3)))))))) x3)))
(assert
 (not
...
(assert
 (not
  (= (car (cdr (cdr (cdr (children (car (cdr (cdr x3))))))))
   (car (cdr (cdr x3))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (cdr (cdr x3))))))))
   (cdr (cdr (cdr (children (car (cdr (cdr x3))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (cdr (cdr x3))))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (cdr (cdr x3)))))))) (cdr (cdr x3)))))
(assert
 (not (= (cdr (cdr (cdr (cdr (children (car (cdr (cdr x3)))))))) (cdr x3))))
(assert (not (= (cdr (cdr (cdr (cdr (children (car (cdr (cdr x3)))))))) x3)))
(assert
...
(assert
 (not
  (= (pred (pred (pred (pred (data (car (cdr (cdr x3))))))))
   (pred (pred (pred (data (car (cdr (cdr x3))))))))))
(assert
 (not
  (= (pred (pred (pred (pred (data (car (cdr (cdr x3))))))))
...
(assert
 (not
  (= (car (children (car (children (car (cdr (cdr (cdr x3))))))))
   (car (children (car (cdr (cdr (cdr x3)))))))))
(assert
 (not
  (= (car (children (car (children (car (cdr (cdr (cdr x3))))))))
   (car (cdr (cdr (cdr x3)))))))
(assert
 (not
  (= (cdr (children (car (children (car (cdr (cdr (cdr x3))))))))
   (children (car (children (car (cdr (cdr (cdr x3))))))))))
(assert
 (not
  (= (cdr (children (car (children (car (cdr (cdr (cdr x3))))))))
...
(assert
 (not
  (= (cdr (children (car (children (car (cdr (cdr (cdr x3)))))))) (cdr x3))))
(assert
 (not (= (cdr (children (car (children (car (cdr (cdr (cdr x3)))))))) x3)))
(assert
 (not
  (= (pred (data (car (children (car (cdr (cdr (cdr x3))))))))
   (data (car (children (car (cdr (cdr (cdr x3))))))))))
(assert
 (not
...
(assert
 (not
  (= (children (car (cdr (children (car (cdr (cdr (cdr x3))))))))
   (cdr (children (car (cdr (cdr (cdr x3)))))))))
(assert
 (not
  (= (children (car (cdr (children (car (cdr (cdr (cdr x3))))))))
...
(assert
 (not
  (= (children (car (cdr (children (car (cdr (cdr (cdr x3)))))))) (cdr x3))))
(assert
 (not (= (children (car (cdr (children (car (cdr (cdr (cdr x3)))))))) x3)))
(assert
 (not
...
(assert
 (not
  (= (car (cdr (cdr (children (car (cdr (cdr (cdr x3))))))))
   (car (cdr (cdr (cdr x3)))))))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (cdr (cdr x3))))))))
   (cdr (cdr (children (car (cdr (cdr (cdr x3))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (cdr (cdr x3))))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (cdr (cdr x3)))))))) (cdr (cdr x3)))))
(assert
 (not (= (cdr (cdr (cdr (children (car (cdr (cdr (cdr x3)))))))) (cdr x3))))
(assert (not (= (cdr (cdr (cdr (children (car (cdr (cdr (cdr x3)))))))) x3)))
(assert
 (not
...
(assert
 (not
  (= (pred (pred (pred (data (car (cdr (cdr (cdr x3))))))))
   (pred (pred (data (car (cdr (cdr (cdr x3))))))))))
(assert
 (not
  (= (pred (pred (pred (data (car (cdr (cdr (cdr x3))))))))
...
(assert
 (not
  (= (children (car (children (car (cdr (cdr (cdr (cdr x3))))))))
...
(assert
 (not
  (= (children (car (children (car (cdr (cdr (cdr (cdr x3)))))))) (cdr x3))))
(assert
 (not (= (children (car (children (car (cdr (cdr (cdr (cdr x3)))))))) x3)))
(assert
 (not
...
(assert
 (not
  (= (car (cdr (children (car (cdr (cdr (cdr (cdr x3))))))))
   (car (cdr (cdr (cdr (cdr x3))))))))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (cdr (cdr x3))))))))
   (cdr (children (car (cdr (cdr (cdr (cdr x3))))))))))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (cdr (cdr x3))))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (cdr (cdr x3)))))))) (cdr (cdr x3)))))
(assert
 (not (= (cdr (cdr (children (car (cdr (cdr (cdr (cdr x3)))))))) (cdr x3))))
(assert (not (= (cdr (cdr (children (car (cdr (cdr (cdr (cdr x3)))))))) x3)))
(assert
 (not
...
(assert
 (not
  (= (pred (pred (data (car (cdr (cdr (cdr (cdr x3))))))))
   (pred (data (car (cdr (cdr (cdr (cdr x3))))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (cdr (cdr (cdr x3))))))))
...
(assert
 (not
  (= (car (children (car (cdr (cdr (cdr (cdr (cdr x3))))))))
   (car (cdr (cdr (cdr (cdr (cdr x3)))))))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (cdr (cdr x3))))))))
   (children (car (cdr (cdr (cdr (cdr (cdr x3))))))))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (cdr (cdr x3))))))))
...
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (cdr (cdr x3)))))))) (cdr (cdr x3)))))
(assert
 (not (= (cdr (children (car (cdr (cdr (cdr (cdr (cdr x3)))))))) (cdr x3))))
(assert (not (= (cdr (children (car (cdr (cdr (cdr (cdr (cdr x3)))))))) x3)))
(assert
 (not
  (= (pred (data (car (cdr (cdr (cdr (cdr (cdr x3))))))))
   (data (car (cdr (cdr (cdr (cdr (cdr x3))))))))))
(assert
 (not
...
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (cdr (cdr x3))))))))
...
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (cdr (cdr x3)))))))) (cdr (cdr x3)))))
(assert
 (not (= (children (car (cdr (cdr (cdr (cdr (cdr (cdr x3)))))))) (cdr x3))))
(assert (not (= (children (car (cdr (cdr (cdr (cdr (cdr (cdr x3)))))))) x3)))
(assert
 (not
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr (cdr x3))))))))
   (cdr (cdr (cdr (cdr (cdr (cdr (cdr x3))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr (cdr x3))))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr (cdr x3)))))))) (cdr (cdr (cdr x3))))))
(assert
 (not (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr (cdr x3)))))))) (cdr (cdr x3)))))
(assert (not (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr (cdr x3)))))))) (cdr x3))))
(assert (not (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr (cdr x3)))))))) x3)))
...
(assert (not (= (car (children contrived_variable10)) contrived_variable10)))
(assert
 (not
  (= (children (car (children contrived_variable10)))
   (children contrived_variable10))))
(assert
 (not
  (= (car (children (car (children contrived_variable10))))
   (car (children contrived_variable10)))))
(assert
 (not
  (= (car (children (car (children contrived_variable10))))
...
(assert
 (not
  (= (children (car (children (car (children contrived_variable10)))))
   (children (car (children contrived_variable10))))))
(assert
 (not
  (= (children (car (children (car (children contrived_variable10)))))
...
(assert
 (not
  (= (car (children (car (children (car (children contrived_variable10))))))
   (car (children (car (children contrived_variable10)))))))
(assert
 (not
  (= (car (children (car (children (car (children contrived_variable10))))))
...
(assert
 (not
  (= (cdr (children (car (children (car (children contrived_variable10))))))
   (children (car (children (car (children contrived_variable10))))))))
(assert
 (not
  (= (cdr (children (car (children (car (children contrived_variable10))))))
...
(assert
 (not
  (= (pred (data (car (children (car (children contrived_variable10))))))
   (data (car (children (car (children contrived_variable10))))))))
(assert
 (not
  (=
   (pred (pred (data (car (children (car (children contrived_variable10)))))))
   (pred (data (car (children (car (children contrived_variable10)))))))))
(assert
 (not
  (=
...
(assert
 (not
  (= (cdr (children (car (children contrived_variable10))))
   (children (car (children contrived_variable10))))))
(assert
 (not
  (= (cdr (children (car (children contrived_variable10))))
...
(assert
 (not
  (= (car (cdr (children (car (children contrived_variable10)))))
   (car (children contrived_variable10)))))
(assert
 (not
  (= (car (cdr (children (car (children contrived_variable10)))))
...
(assert
 (not
  (= (children (car (cdr (children (car (children contrived_variable10))))))
   (cdr (children (car (children contrived_variable10)))))))
(assert
 (not
  (= (children (car (cdr (children (car (children contrived_variable10))))))
...
(assert
 (not
  (=
   (pred (data (car (cdr (children (car (children contrived_variable10)))))))
   (data (car (cdr (children (car (children contrived_variable10)))))))))
(assert
 (not
  (= (cdr (cdr (children (car (children contrived_variable10)))))
   (cdr (children (car (children contrived_variable10)))))))
(assert
 (not
  (= (cdr (cdr (children (car (children contrived_variable10)))))
...
(assert
 (not
  (= (car (cdr (cdr (children (car (children contrived_variable10))))))
   (car (children contrived_variable10)))))
(assert
 (not
  (= (car (cdr (cdr (children (car (children contrived_variable10))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (children (car (children contrived_variable10))))))
   (cdr (cdr (children (car (children contrived_variable10))))))))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (children contrived_variable10))))))
...
(assert
 (not
  (= (car (cdr (cdr (cdr (children (car (children contrived_variable10)))))))
   (car (children contrived_variable10)))))
(assert
 (not
  (= (car (cdr (cdr (cdr (children (car (children contrived_variable10)))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (children contrived_variable10)))))))
   (cdr (cdr (cdr (children (car (children contrived_variable10)))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (children contrived_variable10)))))))
...
(assert
 (not
  (= (pred (data (car (children contrived_variable10))))
   (data (car (children contrived_variable10))))))
(assert
 (not
  (= (pred (pred (data (car (children contrived_variable10)))))
   (pred (data (car (children contrived_variable10)))))))
(assert
 (not
  (= (pred (pred (data (car (children contrived_variable10)))))
...
(assert
 (not
  (= (pred (pred (pred (data (car (children contrived_variable10))))))
   (pred (pred (data (car (children contrived_variable10))))))))
(assert
 (not
  (= (pred (pred (pred (data (car (children contrived_variable10))))))
...
(assert
 (not
  (= (pred (pred (pred (pred (data (car (children contrived_variable10)))))))
   (pred (pred (pred (data (car (children contrived_variable10)))))))))
(assert
 (not
  (= (pred (pred (pred (pred (data (car (children contrived_variable10)))))))
...
(assert
 (not
  (= (cdr (children contrived_variable10)) (children contrived_variable10))))
(assert
 (not (= (car (cdr (children contrived_variable10))) contrived_variable10)))
(assert
 (not
  (= (children (car (cdr (children contrived_variable10))))
   (cdr (children contrived_variable10)))))
(assert
 (not
  (= (children (car (cdr (children contrived_variable10))))
   (children contrived_variable10))))
(assert
 (not
  (= (car (children (car (cdr (children contrived_variable10)))))
   (car (cdr (children contrived_variable10))))))
(assert
 (not
  (= (car (children (car (cdr (children contrived_variable10)))))
   contrived_variable10)))
(assert
 (not
  (= (children (car (children (car (cdr (children contrived_variable10))))))
   (children (car (cdr (children contrived_variable10)))))))
(assert
 (not
  (= (children (car (children (car (cdr (children contrived_variable10))))))
...
(assert
 (not
  (=
   (pred (data (car (children (car (cdr (children contrived_variable10)))))))
   (data (car (children (car (cdr (children contrived_variable10)))))))))
(assert
 (not
  (= (cdr (children (car (cdr (children contrived_variable10)))))
   (children (car (cdr (children contrived_variable10)))))))
(assert
 (not
  (= (cdr (children (car (cdr (children contrived_variable10)))))
...
(assert
 (not
  (= (car (cdr (children (car (cdr (children contrived_variable10))))))
   (car (cdr (children contrived_variable10))))))
(assert
 (not
  (= (car (cdr (children (car (cdr (children contrived_variable10))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (cdr (children contrived_variable10))))))
   (cdr (children (car (cdr (children contrived_variable10))))))))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (children contrived_variable10))))))
...
(assert
 (not
  (= (car (cdr (cdr (children (car (cdr (children contrived_variable10)))))))
   (car (cdr (children contrived_variable10))))))
(assert
 (not
  (= (car (cdr (cdr (children (car (cdr (children contrived_variable10)))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (children contrived_variable10)))))))
   (cdr (cdr (children (car (cdr (children contrived_variable10)))))))))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (children contrived_variable10)))))))
...
(assert
 (not
  (= (pred (data (car (cdr (children contrived_variable10)))))
   (data (car (cdr (children contrived_variable10)))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (children contrived_variable10))))))
   (pred (data (car (cdr (children contrived_variable10))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (children contrived_variable10))))))
...
(assert
 (not
  (= (pred (pred (pred (data (car (cdr (children contrived_variable10)))))))
   (pred (pred (data (car (cdr (children contrived_variable10)))))))))
(assert
 (not
  (= (pred (pred (pred (data (car (cdr (children contrived_variable10)))))))
...
(assert
 (not
  (= (cdr (cdr (children contrived_variable10)))
   (cdr (children contrived_variable10)))))
(assert
 (not
  (= (cdr (cdr (children contrived_variable10)))
...
(assert
 (not
  (= (car (cdr (cdr (children contrived_variable10)))) contrived_variable10)))
(assert
 (not
  (= (children (car (cdr (cdr (children contrived_variable10)))))
   (cdr (cdr (children contrived_variable10))))))
(assert
 (not
  (= (children (car (cdr (cdr (children contrived_variable10)))))
...
(assert
 (not
  (= (car (children (car (cdr (cdr (children contrived_variable10))))))
   (car (cdr (cdr (children contrived_variable10)))))))
(assert
 (not
  (= (car (children (car (cdr (cdr (children contrived_variable10))))))
   contrived_variable10)))
...
(assert
 (not
  (= (cdr (children (car (cdr (cdr (children contrived_variable10))))))
   (children (car (cdr (cdr (children contrived_variable10))))))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (children contrived_variable10))))))
...
(assert
 (not
  (= (car (cdr (children (car (cdr (cdr (children contrived_variable10)))))))
   (car (cdr (cdr (children contrived_variable10)))))))
(assert
 (not
  (= (car (cdr (children (car (cdr (cdr (children contrived_variable10)))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (children contrived_variable10)))))))
   (cdr (children (car (cdr (cdr (children contrived_variable10)))))))))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (children contrived_variable10)))))))
...
(assert
 (not
  (= (pred (data (car (cdr (cdr (children contrived_variable10))))))
   (data (car (cdr (cdr (children contrived_variable10))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (cdr (children contrived_variable10)))))))
   (pred (data (car (cdr (cdr (children contrived_variable10)))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (cdr (children contrived_variable10)))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (children contrived_variable10))))
   (cdr (cdr (children contrived_variable10))))))
(assert
 (not
  (= (cdr (cdr (cdr (children contrived_variable10))))
...
(assert
 (not
  (= (car (cdr (cdr (cdr (children contrived_variable10)))))
   contrived_variable10)))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (children contrived_variable10))))))
   (cdr (cdr (cdr (children contrived_variable10)))))))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (children contrived_variable10))))))
...
(assert
 (not
  (= (car (children (car (cdr (cdr (cdr (children contrived_variable10)))))))
   (car (cdr (cdr (cdr (children contrived_variable10))))))))
(assert
 (not
  (= (car (children (car (cdr (cdr (cdr (children contrived_variable10)))))))
...
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (children contrived_variable10)))))))
   (children (car (cdr (cdr (cdr (children contrived_variable10)))))))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (children contrived_variable10)))))))
...
(assert
 (not
  (= (pred (data (car (cdr (cdr (cdr (children contrived_variable10)))))))
   (data (car (cdr (cdr (cdr (children contrived_variable10)))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children contrived_variable10)))))
   (cdr (cdr (cdr (children contrived_variable10)))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children contrived_variable10)))))
...
(assert
 (not
  (= (car (cdr (cdr (cdr (cdr (children contrived_variable10))))))
   contrived_variable10)))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (children contrived_variable10)))))))
   (cdr (cdr (cdr (cdr (children contrived_variable10))))))))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (children contrived_variable10)))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (children contrived_variable10))))))
   (cdr (cdr (cdr (cdr (children contrived_variable10))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (children contrived_variable10))))))
...
(assert
 (not
  (= (car (cdr (cdr (cdr (cdr (cdr (children contrived_variable10)))))))
   contrived_variable10)))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (children contrived_variable10)))))))
   (cdr (cdr (cdr (cdr (cdr (children contrived_variable10)))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (children contrived_variable10)))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (children contrived_variable10)))))))
   (children contrived_variable10))))
(assert
 (not (= (pred (data contrived_variable10)) (data contrived_variable10))))
(assert
 (not
  (= (pred (pred (data contrived_variable10)))
   (pred (data contrived_variable10)))))
(assert
 (not
  (= (pred (pred (data contrived_variable10))) (data contrived_variable10))))
(assert
 (not
  (= (pred (pred (pred (data contrived_variable10))))
   (pred (pred (data contrived_variable10))))))
(assert
 (not
  (= (pred (pred (pred (data contrived_variable10))))
...
(assert
 (not
  (= (pred (pred (pred (data contrived_variable10))))
   (data contrived_variable10))))
(assert
 (not
  (= (pred (pred (pred (pred (data contrived_variable10)))))
   (pred (pred (pred (data contrived_variable10)))))))
(assert
 (not
  (= (pred (pred (pred (pred (data contrived_variable10)))))
...
(assert
 (not
  (= (pred (pred (pred (pred (pred (data contrived_variable10))))))
   (pred (pred (pred (pred (data contrived_variable10))))))))
(assert
 (not
  (= (pred (pred (pred (pred (pred (data contrived_variable10))))))
...
(assert
 (not
  (= (pred (pred (pred (pred (pred (pred (data contrived_variable10)))))))
   (pred (pred (pred (pred (pred (data contrived_variable10)))))))))
(assert
 (not
  (= (pred (pred (pred (pred (pred (pred (data contrived_variable10)))))))
...
(assert
 (not
  (= (children (car (children (car (children (car (children x6)))))))
   (children (car (children (car (children x6))))))))
(assert
 (not
  (= (children (car (children (car (children (car (children x6)))))))
...
(assert
 (not
  (= (car (cdr (children (car (children (car (children x6)))))))
   (car (children (car (children x6)))))))
(assert
 (not
  (= (car (cdr (children (car (children (car (children x6)))))))
   (car (children x6)))))
(assert
 (not (= (car (cdr (children (car (children (car (children x6))))))) x6)))
(assert
 (not
  (= (cdr (cdr (children (car (children (car (children x6)))))))
   (cdr (children (car (children (car (children x6)))))))))
(assert
 (not
  (= (cdr (cdr (children (car (children (car (children x6)))))))
...
(assert
 (not
  (= (pred (pred (data (car (children (car (children x6)))))))
   (pred (data (car (children (car (children x6)))))))))
(assert
 (not
  (= (pred (pred (data (car (children (car (children x6)))))))
...
(assert
 (not
  (= (car (children (car (cdr (children (car (children x6)))))))
   (car (cdr (children (car (children x6))))))))
(assert
 (not
  (= (car (children (car (cdr (children (car (children x6)))))))
   (car (children x6)))))
(assert
 (not (= (car (children (car (cdr (children (car (children x6))))))) x6)))
(assert
 (not
  (= (cdr (children (car (cdr (children (car (children x6)))))))
   (children (car (cdr (children (car (children x6)))))))))
(assert
 (not
  (= (cdr (children (car (cdr (children (car (children x6)))))))
...
(assert
 (not
  (= (pred (data (car (cdr (children (car (children x6)))))))
   (data (car (cdr (children (car (children x6)))))))))
(assert
 (not
...
(assert
 (not
  (= (children (car (cdr (cdr (children (car (children x6)))))))
   (cdr (cdr (children (car (children x6))))))))
(assert
 (not
  (= (children (car (cdr (cdr (children (car (children x6)))))))
...
(assert
 (not
  (= (car (cdr (cdr (cdr (children (car (children x6)))))))
   (car (children x6)))))
(assert (not (= (car (cdr (cdr (cdr (children (car (children x6))))))) x6)))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (children x6)))))))
   (cdr (cdr (cdr (children (car (children x6)))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (children x6)))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (children x6))))))) (children x6))))
(assert
...
(assert
 (not
  (= (pred (pred (pred (pred (data (car (children x6)))))))
   (pred (pred (pred (data (car (children x6)))))))))
(assert
 (not
  (= (pred (pred (pred (pred (data (car (children x6)))))))
...
(assert
 (not
  (= (car (children (car (children (car (cdr (children x6)))))))
   (car (children (car (cdr (children x6))))))))
(assert
 (not
  (= (car (children (car (children (car (cdr (children x6)))))))
   (car (cdr (children x6))))))
(assert
 (not (= (car (children (car (children (car (cdr (children x6))))))) x6)))
(assert
 (not
  (= (cdr (children (car (children (car (cdr (children x6)))))))
   (children (car (children (car (cdr (children x6)))))))))
(assert
 (not
  (= (cdr (children (car (children (car (cdr (children x6)))))))
...
(assert
 (not
  (= (pred (data (car (children (car (cdr (children x6)))))))
   (data (car (children (car (cdr (children x6)))))))))
(assert
 (not
...
(assert
 (not
  (= (children (car (cdr (children (car (cdr (children x6)))))))
   (cdr (children (car (cdr (children x6))))))))
(assert
 (not
  (= (children (car (cdr (children (car (cdr (children x6)))))))
...
(assert
 (not
  (= (car (cdr (cdr (children (car (cdr (children x6)))))))
   (car (cdr (children x6))))))
(assert (not (= (car (cdr (cdr (children (car (cdr (children x6))))))) x6)))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (children x6)))))))
   (cdr (cdr (children (car (cdr (children x6)))))))))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (children x6)))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (children x6))))))) (children x6))))
(assert
 (not
...
(assert
 (not
  (= (pred (pred (pred (data (car (cdr (children x6)))))))
   (pred (pred (data (car (cdr (children x6)))))))))
(assert
 (not
  (= (pred (pred (pred (data (car (cdr (children x6)))))))
...
(assert
 (not
  (= (children (car (children (car (cdr (cdr (children x6)))))))
...
(assert
 (not
  (= (car (cdr (children (car (cdr (cdr (children x6)))))))
   (car (cdr (cdr (children x6)))))))
(assert (not (= (car (cdr (children (car (cdr (cdr (children x6))))))) x6)))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (children x6)))))))
   (cdr (children (car (cdr (cdr (children x6)))))))))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (children x6)))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (children x6))))))) (children x6))))
(assert
 (not
...
(assert
 (not
  (= (pred (pred (data (car (cdr (cdr (children x6)))))))
   (pred (data (car (cdr (cdr (children x6)))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (cdr (children x6)))))))
...
(assert
 (not
  (= (car (children (car (cdr (cdr (cdr (children x6)))))))
   (car (cdr (cdr (cdr (children x6))))))))
(assert (not (= (car (children (car (cdr (cdr (cdr (children x6))))))) x6)))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (children x6)))))))
   (children (car (cdr (cdr (cdr (children x6)))))))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (children x6)))))))
...
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (children x6))))))) (children x6))))
(assert
 (not
  (= (pred (data (car (cdr (cdr (cdr (children x6)))))))
   (data (car (cdr (cdr (cdr (children x6)))))))))
(assert
 (not
...
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (children x6)))))))
...
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (children x6))))))) (children x6))))
(assert
 (not
...
(assert (not (= (car (cdr (cdr (cdr (cdr (cdr (children x6))))))) x6)))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (children x6)))))))
   (cdr (cdr (cdr (cdr (cdr (children x6)))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (children x6)))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (children x6))))))) (cdr (children x6)))))
(assert
 (not (= (cdr (cdr (cdr (cdr (cdr (cdr (children x6))))))) (children x6))))
...
(assert
 (not
  (= (pred (pred (pred (pred (pred (pred (data x6)))))))
   (pred (pred (pred (pred (pred (data x6)))))))))
(assert
 (not
  (= (pred (pred (pred (pred (pred (pred (data x6)))))))
...
(assert
 (not
  (= (pred (pred (pred (pred (pred (pred (data x6))))))) (pred (data x6)))))
(assert
 (not (= (pred (pred (pred (pred (pred (pred (data x6))))))) (data x6))))
...
(assert
 (not
  (= (children (car (children (car (children (car (children x5)))))))
   (children (car (children (car (children x5))))))))
(assert
 (not
  (= (children (car (children (car (children (car (children x5)))))))
...
(assert
 (not
  (= (car (cdr (children (car (children (car (children x5)))))))
   (car (children (car (children x5)))))))
(assert
 (not
  (= (car (cdr (children (car (children (car (children x5)))))))
   (car (children x5)))))
(assert
 (not (= (car (cdr (children (car (children (car (children x5))))))) x5)))
(assert
 (not
  (= (cdr (cdr (children (car (children (car (children x5)))))))
   (cdr (children (car (children (car (children x5)))))))))
(assert
 (not
  (= (cdr (cdr (children (car (children (car (children x5)))))))
...
(assert
 (not
  (= (pred (pred (data (car (children (car (children x5)))))))
   (pred (data (car (children (car (children x5)))))))))
(assert
 (not
  (= (pred (pred (data (car (children (car (children x5)))))))
...
(assert
 (not
  (= (car (children (car (cdr (children (car (children x5)))))))
   (car (cdr (children (car (children x5))))))))
(assert
 (not
  (= (car (children (car (cdr (children (car (children x5)))))))
   (car (children x5)))))
(assert
 (not (= (car (children (car (cdr (children (car (children x5))))))) x5)))
(assert
 (not
  (= (cdr (children (car (cdr (children (car (children x5)))))))
   (children (car (cdr (children (car (children x5)))))))))
(assert
 (not
  (= (cdr (children (car (cdr (children (car (children x5)))))))
...
(assert
 (not
  (= (pred (data (car (cdr (children (car (children x5)))))))
   (data (car (cdr (children (car (children x5)))))))))
(assert
 (not
...
(assert
 (not
  (= (children (car (cdr (cdr (children (car (children x5)))))))
   (cdr (cdr (children (car (children x5))))))))
(assert
 (not
  (= (children (car (cdr (cdr (children (car (children x5)))))))
...
(assert
 (not
  (= (car (cdr (cdr (cdr (children (car (children x5)))))))
   (car (children x5)))))
(assert (not (= (car (cdr (cdr (cdr (children (car (children x5))))))) x5)))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (children x5)))))))
   (cdr (cdr (cdr (children (car (children x5)))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (children x5)))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (children x5))))))) (children x5))))
(assert
...
(assert
 (not
  (= (pred (pred (pred (pred (data (car (children x5)))))))
   (pred (pred (pred (data (car (children x5)))))))))
(assert
 (not
  (= (pred (pred (pred (pred (data (car (children x5)))))))
...
(assert
 (not
  (= (car (children (car (children (car (cdr (children x5)))))))
   (car (children (car (cdr (children x5))))))))
(assert
 (not
  (= (car (children (car (children (car (cdr (children x5)))))))
   (car (cdr (children x5))))))
(assert
 (not (= (car (children (car (children (car (cdr (children x5))))))) x5)))
(assert
 (not
  (= (cdr (children (car (children (car (cdr (children x5)))))))
   (children (car (children (car (cdr (children x5)))))))))
(assert
 (not
  (= (cdr (children (car (children (car (cdr (children x5)))))))
...
(assert
 (not
  (= (pred (data (car (children (car (cdr (children x5)))))))
   (data (car (children (car (cdr (children x5)))))))))
(assert
 (not
...
(assert
 (not
  (= (children (car (cdr (children (car (cdr (children x5)))))))
   (cdr (children (car (cdr (children x5))))))))
(assert
 (not
  (= (children (car (cdr (children (car (cdr (children x5)))))))
...
(assert
 (not
  (= (car (cdr (cdr (children (car (cdr (children x5)))))))
   (car (cdr (children x5))))))
(assert (not (= (car (cdr (cdr (children (car (cdr (children x5))))))) x5)))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (children x5)))))))
   (cdr (cdr (children (car (cdr (children x5)))))))))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (children x5)))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (children x5))))))) (children x5))))
(assert
 (not
...
(assert
 (not
  (= (pred (pred (pred (data (car (cdr (children x5)))))))
   (pred (pred (data (car (cdr (children x5)))))))))
(assert
 (not
  (= (pred (pred (pred (data (car (cdr (children x5)))))))
...
(assert
 (not
  (= (children (car (children (car (cdr (cdr (children x5)))))))
...
(assert
 (not
  (= (car (cdr (children (car (cdr (cdr (children x5)))))))
   (car (cdr (cdr (children x5)))))))
(assert (not (= (car (cdr (children (car (cdr (cdr (children x5))))))) x5)))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (children x5)))))))
   (cdr (children (car (cdr (cdr (children x5)))))))))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (children x5)))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (children x5))))))) (children x5))))
(assert
 (not
...
(assert
 (not
  (= (pred (pred (data (car (cdr (cdr (children x5)))))))
   (pred (data (car (cdr (cdr (children x5)))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (cdr (children x5)))))))
...
(assert
 (not
  (= (car (children (car (cdr (cdr (cdr (children x5)))))))
   (car (cdr (cdr (cdr (children x5))))))))
(assert (not (= (car (children (car (cdr (cdr (cdr (children x5))))))) x5)))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (children x5)))))))
   (children (car (cdr (cdr (cdr (children x5)))))))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (children x5)))))))
...
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (children x5))))))) (children x5))))
(assert
 (not
  (= (pred (data (car (cdr (cdr (cdr (children x5)))))))
   (data (car (cdr (cdr (cdr (children x5)))))))))
(assert
 (not
...
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (children x5)))))))
...
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (children x5))))))) (children x5))))
(assert
 (not
...
(assert (not (= (car (cdr (cdr (cdr (cdr (cdr (children x5))))))) x5)))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (children x5)))))))
   (cdr (cdr (cdr (cdr (cdr (children x5)))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (children x5)))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (children x5))))))) (cdr (children x5)))))
(assert
 (not (= (cdr (cdr (cdr (cdr (cdr (cdr (children x5))))))) (children x5))))
...
(assert
 (not
  (= (pred (pred (pred (pred (pred (pred (data x5)))))))
   (pred (pred (pred (pred (pred (data x5)))))))))
(assert
 (not
  (= (pred (pred (pred (pred (pred (pred (data x5)))))))
...
(assert
 (not
  (= (pred (pred (pred (pred (pred (pred (data x5))))))) (pred (data x5)))))
(assert
 (not (= (pred (pred (pred (pred (pred (pred (data x5))))))) (data x5))))
