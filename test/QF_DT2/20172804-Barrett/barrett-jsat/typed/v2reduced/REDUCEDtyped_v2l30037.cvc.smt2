...
(assert (is-null null))
(assert
 (and (and (= null contrived_variable0)
  (= contrived_variable2 contrived_variable1))
  (not (= x6 contrived_variable5))))
(assert
 (and (= (succ x2) contrived_variable6) (is-succ contrived_variable6)
  (= (pred contrived_variable6) x2)))
(assert
 (and (= (succ x2) contrived_variable1) (is-succ contrived_variable1)
  (= (pred contrived_variable1) x2)))
(assert
...
(assert
 (or
  (and ((_ is succ) contrived_variable4) (and
   (= (pred contrived_variable3) contrived_variable2)
   (= (succ contrived_variable9) contrived_variable3)
   (= (pred contrived_variable3) contrived_variable9)))
  (and (not ((_ is succ) contrived_variable4)) (= contrived_variable2 zero))))
(assert
