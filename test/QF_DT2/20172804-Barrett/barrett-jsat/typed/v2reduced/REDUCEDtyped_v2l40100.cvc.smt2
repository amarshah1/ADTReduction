...
(assert (is-null null))
(assert
 (and (and (and (= x5 x5) (is-leaf contrived_variable0))
  (not (= contrived_variable1 x3))) (is-cons x3)))
(assert
 (and (= (cons contrived_variable2 x4) contrived_variable1)
  (is-cons contrived_variable1)
  (= (car contrived_variable1) contrived_variable2)
  (= (cdr contrived_variable1) x4)))
(assert
