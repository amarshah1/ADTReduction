...
(assert (is-null null))
(assert
 (and (and (and (and (= contrived_variable0 zero)
  (not ((_ is node) contrived_variable1))) (= x2 contrived_variable2))
  ((_ is null) x4)) (not ((_ is node) contrived_variable3))))
(assert
 (and (= (succ x2) contrived_variable4) (is-succ contrived_variable4)
  (= (pred contrived_variable4) x2)))
(assert
 (and (= (leaf contrived_variable4) contrived_variable3)
  (is-leaf contrived_variable3)
  (= (data contrived_variable3) contrived_variable4)))
(assert
 (or
  (and (is-cons x4) (and (= (car x4) contrived_variable1)
   (= (cons contrived_variable5 contrived_variable6) x4)
   (= (car x4) contrived_variable5) (= (cdr x4) contrived_variable6)))
  (and (not (is-cons x4)) (and (= (leaf zero) contrived_variable1)
   (is-leaf contrived_variable1) (= (data contrived_variable1) zero)))))
(assert
 (or
  (and ((_ is succ) x1) (and (= (pred x1) contrived_variable0)
   (= (succ contrived_variable7) x1) (= (pred x1) contrived_variable7)))
  (and (not ((_ is succ) x1)) (= contrived_variable0 zero))))
(assert
 (or
  (and (is-leaf x6) (and (= (data x6) contrived_variable2)
   (= (leaf contrived_variable8) x6) (= (data x6) contrived_variable8)))
  (and (not (is-leaf x6)) (= contrived_variable2 zero))))
(assert
