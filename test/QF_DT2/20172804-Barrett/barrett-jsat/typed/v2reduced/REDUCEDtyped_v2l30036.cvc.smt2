...
(assert (is-null null))
(assert
 (and (and (not (= contrived_variable0 x6))
  ((_ is succ) contrived_variable3)) ((_ is null) contrived_variable4)))
(assert
...
(assert
 (and (= (cons contrived_variable5 x4) contrived_variable4)
  (is-cons contrived_variable4)
  (= (car contrived_variable4) contrived_variable5)
  (= (cdr contrived_variable4) x4)))
(assert
...
(assert
 (or
  (and ((_ is succ) x1) (and (= (pred x1) contrived_variable6)
   (= (succ contrived_variable7) x1) (= (pred x1) contrived_variable7)))
  (and (not ((_ is succ) x1)) (= contrived_variable6 zero))))
(assert
 (or
  (and (is-leaf x6) (and (= (data x6) contrived_variable3)
   (= (leaf contrived_variable8) x6) (= (data x6) contrived_variable8)))
  (and (not (is-leaf x6)) (= contrived_variable3 zero))))
(assert
 (or
  (and ((_ is succ) x2) (and (= (pred x2) contrived_variable2)
   (= (succ contrived_variable9) x2) (= (pred x2) contrived_variable9)))
