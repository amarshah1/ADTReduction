...
(assert (is-null null))
(assert
 (and (and (and (and (= contrived_variable2 contrived_variable0)
  (not (is-leaf x12))) (= x6 x7)) ((_ is zero) contrived_variable3))
  (not (= contrived_variable4 x10))))
(assert
 (and (= (succ contrived_variable1) contrived_variable0)
  (is-succ contrived_variable0)
  (= (pred contrived_variable0) contrived_variable1)))
(assert
 (and (= (cons x14 null) contrived_variable4) (is-cons contrived_variable4)
  (= (car contrived_variable4) x14) (= (cdr contrived_variable4) null)))
(assert
 (or
  (and (is-leaf x12) (and (= (data x12) contrived_variable1)
   (= (leaf contrived_variable5) x12) (= (data x12) contrived_variable5)))
  (and (not (is-leaf x12)) (= contrived_variable1 zero))))
(assert
 (or
  (and (is-leaf x12) (and (= (data x12) contrived_variable3)
   (= (leaf contrived_variable6) x12) (= (data x12) contrived_variable6)))
  (and (not (is-leaf x12)) (= contrived_variable3 zero))))
(assert
 (or
  (and ((_ is succ) x4) (and (= (pred x4) contrived_variable2)
   (= (succ contrived_variable7) x4) (= (pred x4) contrived_variable7)))
  (and (not ((_ is succ) x4)) (= contrived_variable2 zero))))
(assert
