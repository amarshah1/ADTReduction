...
(assert (is-null null))
(assert
 (and (and (and (and (and (not (= x1 x2))
  (not (is-cons contrived_variable0))) (not (is-cons x6))) (zero x2))
  (node contrived_variable1)) (not (is-leaf x14))))
(assert
 (and (= (node x9) contrived_variable1) (is-node contrived_variable1)
  (= (children contrived_variable1) x9)))
(assert
 (or
  (and (node x11) (and (= (children x11) contrived_variable0)
   (= (node contrived_variable2) x11) (= (children x11) contrived_variable2)))
  (and (node x11) (= contrived_variable0 null))))
(assert
