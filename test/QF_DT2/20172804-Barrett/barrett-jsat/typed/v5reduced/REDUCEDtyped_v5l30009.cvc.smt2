...
(assert (is-null null))
(assert
 (and (and (= x1 zero) (= x2 zero)) (not ((_ is succ) contrived_variable0))))
(assert
 (or
  (and ((_ is leaf) x13) (and (= (data x13) contrived_variable0)
   (= (leaf contrived_variable1) x13) (= (data x13) contrived_variable1)))
  (and (not ((_ is leaf) x13)) (= contrived_variable0 zero))))
(assert
