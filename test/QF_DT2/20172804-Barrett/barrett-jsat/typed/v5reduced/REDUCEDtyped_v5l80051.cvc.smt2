...
(assert (is-null null))
(assert
 (and (and (and (and (and (and (and (not ((_ is node) contrived_variable0))
  (= x10 x7)) (not (= x3 contrived_variable2))) (= zero contrived_variable3))
  (not ((_ is null) x9))) (is-cons x9)) (not (is-leaf x12)))
  (= contrived_variable4 x6)))
(assert
...
(assert
 (and (= (cons x12 x6) contrived_variable4) (is-cons contrived_variable4)
  (= (car contrived_variable4) x12) (= (cdr contrived_variable4) x6)))
(assert
 (or
  (and (is-leaf x15) (and (= (data x15) contrived_variable3)
   (= (leaf contrived_variable5) x15) (= (data x15) contrived_variable5)))
  (and (not (is-leaf x15)) (= contrived_variable3 zero))))
(assert
 (or
  (and ((_ is succ) x5) (and (= (pred x5) contrived_variable2)
   (= (succ contrived_variable6) x5) (= (pred x5) contrived_variable6)))
  (and (not ((_ is succ) x5)) (= contrived_variable2 zero))))
(assert
