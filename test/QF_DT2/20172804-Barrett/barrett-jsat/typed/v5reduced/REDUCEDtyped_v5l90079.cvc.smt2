...
(assert (is-null null))
(assert
 (and (and (and (and (and (and (and (and (= x2 contrived_variable0)
  (node x11)) (zero x2)) (not (= x11 x12))) (not (= x1 x3)))
  (is-cons contrived_variable1)) (not (= zero x3))) (is-leaf x11)) (= x6 x6)))
(assert
 (or
  (and (node x11) (and (= (children x11) contrived_variable1)
   (= (node contrived_variable2) x11) (= (children x11) contrived_variable2)))
  (and (node x11) (= contrived_variable1 null))))
(assert
 (or
  (and (succ x3) (and (= (pred x3) contrived_variable0)
   (= (succ contrived_variable3) x3) (= (pred x3) contrived_variable3)))
  (and (succ x3) (= contrived_variable0 zero))))
(assert
