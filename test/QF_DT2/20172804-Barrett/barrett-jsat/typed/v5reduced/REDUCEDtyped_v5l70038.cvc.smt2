...
(assert (is-null null))
(assert
 (and (and (and (and (and (and (not ((_ is null) x8))
  (= x1 contrived_variable0)) ((_ is succ) x3)) (not ((_ is null) x9)))
  ((_ is zero) x1)) (= x15 contrived_variable1)) (= x1 x3)))
(assert
 (or
  (and (is-cons x8) (and (= (car x8) contrived_variable1)
   (= (cons contrived_variable2 contrived_variable3) x8)
   (= (car x8) contrived_variable2) (= (cdr x8) contrived_variable3)))
  (and (not (is-cons x8)) (and (= (leaf zero) contrived_variable1)
   (is-leaf contrived_variable1) (= (data contrived_variable1) zero)))))
(assert
 (or
  (and ((_ is succ) zero) (and (= (pred zero) contrived_variable0)
   (= (succ contrived_variable4) zero) (= (pred zero) contrived_variable4)))
  (and (not ((_ is succ) zero)) (= contrived_variable0 zero))))
(assert
