...
(assert (is-null null))
(assert
 (and (and (and (and (and ((_ is node) contrived_variable0)
  (= contrived_variable1 x13)) (= x12 x13)) ((_ is succ) x3))
  (not ((_ is null) x8))) (is-cons x9)))
(assert
 (and (= (node x7) contrived_variable1) (is-node contrived_variable1)
  (= (children contrived_variable1) x7)))
(assert
 (and (= (node x9) contrived_variable0) (is-node contrived_variable0)
  (= (children contrived_variable0) x9)))
(assert
