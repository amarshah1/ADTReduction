...
(assert (is-null null))
(assert
 (and (and (and ((_ is node) contrived_variable0) ((_ is null) x8))
  (= contrived_variable2 contrived_variable1)) (= x14 contrived_variable3)))
(assert
 (and (= (leaf x2) contrived_variable0) (is-leaf contrived_variable0)
  (= (data contrived_variable0) x2)))
(assert
 (and (= (succ x2) contrived_variable2) (is-succ contrived_variable2)
  (= (pred contrived_variable2) x2)))
(assert
 (or
  (and ((_ is leaf) x15) (and (= (data x15) contrived_variable1)
   (= (leaf contrived_variable4) x15) (= (data x15) contrived_variable4)))
  (and (not ((_ is leaf) x15)) (= contrived_variable1 zero))))
(assert
 (or
  (and (is-cons x8) (and (= (car x8) contrived_variable3)
   (= (cons contrived_variable5 contrived_variable6) x8)
   (= (car x8) contrived_variable5) (= (cdr x8) contrived_variable6)))
  (and (not (is-cons x8)) (and (= (leaf zero) contrived_variable3)
   (is-leaf contrived_variable3) (= (data contrived_variable3) zero)))))
(assert
