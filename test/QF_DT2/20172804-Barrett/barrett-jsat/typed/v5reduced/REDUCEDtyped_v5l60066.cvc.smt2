...
(assert (is-null null))
(assert
 (and (and (and (and (and (not (= contrived_variable0 x1)) (= x2 x5))
  (not ((_ is zero) x4))) (not (= x6 x8)))
  (not ((_ is zero) contrived_variable1))) (not (= x14 x11))))
(assert
 (and (= (succ x4) contrived_variable0) (is-succ contrived_variable0)
  (= (pred contrived_variable0) x4)))
(assert
 (or
  (and ((_ is succ) x2) (and (= (pred x2) contrived_variable1)
   (= (succ contrived_variable2) x2) (= (pred x2) contrived_variable2)))
