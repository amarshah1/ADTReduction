...
(assert (is-null null))
(assert
 (and (and (and (and (= x4 zero) (not (= x9 x10))) ((_ is null) x6))
  (= contrived_variable1 contrived_variable0)) (not ((_ is leaf) x14))))
(assert
 (or
...
(assert
 (or
  (and ((_ is succ) x3) (and (= (pred x3) contrived_variable0)
   (= (succ contrived_variable5) x3) (= (pred x3) contrived_variable5)))
  (and (not ((_ is succ) x3)) (= contrived_variable0 zero))))
(assert
 (or
...
(assert
 (or
  (and ((_ is succ) x2) (and (= (pred x2) contrived_variable2)
   (= (succ contrived_variable7) x2) (= (pred x2) contrived_variable7)))
  (and (not ((_ is succ) x2)) (= contrived_variable2 zero))))
(assert
