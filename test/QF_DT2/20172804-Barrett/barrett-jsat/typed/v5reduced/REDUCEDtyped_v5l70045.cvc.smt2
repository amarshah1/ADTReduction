...
(assert (is-null null))
(assert
 (and (and (and (and (and (and ((_ is node) x14) ((_ is succ) x4))
  (is-cons x9)) ((_ is node) x13)) (is-leaf x11)) ((_ is node) x11))
  (not (= contrived_variable0 x2))))
(assert
...
(assert
 (or
  (and (is-leaf x11) (and (= (data x11) contrived_variable1)
   (= (leaf contrived_variable2) x11) (= (data x11) contrived_variable2)))
  (and (not (is-leaf x11)) (= contrived_variable1 zero))))
(assert
