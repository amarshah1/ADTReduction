...
(assert (is-null null))
(assert
 (and (and (and (and (and (and (and (= x4 x4) (= contrived_variable0 null))
  (not ((_ is zero) zero))) ((_ is zero) zero))
  (not (= x4 contrived_variable2))) (= zero x1)) (not ((_ is null) x6)))
  (not (= x15 x11))))
(assert
 (and (= (cons contrived_variable1 x10) contrived_variable0)
  (is-cons contrived_variable0)
  (= (car contrived_variable0) contrived_variable1)
  (= (cdr contrived_variable0) x10)))
(assert
 (or
  (and (is-cons x7) (and (= (car x7) contrived_variable1)
   (= (cons contrived_variable3 contrived_variable4) x7)
   (= (car x7) contrived_variable3) (= (cdr x7) contrived_variable4)))
  (and (not (is-cons x7)) (and (= (leaf zero) contrived_variable1)
   (is-leaf contrived_variable1) (= (data contrived_variable1) zero)))))
(assert
 (or
  (and (is-leaf x13) (and (= (data x13) contrived_variable2)
   (= (leaf contrived_variable5) x13) (= (data x13) contrived_variable5)))
  (and (not (is-leaf x13)) (= contrived_variable2 zero))))
(assert
