...
(assert (is-zero zero))
(assert (is-null null))
(assert (and (= x5 contrived_variable0) (not (= x2 x1))))
(assert
 (or
  (and ((_ is succ) x2) (and (= (pred x2) contrived_variable1)
   (= (succ contrived_variable3) x2) (= (pred x2) contrived_variable3)))
  (and (not ((_ is succ) x2)) (= contrived_variable1 zero))))
(assert
 (or
...
(assert
 (or
  (and ((_ is succ) x2) (and (= (pred x2) contrived_variable2)
   (= (succ contrived_variable5) x2) (= (pred x2) contrived_variable5)))
