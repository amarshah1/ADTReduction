...
(assert (is-null null))
(assert
 (and (and (and (and (and (not (= x11 x13)) ((_ is succ) x2))
  (not ((_ is null) null))) ((_ is null) contrived_variable0)) (= x1 x5))
  ((_ is succ) x1)))
(assert
 (or
  (and (is-cons x6) (and (= (cdr x6) contrived_variable0)
   (= (cons contrived_variable1 contrived_variable2) x6)
   (= (car x6) contrived_variable1) (= (cdr x6) contrived_variable2)))
  (and (not (is-cons x6)) (= contrived_variable0 null))))
(assert
