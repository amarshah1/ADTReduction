...
(assert (is-zero zero))
(assert (is-null null))
(assert (and (= x8 x6) (not ((_ is null) contrived_variable0))))
(assert
 (and (= (leaf x3) contrived_variable1) (is-leaf contrived_variable1)
  (= (data contrived_variable1) x3)))
(assert
 (and (= (leaf x3) contrived_variable2) (is-leaf contrived_variable2)
  (= (data contrived_variable2) x3)))
(assert
 (or
  (and ((_ is node) contrived_variable2) (and
   (= (children contrived_variable1) contrived_variable0)
   (= (node contrived_variable3) contrived_variable1)
   (= (children contrived_variable1) contrived_variable3)))
  (and (not ((_ is node) contrived_variable2)) (= contrived_variable0 null))))
(assert
