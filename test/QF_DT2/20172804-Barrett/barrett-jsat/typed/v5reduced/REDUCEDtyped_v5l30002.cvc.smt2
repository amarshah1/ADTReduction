...
(assert (is-null null))
(assert
 (and (and (= x8 contrived_variable0) (not (= x7 x9))) (not (= x12 x14))))
(assert
 (or
  (and ((_ is node) x13) (and (= (children x13) contrived_variable0)
   (= (node contrived_variable1) x13) (= (children x13) contrived_variable1)))
  (and (not ((_ is node) x13)) (= contrived_variable0 null))))
(assert
