...
(assert (is-null null))
(assert
 (and (and (and (not (is-cons x9)) (not (= x2 contrived_variable0)))
  ((_ is succ) x4)) (= x14 contrived_variable1)))
(assert
 (and (= (leaf contrived_variable2) contrived_variable1)
  (is-leaf contrived_variable1)
  (= (data contrived_variable1) contrived_variable2)))
(assert
 (and (= (succ x5) contrived_variable2) (is-succ contrived_variable2)
  (= (pred contrived_variable2) x5)))
(assert
 (or
