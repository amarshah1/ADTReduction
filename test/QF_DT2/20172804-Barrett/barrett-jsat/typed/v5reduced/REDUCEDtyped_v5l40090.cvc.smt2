...
(assert (is-null null))
(assert
 (and (and (and (not (= x12 contrived_variable0))
  (not (= x4 contrived_variable2))) (= x15 x12))
  (not (is-leaf contrived_variable3))))
(assert
 (and (= (succ x3) contrived_variable1) (is-succ contrived_variable1)
  (= (pred contrived_variable1) x3)))
(assert
 (and (= (leaf contrived_variable1) contrived_variable0)
  (is-leaf contrived_variable0)
  (= (data contrived_variable0) contrived_variable1)))
(assert
 (and (= (node contrived_variable4) contrived_variable3)
  (is-node contrived_variable3)
  (= (children contrived_variable3) contrived_variable4)))
(assert
 (or
  (and (is-cons x7) (and (= (cdr x7) contrived_variable4)
   (= (cons contrived_variable5 contrived_variable6) x7)
   (= (car x7) contrived_variable5) (= (cdr x7) contrived_variable6)))
  (and (not (is-cons x7)) (= contrived_variable4 null))))
(assert
 (or
  (and ((_ is succ) x3) (and (= (pred x3) contrived_variable2)
   (= (succ contrived_variable7) x3) (= (pred x3) contrived_variable7)))
  (and (not ((_ is succ) x3)) (= contrived_variable2 zero))))
(assert
 ...
 (not
  (=
   (pred (data (car (cdr (children (car (children (car
    contrived_variable6))))))))
   (data (car (cdr (children (car (children (car contrived_variable6))))))))))
(assert
 (not
 ...
 (not
  (=
   (pred (data (car (children (car (cdr (children (car
    contrived_variable6))))))))
   (data (car (children (car (cdr (children (car contrived_variable6))))))))))
(assert
 (not
...
(assert
 (not
  (=
   (pred (pred (data (car (cdr (cdr (children (car contrived_variable6))))))))
   (pred (data (car (cdr (cdr (children (car contrived_variable6))))))))))
(assert
 (not
  (=
...
(assert
 (not
  (=
   (pred (data (car (cdr (cdr (cdr (children (car contrived_variable6))))))))
   (data (car (cdr (cdr (cdr (children (car contrived_variable6))))))))))
(assert
 (not
...
(assert
 (not
  (= (car (cdr (cdr (cdr (cdr (cdr (children (car contrived_variable6))))))))
   (car contrived_variable6))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (children (car contrived_variable6))))))))
   (cdr (cdr (cdr (cdr (cdr (children (car contrived_variable6))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (children (car contrived_variable6))))))))
...
(assert
 (not
  (=
   (pred (pred (pred (pred (pred (pred (data (car contrived_variable6))))))))
   (pred (pred (pred (pred (pred (data (car contrived_variable6))))))))))
(assert
 (not
  (=
 ...
 (not
  (=
   (pred (data (car (children (car (children (car (cdr
    contrived_variable6))))))))
   (data (car (children (car (children (car (cdr contrived_variable6))))))))))
(assert
 (not
...
(assert
 (not
  (=
   (pred (pred (data (car (cdr (children (car (cdr contrived_variable6))))))))
   (pred (data (car (cdr (children (car (cdr contrived_variable6))))))))))
(assert
 (not
  (=
...
(assert
 (not
  (=
   (pred (data (car (cdr (cdr (children (car (cdr contrived_variable6))))))))
   (data (car (cdr (cdr (children (car (cdr contrived_variable6))))))))))
(assert
 (not
...
(assert
 (not
  (= (car (cdr (cdr (cdr (cdr (children (car (cdr contrived_variable6))))))))
   (car (cdr contrived_variable6)))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (children (car (cdr contrived_variable6))))))))
   (cdr (cdr (cdr (cdr (children (car (cdr contrived_variable6))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (children (car (cdr contrived_variable6))))))))
...
(assert
 (not
  (=
   (pred (pred (pred (pred (pred (data (car (cdr contrived_variable6))))))))
   (pred (pred (pred (pred (data (car (cdr contrived_variable6))))))))))
(assert
 (not
  (=
...
(assert
 (not
  (=
   (pred (pred (data (car (children (car (cdr (cdr contrived_variable6))))))))
   (pred (data (car (children (car (cdr (cdr contrived_variable6))))))))))
(assert
 (not
  (=
...
(assert
 (not
  (=
   (pred (data (car (cdr (children (car (cdr (cdr contrived_variable6))))))))
   (data (car (cdr (children (car (cdr (cdr contrived_variable6))))))))))
(assert
 (not
...
(assert
 (not
  (= (car (cdr (cdr (cdr (children (car (cdr (cdr contrived_variable6))))))))
   (car (cdr (cdr contrived_variable6))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (cdr (cdr contrived_variable6))))))))
   (cdr (cdr (cdr (children (car (cdr (cdr contrived_variable6))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (cdr (cdr contrived_variable6))))))))
...
(assert
 (not
  (= (pred (pred (pred (pred (data (car (cdr (cdr contrived_variable6))))))))
   (pred (pred (pred (data (car (cdr (cdr contrived_variable6))))))))))
(assert
 (not
  (= (pred (pred (pred (pred (data (car (cdr (cdr contrived_variable6))))))))
...
(assert
 (not
  (=
   (pred (data (car (children (car (cdr (cdr (cdr contrived_variable6))))))))
   (data (car (children (car (cdr (cdr (cdr contrived_variable6))))))))))
(assert
 (not
...
(assert
 (not
  (= (car (cdr (cdr (children (car (cdr (cdr (cdr contrived_variable6))))))))
   (car (cdr (cdr (cdr contrived_variable6)))))))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (cdr (cdr contrived_variable6))))))))
   (cdr (cdr (children (car (cdr (cdr (cdr contrived_variable6))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (cdr (cdr contrived_variable6))))))))
...
(assert
 (not
  (= (pred (pred (pred (data (car (cdr (cdr (cdr contrived_variable6))))))))
   (pred (pred (data (car (cdr (cdr (cdr contrived_variable6))))))))))
(assert
 (not
  (= (pred (pred (pred (data (car (cdr (cdr (cdr contrived_variable6))))))))
...
(assert
 (not
  (= (car (cdr (children (car (cdr (cdr (cdr (cdr contrived_variable6))))))))
   (car (cdr (cdr (cdr (cdr contrived_variable6))))))))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (cdr (cdr contrived_variable6))))))))
   (cdr (children (car (cdr (cdr (cdr (cdr contrived_variable6))))))))))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (cdr (cdr contrived_variable6))))))))
...
(assert
 (not
  (= (pred (pred (data (car (cdr (cdr (cdr (cdr contrived_variable6))))))))
   (pred (data (car (cdr (cdr (cdr (cdr contrived_variable6))))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (cdr (cdr (cdr contrived_variable6))))))))
...
(assert
 (not
  (= (car (children (car (cdr (cdr (cdr (cdr (cdr contrived_variable6))))))))
   (car (cdr (cdr (cdr (cdr (cdr contrived_variable6)))))))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (cdr (cdr contrived_variable6))))))))
   (children (car (cdr (cdr (cdr (cdr (cdr contrived_variable6))))))))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (cdr (cdr contrived_variable6))))))))
...
(assert
 (not
  (= (pred (data (car (cdr (cdr (cdr (cdr (cdr contrived_variable6))))))))
   (data (car (cdr (cdr (cdr (cdr (cdr contrived_variable6))))))))))
(assert
 (not
...
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (cdr (cdr contrived_variable6))))))))
   (cdr (cdr (cdr (cdr (cdr (cdr contrived_variable6)))))))))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (cdr (cdr contrived_variable6))))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr (cdr contrived_variable6))))))))
   (cdr (cdr (cdr (cdr (cdr (cdr (cdr contrived_variable6))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr (cdr contrived_variable6))))))))
...
(assert
 (not
  (= (car (children (car (children (car (children (car x10)))))))
   (car (children (car (children (car x10))))))))
(assert
 (not
  (= (car (children (car (children (car (children (car x10)))))))
...
(assert
 (not
  (= (car (children (car (children (car (children (car x10))))))) (car x10))))
(assert
 (not
  (= (children (car (children (car (children (car (children (car x10))))))))
   (children (car (children (car (children (car x10)))))))))
(assert
 (not
  (= (children (car (children (car (children (car (children (car x10))))))))
...
(assert
 (not
  (= (cdr (children (car (children (car (children (car x10)))))))
   (children (car (children (car (children (car x10)))))))))
(assert
 (not
  (= (cdr (children (car (children (car (children (car x10)))))))
...
(assert
 (not
  (= (cdr (children (car (children (car (children (car x10)))))))
   (children (car x10)))))
(assert
 (not (= (cdr (children (car (children (car (children (car x10))))))) x10)))
(assert
 (not
  (= (car (cdr (children (car (children (car (children (car x10))))))))
   (car (children (car (children (car x10))))))))
(assert
 (not
  (= (car (cdr (children (car (children (car (children (car x10))))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (children (car (children (car x10))))))))
   (cdr (children (car (children (car (children (car x10))))))))))
(assert
 (not
  (= (cdr (cdr (children (car (children (car (children (car x10))))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (children (car (children (car x10)))))))) x10)))
(assert
 (not
  (= (pred (data (car (children (car (children (car x10)))))))
   (data (car (children (car (children (car x10)))))))))
(assert
 (not
  (= (pred (pred (data (car (children (car (children (car x10))))))))
   (pred (data (car (children (car (children (car x10))))))))))
(assert
 (not
  (= (pred (pred (data (car (children (car (children (car x10))))))))
...
(assert
 (not
  (= (children (car (cdr (children (car (children (car x10)))))))
   (cdr (children (car (children (car x10))))))))
(assert
 (not
  (= (children (car (cdr (children (car (children (car x10)))))))
...
(assert
 (not
  (= (children (car (cdr (children (car (children (car x10)))))))
   (children (car x10)))))
(assert
 (not (= (children (car (cdr (children (car (children (car x10))))))) x10)))
(assert
 (not
  (= (car (children (car (cdr (children (car (children (car x10))))))))
   (car (cdr (children (car (children (car x10)))))))))
(assert
 (not
  (= (car (children (car (cdr (children (car (children (car x10))))))))
...
(assert
 (not
  (= (cdr (children (car (cdr (children (car (children (car x10))))))))
   (children (car (cdr (children (car (children (car x10))))))))))
(assert
 (not
  (= (cdr (children (car (cdr (children (car (children (car x10))))))))
...
(assert
 (not
  (= (cdr (children (car (cdr (children (car (children (car x10)))))))) x10)))
(assert
 (not
  (= (pred (data (car (cdr (children (car (children (car x10))))))))
   (data (car (cdr (children (car (children (car x10))))))))))
(assert
 (not
...
(assert
 (not
  (= (car (cdr (cdr (children (car (children (car x10)))))))
   (car (children (car x10))))))
(assert
 (not (= (car (cdr (cdr (children (car (children (car x10))))))) (car x10))))
(assert
 (not
  (= (children (car (cdr (cdr (children (car (children (car x10))))))))
   (cdr (cdr (children (car (children (car x10)))))))))
(assert
 (not
  (= (children (car (cdr (cdr (children (car (children (car x10))))))))
...
(assert
 (not
  (= (children (car (cdr (cdr (children (car (children (car x10)))))))) x10)))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (children (car x10)))))))
   (cdr (cdr (children (car (children (car x10)))))))))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (children (car x10)))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (children (car (children (car x10)))))))
   (children (car x10)))))
(assert (not (= (cdr (cdr (cdr (children (car (children (car x10))))))) x10)))
(assert
 (not
  (= (car (cdr (cdr (cdr (children (car (children (car x10))))))))
   (car (children (car x10))))))
(assert
 (not
  (= (car (cdr (cdr (cdr (children (car (children (car x10)))))))) (car x10))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (children (car x10))))))))
   (cdr (cdr (cdr (children (car (children (car x10))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (children (car x10))))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (children (car x10))))))))
   (children (car x10)))))
(assert
 (not (= (cdr (cdr (cdr (cdr (children (car (children (car x10)))))))) x10)))
(assert
 (not
...
(assert
 (not
  (= (pred (pred (pred (data (car (children (car x10)))))))
   (pred (pred (data (car (children (car x10)))))))))
(assert
 (not
  (= (pred (pred (pred (data (car (children (car x10)))))))
...
(assert
 (not
  (= (pred (pred (pred (pred (data (car (children (car x10))))))))
   (pred (pred (pred (data (car (children (car x10))))))))))
(assert
 (not
  (= (pred (pred (pred (pred (data (car (children (car x10))))))))
...
(assert
 (not
  (= (children (car (children (car (cdr (children (car x10)))))))
...
(assert
 (not
  (= (children (car (children (car (cdr (children (car x10)))))))
   (children (car x10)))))
(assert
 (not (= (children (car (children (car (cdr (children (car x10))))))) x10)))
(assert
 (not
  (= (car (children (car (children (car (cdr (children (car x10))))))))
   (car (children (car (cdr (children (car x10)))))))))
(assert
 (not
  (= (car (children (car (children (car (cdr (children (car x10))))))))
...
(assert
 (not
  (= (cdr (children (car (children (car (cdr (children (car x10))))))))
   (children (car (children (car (cdr (children (car x10))))))))))
(assert
 (not
  (= (cdr (children (car (children (car (cdr (children (car x10))))))))
...
(assert
 (not
  (= (cdr (children (car (children (car (cdr (children (car x10)))))))) x10)))
(assert
 (not
  (= (pred (data (car (children (car (cdr (children (car x10))))))))
   (data (car (children (car (cdr (children (car x10))))))))))
(assert
 (not
...
(assert
 (not
  (= (car (cdr (children (car (cdr (children (car x10)))))))
   (car (cdr (children (car x10)))))))
(assert
 (not (= (car (cdr (children (car (cdr (children (car x10))))))) (car x10))))
(assert
 (not
  (= (children (car (cdr (children (car (cdr (children (car x10))))))))
   (cdr (children (car (cdr (children (car x10)))))))))
(assert
 (not
  (= (children (car (cdr (children (car (cdr (children (car x10))))))))
...
(assert
 (not
  (= (children (car (cdr (children (car (cdr (children (car x10)))))))) x10)))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (children (car x10)))))))
   (cdr (children (car (cdr (children (car x10)))))))))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (children (car x10)))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (cdr (children (car x10)))))))
   (children (car x10)))))
(assert (not (= (cdr (cdr (children (car (cdr (children (car x10))))))) x10)))
(assert
 (not
  (= (car (cdr (cdr (children (car (cdr (children (car x10))))))))
   (car (cdr (children (car x10)))))))
(assert
 (not
  (= (car (cdr (cdr (children (car (cdr (children (car x10)))))))) (car x10))))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (children (car x10))))))))
   (cdr (cdr (children (car (cdr (children (car x10))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (children (car x10))))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (children (car x10))))))))
   (children (car x10)))))
(assert
 (not (= (cdr (cdr (cdr (children (car (cdr (children (car x10)))))))) x10)))
(assert
 (not
...
(assert
 (not
  (= (pred (pred (data (car (cdr (children (car x10)))))))
   (pred (data (car (cdr (children (car x10)))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (children (car x10)))))))
...
(assert
 (not
  (= (pred (pred (pred (data (car (cdr (children (car x10))))))))
   (pred (pred (data (car (cdr (children (car x10))))))))))
(assert
 (not
  (= (pred (pred (pred (data (car (cdr (children (car x10))))))))
...
(assert
 (not
  (= (car (children (car (cdr (cdr (children (car x10)))))))
   (car (cdr (cdr (children (car x10))))))))
(assert
 (not (= (car (children (car (cdr (cdr (children (car x10))))))) (car x10))))
(assert
 (not
  (= (children (car (children (car (cdr (cdr (children (car x10))))))))
   (children (car (cdr (cdr (children (car x10)))))))))
(assert
 (not
  (= (children (car (children (car (cdr (cdr (children (car x10))))))))
...
(assert
 (not
  (= (children (car (children (car (cdr (cdr (children (car x10)))))))) x10)))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (children (car x10)))))))
   (children (car (cdr (cdr (children (car x10)))))))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (children (car x10)))))))
...
(assert
 (not
  (= (cdr (children (car (cdr (cdr (children (car x10)))))))
   (children (car x10)))))
(assert (not (= (cdr (children (car (cdr (cdr (children (car x10))))))) x10)))
(assert
 (not
  (= (car (cdr (children (car (cdr (cdr (children (car x10))))))))
   (car (cdr (cdr (children (car x10))))))))
(assert
 (not
  (= (car (cdr (children (car (cdr (cdr (children (car x10)))))))) (car x10))))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (children (car x10))))))))
   (cdr (children (car (cdr (cdr (children (car x10))))))))))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (children (car x10))))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (children (car x10))))))))
   (children (car x10)))))
(assert
 (not (= (cdr (cdr (children (car (cdr (cdr (children (car x10)))))))) x10)))
(assert
 (not
  (= (pred (data (car (cdr (cdr (children (car x10)))))))
   (data (car (cdr (cdr (children (car x10)))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (cdr (children (car x10))))))))
   (pred (data (car (cdr (cdr (children (car x10))))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (cdr (children (car x10))))))))
...
(assert
 (not
  (= (children (car (cdr (cdr (cdr (children (car x10)))))))
...
(assert
 (not
  (= (children (car (cdr (cdr (cdr (children (car x10)))))))
   (children (car x10)))))
(assert (not (= (children (car (cdr (cdr (cdr (children (car x10))))))) x10)))
(assert
 (not
  (= (car (children (car (cdr (cdr (cdr (children (car x10))))))))
   (car (cdr (cdr (cdr (children (car x10)))))))))
(assert
 (not
  (= (car (children (car (cdr (cdr (cdr (children (car x10)))))))) (car x10))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (children (car x10))))))))
   (children (car (cdr (cdr (cdr (children (car x10))))))))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (children (car x10))))))))
...
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (children (car x10))))))))
   (children (car x10)))))
(assert
 (not (= (cdr (children (car (cdr (cdr (cdr (children (car x10)))))))) x10)))
(assert
 (not
  (= (pred (data (car (cdr (cdr (cdr (children (car x10))))))))
   (data (car (cdr (cdr (cdr (children (car x10))))))))))
(assert
 (not
...
(assert
 (not (= (car (cdr (cdr (cdr (cdr (children (car x10))))))) (car x10))))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (children (car x10))))))))
   (cdr (cdr (cdr (cdr (children (car x10)))))))))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (children (car x10))))))))
...
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (children (car x10))))))))
   (children (car x10)))))
(assert
 (not (= (children (car (cdr (cdr (cdr (cdr (children (car x10)))))))) x10)))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (children (car x10)))))))
   (cdr (cdr (cdr (cdr (children (car x10)))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (children (car x10)))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (children (car x10))))))) (children (car x10)))))
(assert (not (= (cdr (cdr (cdr (cdr (cdr (children (car x10))))))) x10)))
(assert
 (not (= (car (cdr (cdr (cdr (cdr (cdr (children (car x10)))))))) (car x10))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (children (car x10))))))))
   (cdr (cdr (cdr (cdr (cdr (children (car x10))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (children (car x10))))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (children (car x10))))))))
   (children (car x10)))))
(assert
 (not (= (cdr (cdr (cdr (cdr (cdr (cdr (children (car x10)))))))) x10)))
...
(assert
 (not
  (= (pred (pred (pred (pred (pred (data (car x10)))))))
   (pred (pred (pred (pred (data (car x10)))))))))
(assert
 (not
  (= (pred (pred (pred (pred (pred (data (car x10)))))))
...
(assert
 (not
  (= (pred (pred (pred (pred (pred (data (car x10))))))) (data (car x10)))))
(assert
 (not
  (= (pred (pred (pred (pred (pred (pred (data (car x10))))))))
   (pred (pred (pred (pred (pred (data (car x10))))))))))
(assert
 (not
  (= (pred (pred (pred (pred (pred (pred (data (car x10))))))))
...
(assert
 (not
  (= (children (car (children (car (children (car (cdr x10)))))))
...
(assert
 (not
  (= (children (car (children (car (children (car (cdr x10))))))) (cdr x10))))
(assert
 (not (= (children (car (children (car (children (car (cdr x10))))))) x10)))
(assert
 (not
  (= (car (children (car (children (car (children (car (cdr x10))))))))
   (car (children (car (children (car (cdr x10)))))))))
(assert
 (not
  (= (car (children (car (children (car (children (car (cdr x10))))))))
...
(assert
 (not
  (= (cdr (children (car (children (car (children (car (cdr x10))))))))
   (children (car (children (car (children (car (cdr x10))))))))))
(assert
 (not
  (= (cdr (children (car (children (car (children (car (cdr x10))))))))
...
(assert
 (not
  (= (cdr (children (car (children (car (children (car (cdr x10)))))))) x10)))
(assert
 (not
  (= (pred (data (car (children (car (children (car (cdr x10))))))))
   (data (car (children (car (children (car (cdr x10))))))))))
(assert
 (not
...
(assert
 (not
  (= (car (cdr (children (car (children (car (cdr x10)))))))
   (car (children (car (cdr x10)))))))
(assert
 (not
  (= (car (cdr (children (car (children (car (cdr x10))))))) (car (cdr x10)))))
(assert
 (not
  (= (children (car (cdr (children (car (children (car (cdr x10))))))))
   (cdr (children (car (children (car (cdr x10)))))))))
(assert
 (not
  (= (children (car (cdr (children (car (children (car (cdr x10))))))))
...
(assert
 (not
  (= (children (car (cdr (children (car (children (car (cdr x10)))))))) x10)))
(assert
 (not
  (= (cdr (cdr (children (car (children (car (cdr x10)))))))
   (cdr (children (car (children (car (cdr x10)))))))))
(assert
 (not
  (= (cdr (cdr (children (car (children (car (cdr x10)))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (children (car (cdr x10)))))))
   (children (car (cdr x10))))))
(assert
 (not (= (cdr (cdr (children (car (children (car (cdr x10))))))) (cdr x10))))
(assert (not (= (cdr (cdr (children (car (children (car (cdr x10))))))) x10)))
(assert
 (not
  (= (car (cdr (cdr (children (car (children (car (cdr x10))))))))
   (car (children (car (cdr x10)))))))
(assert
 (not
  (= (car (cdr (cdr (children (car (children (car (cdr x10))))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (children (car (children (car (cdr x10))))))))
   (cdr (cdr (children (car (children (car (cdr x10))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (children (car (cdr x10))))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (children (car (children (car (cdr x10)))))))) (cdr x10))))
(assert
 (not (= (cdr (cdr (cdr (children (car (children (car (cdr x10)))))))) x10)))
(assert
 (not
...
(assert
 (not
  (= (pred (pred (data (car (children (car (cdr x10)))))))
   (pred (data (car (children (car (cdr x10)))))))))
(assert
 (not
  (= (pred (pred (data (car (children (car (cdr x10)))))))
...
(assert
 (not
  (= (pred (pred (pred (data (car (children (car (cdr x10))))))))
   (pred (pred (data (car (children (car (cdr x10))))))))))
(assert
 (not
  (= (pred (pred (pred (data (car (children (car (cdr x10))))))))
...
(assert
 (not
  (= (car (children (car (cdr (children (car (cdr x10)))))))
   (car (cdr (children (car (cdr x10))))))))
(assert
 (not
  (= (car (children (car (cdr (children (car (cdr x10))))))) (car (cdr x10)))))
(assert
 (not
  (= (children (car (children (car (cdr (children (car (cdr x10))))))))
   (children (car (cdr (children (car (cdr x10)))))))))
(assert
 (not
  (= (children (car (children (car (cdr (children (car (cdr x10))))))))
...
(assert
 (not
  (= (children (car (children (car (cdr (children (car (cdr x10)))))))) x10)))
(assert
 (not
  (= (cdr (children (car (cdr (children (car (cdr x10)))))))
   (children (car (cdr (children (car (cdr x10)))))))))
(assert
 (not
  (= (cdr (children (car (cdr (children (car (cdr x10)))))))
...
(assert
 (not
  (= (cdr (children (car (cdr (children (car (cdr x10)))))))
   (children (car (cdr x10))))))
(assert
 (not (= (cdr (children (car (cdr (children (car (cdr x10))))))) (cdr x10))))
(assert (not (= (cdr (children (car (cdr (children (car (cdr x10))))))) x10)))
(assert
 (not
  (= (car (cdr (children (car (cdr (children (car (cdr x10))))))))
   (car (cdr (children (car (cdr x10))))))))
(assert
 (not
  (= (car (cdr (children (car (cdr (children (car (cdr x10))))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (cdr (children (car (cdr x10))))))))
   (cdr (children (car (cdr (children (car (cdr x10))))))))))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (children (car (cdr x10))))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (cdr (children (car (cdr x10)))))))) (cdr x10))))
(assert
 (not (= (cdr (cdr (children (car (cdr (children (car (cdr x10)))))))) x10)))
(assert
 (not
  (= (pred (data (car (cdr (children (car (cdr x10)))))))
   (data (car (cdr (children (car (cdr x10)))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (children (car (cdr x10))))))))
   (pred (data (car (cdr (children (car (cdr x10))))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (children (car (cdr x10))))))))
...
(assert
 (not
  (= (children (car (cdr (cdr (children (car (cdr x10)))))))
...
(assert
 (not
  (= (children (car (cdr (cdr (children (car (cdr x10)))))))
   (children (car (cdr x10))))))
(assert
 (not (= (children (car (cdr (cdr (children (car (cdr x10))))))) (cdr x10))))
(assert (not (= (children (car (cdr (cdr (children (car (cdr x10))))))) x10)))
(assert
 (not
  (= (car (children (car (cdr (cdr (children (car (cdr x10))))))))
   (car (cdr (cdr (children (car (cdr x10)))))))))
(assert
 (not
  (= (car (children (car (cdr (cdr (children (car (cdr x10))))))))
   (car (cdr x10)))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (children (car (cdr x10))))))))
   (children (car (cdr (cdr (children (car (cdr x10))))))))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (children (car (cdr x10))))))))
...
(assert
 (not
  (= (cdr (children (car (cdr (cdr (children (car (cdr x10)))))))) (cdr x10))))
(assert
 (not (= (cdr (children (car (cdr (cdr (children (car (cdr x10)))))))) x10)))
(assert
 (not
  (= (pred (data (car (cdr (cdr (children (car (cdr x10))))))))
   (data (car (cdr (cdr (children (car (cdr x10))))))))))
(assert
 (not
...
(assert
 (not (= (car (cdr (cdr (cdr (children (car (cdr x10))))))) (car (cdr x10)))))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (children (car (cdr x10))))))))
   (cdr (cdr (cdr (children (car (cdr x10)))))))))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (children (car (cdr x10))))))))
...
(assert
 (not
  (= (children (car (cdr (cdr (cdr (children (car (cdr x10)))))))) (cdr x10))))
(assert
 (not (= (children (car (cdr (cdr (cdr (children (car (cdr x10)))))))) x10)))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (cdr x10)))))))
   (cdr (cdr (cdr (children (car (cdr x10)))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (cdr x10)))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (cdr x10)))))))
   (children (car (cdr x10))))))
(assert
 (not (= (cdr (cdr (cdr (cdr (children (car (cdr x10))))))) (cdr x10))))
(assert (not (= (cdr (cdr (cdr (cdr (children (car (cdr x10))))))) x10)))
(assert
 (not
  (= (car (cdr (cdr (cdr (cdr (children (car (cdr x10)))))))) (car (cdr x10)))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (children (car (cdr x10))))))))
   (cdr (cdr (cdr (cdr (children (car (cdr x10))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (children (car (cdr x10))))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (children (car (cdr x10))))))))
   (children (car (cdr x10))))))
(assert
 (not (= (cdr (cdr (cdr (cdr (cdr (children (car (cdr x10)))))))) (cdr x10))))
(assert
 (not (= (cdr (cdr (cdr (cdr (cdr (children (car (cdr x10)))))))) x10)))
...
(assert
 (not
  (= (pred (pred (pred (pred (data (car (cdr x10)))))))
   (pred (pred (pred (data (car (cdr x10)))))))))
(assert
 (not
  (= (pred (pred (pred (pred (data (car (cdr x10)))))))
...
(assert
 (not
  (= (pred (pred (pred (pred (pred (data (car (cdr x10))))))))
   (pred (pred (pred (pred (data (car (cdr x10))))))))))
(assert
 (not
  (= (pred (pred (pred (pred (pred (data (car (cdr x10))))))))
...
(assert
 (not
  (= (car (children (car (children (car (cdr (cdr x10)))))))
   (car (children (car (cdr (cdr x10))))))))
(assert
 (not
  (= (car (children (car (children (car (cdr (cdr x10)))))))
   (car (cdr (cdr x10))))))
(assert
 (not
  (= (children (car (children (car (children (car (cdr (cdr x10))))))))
   (children (car (children (car (cdr (cdr x10)))))))))
(assert
 (not
  (= (children (car (children (car (children (car (cdr (cdr x10))))))))
...
(assert
 (not
  (= (children (car (children (car (children (car (cdr (cdr x10)))))))) x10)))
(assert
 (not
  (= (cdr (children (car (children (car (cdr (cdr x10)))))))
   (children (car (children (car (cdr (cdr x10)))))))))
(assert
 (not
  (= (cdr (children (car (children (car (cdr (cdr x10)))))))
...
(assert
 (not
  (= (cdr (children (car (children (car (cdr (cdr x10))))))) (cdr (cdr x10)))))
(assert
 (not (= (cdr (children (car (children (car (cdr (cdr x10))))))) (cdr x10))))
(assert (not (= (cdr (children (car (children (car (cdr (cdr x10))))))) x10)))
(assert
 (not
  (= (car (cdr (children (car (children (car (cdr (cdr x10))))))))
   (car (children (car (cdr (cdr x10))))))))
(assert
 (not
  (= (car (cdr (children (car (children (car (cdr (cdr x10))))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (children (car (cdr (cdr x10))))))))
   (cdr (children (car (children (car (cdr (cdr x10))))))))))
(assert
 (not
  (= (cdr (cdr (children (car (children (car (cdr (cdr x10))))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (children (car (cdr (cdr x10)))))))) (cdr x10))))
(assert
 (not (= (cdr (cdr (children (car (children (car (cdr (cdr x10)))))))) x10)))
(assert
 (not
  (= (pred (data (car (children (car (cdr (cdr x10)))))))
   (data (car (children (car (cdr (cdr x10)))))))))
(assert
 (not
  (= (pred (pred (data (car (children (car (cdr (cdr x10))))))))
   (pred (data (car (children (car (cdr (cdr x10))))))))))
(assert
 (not
  (= (pred (pred (data (car (children (car (cdr (cdr x10))))))))
...
(assert
 (not
  (= (children (car (cdr (children (car (cdr (cdr x10)))))))
...
(assert
 (not
  (= (children (car (cdr (children (car (cdr (cdr x10))))))) (cdr (cdr x10)))))
(assert
 (not (= (children (car (cdr (children (car (cdr (cdr x10))))))) (cdr x10))))
(assert (not (= (children (car (cdr (children (car (cdr (cdr x10))))))) x10)))
(assert
 (not
  (= (car (children (car (cdr (children (car (cdr (cdr x10))))))))
   (car (cdr (children (car (cdr (cdr x10)))))))))
(assert
 (not
  (= (car (children (car (cdr (children (car (cdr (cdr x10))))))))
   (car (cdr (cdr x10))))))
(assert
 (not
  (= (cdr (children (car (cdr (children (car (cdr (cdr x10))))))))
   (children (car (cdr (children (car (cdr (cdr x10))))))))))
(assert
 (not
  (= (cdr (children (car (cdr (children (car (cdr (cdr x10))))))))
...
(assert
 (not
  (= (cdr (children (car (cdr (children (car (cdr (cdr x10)))))))) (cdr x10))))
(assert
 (not (= (cdr (children (car (cdr (children (car (cdr (cdr x10)))))))) x10)))
(assert
 (not
  (= (pred (data (car (cdr (children (car (cdr (cdr x10))))))))
   (data (car (cdr (children (car (cdr (cdr x10))))))))))
(assert
 (not
...
(assert
 (not
  (= (car (cdr (cdr (children (car (cdr (cdr x10))))))) (car (cdr (cdr x10))))))
(assert
 (not
  (= (children (car (cdr (cdr (children (car (cdr (cdr x10))))))))
   (cdr (cdr (children (car (cdr (cdr x10)))))))))
(assert
 (not
  (= (children (car (cdr (cdr (children (car (cdr (cdr x10))))))))
...
(assert
 (not
  (= (children (car (cdr (cdr (children (car (cdr (cdr x10)))))))) (cdr x10))))
(assert
 (not (= (children (car (cdr (cdr (children (car (cdr (cdr x10)))))))) x10)))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (cdr x10)))))))
   (cdr (cdr (children (car (cdr (cdr x10)))))))))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (cdr x10)))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (cdr x10)))))))
   (children (car (cdr (cdr x10)))))))
(assert
 (not (= (cdr (cdr (cdr (children (car (cdr (cdr x10))))))) (cdr (cdr x10)))))
(assert
 (not (= (cdr (cdr (cdr (children (car (cdr (cdr x10))))))) (cdr x10))))
(assert (not (= (cdr (cdr (cdr (children (car (cdr (cdr x10))))))) x10)))
(assert
 (not
  (= (car (cdr (cdr (cdr (children (car (cdr (cdr x10))))))))
   (car (cdr (cdr x10))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (cdr (cdr x10))))))))
   (cdr (cdr (cdr (children (car (cdr (cdr x10))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (cdr (cdr x10))))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (cdr (cdr x10)))))))) (cdr (cdr x10)))))
(assert
 (not (= (cdr (cdr (cdr (cdr (children (car (cdr (cdr x10)))))))) (cdr x10))))
(assert
 (not (= (cdr (cdr (cdr (cdr (children (car (cdr (cdr x10)))))))) x10)))
(assert
...
(assert
 (not
  (= (pred (pred (pred (data (car (cdr (cdr x10)))))))
   (pred (pred (data (car (cdr (cdr x10)))))))))
(assert
 (not
  (= (pred (pred (pred (data (car (cdr (cdr x10)))))))
...
(assert
 (not
  (= (pred (pred (pred (data (car (cdr (cdr x10)))))))
   (data (car (cdr (cdr x10)))))))
(assert
 (not
  (= (pred (pred (pred (pred (data (car (cdr (cdr x10))))))))
   (pred (pred (pred (data (car (cdr (cdr x10))))))))))
(assert
 (not
  (= (pred (pred (pred (pred (data (car (cdr (cdr x10))))))))
...
(assert
 (not
  (= (children (car (children (car (cdr (cdr (cdr x10)))))))
...
(assert
 (not
  (= (children (car (children (car (cdr (cdr (cdr x10))))))) (cdr (cdr x10)))))
(assert
 (not (= (children (car (children (car (cdr (cdr (cdr x10))))))) (cdr x10))))
(assert (not (= (children (car (children (car (cdr (cdr (cdr x10))))))) x10)))
(assert
 (not
  (= (car (children (car (children (car (cdr (cdr (cdr x10))))))))
   (car (children (car (cdr (cdr (cdr x10)))))))))
(assert
 (not
  (= (car (children (car (children (car (cdr (cdr (cdr x10))))))))
   (car (cdr (cdr (cdr x10)))))))
(assert
 (not
  (= (cdr (children (car (children (car (cdr (cdr (cdr x10))))))))
   (children (car (children (car (cdr (cdr (cdr x10))))))))))
(assert
 (not
  (= (cdr (children (car (children (car (cdr (cdr (cdr x10))))))))
...
(assert
 (not
  (= (cdr (children (car (children (car (cdr (cdr (cdr x10)))))))) (cdr x10))))
(assert
 (not (= (cdr (children (car (children (car (cdr (cdr (cdr x10)))))))) x10)))
(assert
 (not
  (= (pred (data (car (children (car (cdr (cdr (cdr x10))))))))
   (data (car (children (car (cdr (cdr (cdr x10))))))))))
(assert
 (not
...
(assert
 (not
  (= (car (cdr (children (car (cdr (cdr (cdr x10)))))))
   (car (cdr (cdr (cdr x10)))))))
(assert
 (not
  (= (children (car (cdr (children (car (cdr (cdr (cdr x10))))))))
   (cdr (children (car (cdr (cdr (cdr x10)))))))))
(assert
 (not
  (= (children (car (cdr (children (car (cdr (cdr (cdr x10))))))))
...
(assert
 (not
  (= (children (car (cdr (children (car (cdr (cdr (cdr x10)))))))) (cdr x10))))
(assert
 (not (= (children (car (cdr (children (car (cdr (cdr (cdr x10)))))))) x10)))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (cdr x10)))))))
   (cdr (children (car (cdr (cdr (cdr x10)))))))))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (cdr x10)))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (cdr x10))))))) (cdr (cdr (cdr x10))))))
(assert
 (not (= (cdr (cdr (children (car (cdr (cdr (cdr x10))))))) (cdr (cdr x10)))))
(assert
 (not (= (cdr (cdr (children (car (cdr (cdr (cdr x10))))))) (cdr x10))))
(assert (not (= (cdr (cdr (children (car (cdr (cdr (cdr x10))))))) x10)))
(assert
 (not
  (= (car (cdr (cdr (children (car (cdr (cdr (cdr x10))))))))
   (car (cdr (cdr (cdr x10)))))))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (cdr (cdr x10))))))))
   (cdr (cdr (children (car (cdr (cdr (cdr x10))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (cdr (cdr x10))))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (cdr (cdr x10)))))))) (cdr (cdr x10)))))
(assert
 (not (= (cdr (cdr (cdr (children (car (cdr (cdr (cdr x10)))))))) (cdr x10))))
(assert
 (not (= (cdr (cdr (cdr (children (car (cdr (cdr (cdr x10)))))))) x10)))
(assert
 (not
...
(assert
 (not
  (= (pred (pred (data (car (cdr (cdr (cdr x10)))))))
   (pred (data (car (cdr (cdr (cdr x10)))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (cdr (cdr x10)))))))
...
(assert
 (not
  (= (pred (pred (pred (data (car (cdr (cdr (cdr x10))))))))
   (pred (pred (data (car (cdr (cdr (cdr x10))))))))))
(assert
 (not
  (= (pred (pred (pred (data (car (cdr (cdr (cdr x10))))))))
...
(assert
 (not
  (= (car (children (car (cdr (cdr (cdr (cdr x10)))))))
   (car (cdr (cdr (cdr (cdr x10))))))))
(assert
 (not
  (= (children (car (children (car (cdr (cdr (cdr (cdr x10))))))))
   (children (car (cdr (cdr (cdr (cdr x10)))))))))
(assert
 (not
  (= (children (car (children (car (cdr (cdr (cdr (cdr x10))))))))
   (cdr (cdr (cdr (cdr x10)))))))
...
(assert
 (not
  (= (children (car (children (car (cdr (cdr (cdr (cdr x10)))))))) (cdr x10))))
(assert
 (not (= (children (car (children (car (cdr (cdr (cdr (cdr x10)))))))) x10)))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (cdr x10)))))))
   (children (car (cdr (cdr (cdr (cdr x10)))))))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (cdr x10)))))))
...
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (cdr x10))))))) (cdr (cdr (cdr x10))))))
(assert
 (not (= (cdr (children (car (cdr (cdr (cdr (cdr x10))))))) (cdr (cdr x10)))))
(assert
 (not (= (cdr (children (car (cdr (cdr (cdr (cdr x10))))))) (cdr x10))))
(assert (not (= (cdr (children (car (cdr (cdr (cdr (cdr x10))))))) x10)))
(assert
 (not
  (= (car (cdr (children (car (cdr (cdr (cdr (cdr x10))))))))
   (car (cdr (cdr (cdr (cdr x10))))))))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (cdr (cdr x10))))))))
   (cdr (children (car (cdr (cdr (cdr (cdr x10))))))))))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (cdr (cdr x10))))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (cdr (cdr x10)))))))) (cdr (cdr x10)))))
(assert
 (not (= (cdr (cdr (children (car (cdr (cdr (cdr (cdr x10)))))))) (cdr x10))))
(assert
 (not (= (cdr (cdr (children (car (cdr (cdr (cdr (cdr x10)))))))) x10)))
(assert
 (not
  (= (pred (data (car (cdr (cdr (cdr (cdr x10)))))))
   (data (car (cdr (cdr (cdr (cdr x10)))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (cdr (cdr (cdr x10))))))))
   (pred (data (car (cdr (cdr (cdr (cdr x10))))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (cdr (cdr (cdr x10))))))))
...
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (cdr x10)))))))
...
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (cdr x10))))))) (cdr (cdr (cdr x10))))))
(assert
 (not (= (children (car (cdr (cdr (cdr (cdr (cdr x10))))))) (cdr (cdr x10)))))
(assert
 (not (= (children (car (cdr (cdr (cdr (cdr (cdr x10))))))) (cdr x10))))
(assert (not (= (children (car (cdr (cdr (cdr (cdr (cdr x10))))))) x10)))
(assert
 (not
  (= (car (children (car (cdr (cdr (cdr (cdr (cdr x10))))))))
   (car (cdr (cdr (cdr (cdr (cdr x10)))))))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (cdr (cdr x10))))))))
   (children (car (cdr (cdr (cdr (cdr (cdr x10))))))))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (cdr (cdr x10))))))))
...
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (cdr (cdr x10)))))))) (cdr (cdr x10)))))
(assert
 (not (= (cdr (children (car (cdr (cdr (cdr (cdr (cdr x10)))))))) (cdr x10))))
(assert
 (not (= (cdr (children (car (cdr (cdr (cdr (cdr (cdr x10)))))))) x10)))
(assert
 (not
  (= (pred (data (car (cdr (cdr (cdr (cdr (cdr x10))))))))
   (data (car (cdr (cdr (cdr (cdr (cdr x10))))))))))
(assert
 (not
...
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (cdr (cdr x10))))))))
   (cdr (cdr (cdr (cdr (cdr (cdr x10)))))))))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (cdr (cdr x10))))))))
...
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (cdr (cdr x10)))))))) (cdr (cdr x10)))))
(assert
 (not (= (children (car (cdr (cdr (cdr (cdr (cdr (cdr x10)))))))) (cdr x10))))
(assert
 (not (= (children (car (cdr (cdr (cdr (cdr (cdr (cdr x10)))))))) x10)))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr x10)))))))
   (cdr (cdr (cdr (cdr (cdr (cdr x10)))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr x10)))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr x10)))))))
   (cdr (cdr (cdr (cdr x10)))))))
(assert
 (not (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr x10))))))) (cdr (cdr (cdr x10))))))
(assert
 (not (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr x10))))))) (cdr (cdr x10)))))
(assert (not (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr x10))))))) (cdr x10))))
(assert (not (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr x10))))))) x10)))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr (cdr x10))))))))
   (cdr (cdr (cdr (cdr (cdr (cdr (cdr x10))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr (cdr x10))))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr (cdr x10))))))))
   (cdr (cdr (cdr x10))))))
(assert
 (not (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr (cdr x10)))))))) (cdr (cdr x10)))))
(assert
 (not (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr (cdr x10)))))))) (cdr x10))))
(assert (not (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr (cdr x10)))))))) x10)))
...
(assert
 (not
  (= (car (children (car (children (car (children (car x9)))))))
   (car (children (car (children (car x9))))))))
(assert
 (not
  (= (car (children (car (children (car (children (car x9)))))))
   (car (children (car x9))))))
(assert
 (not
  (= (car (children (car (children (car (children (car x9))))))) (car x9))))
(assert
 (not
  (= (children (car (children (car (children (car (children (car x9))))))))
   (children (car (children (car (children (car x9)))))))))
(assert
 (not
  (= (children (car (children (car (children (car (children (car x9))))))))
...
(assert
 (not
  (= (cdr (children (car (children (car (children (car x9)))))))
   (children (car (children (car (children (car x9)))))))))
(assert
 (not
  (= (cdr (children (car (children (car (children (car x9)))))))
...
(assert
 (not
  (= (cdr (children (car (children (car (children (car x9)))))))
   (children (car x9)))))
(assert
 (not (= (cdr (children (car (children (car (children (car x9))))))) x9)))
(assert
 (not
  (= (car (cdr (children (car (children (car (children (car x9))))))))
   (car (children (car (children (car x9))))))))
(assert
 (not
  (= (car (cdr (children (car (children (car (children (car x9))))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (children (car (children (car x9))))))))
   (cdr (children (car (children (car (children (car x9))))))))))
(assert
 (not
  (= (cdr (cdr (children (car (children (car (children (car x9))))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (children (car (children (car x9)))))))) x9)))
(assert
 (not
  (= (pred (data (car (children (car (children (car x9)))))))
   (data (car (children (car (children (car x9)))))))))
(assert
 (not
  (= (pred (pred (data (car (children (car (children (car x9))))))))
   (pred (data (car (children (car (children (car x9))))))))))
(assert
 (not
  (= (pred (pred (data (car (children (car (children (car x9))))))))
...
(assert
 (not
  (= (children (car (cdr (children (car (children (car x9)))))))
   (cdr (children (car (children (car x9))))))))
(assert
 (not
  (= (children (car (cdr (children (car (children (car x9)))))))
...
(assert
 (not
  (= (children (car (cdr (children (car (children (car x9)))))))
   (children (car x9)))))
(assert
 (not (= (children (car (cdr (children (car (children (car x9))))))) x9)))
(assert
 (not
  (= (car (children (car (cdr (children (car (children (car x9))))))))
   (car (cdr (children (car (children (car x9)))))))))
(assert
 (not
  (= (car (children (car (cdr (children (car (children (car x9))))))))
...
(assert
 (not
  (= (cdr (children (car (cdr (children (car (children (car x9))))))))
   (children (car (cdr (children (car (children (car x9))))))))))
(assert
 (not
  (= (cdr (children (car (cdr (children (car (children (car x9))))))))
...
(assert
 (not
  (= (cdr (children (car (cdr (children (car (children (car x9)))))))) x9)))
(assert
 (not
  (= (pred (data (car (cdr (children (car (children (car x9))))))))
   (data (car (cdr (children (car (children (car x9))))))))))
(assert
 (not
...
(assert
 (not
  (= (car (cdr (cdr (children (car (children (car x9)))))))
   (car (children (car x9))))))
(assert
 (not (= (car (cdr (cdr (children (car (children (car x9))))))) (car x9))))
(assert
 (not
  (= (children (car (cdr (cdr (children (car (children (car x9))))))))
   (cdr (cdr (children (car (children (car x9)))))))))
(assert
 (not
  (= (children (car (cdr (cdr (children (car (children (car x9))))))))
...
(assert
 (not
  (= (children (car (cdr (cdr (children (car (children (car x9)))))))) x9)))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (children (car x9)))))))
   (cdr (cdr (children (car (children (car x9)))))))))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (children (car x9)))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (children (car (children (car x9)))))))
   (children (car x9)))))
(assert (not (= (cdr (cdr (cdr (children (car (children (car x9))))))) x9)))
(assert
 (not
  (= (car (cdr (cdr (cdr (children (car (children (car x9))))))))
   (car (children (car x9))))))
(assert
 (not
  (= (car (cdr (cdr (cdr (children (car (children (car x9)))))))) (car x9))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (children (car x9))))))))
   (cdr (cdr (cdr (children (car (children (car x9))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (children (car x9))))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (children (car x9))))))))
   (children (car x9)))))
(assert
 (not (= (cdr (cdr (cdr (cdr (children (car (children (car x9)))))))) x9)))
(assert
 (not
...
(assert
 (not
  (= (pred (pred (pred (data (car (children (car x9)))))))
   (pred (pred (data (car (children (car x9)))))))))
(assert
 (not
  (= (pred (pred (pred (data (car (children (car x9)))))))
...
(assert
 (not
  (= (pred (pred (pred (pred (data (car (children (car x9))))))))
   (pred (pred (pred (data (car (children (car x9))))))))))
(assert
 (not
  (= (pred (pred (pred (pred (data (car (children (car x9))))))))
...
(assert
 (not
  (= (children (car (children (car (cdr (children (car x9)))))))
...
(assert
 (not
  (= (children (car (children (car (cdr (children (car x9)))))))
   (children (car x9)))))
(assert
 (not (= (children (car (children (car (cdr (children (car x9))))))) x9)))
(assert
 (not
  (= (car (children (car (children (car (cdr (children (car x9))))))))
   (car (children (car (cdr (children (car x9)))))))))
(assert
 (not
  (= (car (children (car (children (car (cdr (children (car x9))))))))
...
(assert
 (not
  (= (cdr (children (car (children (car (cdr (children (car x9))))))))
   (children (car (children (car (cdr (children (car x9))))))))))
(assert
 (not
  (= (cdr (children (car (children (car (cdr (children (car x9))))))))
...
(assert
 (not
  (= (cdr (children (car (children (car (cdr (children (car x9)))))))) x9)))
(assert
 (not
  (= (pred (data (car (children (car (cdr (children (car x9))))))))
   (data (car (children (car (cdr (children (car x9))))))))))
(assert
 (not
...
(assert
 (not
  (= (car (cdr (children (car (cdr (children (car x9)))))))
   (car (cdr (children (car x9)))))))
(assert
 (not (= (car (cdr (children (car (cdr (children (car x9))))))) (car x9))))
(assert
 (not
  (= (children (car (cdr (children (car (cdr (children (car x9))))))))
   (cdr (children (car (cdr (children (car x9)))))))))
(assert
 (not
  (= (children (car (cdr (children (car (cdr (children (car x9))))))))
...
(assert
 (not
  (= (children (car (cdr (children (car (cdr (children (car x9)))))))) x9)))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (children (car x9)))))))
   (cdr (children (car (cdr (children (car x9)))))))))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (children (car x9)))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (cdr (children (car x9)))))))
   (children (car x9)))))
(assert (not (= (cdr (cdr (children (car (cdr (children (car x9))))))) x9)))
(assert
 (not
  (= (car (cdr (cdr (children (car (cdr (children (car x9))))))))
   (car (cdr (children (car x9)))))))
(assert
 (not
  (= (car (cdr (cdr (children (car (cdr (children (car x9)))))))) (car x9))))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (children (car x9))))))))
   (cdr (cdr (children (car (cdr (children (car x9))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (children (car x9))))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (children (car x9))))))))
   (children (car x9)))))
(assert
 (not (= (cdr (cdr (cdr (children (car (cdr (children (car x9)))))))) x9)))
(assert
 (not
...
(assert
 (not
  (= (pred (pred (data (car (cdr (children (car x9)))))))
   (pred (data (car (cdr (children (car x9)))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (children (car x9)))))))
...
(assert
 (not
  (= (pred (pred (pred (data (car (cdr (children (car x9))))))))
   (pred (pred (data (car (cdr (children (car x9))))))))))
(assert
 (not
  (= (pred (pred (pred (data (car (cdr (children (car x9))))))))
...
(assert
 (not
  (= (car (children (car (cdr (cdr (children (car x9)))))))
   (car (cdr (cdr (children (car x9))))))))
(assert
 (not (= (car (children (car (cdr (cdr (children (car x9))))))) (car x9))))
(assert
 (not
  (= (children (car (children (car (cdr (cdr (children (car x9))))))))
   (children (car (cdr (cdr (children (car x9)))))))))
(assert
 (not
  (= (children (car (children (car (cdr (cdr (children (car x9))))))))
...
(assert
 (not
  (= (children (car (children (car (cdr (cdr (children (car x9)))))))) x9)))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (children (car x9)))))))
   (children (car (cdr (cdr (children (car x9)))))))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (children (car x9)))))))
...
(assert
 (not
  (= (cdr (children (car (cdr (cdr (children (car x9)))))))
   (children (car x9)))))
(assert (not (= (cdr (children (car (cdr (cdr (children (car x9))))))) x9)))
(assert
 (not
  (= (car (cdr (children (car (cdr (cdr (children (car x9))))))))
   (car (cdr (cdr (children (car x9))))))))
(assert
 (not
  (= (car (cdr (children (car (cdr (cdr (children (car x9)))))))) (car x9))))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (children (car x9))))))))
   (cdr (children (car (cdr (cdr (children (car x9))))))))))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (children (car x9))))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (children (car x9))))))))
   (children (car x9)))))
(assert
 (not (= (cdr (cdr (children (car (cdr (cdr (children (car x9)))))))) x9)))
(assert
 (not
  (= (pred (data (car (cdr (cdr (children (car x9)))))))
   (data (car (cdr (cdr (children (car x9)))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (cdr (children (car x9))))))))
   (pred (data (car (cdr (cdr (children (car x9))))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (cdr (children (car x9))))))))
...
(assert
 (not
  (= (children (car (cdr (cdr (cdr (children (car x9)))))))
...
(assert
 (not
  (= (children (car (cdr (cdr (cdr (children (car x9)))))))
   (children (car x9)))))
(assert (not (= (children (car (cdr (cdr (cdr (children (car x9))))))) x9)))
(assert
 (not
  (= (car (children (car (cdr (cdr (cdr (children (car x9))))))))
   (car (cdr (cdr (cdr (children (car x9)))))))))
(assert
 (not
  (= (car (children (car (cdr (cdr (cdr (children (car x9)))))))) (car x9))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (children (car x9))))))))
   (children (car (cdr (cdr (cdr (children (car x9))))))))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (children (car x9))))))))
...
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (children (car x9))))))))
   (children (car x9)))))
(assert
 (not (= (cdr (children (car (cdr (cdr (cdr (children (car x9)))))))) x9)))
(assert
 (not
  (= (pred (data (car (cdr (cdr (cdr (children (car x9))))))))
   (data (car (cdr (cdr (cdr (children (car x9))))))))))
(assert
 (not
...
(assert (not (= (car (cdr (cdr (cdr (cdr (children (car x9))))))) (car x9))))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (children (car x9))))))))
   (cdr (cdr (cdr (cdr (children (car x9)))))))))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (children (car x9))))))))
...
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (children (car x9))))))))
   (children (car x9)))))
(assert
 (not (= (children (car (cdr (cdr (cdr (cdr (children (car x9)))))))) x9)))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (children (car x9)))))))
   (cdr (cdr (cdr (cdr (children (car x9)))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (children (car x9)))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (children (car x9))))))) (children (car x9)))))
(assert (not (= (cdr (cdr (cdr (cdr (cdr (children (car x9))))))) x9)))
(assert
 (not (= (car (cdr (cdr (cdr (cdr (cdr (children (car x9)))))))) (car x9))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (children (car x9))))))))
   (cdr (cdr (cdr (cdr (cdr (children (car x9))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (children (car x9))))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (children (car x9))))))))
   (children (car x9)))))
(assert (not (= (cdr (cdr (cdr (cdr (cdr (cdr (children (car x9)))))))) x9)))
...
(assert
 (not
  (= (pred (pred (pred (pred (pred (data (car x9)))))))
   (pred (pred (pred (pred (data (car x9)))))))))
(assert
 (not
  (= (pred (pred (pred (pred (pred (data (car x9)))))))
...
(assert
 (not
  (= (pred (pred (pred (pred (pred (data (car x9)))))))
   (pred (data (car x9))))))
(assert
 (not (= (pred (pred (pred (pred (pred (data (car x9))))))) (data (car x9)))))
(assert
 (not
  (= (pred (pred (pred (pred (pred (pred (data (car x9))))))))
   (pred (pred (pred (pred (pred (data (car x9))))))))))
(assert
 (not
  (= (pred (pred (pred (pred (pred (pred (data (car x9))))))))
...
(assert
 (not
  (= (children (car (children (car (children (car (cdr x9)))))))
...
(assert
 (not
  (= (children (car (children (car (children (car (cdr x9))))))) (cdr x9))))
(assert
 (not (= (children (car (children (car (children (car (cdr x9))))))) x9)))
(assert
 (not
  (= (car (children (car (children (car (children (car (cdr x9))))))))
   (car (children (car (children (car (cdr x9)))))))))
(assert
 (not
  (= (car (children (car (children (car (children (car (cdr x9))))))))
...
(assert
 (not
  (= (cdr (children (car (children (car (children (car (cdr x9))))))))
   (children (car (children (car (children (car (cdr x9))))))))))
(assert
 (not
  (= (cdr (children (car (children (car (children (car (cdr x9))))))))
...
(assert
 (not
  (= (cdr (children (car (children (car (children (car (cdr x9)))))))) x9)))
(assert
 (not
  (= (pred (data (car (children (car (children (car (cdr x9))))))))
   (data (car (children (car (children (car (cdr x9))))))))))
(assert
 (not
...
(assert
 (not
  (= (car (cdr (children (car (children (car (cdr x9)))))))
   (car (children (car (cdr x9)))))))
(assert
 (not
  (= (car (cdr (children (car (children (car (cdr x9))))))) (car (cdr x9)))))
(assert
 (not
  (= (children (car (cdr (children (car (children (car (cdr x9))))))))
   (cdr (children (car (children (car (cdr x9)))))))))
(assert
 (not
  (= (children (car (cdr (children (car (children (car (cdr x9))))))))
...
(assert
 (not
  (= (children (car (cdr (children (car (children (car (cdr x9)))))))) x9)))
(assert
 (not
  (= (cdr (cdr (children (car (children (car (cdr x9)))))))
   (cdr (children (car (children (car (cdr x9)))))))))
(assert
 (not
  (= (cdr (cdr (children (car (children (car (cdr x9)))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (children (car (cdr x9)))))))
   (children (car (cdr x9))))))
(assert
 (not (= (cdr (cdr (children (car (children (car (cdr x9))))))) (cdr x9))))
(assert (not (= (cdr (cdr (children (car (children (car (cdr x9))))))) x9)))
(assert
 (not
  (= (car (cdr (cdr (children (car (children (car (cdr x9))))))))
   (car (children (car (cdr x9)))))))
(assert
 (not
  (= (car (cdr (cdr (children (car (children (car (cdr x9))))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (children (car (children (car (cdr x9))))))))
   (cdr (cdr (children (car (children (car (cdr x9))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (children (car (cdr x9))))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (children (car (children (car (cdr x9)))))))) (cdr x9))))
(assert
 (not (= (cdr (cdr (cdr (children (car (children (car (cdr x9)))))))) x9)))
(assert
 (not
...
(assert
 (not
  (= (pred (pred (data (car (children (car (cdr x9)))))))
   (pred (data (car (children (car (cdr x9)))))))))
(assert
 (not
  (= (pred (pred (data (car (children (car (cdr x9)))))))
...
(assert
 (not
  (= (pred (pred (pred (data (car (children (car (cdr x9))))))))
   (pred (pred (data (car (children (car (cdr x9))))))))))
(assert
 (not
  (= (pred (pred (pred (data (car (children (car (cdr x9))))))))
...
(assert
 (not
  (= (car (children (car (cdr (children (car (cdr x9)))))))
   (car (cdr (children (car (cdr x9))))))))
(assert
 (not
  (= (car (children (car (cdr (children (car (cdr x9))))))) (car (cdr x9)))))
(assert
 (not
  (= (children (car (children (car (cdr (children (car (cdr x9))))))))
   (children (car (cdr (children (car (cdr x9)))))))))
(assert
 (not
  (= (children (car (children (car (cdr (children (car (cdr x9))))))))
...
(assert
 (not
  (= (children (car (children (car (cdr (children (car (cdr x9)))))))) x9)))
(assert
 (not
  (= (cdr (children (car (cdr (children (car (cdr x9)))))))
   (children (car (cdr (children (car (cdr x9)))))))))
(assert
 (not
  (= (cdr (children (car (cdr (children (car (cdr x9)))))))
...
(assert
 (not
  (= (cdr (children (car (cdr (children (car (cdr x9)))))))
   (children (car (cdr x9))))))
(assert
 (not (= (cdr (children (car (cdr (children (car (cdr x9))))))) (cdr x9))))
(assert (not (= (cdr (children (car (cdr (children (car (cdr x9))))))) x9)))
(assert
 (not
  (= (car (cdr (children (car (cdr (children (car (cdr x9))))))))
   (car (cdr (children (car (cdr x9))))))))
(assert
 (not
  (= (car (cdr (children (car (cdr (children (car (cdr x9))))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (cdr (children (car (cdr x9))))))))
   (cdr (children (car (cdr (children (car (cdr x9))))))))))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (children (car (cdr x9))))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (cdr (children (car (cdr x9)))))))) (cdr x9))))
(assert
 (not (= (cdr (cdr (children (car (cdr (children (car (cdr x9)))))))) x9)))
(assert
 (not
  (= (pred (data (car (cdr (children (car (cdr x9)))))))
   (data (car (cdr (children (car (cdr x9)))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (children (car (cdr x9))))))))
   (pred (data (car (cdr (children (car (cdr x9))))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (children (car (cdr x9))))))))
...
(assert
 (not
  (= (children (car (cdr (cdr (children (car (cdr x9)))))))
...
(assert
 (not
  (= (children (car (cdr (cdr (children (car (cdr x9)))))))
   (children (car (cdr x9))))))
(assert
 (not (= (children (car (cdr (cdr (children (car (cdr x9))))))) (cdr x9))))
(assert (not (= (children (car (cdr (cdr (children (car (cdr x9))))))) x9)))
(assert
 (not
  (= (car (children (car (cdr (cdr (children (car (cdr x9))))))))
   (car (cdr (cdr (children (car (cdr x9)))))))))
(assert
 (not
  (= (car (children (car (cdr (cdr (children (car (cdr x9))))))))
   (car (cdr x9)))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (children (car (cdr x9))))))))
   (children (car (cdr (cdr (children (car (cdr x9))))))))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (children (car (cdr x9))))))))
...
(assert
 (not
  (= (cdr (children (car (cdr (cdr (children (car (cdr x9)))))))) (cdr x9))))
(assert
 (not (= (cdr (children (car (cdr (cdr (children (car (cdr x9)))))))) x9)))
(assert
 (not
  (= (pred (data (car (cdr (cdr (children (car (cdr x9))))))))
   (data (car (cdr (cdr (children (car (cdr x9))))))))))
(assert
 (not
...
(assert
 (not (= (car (cdr (cdr (cdr (children (car (cdr x9))))))) (car (cdr x9)))))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (children (car (cdr x9))))))))
   (cdr (cdr (cdr (children (car (cdr x9)))))))))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (children (car (cdr x9))))))))
...
(assert
 (not
  (= (children (car (cdr (cdr (cdr (children (car (cdr x9)))))))) (cdr x9))))
(assert
 (not (= (children (car (cdr (cdr (cdr (children (car (cdr x9)))))))) x9)))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (cdr x9)))))))
   (cdr (cdr (cdr (children (car (cdr x9)))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (cdr x9)))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (cdr x9)))))))
   (children (car (cdr x9))))))
(assert (not (= (cdr (cdr (cdr (cdr (children (car (cdr x9))))))) (cdr x9))))
(assert (not (= (cdr (cdr (cdr (cdr (children (car (cdr x9))))))) x9)))
(assert
 (not
  (= (car (cdr (cdr (cdr (cdr (children (car (cdr x9)))))))) (car (cdr x9)))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (children (car (cdr x9))))))))
   (cdr (cdr (cdr (cdr (children (car (cdr x9))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (children (car (cdr x9))))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (children (car (cdr x9))))))))
   (children (car (cdr x9))))))
(assert
 (not (= (cdr (cdr (cdr (cdr (cdr (children (car (cdr x9)))))))) (cdr x9))))
(assert (not (= (cdr (cdr (cdr (cdr (cdr (children (car (cdr x9)))))))) x9)))
...
(assert
 (not
  (= (pred (pred (pred (pred (data (car (cdr x9)))))))
   (pred (pred (pred (data (car (cdr x9)))))))))
(assert
 (not
  (= (pred (pred (pred (pred (data (car (cdr x9)))))))
...
(assert
 (not
  (= (pred (pred (pred (pred (data (car (cdr x9)))))))
   (pred (data (car (cdr x9)))))))
(assert
 (not
  (= (pred (pred (pred (pred (data (car (cdr x9))))))) (data (car (cdr x9))))))
(assert
 (not
  (= (pred (pred (pred (pred (pred (data (car (cdr x9))))))))
   (pred (pred (pred (pred (data (car (cdr x9))))))))))
(assert
 (not
  (= (pred (pred (pred (pred (pred (data (car (cdr x9))))))))
...
(assert
 (not
  (= (car (children (car (children (car (cdr (cdr x9)))))))
   (car (children (car (cdr (cdr x9))))))))
(assert
 (not
  (= (car (children (car (children (car (cdr (cdr x9)))))))
   (car (cdr (cdr x9))))))
(assert
 (not
  (= (children (car (children (car (children (car (cdr (cdr x9))))))))
   (children (car (children (car (cdr (cdr x9)))))))))
(assert
 (not
  (= (children (car (children (car (children (car (cdr (cdr x9))))))))
...
(assert
 (not
  (= (children (car (children (car (children (car (cdr (cdr x9)))))))) x9)))
(assert
 (not
  (= (cdr (children (car (children (car (cdr (cdr x9)))))))
   (children (car (children (car (cdr (cdr x9)))))))))
(assert
 (not
  (= (cdr (children (car (children (car (cdr (cdr x9)))))))
...
(assert
 (not
  (= (cdr (children (car (children (car (cdr (cdr x9))))))) (cdr (cdr x9)))))
(assert
 (not (= (cdr (children (car (children (car (cdr (cdr x9))))))) (cdr x9))))
(assert (not (= (cdr (children (car (children (car (cdr (cdr x9))))))) x9)))
(assert
 (not
  (= (car (cdr (children (car (children (car (cdr (cdr x9))))))))
   (car (children (car (cdr (cdr x9))))))))
(assert
 (not
  (= (car (cdr (children (car (children (car (cdr (cdr x9))))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (children (car (cdr (cdr x9))))))))
   (cdr (children (car (children (car (cdr (cdr x9))))))))))
(assert
 (not
  (= (cdr (cdr (children (car (children (car (cdr (cdr x9))))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (children (car (cdr (cdr x9)))))))) (cdr x9))))
(assert
 (not (= (cdr (cdr (children (car (children (car (cdr (cdr x9)))))))) x9)))
(assert
 (not
  (= (pred (data (car (children (car (cdr (cdr x9)))))))
   (data (car (children (car (cdr (cdr x9)))))))))
(assert
 (not
  (= (pred (pred (data (car (children (car (cdr (cdr x9))))))))
   (pred (data (car (children (car (cdr (cdr x9))))))))))
(assert
 (not
  (= (pred (pred (data (car (children (car (cdr (cdr x9))))))))
...
(assert
 (not
  (= (children (car (cdr (children (car (cdr (cdr x9)))))))
...
(assert
 (not
  (= (children (car (cdr (children (car (cdr (cdr x9))))))) (cdr (cdr x9)))))
(assert
 (not (= (children (car (cdr (children (car (cdr (cdr x9))))))) (cdr x9))))
(assert (not (= (children (car (cdr (children (car (cdr (cdr x9))))))) x9)))
(assert
 (not
  (= (car (children (car (cdr (children (car (cdr (cdr x9))))))))
   (car (cdr (children (car (cdr (cdr x9)))))))))
(assert
 (not
  (= (car (children (car (cdr (children (car (cdr (cdr x9))))))))
   (car (cdr (cdr x9))))))
(assert
 (not
  (= (cdr (children (car (cdr (children (car (cdr (cdr x9))))))))
   (children (car (cdr (children (car (cdr (cdr x9))))))))))
(assert
 (not
  (= (cdr (children (car (cdr (children (car (cdr (cdr x9))))))))
...
(assert
 (not
  (= (cdr (children (car (cdr (children (car (cdr (cdr x9)))))))) (cdr x9))))
(assert
 (not (= (cdr (children (car (cdr (children (car (cdr (cdr x9)))))))) x9)))
(assert
 (not
  (= (pred (data (car (cdr (children (car (cdr (cdr x9))))))))
   (data (car (cdr (children (car (cdr (cdr x9))))))))))
(assert
 (not
...
(assert
 (not
  (= (car (cdr (cdr (children (car (cdr (cdr x9))))))) (car (cdr (cdr x9))))))
(assert
 (not
  (= (children (car (cdr (cdr (children (car (cdr (cdr x9))))))))
   (cdr (cdr (children (car (cdr (cdr x9)))))))))
(assert
 (not
  (= (children (car (cdr (cdr (children (car (cdr (cdr x9))))))))
...
(assert
 (not
  (= (children (car (cdr (cdr (children (car (cdr (cdr x9)))))))) (cdr x9))))
(assert
 (not (= (children (car (cdr (cdr (children (car (cdr (cdr x9)))))))) x9)))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (cdr x9)))))))
   (cdr (cdr (children (car (cdr (cdr x9)))))))))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (cdr x9)))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (cdr x9)))))))
   (children (car (cdr (cdr x9)))))))
(assert
 (not (= (cdr (cdr (cdr (children (car (cdr (cdr x9))))))) (cdr (cdr x9)))))
(assert (not (= (cdr (cdr (cdr (children (car (cdr (cdr x9))))))) (cdr x9))))
(assert (not (= (cdr (cdr (cdr (children (car (cdr (cdr x9))))))) x9)))
(assert
 (not
  (= (car (cdr (cdr (cdr (children (car (cdr (cdr x9))))))))
   (car (cdr (cdr x9))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (cdr (cdr x9))))))))
   (cdr (cdr (cdr (children (car (cdr (cdr x9))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (cdr (cdr x9))))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (cdr (cdr x9)))))))) (cdr (cdr x9)))))
(assert
 (not (= (cdr (cdr (cdr (cdr (children (car (cdr (cdr x9)))))))) (cdr x9))))
(assert (not (= (cdr (cdr (cdr (cdr (children (car (cdr (cdr x9)))))))) x9)))
(assert
...
(assert
 (not
  (= (pred (pred (pred (data (car (cdr (cdr x9)))))))
   (pred (pred (data (car (cdr (cdr x9)))))))))
(assert
 (not
  (= (pred (pred (pred (data (car (cdr (cdr x9)))))))
...
(assert
 (not
  (= (pred (pred (pred (pred (data (car (cdr (cdr x9))))))))
   (pred (pred (pred (data (car (cdr (cdr x9))))))))))
(assert
 (not
  (= (pred (pred (pred (pred (data (car (cdr (cdr x9))))))))
...
(assert
 (not
  (= (children (car (children (car (cdr (cdr (cdr x9)))))))
...
(assert
 (not
  (= (children (car (children (car (cdr (cdr (cdr x9))))))) (cdr (cdr x9)))))
(assert
 (not (= (children (car (children (car (cdr (cdr (cdr x9))))))) (cdr x9))))
(assert (not (= (children (car (children (car (cdr (cdr (cdr x9))))))) x9)))
(assert
 (not
  (= (car (children (car (children (car (cdr (cdr (cdr x9))))))))
   (car (children (car (cdr (cdr (cdr x9)))))))))
(assert
 (not
  (= (car (children (car (children (car (cdr (cdr (cdr x9))))))))
   (car (cdr (cdr (cdr x9)))))))
(assert
 (not
  (= (cdr (children (car (children (car (cdr (cdr (cdr x9))))))))
   (children (car (children (car (cdr (cdr (cdr x9))))))))))
(assert
 (not
  (= (cdr (children (car (children (car (cdr (cdr (cdr x9))))))))
...
(assert
 (not
  (= (cdr (children (car (children (car (cdr (cdr (cdr x9)))))))) (cdr x9))))
(assert
 (not (= (cdr (children (car (children (car (cdr (cdr (cdr x9)))))))) x9)))
(assert
 (not
  (= (pred (data (car (children (car (cdr (cdr (cdr x9))))))))
   (data (car (children (car (cdr (cdr (cdr x9))))))))))
(assert
 (not
...
(assert
 (not
  (= (car (cdr (children (car (cdr (cdr (cdr x9)))))))
   (car (cdr (cdr (cdr x9)))))))
(assert
 (not
  (= (children (car (cdr (children (car (cdr (cdr (cdr x9))))))))
   (cdr (children (car (cdr (cdr (cdr x9)))))))))
(assert
 (not
  (= (children (car (cdr (children (car (cdr (cdr (cdr x9))))))))
...
(assert
 (not
  (= (children (car (cdr (children (car (cdr (cdr (cdr x9)))))))) (cdr x9))))
(assert
 (not (= (children (car (cdr (children (car (cdr (cdr (cdr x9)))))))) x9)))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (cdr x9)))))))
   (cdr (children (car (cdr (cdr (cdr x9)))))))))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (cdr x9)))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (cdr x9))))))) (cdr (cdr (cdr x9))))))
(assert
 (not (= (cdr (cdr (children (car (cdr (cdr (cdr x9))))))) (cdr (cdr x9)))))
(assert (not (= (cdr (cdr (children (car (cdr (cdr (cdr x9))))))) (cdr x9))))
(assert (not (= (cdr (cdr (children (car (cdr (cdr (cdr x9))))))) x9)))
(assert
 (not
  (= (car (cdr (cdr (children (car (cdr (cdr (cdr x9))))))))
   (car (cdr (cdr (cdr x9)))))))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (cdr (cdr x9))))))))
   (cdr (cdr (children (car (cdr (cdr (cdr x9))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (cdr (cdr x9))))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (cdr (cdr x9)))))))) (cdr (cdr x9)))))
(assert
 (not (= (cdr (cdr (cdr (children (car (cdr (cdr (cdr x9)))))))) (cdr x9))))
(assert (not (= (cdr (cdr (cdr (children (car (cdr (cdr (cdr x9)))))))) x9)))
(assert
 (not
...
(assert
 (not
  (= (pred (pred (data (car (cdr (cdr (cdr x9)))))))
   (pred (data (car (cdr (cdr (cdr x9)))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (cdr (cdr x9)))))))
...
(assert
 (not
  (= (pred (pred (pred (data (car (cdr (cdr (cdr x9))))))))
   (pred (pred (data (car (cdr (cdr (cdr x9))))))))))
(assert
 (not
  (= (pred (pred (pred (data (car (cdr (cdr (cdr x9))))))))
...
(assert
 (not
  (= (car (children (car (cdr (cdr (cdr (cdr x9)))))))
   (car (cdr (cdr (cdr (cdr x9))))))))
(assert
 (not
  (= (children (car (children (car (cdr (cdr (cdr (cdr x9))))))))
   (children (car (cdr (cdr (cdr (cdr x9)))))))))
(assert
 (not
  (= (children (car (children (car (cdr (cdr (cdr (cdr x9))))))))
   (cdr (cdr (cdr (cdr x9)))))))
...
(assert
 (not
  (= (children (car (children (car (cdr (cdr (cdr (cdr x9)))))))) (cdr x9))))
(assert
 (not (= (children (car (children (car (cdr (cdr (cdr (cdr x9)))))))) x9)))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (cdr x9)))))))
   (children (car (cdr (cdr (cdr (cdr x9)))))))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (cdr x9)))))))
...
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (cdr x9))))))) (cdr (cdr (cdr x9))))))
(assert
 (not (= (cdr (children (car (cdr (cdr (cdr (cdr x9))))))) (cdr (cdr x9)))))
(assert (not (= (cdr (children (car (cdr (cdr (cdr (cdr x9))))))) (cdr x9))))
(assert (not (= (cdr (children (car (cdr (cdr (cdr (cdr x9))))))) x9)))
(assert
 (not
  (= (car (cdr (children (car (cdr (cdr (cdr (cdr x9))))))))
   (car (cdr (cdr (cdr (cdr x9))))))))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (cdr (cdr x9))))))))
   (cdr (children (car (cdr (cdr (cdr (cdr x9))))))))))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (cdr (cdr x9))))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (cdr (cdr x9)))))))) (cdr (cdr x9)))))
(assert
 (not (= (cdr (cdr (children (car (cdr (cdr (cdr (cdr x9)))))))) (cdr x9))))
(assert (not (= (cdr (cdr (children (car (cdr (cdr (cdr (cdr x9)))))))) x9)))
(assert
 (not
  (= (pred (data (car (cdr (cdr (cdr (cdr x9)))))))
   (data (car (cdr (cdr (cdr (cdr x9)))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (cdr (cdr (cdr x9))))))))
   (pred (data (car (cdr (cdr (cdr (cdr x9))))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (cdr (cdr (cdr x9))))))))
...
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (cdr x9)))))))
   (cdr (cdr (cdr (cdr (cdr x9))))))))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (cdr x9)))))))
   (cdr (cdr (cdr (cdr x9)))))))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (cdr x9))))))) (cdr (cdr (cdr x9))))))
(assert
 (not (= (children (car (cdr (cdr (cdr (cdr (cdr x9))))))) (cdr (cdr x9)))))
(assert (not (= (children (car (cdr (cdr (cdr (cdr (cdr x9))))))) (cdr x9))))
(assert (not (= (children (car (cdr (cdr (cdr (cdr (cdr x9))))))) x9)))
(assert
 (not
  (= (car (children (car (cdr (cdr (cdr (cdr (cdr x9))))))))
   (car (cdr (cdr (cdr (cdr (cdr x9)))))))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (cdr (cdr x9))))))))
   (children (car (cdr (cdr (cdr (cdr (cdr x9))))))))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (cdr (cdr x9))))))))
...
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (cdr (cdr x9)))))))) (cdr (cdr x9)))))
(assert
 (not (= (cdr (children (car (cdr (cdr (cdr (cdr (cdr x9)))))))) (cdr x9))))
(assert (not (= (cdr (children (car (cdr (cdr (cdr (cdr (cdr x9)))))))) x9)))
(assert
 (not
  (= (pred (data (car (cdr (cdr (cdr (cdr (cdr x9))))))))
   (data (car (cdr (cdr (cdr (cdr (cdr x9))))))))))
(assert
 (not
...
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (cdr (cdr x9))))))))
   (cdr (cdr (cdr (cdr (cdr (cdr x9)))))))))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (cdr (cdr x9))))))))
   (cdr (cdr (cdr (cdr (cdr x9))))))))
...
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (cdr (cdr x9)))))))) (cdr (cdr x9)))))
(assert
 (not (= (children (car (cdr (cdr (cdr (cdr (cdr (cdr x9)))))))) (cdr x9))))
(assert (not (= (children (car (cdr (cdr (cdr (cdr (cdr (cdr x9)))))))) x9)))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr x9)))))))
   (cdr (cdr (cdr (cdr (cdr (cdr x9)))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr x9)))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr x9))))))) (cdr (cdr (cdr (cdr x9)))))))
(assert
 (not (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr x9))))))) (cdr (cdr (cdr x9))))))
(assert (not (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr x9))))))) (cdr (cdr x9)))))
(assert (not (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr x9))))))) (cdr x9))))
(assert (not (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr x9))))))) x9)))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr (cdr x9))))))))
   (cdr (cdr (cdr (cdr (cdr (cdr (cdr x9))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr (cdr x9))))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr (cdr x9)))))))) (cdr (cdr (cdr x9))))))
(assert
 (not (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr (cdr x9)))))))) (cdr (cdr x9)))))
(assert (not (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr (cdr x9)))))))) (cdr x9))))
(assert (not (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr (cdr x9)))))))) x9)))
...
(assert
 (not
  (= (car (children (car (children (car (children (car x8)))))))
   (car (children (car (children (car x8))))))))
(assert
 (not
  (= (car (children (car (children (car (children (car x8)))))))
   (car (children (car x8))))))
(assert
 (not
  (= (car (children (car (children (car (children (car x8))))))) (car x8))))
(assert
 (not
  (= (children (car (children (car (children (car (children (car x8))))))))
   (children (car (children (car (children (car x8)))))))))
(assert
 (not
  (= (children (car (children (car (children (car (children (car x8))))))))
...
(assert
 (not
  (= (cdr (children (car (children (car (children (car x8)))))))
   (children (car (children (car (children (car x8)))))))))
(assert
 (not
  (= (cdr (children (car (children (car (children (car x8)))))))
...
(assert
 (not
  (= (cdr (children (car (children (car (children (car x8)))))))
   (children (car x8)))))
(assert
 (not (= (cdr (children (car (children (car (children (car x8))))))) x8)))
(assert
 (not
  (= (car (cdr (children (car (children (car (children (car x8))))))))
   (car (children (car (children (car x8))))))))
(assert
 (not
  (= (car (cdr (children (car (children (car (children (car x8))))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (children (car (children (car x8))))))))
   (cdr (children (car (children (car (children (car x8))))))))))
(assert
 (not
  (= (cdr (cdr (children (car (children (car (children (car x8))))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (children (car (children (car x8)))))))) x8)))
(assert
 (not
  (= (pred (data (car (children (car (children (car x8)))))))
   (data (car (children (car (children (car x8)))))))))
(assert
 (not
  (= (pred (pred (data (car (children (car (children (car x8))))))))
   (pred (data (car (children (car (children (car x8))))))))))
(assert
 (not
  (= (pred (pred (data (car (children (car (children (car x8))))))))
...
(assert
 (not
  (= (children (car (cdr (children (car (children (car x8)))))))
   (cdr (children (car (children (car x8))))))))
(assert
 (not
  (= (children (car (cdr (children (car (children (car x8)))))))
...
(assert
 (not
  (= (children (car (cdr (children (car (children (car x8)))))))
   (children (car x8)))))
(assert
 (not (= (children (car (cdr (children (car (children (car x8))))))) x8)))
(assert
 (not
  (= (car (children (car (cdr (children (car (children (car x8))))))))
   (car (cdr (children (car (children (car x8)))))))))
(assert
 (not
  (= (car (children (car (cdr (children (car (children (car x8))))))))
...
(assert
 (not
  (= (cdr (children (car (cdr (children (car (children (car x8))))))))
   (children (car (cdr (children (car (children (car x8))))))))))
(assert
 (not
  (= (cdr (children (car (cdr (children (car (children (car x8))))))))
...
(assert
 (not
  (= (cdr (children (car (cdr (children (car (children (car x8)))))))) x8)))
(assert
 (not
  (= (pred (data (car (cdr (children (car (children (car x8))))))))
   (data (car (cdr (children (car (children (car x8))))))))))
(assert
 (not
...
(assert
 (not
  (= (car (cdr (cdr (children (car (children (car x8)))))))
   (car (children (car x8))))))
(assert
 (not (= (car (cdr (cdr (children (car (children (car x8))))))) (car x8))))
(assert
 (not
  (= (children (car (cdr (cdr (children (car (children (car x8))))))))
   (cdr (cdr (children (car (children (car x8)))))))))
(assert
 (not
  (= (children (car (cdr (cdr (children (car (children (car x8))))))))
...
(assert
 (not
  (= (children (car (cdr (cdr (children (car (children (car x8)))))))) x8)))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (children (car x8)))))))
   (cdr (cdr (children (car (children (car x8)))))))))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (children (car x8)))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (children (car (children (car x8)))))))
   (children (car x8)))))
(assert (not (= (cdr (cdr (cdr (children (car (children (car x8))))))) x8)))
(assert
 (not
  (= (car (cdr (cdr (cdr (children (car (children (car x8))))))))
   (car (children (car x8))))))
(assert
 (not
  (= (car (cdr (cdr (cdr (children (car (children (car x8)))))))) (car x8))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (children (car x8))))))))
   (cdr (cdr (cdr (children (car (children (car x8))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (children (car x8))))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (children (car x8))))))))
   (children (car x8)))))
(assert
 (not (= (cdr (cdr (cdr (cdr (children (car (children (car x8)))))))) x8)))
(assert
 (not
...
(assert
 (not
  (= (pred (pred (pred (data (car (children (car x8)))))))
   (pred (pred (data (car (children (car x8)))))))))
(assert
 (not
  (= (pred (pred (pred (data (car (children (car x8)))))))
...
(assert
 (not
  (= (pred (pred (pred (pred (data (car (children (car x8))))))))
   (pred (pred (pred (data (car (children (car x8))))))))))
(assert
 (not
  (= (pred (pred (pred (pred (data (car (children (car x8))))))))
...
(assert
 (not
  (= (children (car (children (car (cdr (children (car x8)))))))
...
(assert
 (not
  (= (children (car (children (car (cdr (children (car x8)))))))
   (children (car x8)))))
(assert
 (not (= (children (car (children (car (cdr (children (car x8))))))) x8)))
(assert
 (not
  (= (car (children (car (children (car (cdr (children (car x8))))))))
   (car (children (car (cdr (children (car x8)))))))))
(assert
 (not
  (= (car (children (car (children (car (cdr (children (car x8))))))))
...
(assert
 (not
  (= (cdr (children (car (children (car (cdr (children (car x8))))))))
   (children (car (children (car (cdr (children (car x8))))))))))
(assert
 (not
  (= (cdr (children (car (children (car (cdr (children (car x8))))))))
...
(assert
 (not
  (= (cdr (children (car (children (car (cdr (children (car x8)))))))) x8)))
(assert
 (not
  (= (pred (data (car (children (car (cdr (children (car x8))))))))
   (data (car (children (car (cdr (children (car x8))))))))))
(assert
 (not
...
(assert
 (not
  (= (car (cdr (children (car (cdr (children (car x8)))))))
   (car (cdr (children (car x8)))))))
(assert
 (not (= (car (cdr (children (car (cdr (children (car x8))))))) (car x8))))
(assert
 (not
  (= (children (car (cdr (children (car (cdr (children (car x8))))))))
   (cdr (children (car (cdr (children (car x8)))))))))
(assert
 (not
  (= (children (car (cdr (children (car (cdr (children (car x8))))))))
...
(assert
 (not
  (= (children (car (cdr (children (car (cdr (children (car x8)))))))) x8)))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (children (car x8)))))))
   (cdr (children (car (cdr (children (car x8)))))))))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (children (car x8)))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (cdr (children (car x8)))))))
   (children (car x8)))))
(assert (not (= (cdr (cdr (children (car (cdr (children (car x8))))))) x8)))
(assert
 (not
  (= (car (cdr (cdr (children (car (cdr (children (car x8))))))))
   (car (cdr (children (car x8)))))))
(assert
 (not
  (= (car (cdr (cdr (children (car (cdr (children (car x8)))))))) (car x8))))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (children (car x8))))))))
   (cdr (cdr (children (car (cdr (children (car x8))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (children (car x8))))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (children (car x8))))))))
   (children (car x8)))))
(assert
 (not (= (cdr (cdr (cdr (children (car (cdr (children (car x8)))))))) x8)))
(assert
 (not
...
(assert
 (not
  (= (pred (pred (data (car (cdr (children (car x8)))))))
   (pred (data (car (cdr (children (car x8)))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (children (car x8)))))))
...
(assert
 (not
  (= (pred (pred (pred (data (car (cdr (children (car x8))))))))
   (pred (pred (data (car (cdr (children (car x8))))))))))
(assert
 (not
  (= (pred (pred (pred (data (car (cdr (children (car x8))))))))
...
(assert
 (not
  (= (car (children (car (cdr (cdr (children (car x8)))))))
   (car (cdr (cdr (children (car x8))))))))
(assert
 (not (= (car (children (car (cdr (cdr (children (car x8))))))) (car x8))))
(assert
 (not
  (= (children (car (children (car (cdr (cdr (children (car x8))))))))
   (children (car (cdr (cdr (children (car x8)))))))))
(assert
 (not
  (= (children (car (children (car (cdr (cdr (children (car x8))))))))
...
(assert
 (not
  (= (children (car (children (car (cdr (cdr (children (car x8)))))))) x8)))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (children (car x8)))))))
   (children (car (cdr (cdr (children (car x8)))))))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (children (car x8)))))))
...
(assert
 (not
  (= (cdr (children (car (cdr (cdr (children (car x8)))))))
   (children (car x8)))))
(assert (not (= (cdr (children (car (cdr (cdr (children (car x8))))))) x8)))
(assert
 (not
  (= (car (cdr (children (car (cdr (cdr (children (car x8))))))))
   (car (cdr (cdr (children (car x8))))))))
(assert
 (not
  (= (car (cdr (children (car (cdr (cdr (children (car x8)))))))) (car x8))))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (children (car x8))))))))
   (cdr (children (car (cdr (cdr (children (car x8))))))))))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (children (car x8))))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (children (car x8))))))))
   (children (car x8)))))
(assert
 (not (= (cdr (cdr (children (car (cdr (cdr (children (car x8)))))))) x8)))
(assert
 (not
  (= (pred (data (car (cdr (cdr (children (car x8)))))))
   (data (car (cdr (cdr (children (car x8)))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (cdr (children (car x8))))))))
   (pred (data (car (cdr (cdr (children (car x8))))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (cdr (children (car x8))))))))
...
(assert
 (not
  (= (children (car (cdr (cdr (cdr (children (car x8)))))))
...
(assert
 (not
  (= (children (car (cdr (cdr (cdr (children (car x8)))))))
   (children (car x8)))))
(assert (not (= (children (car (cdr (cdr (cdr (children (car x8))))))) x8)))
(assert
 (not
  (= (car (children (car (cdr (cdr (cdr (children (car x8))))))))
   (car (cdr (cdr (cdr (children (car x8)))))))))
(assert
 (not
  (= (car (children (car (cdr (cdr (cdr (children (car x8)))))))) (car x8))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (children (car x8))))))))
   (children (car (cdr (cdr (cdr (children (car x8))))))))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (children (car x8))))))))
...
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (children (car x8))))))))
   (children (car x8)))))
(assert
 (not (= (cdr (children (car (cdr (cdr (cdr (children (car x8)))))))) x8)))
(assert
 (not
  (= (pred (data (car (cdr (cdr (cdr (children (car x8))))))))
   (data (car (cdr (cdr (cdr (children (car x8))))))))))
(assert
 (not
...
(assert (not (= (car (cdr (cdr (cdr (cdr (children (car x8))))))) (car x8))))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (children (car x8))))))))
   (cdr (cdr (cdr (cdr (children (car x8)))))))))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (children (car x8))))))))
...
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (children (car x8))))))))
   (children (car x8)))))
(assert
 (not (= (children (car (cdr (cdr (cdr (cdr (children (car x8)))))))) x8)))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (children (car x8)))))))
   (cdr (cdr (cdr (cdr (children (car x8)))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (children (car x8)))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (children (car x8))))))) (children (car x8)))))
(assert (not (= (cdr (cdr (cdr (cdr (cdr (children (car x8))))))) x8)))
(assert
 (not (= (car (cdr (cdr (cdr (cdr (cdr (children (car x8)))))))) (car x8))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (children (car x8))))))))
   (cdr (cdr (cdr (cdr (cdr (children (car x8))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (children (car x8))))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (children (car x8))))))))
   (children (car x8)))))
(assert (not (= (cdr (cdr (cdr (cdr (cdr (cdr (children (car x8)))))))) x8)))
...
(assert
 (not
  (= (pred (pred (pred (pred (pred (data (car x8)))))))
   (pred (pred (pred (pred (data (car x8)))))))))
(assert
 (not
  (= (pred (pred (pred (pred (pred (data (car x8)))))))
...
(assert
 (not
  (= (pred (pred (pred (pred (pred (data (car x8)))))))
   (pred (data (car x8))))))
(assert
 (not (= (pred (pred (pred (pred (pred (data (car x8))))))) (data (car x8)))))
(assert
 (not
  (= (pred (pred (pred (pred (pred (pred (data (car x8))))))))
   (pred (pred (pred (pred (pred (data (car x8))))))))))
(assert
 (not
  (= (pred (pred (pred (pred (pred (pred (data (car x8))))))))
...
(assert
 (not
  (= (children (car (children (car (children (car (cdr x8)))))))
...
(assert
 (not
  (= (children (car (children (car (children (car (cdr x8))))))) (cdr x8))))
(assert
 (not (= (children (car (children (car (children (car (cdr x8))))))) x8)))
(assert
 (not
  (= (car (children (car (children (car (children (car (cdr x8))))))))
   (car (children (car (children (car (cdr x8)))))))))
(assert
 (not
  (= (car (children (car (children (car (children (car (cdr x8))))))))
...
(assert
 (not
  (= (cdr (children (car (children (car (children (car (cdr x8))))))))
   (children (car (children (car (children (car (cdr x8))))))))))
(assert
 (not
  (= (cdr (children (car (children (car (children (car (cdr x8))))))))
...
(assert
 (not
  (= (cdr (children (car (children (car (children (car (cdr x8)))))))) x8)))
(assert
 (not
  (= (pred (data (car (children (car (children (car (cdr x8))))))))
   (data (car (children (car (children (car (cdr x8))))))))))
(assert
 (not
...
(assert
 (not
  (= (car (cdr (children (car (children (car (cdr x8)))))))
   (car (children (car (cdr x8)))))))
(assert
 (not
  (= (car (cdr (children (car (children (car (cdr x8))))))) (car (cdr x8)))))
(assert
 (not
  (= (children (car (cdr (children (car (children (car (cdr x8))))))))
   (cdr (children (car (children (car (cdr x8)))))))))
(assert
 (not
  (= (children (car (cdr (children (car (children (car (cdr x8))))))))
...
(assert
 (not
  (= (children (car (cdr (children (car (children (car (cdr x8)))))))) x8)))
(assert
 (not
  (= (cdr (cdr (children (car (children (car (cdr x8)))))))
   (cdr (children (car (children (car (cdr x8)))))))))
(assert
 (not
  (= (cdr (cdr (children (car (children (car (cdr x8)))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (children (car (cdr x8)))))))
   (children (car (cdr x8))))))
(assert
 (not (= (cdr (cdr (children (car (children (car (cdr x8))))))) (cdr x8))))
(assert (not (= (cdr (cdr (children (car (children (car (cdr x8))))))) x8)))
(assert
 (not
  (= (car (cdr (cdr (children (car (children (car (cdr x8))))))))
   (car (children (car (cdr x8)))))))
(assert
 (not
  (= (car (cdr (cdr (children (car (children (car (cdr x8))))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (children (car (children (car (cdr x8))))))))
   (cdr (cdr (children (car (children (car (cdr x8))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (children (car (cdr x8))))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (children (car (children (car (cdr x8)))))))) (cdr x8))))
(assert
 (not (= (cdr (cdr (cdr (children (car (children (car (cdr x8)))))))) x8)))
(assert
 (not
...
(assert
 (not
  (= (pred (pred (data (car (children (car (cdr x8)))))))
   (pred (data (car (children (car (cdr x8)))))))))
(assert
 (not
  (= (pred (pred (data (car (children (car (cdr x8)))))))
...
(assert
 (not
  (= (pred (pred (pred (data (car (children (car (cdr x8))))))))
   (pred (pred (data (car (children (car (cdr x8))))))))))
(assert
 (not
  (= (pred (pred (pred (data (car (children (car (cdr x8))))))))
...
(assert
 (not
  (= (car (children (car (cdr (children (car (cdr x8)))))))
   (car (cdr (children (car (cdr x8))))))))
(assert
 (not
  (= (car (children (car (cdr (children (car (cdr x8))))))) (car (cdr x8)))))
(assert
 (not
  (= (children (car (children (car (cdr (children (car (cdr x8))))))))
   (children (car (cdr (children (car (cdr x8)))))))))
(assert
 (not
  (= (children (car (children (car (cdr (children (car (cdr x8))))))))
...
(assert
 (not
  (= (children (car (children (car (cdr (children (car (cdr x8)))))))) x8)))
(assert
 (not
  (= (cdr (children (car (cdr (children (car (cdr x8)))))))
   (children (car (cdr (children (car (cdr x8)))))))))
(assert
 (not
  (= (cdr (children (car (cdr (children (car (cdr x8)))))))
...
(assert
 (not
  (= (cdr (children (car (cdr (children (car (cdr x8)))))))
   (children (car (cdr x8))))))
(assert
 (not (= (cdr (children (car (cdr (children (car (cdr x8))))))) (cdr x8))))
(assert (not (= (cdr (children (car (cdr (children (car (cdr x8))))))) x8)))
(assert
 (not
  (= (car (cdr (children (car (cdr (children (car (cdr x8))))))))
   (car (cdr (children (car (cdr x8))))))))
(assert
 (not
  (= (car (cdr (children (car (cdr (children (car (cdr x8))))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (cdr (children (car (cdr x8))))))))
   (cdr (children (car (cdr (children (car (cdr x8))))))))))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (children (car (cdr x8))))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (cdr (children (car (cdr x8)))))))) (cdr x8))))
(assert
 (not (= (cdr (cdr (children (car (cdr (children (car (cdr x8)))))))) x8)))
(assert
 (not
  (= (pred (data (car (cdr (children (car (cdr x8)))))))
   (data (car (cdr (children (car (cdr x8)))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (children (car (cdr x8))))))))
   (pred (data (car (cdr (children (car (cdr x8))))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (children (car (cdr x8))))))))
...
(assert
 (not
  (= (children (car (cdr (cdr (children (car (cdr x8)))))))
...
(assert
 (not
  (= (children (car (cdr (cdr (children (car (cdr x8)))))))
   (children (car (cdr x8))))))
(assert
 (not (= (children (car (cdr (cdr (children (car (cdr x8))))))) (cdr x8))))
(assert (not (= (children (car (cdr (cdr (children (car (cdr x8))))))) x8)))
(assert
 (not
  (= (car (children (car (cdr (cdr (children (car (cdr x8))))))))
   (car (cdr (cdr (children (car (cdr x8)))))))))
(assert
 (not
  (= (car (children (car (cdr (cdr (children (car (cdr x8))))))))
   (car (cdr x8)))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (children (car (cdr x8))))))))
   (children (car (cdr (cdr (children (car (cdr x8))))))))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (children (car (cdr x8))))))))
...
(assert
 (not
  (= (cdr (children (car (cdr (cdr (children (car (cdr x8)))))))) (cdr x8))))
(assert
 (not (= (cdr (children (car (cdr (cdr (children (car (cdr x8)))))))) x8)))
(assert
 (not
  (= (pred (data (car (cdr (cdr (children (car (cdr x8))))))))
   (data (car (cdr (cdr (children (car (cdr x8))))))))))
(assert
 (not
...
(assert
 (not (= (car (cdr (cdr (cdr (children (car (cdr x8))))))) (car (cdr x8)))))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (children (car (cdr x8))))))))
   (cdr (cdr (cdr (children (car (cdr x8)))))))))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (children (car (cdr x8))))))))
...
(assert
 (not
  (= (children (car (cdr (cdr (cdr (children (car (cdr x8)))))))) (cdr x8))))
(assert
 (not (= (children (car (cdr (cdr (cdr (children (car (cdr x8)))))))) x8)))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (cdr x8)))))))
   (cdr (cdr (cdr (children (car (cdr x8)))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (cdr x8)))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (cdr x8)))))))
   (children (car (cdr x8))))))
(assert (not (= (cdr (cdr (cdr (cdr (children (car (cdr x8))))))) (cdr x8))))
(assert (not (= (cdr (cdr (cdr (cdr (children (car (cdr x8))))))) x8)))
(assert
 (not
  (= (car (cdr (cdr (cdr (cdr (children (car (cdr x8)))))))) (car (cdr x8)))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (children (car (cdr x8))))))))
   (cdr (cdr (cdr (cdr (children (car (cdr x8))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (children (car (cdr x8))))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (children (car (cdr x8))))))))
   (children (car (cdr x8))))))
(assert
 (not (= (cdr (cdr (cdr (cdr (cdr (children (car (cdr x8)))))))) (cdr x8))))
(assert (not (= (cdr (cdr (cdr (cdr (cdr (children (car (cdr x8)))))))) x8)))
...
(assert
 (not
  (= (pred (pred (pred (pred (data (car (cdr x8)))))))
   (pred (pred (pred (data (car (cdr x8)))))))))
(assert
 (not
  (= (pred (pred (pred (pred (data (car (cdr x8)))))))
...
(assert
 (not
  (= (pred (pred (pred (pred (data (car (cdr x8)))))))
   (pred (data (car (cdr x8)))))))
(assert
 (not
  (= (pred (pred (pred (pred (data (car (cdr x8))))))) (data (car (cdr x8))))))
(assert
 (not
  (= (pred (pred (pred (pred (pred (data (car (cdr x8))))))))
   (pred (pred (pred (pred (data (car (cdr x8))))))))))
(assert
 (not
  (= (pred (pred (pred (pred (pred (data (car (cdr x8))))))))
...
(assert
 (not
  (= (car (children (car (children (car (cdr (cdr x8)))))))
   (car (children (car (cdr (cdr x8))))))))
(assert
 (not
  (= (car (children (car (children (car (cdr (cdr x8)))))))
   (car (cdr (cdr x8))))))
(assert
 (not
  (= (children (car (children (car (children (car (cdr (cdr x8))))))))
   (children (car (children (car (cdr (cdr x8)))))))))
(assert
 (not
  (= (children (car (children (car (children (car (cdr (cdr x8))))))))
...
(assert
 (not
  (= (children (car (children (car (children (car (cdr (cdr x8)))))))) x8)))
(assert
 (not
  (= (cdr (children (car (children (car (cdr (cdr x8)))))))
   (children (car (children (car (cdr (cdr x8)))))))))
(assert
 (not
  (= (cdr (children (car (children (car (cdr (cdr x8)))))))
...
(assert
 (not
  (= (cdr (children (car (children (car (cdr (cdr x8))))))) (cdr (cdr x8)))))
(assert
 (not (= (cdr (children (car (children (car (cdr (cdr x8))))))) (cdr x8))))
(assert (not (= (cdr (children (car (children (car (cdr (cdr x8))))))) x8)))
(assert
 (not
  (= (car (cdr (children (car (children (car (cdr (cdr x8))))))))
   (car (children (car (cdr (cdr x8))))))))
(assert
 (not
  (= (car (cdr (children (car (children (car (cdr (cdr x8))))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (children (car (cdr (cdr x8))))))))
   (cdr (children (car (children (car (cdr (cdr x8))))))))))
(assert
 (not
  (= (cdr (cdr (children (car (children (car (cdr (cdr x8))))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (children (car (cdr (cdr x8)))))))) (cdr x8))))
(assert
 (not (= (cdr (cdr (children (car (children (car (cdr (cdr x8)))))))) x8)))
(assert
 (not
  (= (pred (data (car (children (car (cdr (cdr x8)))))))
   (data (car (children (car (cdr (cdr x8)))))))))
(assert
 (not
  (= (pred (pred (data (car (children (car (cdr (cdr x8))))))))
   (pred (data (car (children (car (cdr (cdr x8))))))))))
(assert
 (not
  (= (pred (pred (data (car (children (car (cdr (cdr x8))))))))
...
(assert
 (not
  (= (children (car (cdr (children (car (cdr (cdr x8)))))))
...
(assert
 (not
  (= (children (car (cdr (children (car (cdr (cdr x8))))))) (cdr (cdr x8)))))
(assert
 (not (= (children (car (cdr (children (car (cdr (cdr x8))))))) (cdr x8))))
(assert (not (= (children (car (cdr (children (car (cdr (cdr x8))))))) x8)))
(assert
 (not
  (= (car (children (car (cdr (children (car (cdr (cdr x8))))))))
   (car (cdr (children (car (cdr (cdr x8)))))))))
(assert
 (not
  (= (car (children (car (cdr (children (car (cdr (cdr x8))))))))
   (car (cdr (cdr x8))))))
(assert
 (not
  (= (cdr (children (car (cdr (children (car (cdr (cdr x8))))))))
   (children (car (cdr (children (car (cdr (cdr x8))))))))))
(assert
 (not
  (= (cdr (children (car (cdr (children (car (cdr (cdr x8))))))))
...
(assert
 (not
  (= (cdr (children (car (cdr (children (car (cdr (cdr x8)))))))) (cdr x8))))
(assert
 (not (= (cdr (children (car (cdr (children (car (cdr (cdr x8)))))))) x8)))
(assert
 (not
  (= (pred (data (car (cdr (children (car (cdr (cdr x8))))))))
   (data (car (cdr (children (car (cdr (cdr x8))))))))))
(assert
 (not
...
(assert
 (not
  (= (car (cdr (cdr (children (car (cdr (cdr x8))))))) (car (cdr (cdr x8))))))
(assert
 (not
  (= (children (car (cdr (cdr (children (car (cdr (cdr x8))))))))
   (cdr (cdr (children (car (cdr (cdr x8)))))))))
(assert
 (not
  (= (children (car (cdr (cdr (children (car (cdr (cdr x8))))))))
...
(assert
 (not
  (= (children (car (cdr (cdr (children (car (cdr (cdr x8)))))))) (cdr x8))))
(assert
 (not (= (children (car (cdr (cdr (children (car (cdr (cdr x8)))))))) x8)))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (cdr x8)))))))
   (cdr (cdr (children (car (cdr (cdr x8)))))))))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (cdr x8)))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (cdr x8)))))))
   (children (car (cdr (cdr x8)))))))
(assert
 (not (= (cdr (cdr (cdr (children (car (cdr (cdr x8))))))) (cdr (cdr x8)))))
(assert (not (= (cdr (cdr (cdr (children (car (cdr (cdr x8))))))) (cdr x8))))
(assert (not (= (cdr (cdr (cdr (children (car (cdr (cdr x8))))))) x8)))
(assert
 (not
  (= (car (cdr (cdr (cdr (children (car (cdr (cdr x8))))))))
   (car (cdr (cdr x8))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (cdr (cdr x8))))))))
   (cdr (cdr (cdr (children (car (cdr (cdr x8))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (cdr (cdr x8))))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (cdr (cdr x8)))))))) (cdr (cdr x8)))))
(assert
 (not (= (cdr (cdr (cdr (cdr (children (car (cdr (cdr x8)))))))) (cdr x8))))
(assert (not (= (cdr (cdr (cdr (cdr (children (car (cdr (cdr x8)))))))) x8)))
(assert
...
(assert
 (not
  (= (pred (pred (pred (data (car (cdr (cdr x8)))))))
   (pred (pred (data (car (cdr (cdr x8)))))))))
(assert
 (not
  (= (pred (pred (pred (data (car (cdr (cdr x8)))))))
...
(assert
 (not
  (= (pred (pred (pred (pred (data (car (cdr (cdr x8))))))))
   (pred (pred (pred (data (car (cdr (cdr x8))))))))))
(assert
 (not
  (= (pred (pred (pred (pred (data (car (cdr (cdr x8))))))))
...
(assert
 (not
  (= (children (car (children (car (cdr (cdr (cdr x8)))))))
...
(assert
 (not
  (= (children (car (children (car (cdr (cdr (cdr x8))))))) (cdr (cdr x8)))))
(assert
 (not (= (children (car (children (car (cdr (cdr (cdr x8))))))) (cdr x8))))
(assert (not (= (children (car (children (car (cdr (cdr (cdr x8))))))) x8)))
(assert
 (not
  (= (car (children (car (children (car (cdr (cdr (cdr x8))))))))
   (car (children (car (cdr (cdr (cdr x8)))))))))
(assert
 (not
  (= (car (children (car (children (car (cdr (cdr (cdr x8))))))))
   (car (cdr (cdr (cdr x8)))))))
(assert
 (not
  (= (cdr (children (car (children (car (cdr (cdr (cdr x8))))))))
   (children (car (children (car (cdr (cdr (cdr x8))))))))))
(assert
 (not
  (= (cdr (children (car (children (car (cdr (cdr (cdr x8))))))))
...
(assert
 (not
  (= (cdr (children (car (children (car (cdr (cdr (cdr x8)))))))) (cdr x8))))
(assert
 (not (= (cdr (children (car (children (car (cdr (cdr (cdr x8)))))))) x8)))
(assert
 (not
  (= (pred (data (car (children (car (cdr (cdr (cdr x8))))))))
   (data (car (children (car (cdr (cdr (cdr x8))))))))))
(assert
 (not
...
(assert
 (not
  (= (car (cdr (children (car (cdr (cdr (cdr x8)))))))
   (car (cdr (cdr (cdr x8)))))))
(assert
 (not
  (= (children (car (cdr (children (car (cdr (cdr (cdr x8))))))))
   (cdr (children (car (cdr (cdr (cdr x8)))))))))
(assert
 (not
  (= (children (car (cdr (children (car (cdr (cdr (cdr x8))))))))
...
(assert
 (not
  (= (children (car (cdr (children (car (cdr (cdr (cdr x8)))))))) (cdr x8))))
(assert
 (not (= (children (car (cdr (children (car (cdr (cdr (cdr x8)))))))) x8)))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (cdr x8)))))))
   (cdr (children (car (cdr (cdr (cdr x8)))))))))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (cdr x8)))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (cdr x8))))))) (cdr (cdr (cdr x8))))))
(assert
 (not (= (cdr (cdr (children (car (cdr (cdr (cdr x8))))))) (cdr (cdr x8)))))
(assert (not (= (cdr (cdr (children (car (cdr (cdr (cdr x8))))))) (cdr x8))))
(assert (not (= (cdr (cdr (children (car (cdr (cdr (cdr x8))))))) x8)))
(assert
 (not
  (= (car (cdr (cdr (children (car (cdr (cdr (cdr x8))))))))
   (car (cdr (cdr (cdr x8)))))))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (cdr (cdr x8))))))))
   (cdr (cdr (children (car (cdr (cdr (cdr x8))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (cdr (cdr x8))))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (cdr (cdr x8)))))))) (cdr (cdr x8)))))
(assert
 (not (= (cdr (cdr (cdr (children (car (cdr (cdr (cdr x8)))))))) (cdr x8))))
(assert (not (= (cdr (cdr (cdr (children (car (cdr (cdr (cdr x8)))))))) x8)))
(assert
 (not
...
(assert
 (not
  (= (pred (pred (data (car (cdr (cdr (cdr x8)))))))
   (pred (data (car (cdr (cdr (cdr x8)))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (cdr (cdr x8)))))))
...
(assert
 (not
  (= (pred (pred (pred (data (car (cdr (cdr (cdr x8))))))))
   (pred (pred (data (car (cdr (cdr (cdr x8))))))))))
(assert
 (not
  (= (pred (pred (pred (data (car (cdr (cdr (cdr x8))))))))
...
(assert
 (not
  (= (car (children (car (cdr (cdr (cdr (cdr x8)))))))
   (car (cdr (cdr (cdr (cdr x8))))))))
(assert
 (not
  (= (children (car (children (car (cdr (cdr (cdr (cdr x8))))))))
   (children (car (cdr (cdr (cdr (cdr x8)))))))))
(assert
 (not
  (= (children (car (children (car (cdr (cdr (cdr (cdr x8))))))))
   (cdr (cdr (cdr (cdr x8)))))))
...
(assert
 (not
  (= (children (car (children (car (cdr (cdr (cdr (cdr x8)))))))) (cdr x8))))
(assert
 (not (= (children (car (children (car (cdr (cdr (cdr (cdr x8)))))))) x8)))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (cdr x8)))))))
   (children (car (cdr (cdr (cdr (cdr x8)))))))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (cdr x8)))))))
...
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (cdr x8))))))) (cdr (cdr (cdr x8))))))
(assert
 (not (= (cdr (children (car (cdr (cdr (cdr (cdr x8))))))) (cdr (cdr x8)))))
(assert (not (= (cdr (children (car (cdr (cdr (cdr (cdr x8))))))) (cdr x8))))
(assert (not (= (cdr (children (car (cdr (cdr (cdr (cdr x8))))))) x8)))
(assert
 (not
  (= (car (cdr (children (car (cdr (cdr (cdr (cdr x8))))))))
   (car (cdr (cdr (cdr (cdr x8))))))))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (cdr (cdr x8))))))))
   (cdr (children (car (cdr (cdr (cdr (cdr x8))))))))))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (cdr (cdr x8))))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (cdr (cdr x8)))))))) (cdr (cdr x8)))))
(assert
 (not (= (cdr (cdr (children (car (cdr (cdr (cdr (cdr x8)))))))) (cdr x8))))
(assert (not (= (cdr (cdr (children (car (cdr (cdr (cdr (cdr x8)))))))) x8)))
(assert
 (not
  (= (pred (data (car (cdr (cdr (cdr (cdr x8)))))))
   (data (car (cdr (cdr (cdr (cdr x8)))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (cdr (cdr (cdr x8))))))))
   (pred (data (car (cdr (cdr (cdr (cdr x8))))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (cdr (cdr (cdr x8))))))))
...
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (cdr x8)))))))
   (cdr (cdr (cdr (cdr (cdr x8))))))))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (cdr x8)))))))
   (cdr (cdr (cdr (cdr x8)))))))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (cdr x8))))))) (cdr (cdr (cdr x8))))))
(assert
 (not (= (children (car (cdr (cdr (cdr (cdr (cdr x8))))))) (cdr (cdr x8)))))
(assert (not (= (children (car (cdr (cdr (cdr (cdr (cdr x8))))))) (cdr x8))))
(assert (not (= (children (car (cdr (cdr (cdr (cdr (cdr x8))))))) x8)))
(assert
 (not
  (= (car (children (car (cdr (cdr (cdr (cdr (cdr x8))))))))
   (car (cdr (cdr (cdr (cdr (cdr x8)))))))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (cdr (cdr x8))))))))
   (children (car (cdr (cdr (cdr (cdr (cdr x8))))))))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (cdr (cdr x8))))))))
...
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (cdr (cdr x8)))))))) (cdr (cdr x8)))))
(assert
 (not (= (cdr (children (car (cdr (cdr (cdr (cdr (cdr x8)))))))) (cdr x8))))
(assert (not (= (cdr (children (car (cdr (cdr (cdr (cdr (cdr x8)))))))) x8)))
(assert
 (not
  (= (pred (data (car (cdr (cdr (cdr (cdr (cdr x8))))))))
   (data (car (cdr (cdr (cdr (cdr (cdr x8))))))))))
(assert
 (not
...
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (cdr (cdr x8))))))))
   (cdr (cdr (cdr (cdr (cdr (cdr x8)))))))))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (cdr (cdr x8))))))))
   (cdr (cdr (cdr (cdr (cdr x8))))))))
...
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (cdr (cdr x8)))))))) (cdr (cdr x8)))))
(assert
 (not (= (children (car (cdr (cdr (cdr (cdr (cdr (cdr x8)))))))) (cdr x8))))
(assert (not (= (children (car (cdr (cdr (cdr (cdr (cdr (cdr x8)))))))) x8)))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr x8)))))))
   (cdr (cdr (cdr (cdr (cdr (cdr x8)))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr x8)))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr x8))))))) (cdr (cdr (cdr (cdr x8)))))))
(assert
 (not (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr x8))))))) (cdr (cdr (cdr x8))))))
(assert (not (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr x8))))))) (cdr (cdr x8)))))
(assert (not (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr x8))))))) (cdr x8))))
(assert (not (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr x8))))))) x8)))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr (cdr x8))))))))
   (cdr (cdr (cdr (cdr (cdr (cdr (cdr x8))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr (cdr x8))))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr (cdr x8)))))))) (cdr (cdr (cdr x8))))))
(assert
 (not (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr (cdr x8)))))))) (cdr (cdr x8)))))
(assert (not (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr (cdr x8)))))))) (cdr x8))))
(assert (not (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr (cdr x8)))))))) x8)))
...
(assert
 (not
  (= (car (children (car (children (car (children (car x7)))))))
   (car (children (car (children (car x7))))))))
(assert
 (not
  (= (car (children (car (children (car (children (car x7)))))))
   (car (children (car x7))))))
(assert
 (not
  (= (car (children (car (children (car (children (car x7))))))) (car x7))))
(assert
 (not
  (= (children (car (children (car (children (car (children (car x7))))))))
   (children (car (children (car (children (car x7)))))))))
(assert
 (not
  (= (children (car (children (car (children (car (children (car x7))))))))
...
(assert
 (not
  (= (cdr (children (car (children (car (children (car x7)))))))
   (children (car (children (car (children (car x7)))))))))
(assert
 (not
  (= (cdr (children (car (children (car (children (car x7)))))))
...
(assert
 (not
  (= (cdr (children (car (children (car (children (car x7)))))))
   (children (car x7)))))
(assert
 (not (= (cdr (children (car (children (car (children (car x7))))))) x7)))
(assert
 (not
  (= (car (cdr (children (car (children (car (children (car x7))))))))
   (car (children (car (children (car x7))))))))
(assert
 (not
  (= (car (cdr (children (car (children (car (children (car x7))))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (children (car (children (car x7))))))))
   (cdr (children (car (children (car (children (car x7))))))))))
(assert
 (not
  (= (cdr (cdr (children (car (children (car (children (car x7))))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (children (car (children (car x7)))))))) x7)))
(assert
 (not
  (= (pred (data (car (children (car (children (car x7)))))))
   (data (car (children (car (children (car x7)))))))))
(assert
 (not
  (= (pred (pred (data (car (children (car (children (car x7))))))))
   (pred (data (car (children (car (children (car x7))))))))))
(assert
 (not
  (= (pred (pred (data (car (children (car (children (car x7))))))))
...
(assert
 (not
  (= (children (car (cdr (children (car (children (car x7)))))))
   (cdr (children (car (children (car x7))))))))
(assert
 (not
  (= (children (car (cdr (children (car (children (car x7)))))))
...
(assert
 (not
  (= (children (car (cdr (children (car (children (car x7)))))))
   (children (car x7)))))
(assert
 (not (= (children (car (cdr (children (car (children (car x7))))))) x7)))
(assert
 (not
  (= (car (children (car (cdr (children (car (children (car x7))))))))
   (car (cdr (children (car (children (car x7)))))))))
(assert
 (not
  (= (car (children (car (cdr (children (car (children (car x7))))))))
...
(assert
 (not
  (= (cdr (children (car (cdr (children (car (children (car x7))))))))
   (children (car (cdr (children (car (children (car x7))))))))))
(assert
 (not
  (= (cdr (children (car (cdr (children (car (children (car x7))))))))
...
(assert
 (not
  (= (cdr (children (car (cdr (children (car (children (car x7)))))))) x7)))
(assert
 (not
  (= (pred (data (car (cdr (children (car (children (car x7))))))))
   (data (car (cdr (children (car (children (car x7))))))))))
(assert
 (not
...
(assert
 (not
  (= (car (cdr (cdr (children (car (children (car x7)))))))
   (car (children (car x7))))))
(assert
 (not (= (car (cdr (cdr (children (car (children (car x7))))))) (car x7))))
(assert
 (not
  (= (children (car (cdr (cdr (children (car (children (car x7))))))))
   (cdr (cdr (children (car (children (car x7)))))))))
(assert
 (not
  (= (children (car (cdr (cdr (children (car (children (car x7))))))))
...
(assert
 (not
  (= (children (car (cdr (cdr (children (car (children (car x7)))))))) x7)))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (children (car x7)))))))
   (cdr (cdr (children (car (children (car x7)))))))))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (children (car x7)))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (children (car (children (car x7)))))))
   (children (car x7)))))
(assert (not (= (cdr (cdr (cdr (children (car (children (car x7))))))) x7)))
(assert
 (not
  (= (car (cdr (cdr (cdr (children (car (children (car x7))))))))
   (car (children (car x7))))))
(assert
 (not
  (= (car (cdr (cdr (cdr (children (car (children (car x7)))))))) (car x7))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (children (car x7))))))))
   (cdr (cdr (cdr (children (car (children (car x7))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (children (car x7))))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (children (car x7))))))))
   (children (car x7)))))
(assert
 (not (= (cdr (cdr (cdr (cdr (children (car (children (car x7)))))))) x7)))
(assert
 (not
...
(assert
 (not
  (= (pred (pred (pred (data (car (children (car x7)))))))
   (pred (pred (data (car (children (car x7)))))))))
(assert
 (not
  (= (pred (pred (pred (data (car (children (car x7)))))))
...
(assert
 (not
  (= (pred (pred (pred (pred (data (car (children (car x7))))))))
   (pred (pred (pred (data (car (children (car x7))))))))))
(assert
 (not
  (= (pred (pred (pred (pred (data (car (children (car x7))))))))
...
(assert
 (not
  (= (children (car (children (car (cdr (children (car x7)))))))
...
(assert
 (not
  (= (children (car (children (car (cdr (children (car x7)))))))
   (children (car x7)))))
(assert
 (not (= (children (car (children (car (cdr (children (car x7))))))) x7)))
(assert
 (not
  (= (car (children (car (children (car (cdr (children (car x7))))))))
   (car (children (car (cdr (children (car x7)))))))))
(assert
 (not
  (= (car (children (car (children (car (cdr (children (car x7))))))))
...
(assert
 (not
  (= (cdr (children (car (children (car (cdr (children (car x7))))))))
   (children (car (children (car (cdr (children (car x7))))))))))
(assert
 (not
  (= (cdr (children (car (children (car (cdr (children (car x7))))))))
...
(assert
 (not
  (= (cdr (children (car (children (car (cdr (children (car x7)))))))) x7)))
(assert
 (not
  (= (pred (data (car (children (car (cdr (children (car x7))))))))
   (data (car (children (car (cdr (children (car x7))))))))))
(assert
 (not
...
(assert
 (not
  (= (car (cdr (children (car (cdr (children (car x7)))))))
   (car (cdr (children (car x7)))))))
(assert
 (not (= (car (cdr (children (car (cdr (children (car x7))))))) (car x7))))
(assert
 (not
  (= (children (car (cdr (children (car (cdr (children (car x7))))))))
   (cdr (children (car (cdr (children (car x7)))))))))
(assert
 (not
  (= (children (car (cdr (children (car (cdr (children (car x7))))))))
...
(assert
 (not
  (= (children (car (cdr (children (car (cdr (children (car x7)))))))) x7)))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (children (car x7)))))))
   (cdr (children (car (cdr (children (car x7)))))))))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (children (car x7)))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (cdr (children (car x7)))))))
   (children (car x7)))))
(assert (not (= (cdr (cdr (children (car (cdr (children (car x7))))))) x7)))
(assert
 (not
  (= (car (cdr (cdr (children (car (cdr (children (car x7))))))))
   (car (cdr (children (car x7)))))))
(assert
 (not
  (= (car (cdr (cdr (children (car (cdr (children (car x7)))))))) (car x7))))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (children (car x7))))))))
   (cdr (cdr (children (car (cdr (children (car x7))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (children (car x7))))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (children (car x7))))))))
   (children (car x7)))))
(assert
 (not (= (cdr (cdr (cdr (children (car (cdr (children (car x7)))))))) x7)))
(assert
 (not
...
(assert
 (not
  (= (pred (pred (data (car (cdr (children (car x7)))))))
   (pred (data (car (cdr (children (car x7)))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (children (car x7)))))))
...
(assert
 (not
  (= (pred (pred (pred (data (car (cdr (children (car x7))))))))
   (pred (pred (data (car (cdr (children (car x7))))))))))
(assert
 (not
  (= (pred (pred (pred (data (car (cdr (children (car x7))))))))
...
(assert
 (not
  (= (car (children (car (cdr (cdr (children (car x7)))))))
   (car (cdr (cdr (children (car x7))))))))
(assert
 (not (= (car (children (car (cdr (cdr (children (car x7))))))) (car x7))))
(assert
 (not
  (= (children (car (children (car (cdr (cdr (children (car x7))))))))
   (children (car (cdr (cdr (children (car x7)))))))))
(assert
 (not
  (= (children (car (children (car (cdr (cdr (children (car x7))))))))
...
(assert
 (not
  (= (children (car (children (car (cdr (cdr (children (car x7)))))))) x7)))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (children (car x7)))))))
   (children (car (cdr (cdr (children (car x7)))))))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (children (car x7)))))))
...
(assert
 (not
  (= (cdr (children (car (cdr (cdr (children (car x7)))))))
   (children (car x7)))))
(assert (not (= (cdr (children (car (cdr (cdr (children (car x7))))))) x7)))
(assert
 (not
  (= (car (cdr (children (car (cdr (cdr (children (car x7))))))))
   (car (cdr (cdr (children (car x7))))))))
(assert
 (not
  (= (car (cdr (children (car (cdr (cdr (children (car x7)))))))) (car x7))))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (children (car x7))))))))
   (cdr (children (car (cdr (cdr (children (car x7))))))))))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (children (car x7))))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (children (car x7))))))))
   (children (car x7)))))
(assert
 (not (= (cdr (cdr (children (car (cdr (cdr (children (car x7)))))))) x7)))
(assert
 (not
  (= (pred (data (car (cdr (cdr (children (car x7)))))))
   (data (car (cdr (cdr (children (car x7)))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (cdr (children (car x7))))))))
   (pred (data (car (cdr (cdr (children (car x7))))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (cdr (children (car x7))))))))
...
(assert
 (not
  (= (children (car (cdr (cdr (cdr (children (car x7)))))))
...
(assert
 (not
  (= (children (car (cdr (cdr (cdr (children (car x7)))))))
   (children (car x7)))))
(assert (not (= (children (car (cdr (cdr (cdr (children (car x7))))))) x7)))
(assert
 (not
  (= (car (children (car (cdr (cdr (cdr (children (car x7))))))))
   (car (cdr (cdr (cdr (children (car x7)))))))))
(assert
 (not
  (= (car (children (car (cdr (cdr (cdr (children (car x7)))))))) (car x7))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (children (car x7))))))))
   (children (car (cdr (cdr (cdr (children (car x7))))))))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (children (car x7))))))))
...
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (children (car x7))))))))
   (children (car x7)))))
(assert
 (not (= (cdr (children (car (cdr (cdr (cdr (children (car x7)))))))) x7)))
(assert
 (not
  (= (pred (data (car (cdr (cdr (cdr (children (car x7))))))))
   (data (car (cdr (cdr (cdr (children (car x7))))))))))
(assert
 (not
...
(assert (not (= (car (cdr (cdr (cdr (cdr (children (car x7))))))) (car x7))))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (children (car x7))))))))
   (cdr (cdr (cdr (cdr (children (car x7)))))))))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (children (car x7))))))))
...
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (children (car x7))))))))
   (children (car x7)))))
(assert
 (not (= (children (car (cdr (cdr (cdr (cdr (children (car x7)))))))) x7)))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (children (car x7)))))))
   (cdr (cdr (cdr (cdr (children (car x7)))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (children (car x7)))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (children (car x7))))))) (children (car x7)))))
(assert (not (= (cdr (cdr (cdr (cdr (cdr (children (car x7))))))) x7)))
(assert
 (not (= (car (cdr (cdr (cdr (cdr (cdr (children (car x7)))))))) (car x7))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (children (car x7))))))))
   (cdr (cdr (cdr (cdr (cdr (children (car x7))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (children (car x7))))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (children (car x7))))))))
   (children (car x7)))))
(assert (not (= (cdr (cdr (cdr (cdr (cdr (cdr (children (car x7)))))))) x7)))
...
(assert
 (not
  (= (pred (pred (pred (pred (pred (data (car x7)))))))
   (pred (pred (pred (pred (data (car x7)))))))))
(assert
 (not
  (= (pred (pred (pred (pred (pred (data (car x7)))))))
...
(assert
 (not
  (= (pred (pred (pred (pred (pred (data (car x7)))))))
   (pred (data (car x7))))))
(assert
 (not (= (pred (pred (pred (pred (pred (data (car x7))))))) (data (car x7)))))
(assert
 (not
  (= (pred (pred (pred (pred (pred (pred (data (car x7))))))))
   (pred (pred (pred (pred (pred (data (car x7))))))))))
(assert
 (not
  (= (pred (pred (pred (pred (pred (pred (data (car x7))))))))
...
(assert
 (not
  (= (children (car (children (car (children (car (cdr x7)))))))
...
(assert
 (not
  (= (children (car (children (car (children (car (cdr x7))))))) (cdr x7))))
(assert
 (not (= (children (car (children (car (children (car (cdr x7))))))) x7)))
(assert
 (not
  (= (car (children (car (children (car (children (car (cdr x7))))))))
   (car (children (car (children (car (cdr x7)))))))))
(assert
 (not
  (= (car (children (car (children (car (children (car (cdr x7))))))))
...
(assert
 (not
  (= (cdr (children (car (children (car (children (car (cdr x7))))))))
   (children (car (children (car (children (car (cdr x7))))))))))
(assert
 (not
  (= (cdr (children (car (children (car (children (car (cdr x7))))))))
...
(assert
 (not
  (= (cdr (children (car (children (car (children (car (cdr x7)))))))) x7)))
(assert
 (not
  (= (pred (data (car (children (car (children (car (cdr x7))))))))
   (data (car (children (car (children (car (cdr x7))))))))))
(assert
 (not
...
(assert
 (not
  (= (car (cdr (children (car (children (car (cdr x7)))))))
   (car (children (car (cdr x7)))))))
(assert
 (not
  (= (car (cdr (children (car (children (car (cdr x7))))))) (car (cdr x7)))))
(assert
 (not
  (= (children (car (cdr (children (car (children (car (cdr x7))))))))
   (cdr (children (car (children (car (cdr x7)))))))))
(assert
 (not
  (= (children (car (cdr (children (car (children (car (cdr x7))))))))
...
(assert
 (not
  (= (children (car (cdr (children (car (children (car (cdr x7)))))))) x7)))
(assert
 (not
  (= (cdr (cdr (children (car (children (car (cdr x7)))))))
   (cdr (children (car (children (car (cdr x7)))))))))
(assert
 (not
  (= (cdr (cdr (children (car (children (car (cdr x7)))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (children (car (cdr x7)))))))
   (children (car (cdr x7))))))
(assert
 (not (= (cdr (cdr (children (car (children (car (cdr x7))))))) (cdr x7))))
(assert (not (= (cdr (cdr (children (car (children (car (cdr x7))))))) x7)))
(assert
 (not
  (= (car (cdr (cdr (children (car (children (car (cdr x7))))))))
   (car (children (car (cdr x7)))))))
(assert
 (not
  (= (car (cdr (cdr (children (car (children (car (cdr x7))))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (children (car (children (car (cdr x7))))))))
   (cdr (cdr (children (car (children (car (cdr x7))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (children (car (cdr x7))))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (children (car (children (car (cdr x7)))))))) (cdr x7))))
(assert
 (not (= (cdr (cdr (cdr (children (car (children (car (cdr x7)))))))) x7)))
(assert
 (not
...
(assert
 (not
  (= (pred (pred (data (car (children (car (cdr x7)))))))
   (pred (data (car (children (car (cdr x7)))))))))
(assert
 (not
  (= (pred (pred (data (car (children (car (cdr x7)))))))
...
(assert
 (not
  (= (pred (pred (pred (data (car (children (car (cdr x7))))))))
   (pred (pred (data (car (children (car (cdr x7))))))))))
(assert
 (not
  (= (pred (pred (pred (data (car (children (car (cdr x7))))))))
...
(assert
 (not
  (= (car (children (car (cdr (children (car (cdr x7)))))))
   (car (cdr (children (car (cdr x7))))))))
(assert
 (not
  (= (car (children (car (cdr (children (car (cdr x7))))))) (car (cdr x7)))))
(assert
 (not
  (= (children (car (children (car (cdr (children (car (cdr x7))))))))
   (children (car (cdr (children (car (cdr x7)))))))))
(assert
 (not
  (= (children (car (children (car (cdr (children (car (cdr x7))))))))
...
(assert
 (not
  (= (children (car (children (car (cdr (children (car (cdr x7)))))))) x7)))
(assert
 (not
  (= (cdr (children (car (cdr (children (car (cdr x7)))))))
   (children (car (cdr (children (car (cdr x7)))))))))
(assert
 (not
  (= (cdr (children (car (cdr (children (car (cdr x7)))))))
...
(assert
 (not
  (= (cdr (children (car (cdr (children (car (cdr x7)))))))
   (children (car (cdr x7))))))
(assert
 (not (= (cdr (children (car (cdr (children (car (cdr x7))))))) (cdr x7))))
(assert (not (= (cdr (children (car (cdr (children (car (cdr x7))))))) x7)))
(assert
 (not
  (= (car (cdr (children (car (cdr (children (car (cdr x7))))))))
   (car (cdr (children (car (cdr x7))))))))
(assert
 (not
  (= (car (cdr (children (car (cdr (children (car (cdr x7))))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (cdr (children (car (cdr x7))))))))
   (cdr (children (car (cdr (children (car (cdr x7))))))))))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (children (car (cdr x7))))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (cdr (children (car (cdr x7)))))))) (cdr x7))))
(assert
 (not (= (cdr (cdr (children (car (cdr (children (car (cdr x7)))))))) x7)))
(assert
 (not
  (= (pred (data (car (cdr (children (car (cdr x7)))))))
   (data (car (cdr (children (car (cdr x7)))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (children (car (cdr x7))))))))
   (pred (data (car (cdr (children (car (cdr x7))))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (children (car (cdr x7))))))))
...
(assert
 (not
  (= (children (car (cdr (cdr (children (car (cdr x7)))))))
...
(assert
 (not
  (= (children (car (cdr (cdr (children (car (cdr x7)))))))
   (children (car (cdr x7))))))
(assert
 (not (= (children (car (cdr (cdr (children (car (cdr x7))))))) (cdr x7))))
(assert (not (= (children (car (cdr (cdr (children (car (cdr x7))))))) x7)))
(assert
 (not
  (= (car (children (car (cdr (cdr (children (car (cdr x7))))))))
   (car (cdr (cdr (children (car (cdr x7)))))))))
(assert
 (not
  (= (car (children (car (cdr (cdr (children (car (cdr x7))))))))
   (car (cdr x7)))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (children (car (cdr x7))))))))
   (children (car (cdr (cdr (children (car (cdr x7))))))))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (children (car (cdr x7))))))))
...
(assert
 (not
  (= (cdr (children (car (cdr (cdr (children (car (cdr x7)))))))) (cdr x7))))
(assert
 (not (= (cdr (children (car (cdr (cdr (children (car (cdr x7)))))))) x7)))
(assert
 (not
  (= (pred (data (car (cdr (cdr (children (car (cdr x7))))))))
   (data (car (cdr (cdr (children (car (cdr x7))))))))))
(assert
 (not
...
(assert
 (not (= (car (cdr (cdr (cdr (children (car (cdr x7))))))) (car (cdr x7)))))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (children (car (cdr x7))))))))
   (cdr (cdr (cdr (children (car (cdr x7)))))))))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (children (car (cdr x7))))))))
...
(assert
 (not
  (= (children (car (cdr (cdr (cdr (children (car (cdr x7)))))))) (cdr x7))))
(assert
 (not (= (children (car (cdr (cdr (cdr (children (car (cdr x7)))))))) x7)))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (cdr x7)))))))
   (cdr (cdr (cdr (children (car (cdr x7)))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (cdr x7)))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (cdr x7)))))))
   (children (car (cdr x7))))))
(assert (not (= (cdr (cdr (cdr (cdr (children (car (cdr x7))))))) (cdr x7))))
(assert (not (= (cdr (cdr (cdr (cdr (children (car (cdr x7))))))) x7)))
(assert
 (not
  (= (car (cdr (cdr (cdr (cdr (children (car (cdr x7)))))))) (car (cdr x7)))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (children (car (cdr x7))))))))
   (cdr (cdr (cdr (cdr (children (car (cdr x7))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (children (car (cdr x7))))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (children (car (cdr x7))))))))
   (children (car (cdr x7))))))
(assert
 (not (= (cdr (cdr (cdr (cdr (cdr (children (car (cdr x7)))))))) (cdr x7))))
(assert (not (= (cdr (cdr (cdr (cdr (cdr (children (car (cdr x7)))))))) x7)))
...
(assert
 (not
  (= (pred (pred (pred (pred (data (car (cdr x7)))))))
   (pred (pred (pred (data (car (cdr x7)))))))))
(assert
 (not
  (= (pred (pred (pred (pred (data (car (cdr x7)))))))
...
(assert
 (not
  (= (pred (pred (pred (pred (data (car (cdr x7)))))))
   (pred (data (car (cdr x7)))))))
(assert
 (not
  (= (pred (pred (pred (pred (data (car (cdr x7))))))) (data (car (cdr x7))))))
(assert
 (not
  (= (pred (pred (pred (pred (pred (data (car (cdr x7))))))))
   (pred (pred (pred (pred (data (car (cdr x7))))))))))
(assert
 (not
  (= (pred (pred (pred (pred (pred (data (car (cdr x7))))))))
...
(assert
 (not
  (= (car (children (car (children (car (cdr (cdr x7)))))))
   (car (children (car (cdr (cdr x7))))))))
(assert
 (not
  (= (car (children (car (children (car (cdr (cdr x7)))))))
   (car (cdr (cdr x7))))))
(assert
 (not
  (= (children (car (children (car (children (car (cdr (cdr x7))))))))
   (children (car (children (car (cdr (cdr x7)))))))))
(assert
 (not
  (= (children (car (children (car (children (car (cdr (cdr x7))))))))
...
(assert
 (not
  (= (children (car (children (car (children (car (cdr (cdr x7)))))))) x7)))
(assert
 (not
  (= (cdr (children (car (children (car (cdr (cdr x7)))))))
   (children (car (children (car (cdr (cdr x7)))))))))
(assert
 (not
  (= (cdr (children (car (children (car (cdr (cdr x7)))))))
...
(assert
 (not
  (= (cdr (children (car (children (car (cdr (cdr x7))))))) (cdr (cdr x7)))))
(assert
 (not (= (cdr (children (car (children (car (cdr (cdr x7))))))) (cdr x7))))
(assert (not (= (cdr (children (car (children (car (cdr (cdr x7))))))) x7)))
(assert
 (not
  (= (car (cdr (children (car (children (car (cdr (cdr x7))))))))
   (car (children (car (cdr (cdr x7))))))))
(assert
 (not
  (= (car (cdr (children (car (children (car (cdr (cdr x7))))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (children (car (cdr (cdr x7))))))))
   (cdr (children (car (children (car (cdr (cdr x7))))))))))
(assert
 (not
  (= (cdr (cdr (children (car (children (car (cdr (cdr x7))))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (children (car (cdr (cdr x7)))))))) (cdr x7))))
(assert
 (not (= (cdr (cdr (children (car (children (car (cdr (cdr x7)))))))) x7)))
(assert
 (not
  (= (pred (data (car (children (car (cdr (cdr x7)))))))
   (data (car (children (car (cdr (cdr x7)))))))))
(assert
 (not
  (= (pred (pred (data (car (children (car (cdr (cdr x7))))))))
   (pred (data (car (children (car (cdr (cdr x7))))))))))
(assert
 (not
  (= (pred (pred (data (car (children (car (cdr (cdr x7))))))))
...
(assert
 (not
  (= (children (car (cdr (children (car (cdr (cdr x7)))))))
...
(assert
 (not
  (= (children (car (cdr (children (car (cdr (cdr x7))))))) (cdr (cdr x7)))))
(assert
 (not (= (children (car (cdr (children (car (cdr (cdr x7))))))) (cdr x7))))
(assert (not (= (children (car (cdr (children (car (cdr (cdr x7))))))) x7)))
(assert
 (not
  (= (car (children (car (cdr (children (car (cdr (cdr x7))))))))
   (car (cdr (children (car (cdr (cdr x7)))))))))
(assert
 (not
  (= (car (children (car (cdr (children (car (cdr (cdr x7))))))))
   (car (cdr (cdr x7))))))
(assert
 (not
  (= (cdr (children (car (cdr (children (car (cdr (cdr x7))))))))
   (children (car (cdr (children (car (cdr (cdr x7))))))))))
(assert
 (not
  (= (cdr (children (car (cdr (children (car (cdr (cdr x7))))))))
...
(assert
 (not
  (= (cdr (children (car (cdr (children (car (cdr (cdr x7)))))))) (cdr x7))))
(assert
 (not (= (cdr (children (car (cdr (children (car (cdr (cdr x7)))))))) x7)))
(assert
 (not
  (= (pred (data (car (cdr (children (car (cdr (cdr x7))))))))
   (data (car (cdr (children (car (cdr (cdr x7))))))))))
(assert
 (not
...
(assert
 (not
  (= (car (cdr (cdr (children (car (cdr (cdr x7))))))) (car (cdr (cdr x7))))))
(assert
 (not
  (= (children (car (cdr (cdr (children (car (cdr (cdr x7))))))))
   (cdr (cdr (children (car (cdr (cdr x7)))))))))
(assert
 (not
  (= (children (car (cdr (cdr (children (car (cdr (cdr x7))))))))
...
(assert
 (not
  (= (children (car (cdr (cdr (children (car (cdr (cdr x7)))))))) (cdr x7))))
(assert
 (not (= (children (car (cdr (cdr (children (car (cdr (cdr x7)))))))) x7)))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (cdr x7)))))))
   (cdr (cdr (children (car (cdr (cdr x7)))))))))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (cdr x7)))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (cdr x7)))))))
   (children (car (cdr (cdr x7)))))))
(assert
 (not (= (cdr (cdr (cdr (children (car (cdr (cdr x7))))))) (cdr (cdr x7)))))
(assert (not (= (cdr (cdr (cdr (children (car (cdr (cdr x7))))))) (cdr x7))))
(assert (not (= (cdr (cdr (cdr (children (car (cdr (cdr x7))))))) x7)))
(assert
 (not
  (= (car (cdr (cdr (cdr (children (car (cdr (cdr x7))))))))
   (car (cdr (cdr x7))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (cdr (cdr x7))))))))
   (cdr (cdr (cdr (children (car (cdr (cdr x7))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (cdr (cdr x7))))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (cdr (cdr x7)))))))) (cdr (cdr x7)))))
(assert
 (not (= (cdr (cdr (cdr (cdr (children (car (cdr (cdr x7)))))))) (cdr x7))))
(assert (not (= (cdr (cdr (cdr (cdr (children (car (cdr (cdr x7)))))))) x7)))
(assert
...
(assert
 (not
  (= (pred (pred (pred (data (car (cdr (cdr x7)))))))
   (pred (pred (data (car (cdr (cdr x7)))))))))
(assert
 (not
  (= (pred (pred (pred (data (car (cdr (cdr x7)))))))
...
(assert
 (not
  (= (pred (pred (pred (pred (data (car (cdr (cdr x7))))))))
   (pred (pred (pred (data (car (cdr (cdr x7))))))))))
(assert
 (not
  (= (pred (pred (pred (pred (data (car (cdr (cdr x7))))))))
...
(assert
 (not
  (= (children (car (children (car (cdr (cdr (cdr x7)))))))
...
(assert
 (not
  (= (children (car (children (car (cdr (cdr (cdr x7))))))) (cdr (cdr x7)))))
(assert
 (not (= (children (car (children (car (cdr (cdr (cdr x7))))))) (cdr x7))))
(assert (not (= (children (car (children (car (cdr (cdr (cdr x7))))))) x7)))
(assert
 (not
  (= (car (children (car (children (car (cdr (cdr (cdr x7))))))))
   (car (children (car (cdr (cdr (cdr x7)))))))))
(assert
 (not
  (= (car (children (car (children (car (cdr (cdr (cdr x7))))))))
   (car (cdr (cdr (cdr x7)))))))
(assert
 (not
  (= (cdr (children (car (children (car (cdr (cdr (cdr x7))))))))
   (children (car (children (car (cdr (cdr (cdr x7))))))))))
(assert
 (not
  (= (cdr (children (car (children (car (cdr (cdr (cdr x7))))))))
...
(assert
 (not
  (= (cdr (children (car (children (car (cdr (cdr (cdr x7)))))))) (cdr x7))))
(assert
 (not (= (cdr (children (car (children (car (cdr (cdr (cdr x7)))))))) x7)))
(assert
 (not
  (= (pred (data (car (children (car (cdr (cdr (cdr x7))))))))
   (data (car (children (car (cdr (cdr (cdr x7))))))))))
(assert
 (not
...
(assert
 (not
  (= (car (cdr (children (car (cdr (cdr (cdr x7)))))))
   (car (cdr (cdr (cdr x7)))))))
(assert
 (not
  (= (children (car (cdr (children (car (cdr (cdr (cdr x7))))))))
   (cdr (children (car (cdr (cdr (cdr x7)))))))))
(assert
 (not
  (= (children (car (cdr (children (car (cdr (cdr (cdr x7))))))))
...
(assert
 (not
  (= (children (car (cdr (children (car (cdr (cdr (cdr x7)))))))) (cdr x7))))
(assert
 (not (= (children (car (cdr (children (car (cdr (cdr (cdr x7)))))))) x7)))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (cdr x7)))))))
   (cdr (children (car (cdr (cdr (cdr x7)))))))))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (cdr x7)))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (cdr x7))))))) (cdr (cdr (cdr x7))))))
(assert
 (not (= (cdr (cdr (children (car (cdr (cdr (cdr x7))))))) (cdr (cdr x7)))))
(assert (not (= (cdr (cdr (children (car (cdr (cdr (cdr x7))))))) (cdr x7))))
(assert (not (= (cdr (cdr (children (car (cdr (cdr (cdr x7))))))) x7)))
(assert
 (not
  (= (car (cdr (cdr (children (car (cdr (cdr (cdr x7))))))))
   (car (cdr (cdr (cdr x7)))))))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (cdr (cdr x7))))))))
   (cdr (cdr (children (car (cdr (cdr (cdr x7))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (cdr (cdr x7))))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (cdr (cdr x7)))))))) (cdr (cdr x7)))))
(assert
 (not (= (cdr (cdr (cdr (children (car (cdr (cdr (cdr x7)))))))) (cdr x7))))
(assert (not (= (cdr (cdr (cdr (children (car (cdr (cdr (cdr x7)))))))) x7)))
(assert
 (not
...
(assert
 (not
  (= (pred (pred (data (car (cdr (cdr (cdr x7)))))))
   (pred (data (car (cdr (cdr (cdr x7)))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (cdr (cdr x7)))))))
...
(assert
 (not
  (= (pred (pred (pred (data (car (cdr (cdr (cdr x7))))))))
   (pred (pred (data (car (cdr (cdr (cdr x7))))))))))
(assert
 (not
  (= (pred (pred (pred (data (car (cdr (cdr (cdr x7))))))))
...
(assert
 (not
  (= (car (children (car (cdr (cdr (cdr (cdr x7)))))))
   (car (cdr (cdr (cdr (cdr x7))))))))
(assert
 (not
  (= (children (car (children (car (cdr (cdr (cdr (cdr x7))))))))
   (children (car (cdr (cdr (cdr (cdr x7)))))))))
(assert
 (not
  (= (children (car (children (car (cdr (cdr (cdr (cdr x7))))))))
   (cdr (cdr (cdr (cdr x7)))))))
...
(assert
 (not
  (= (children (car (children (car (cdr (cdr (cdr (cdr x7)))))))) (cdr x7))))
(assert
 (not (= (children (car (children (car (cdr (cdr (cdr (cdr x7)))))))) x7)))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (cdr x7)))))))
   (children (car (cdr (cdr (cdr (cdr x7)))))))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (cdr x7)))))))
...
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (cdr x7))))))) (cdr (cdr (cdr x7))))))
(assert
 (not (= (cdr (children (car (cdr (cdr (cdr (cdr x7))))))) (cdr (cdr x7)))))
(assert (not (= (cdr (children (car (cdr (cdr (cdr (cdr x7))))))) (cdr x7))))
(assert (not (= (cdr (children (car (cdr (cdr (cdr (cdr x7))))))) x7)))
(assert
 (not
  (= (car (cdr (children (car (cdr (cdr (cdr (cdr x7))))))))
   (car (cdr (cdr (cdr (cdr x7))))))))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (cdr (cdr x7))))))))
   (cdr (children (car (cdr (cdr (cdr (cdr x7))))))))))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (cdr (cdr x7))))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (cdr (cdr x7)))))))) (cdr (cdr x7)))))
(assert
 (not (= (cdr (cdr (children (car (cdr (cdr (cdr (cdr x7)))))))) (cdr x7))))
(assert (not (= (cdr (cdr (children (car (cdr (cdr (cdr (cdr x7)))))))) x7)))
(assert
 (not
  (= (pred (data (car (cdr (cdr (cdr (cdr x7)))))))
   (data (car (cdr (cdr (cdr (cdr x7)))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (cdr (cdr (cdr x7))))))))
   (pred (data (car (cdr (cdr (cdr (cdr x7))))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (cdr (cdr (cdr x7))))))))
...
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (cdr x7)))))))
   (cdr (cdr (cdr (cdr (cdr x7))))))))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (cdr x7)))))))
   (cdr (cdr (cdr (cdr x7)))))))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (cdr x7))))))) (cdr (cdr (cdr x7))))))
(assert
 (not (= (children (car (cdr (cdr (cdr (cdr (cdr x7))))))) (cdr (cdr x7)))))
(assert (not (= (children (car (cdr (cdr (cdr (cdr (cdr x7))))))) (cdr x7))))
(assert (not (= (children (car (cdr (cdr (cdr (cdr (cdr x7))))))) x7)))
(assert
 (not
  (= (car (children (car (cdr (cdr (cdr (cdr (cdr x7))))))))
   (car (cdr (cdr (cdr (cdr (cdr x7)))))))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (cdr (cdr x7))))))))
   (children (car (cdr (cdr (cdr (cdr (cdr x7))))))))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (cdr (cdr x7))))))))
...
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (cdr (cdr x7)))))))) (cdr (cdr x7)))))
(assert
 (not (= (cdr (children (car (cdr (cdr (cdr (cdr (cdr x7)))))))) (cdr x7))))
(assert (not (= (cdr (children (car (cdr (cdr (cdr (cdr (cdr x7)))))))) x7)))
(assert
 (not
  (= (pred (data (car (cdr (cdr (cdr (cdr (cdr x7))))))))
   (data (car (cdr (cdr (cdr (cdr (cdr x7))))))))))
(assert
 (not
...
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (cdr (cdr x7))))))))
   (cdr (cdr (cdr (cdr (cdr (cdr x7)))))))))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (cdr (cdr x7))))))))
   (cdr (cdr (cdr (cdr (cdr x7))))))))
...
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (cdr (cdr x7)))))))) (cdr (cdr x7)))))
(assert
 (not (= (children (car (cdr (cdr (cdr (cdr (cdr (cdr x7)))))))) (cdr x7))))
(assert (not (= (children (car (cdr (cdr (cdr (cdr (cdr (cdr x7)))))))) x7)))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr x7)))))))
   (cdr (cdr (cdr (cdr (cdr (cdr x7)))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr x7)))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr x7))))))) (cdr (cdr (cdr (cdr x7)))))))
(assert
 (not (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr x7))))))) (cdr (cdr (cdr x7))))))
(assert (not (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr x7))))))) (cdr (cdr x7)))))
(assert (not (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr x7))))))) (cdr x7))))
(assert (not (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr x7))))))) x7)))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr (cdr x7))))))))
   (cdr (cdr (cdr (cdr (cdr (cdr (cdr x7))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr (cdr x7))))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr (cdr x7)))))))) (cdr (cdr (cdr x7))))))
(assert
 (not (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr (cdr x7)))))))) (cdr (cdr x7)))))
(assert (not (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr (cdr x7)))))))) (cdr x7))))
(assert (not (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr (cdr x7)))))))) x7)))
...
(assert
 (not
  (= (children (car (children (car (children (car (children (car x6))))))))
   (children (car (children (car (children (car x6)))))))))
(assert
 (not
  (= (children (car (children (car (children (car (children (car x6))))))))
...
(assert
 (not
  (= (car (cdr (children (car (children (car (children (car x6))))))))
   (car (children (car (children (car x6))))))))
(assert
 (not
  (= (car (cdr (children (car (children (car (children (car x6))))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (children (car (children (car x6))))))))
   (cdr (children (car (children (car (children (car x6))))))))))
(assert
 (not
  (= (cdr (cdr (children (car (children (car (children (car x6))))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (children (car (children (car x6)))))))) x6)))
(assert
 (not
...
(assert
 (not
  (= (pred (pred (data (car (children (car (children (car x6))))))))
   (pred (data (car (children (car (children (car x6))))))))))
(assert
 (not
  (= (pred (pred (data (car (children (car (children (car x6))))))))
...
(assert
 (not
  (= (car (children (car (cdr (children (car (children (car x6))))))))
   (car (cdr (children (car (children (car x6)))))))))
(assert
 (not
  (= (car (children (car (cdr (children (car (children (car x6))))))))
...
(assert
 (not
  (= (cdr (children (car (cdr (children (car (children (car x6))))))))
   (children (car (cdr (children (car (children (car x6))))))))))
(assert
 (not
  (= (cdr (children (car (cdr (children (car (children (car x6))))))))
...
(assert
 (not
  (= (cdr (children (car (cdr (children (car (children (car x6)))))))) x6)))
(assert
 (not
  (= (pred (data (car (cdr (children (car (children (car x6))))))))
   (data (car (cdr (children (car (children (car x6))))))))))
(assert
 (not
...
(assert
 (not
  (= (children (car (cdr (cdr (children (car (children (car x6))))))))
   (cdr (cdr (children (car (children (car x6)))))))))
(assert
 (not
  (= (children (car (cdr (cdr (children (car (children (car x6))))))))
...
(assert
 (not
  (= (children (car (cdr (cdr (children (car (children (car x6)))))))) x6)))
(assert
 (not
...
(assert
 (not
  (= (car (cdr (cdr (cdr (children (car (children (car x6))))))))
   (car (children (car x6))))))
(assert
 (not
  (= (car (cdr (cdr (cdr (children (car (children (car x6)))))))) (car x6))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (children (car x6))))))))
   (cdr (cdr (cdr (children (car (children (car x6))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (children (car x6))))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (children (car x6))))))))
   (children (car x6)))))
(assert
 (not (= (cdr (cdr (cdr (cdr (children (car (children (car x6)))))))) x6)))
(assert
 (not
...
(assert
 (not
  (= (pred (pred (pred (pred (data (car (children (car x6))))))))
   (pred (pred (pred (data (car (children (car x6))))))))))
(assert
 (not
  (= (pred (pred (pred (pred (data (car (children (car x6))))))))
...
(assert
 (not
  (= (car (children (car (children (car (cdr (children (car x6))))))))
   (car (children (car (cdr (children (car x6)))))))))
(assert
 (not
  (= (car (children (car (children (car (cdr (children (car x6))))))))
...
(assert
 (not
  (= (cdr (children (car (children (car (cdr (children (car x6))))))))
   (children (car (children (car (cdr (children (car x6))))))))))
(assert
 (not
  (= (cdr (children (car (children (car (cdr (children (car x6))))))))
...
(assert
 (not
  (= (cdr (children (car (children (car (cdr (children (car x6)))))))) x6)))
(assert
 (not
  (= (pred (data (car (children (car (cdr (children (car x6))))))))
   (data (car (children (car (cdr (children (car x6))))))))))
(assert
 (not
...
(assert
 (not
  (= (children (car (cdr (children (car (cdr (children (car x6))))))))
   (cdr (children (car (cdr (children (car x6)))))))))
(assert
 (not
  (= (children (car (cdr (children (car (cdr (children (car x6))))))))
...
(assert
 (not
  (= (children (car (cdr (children (car (cdr (children (car x6)))))))) x6)))
(assert
 (not
...
(assert
 (not
  (= (car (cdr (cdr (children (car (cdr (children (car x6))))))))
   (car (cdr (children (car x6)))))))
(assert
 (not
  (= (car (cdr (cdr (children (car (cdr (children (car x6)))))))) (car x6))))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (children (car x6))))))))
   (cdr (cdr (children (car (cdr (children (car x6))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (children (car x6))))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (children (car x6))))))))
   (children (car x6)))))
(assert
 (not (= (cdr (cdr (cdr (children (car (cdr (children (car x6)))))))) x6)))
(assert
 (not
...
(assert
 (not
  (= (pred (pred (pred (data (car (cdr (children (car x6))))))))
   (pred (pred (data (car (cdr (children (car x6))))))))))
(assert
 (not
  (= (pred (pred (pred (data (car (cdr (children (car x6))))))))
...
(assert
 (not
  (= (children (car (children (car (cdr (cdr (children (car x6))))))))
   (children (car (cdr (cdr (children (car x6)))))))))
(assert
 (not
  (= (children (car (children (car (cdr (cdr (children (car x6))))))))
...
(assert
 (not
  (= (children (car (children (car (cdr (cdr (children (car x6)))))))) x6)))
(assert
 (not
...
(assert
 (not
  (= (car (cdr (children (car (cdr (cdr (children (car x6))))))))
   (car (cdr (cdr (children (car x6))))))))
(assert
 (not
  (= (car (cdr (children (car (cdr (cdr (children (car x6)))))))) (car x6))))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (children (car x6))))))))
   (cdr (children (car (cdr (cdr (children (car x6))))))))))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (children (car x6))))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (children (car x6))))))))
   (children (car x6)))))
(assert
 (not (= (cdr (cdr (children (car (cdr (cdr (children (car x6)))))))) x6)))
(assert
 (not
...
(assert
 (not
  (= (pred (pred (data (car (cdr (cdr (children (car x6))))))))
   (pred (data (car (cdr (cdr (children (car x6))))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (cdr (children (car x6))))))))
...
(assert
 (not
  (= (car (children (car (cdr (cdr (cdr (children (car x6))))))))
   (car (cdr (cdr (cdr (children (car x6)))))))))
(assert
 (not
  (= (car (children (car (cdr (cdr (cdr (children (car x6)))))))) (car x6))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (children (car x6))))))))
   (children (car (cdr (cdr (cdr (children (car x6))))))))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (children (car x6))))))))
...
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (children (car x6))))))))
   (children (car x6)))))
(assert
 (not (= (cdr (children (car (cdr (cdr (cdr (children (car x6)))))))) x6)))
(assert
 (not
  (= (pred (data (car (cdr (cdr (cdr (children (car x6))))))))
   (data (car (cdr (cdr (cdr (children (car x6))))))))))
(assert
 (not
...
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (children (car x6))))))))
   (cdr (cdr (cdr (cdr (children (car x6)))))))))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (children (car x6))))))))
...
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (children (car x6))))))))
   (children (car x6)))))
(assert
 (not (= (children (car (cdr (cdr (cdr (cdr (children (car x6)))))))) x6)))
(assert
 (not
...
(assert
 (not (= (car (cdr (cdr (cdr (cdr (cdr (children (car x6)))))))) (car x6))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (children (car x6))))))))
   (cdr (cdr (cdr (cdr (cdr (children (car x6))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (children (car x6))))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (children (car x6))))))))
   (children (car x6)))))
(assert (not (= (cdr (cdr (cdr (cdr (cdr (cdr (children (car x6)))))))) x6)))
...
(assert
 (not
  (= (pred (pred (pred (pred (pred (pred (data (car x6))))))))
   (pred (pred (pred (pred (pred (data (car x6))))))))))
(assert
 (not
  (= (pred (pred (pred (pred (pred (pred (data (car x6))))))))
...
(assert
 (not
  (= (car (children (car (children (car (children (car (cdr x6))))))))
   (car (children (car (children (car (cdr x6)))))))))
(assert
 (not
  (= (car (children (car (children (car (children (car (cdr x6))))))))
...
(assert
 (not
  (= (cdr (children (car (children (car (children (car (cdr x6))))))))
   (children (car (children (car (children (car (cdr x6))))))))))
(assert
 (not
  (= (cdr (children (car (children (car (children (car (cdr x6))))))))
...
(assert
 (not
  (= (cdr (children (car (children (car (children (car (cdr x6)))))))) x6)))
(assert
 (not
  (= (pred (data (car (children (car (children (car (cdr x6))))))))
   (data (car (children (car (children (car (cdr x6))))))))))
(assert
 (not
...
(assert
 (not
  (= (children (car (cdr (children (car (children (car (cdr x6))))))))
   (cdr (children (car (children (car (cdr x6)))))))))
(assert
 (not
  (= (children (car (cdr (children (car (children (car (cdr x6))))))))
...
(assert
 (not
  (= (children (car (cdr (children (car (children (car (cdr x6)))))))) x6)))
(assert
 (not
...
(assert
 (not
  (= (car (cdr (cdr (children (car (children (car (cdr x6))))))))
   (car (children (car (cdr x6)))))))
(assert
 (not
  (= (car (cdr (cdr (children (car (children (car (cdr x6))))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (children (car (children (car (cdr x6))))))))
   (cdr (cdr (children (car (children (car (cdr x6))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (children (car (cdr x6))))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (children (car (children (car (cdr x6)))))))) (cdr x6))))
(assert
 (not (= (cdr (cdr (cdr (children (car (children (car (cdr x6)))))))) x6)))
(assert
 (not
...
(assert
 (not
  (= (pred (pred (pred (data (car (children (car (cdr x6))))))))
   (pred (pred (data (car (children (car (cdr x6))))))))))
(assert
 (not
  (= (pred (pred (pred (data (car (children (car (cdr x6))))))))
...
(assert
 (not
  (= (children (car (children (car (cdr (children (car (cdr x6))))))))
   (children (car (cdr (children (car (cdr x6)))))))))
(assert
 (not
  (= (children (car (children (car (cdr (children (car (cdr x6))))))))
...
(assert
 (not
  (= (children (car (children (car (cdr (children (car (cdr x6)))))))) x6)))
(assert
 (not
...
(assert
 (not
  (= (car (cdr (children (car (cdr (children (car (cdr x6))))))))
   (car (cdr (children (car (cdr x6))))))))
(assert
 (not
  (= (car (cdr (children (car (cdr (children (car (cdr x6))))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (cdr (children (car (cdr x6))))))))
   (cdr (children (car (cdr (children (car (cdr x6))))))))))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (children (car (cdr x6))))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (cdr (children (car (cdr x6)))))))) (cdr x6))))
(assert
 (not (= (cdr (cdr (children (car (cdr (children (car (cdr x6)))))))) x6)))
(assert
 (not
...
(assert
 (not
  (= (pred (pred (data (car (cdr (children (car (cdr x6))))))))
   (pred (data (car (cdr (children (car (cdr x6))))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (children (car (cdr x6))))))))
...
(assert
 (not
  (= (car (children (car (cdr (cdr (children (car (cdr x6))))))))
   (car (cdr (cdr (children (car (cdr x6)))))))))
(assert
 (not
  (= (car (children (car (cdr (cdr (children (car (cdr x6))))))))
   (car (cdr x6)))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (children (car (cdr x6))))))))
   (children (car (cdr (cdr (children (car (cdr x6))))))))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (children (car (cdr x6))))))))
...
(assert
 (not
  (= (cdr (children (car (cdr (cdr (children (car (cdr x6)))))))) (cdr x6))))
(assert
 (not (= (cdr (children (car (cdr (cdr (children (car (cdr x6)))))))) x6)))
(assert
 (not
  (= (pred (data (car (cdr (cdr (children (car (cdr x6))))))))
   (data (car (cdr (cdr (children (car (cdr x6))))))))))
(assert
 (not
...
(assert
 (not
  (= (children (car (cdr (cdr (cdr (children (car (cdr x6))))))))
   (cdr (cdr (cdr (children (car (cdr x6)))))))))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (children (car (cdr x6))))))))
...
(assert
 (not
  (= (children (car (cdr (cdr (cdr (children (car (cdr x6)))))))) (cdr x6))))
(assert
 (not (= (children (car (cdr (cdr (cdr (children (car (cdr x6)))))))) x6)))
(assert
 (not
...
(assert
 (not
  (= (car (cdr (cdr (cdr (cdr (children (car (cdr x6)))))))) (car (cdr x6)))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (children (car (cdr x6))))))))
   (cdr (cdr (cdr (cdr (children (car (cdr x6))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (children (car (cdr x6))))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (children (car (cdr x6))))))))
   (children (car (cdr x6))))))
(assert
 (not (= (cdr (cdr (cdr (cdr (cdr (children (car (cdr x6)))))))) (cdr x6))))
(assert (not (= (cdr (cdr (cdr (cdr (cdr (children (car (cdr x6)))))))) x6)))
...
(assert
 (not
  (= (pred (pred (pred (pred (pred (data (car (cdr x6))))))))
   (pred (pred (pred (pred (data (car (cdr x6))))))))))
(assert
 (not
  (= (pred (pred (pred (pred (pred (data (car (cdr x6))))))))
...
(assert
 (not
  (= (children (car (children (car (children (car (cdr (cdr x6))))))))
   (children (car (children (car (cdr (cdr x6)))))))))
(assert
 (not
  (= (children (car (children (car (children (car (cdr (cdr x6))))))))
...
(assert
 (not
  (= (children (car (children (car (children (car (cdr (cdr x6)))))))) x6)))
(assert
 (not
...
(assert
 (not
  (= (car (cdr (children (car (children (car (cdr (cdr x6))))))))
   (car (children (car (cdr (cdr x6))))))))
(assert
 (not
  (= (car (cdr (children (car (children (car (cdr (cdr x6))))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (children (car (cdr (cdr x6))))))))
   (cdr (children (car (children (car (cdr (cdr x6))))))))))
(assert
 (not
  (= (cdr (cdr (children (car (children (car (cdr (cdr x6))))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (children (car (cdr (cdr x6)))))))) (cdr x6))))
(assert
 (not (= (cdr (cdr (children (car (children (car (cdr (cdr x6)))))))) x6)))
(assert
 (not
...
(assert
 (not
  (= (pred (pred (data (car (children (car (cdr (cdr x6))))))))
   (pred (data (car (children (car (cdr (cdr x6))))))))))
(assert
 (not
  (= (pred (pred (data (car (children (car (cdr (cdr x6))))))))
...
(assert
 (not
  (= (car (children (car (cdr (children (car (cdr (cdr x6))))))))
   (car (cdr (children (car (cdr (cdr x6)))))))))
(assert
 (not
  (= (car (children (car (cdr (children (car (cdr (cdr x6))))))))
   (car (cdr (cdr x6))))))
(assert
 (not
  (= (cdr (children (car (cdr (children (car (cdr (cdr x6))))))))
   (children (car (cdr (children (car (cdr (cdr x6))))))))))
(assert
 (not
  (= (cdr (children (car (cdr (children (car (cdr (cdr x6))))))))
...
(assert
 (not
  (= (cdr (children (car (cdr (children (car (cdr (cdr x6)))))))) (cdr x6))))
(assert
 (not (= (cdr (children (car (cdr (children (car (cdr (cdr x6)))))))) x6)))
(assert
 (not
  (= (pred (data (car (cdr (children (car (cdr (cdr x6))))))))
   (data (car (cdr (children (car (cdr (cdr x6))))))))))
(assert
 (not
...
(assert
 (not
  (= (children (car (cdr (cdr (children (car (cdr (cdr x6))))))))
   (cdr (cdr (children (car (cdr (cdr x6)))))))))
(assert
 (not
  (= (children (car (cdr (cdr (children (car (cdr (cdr x6))))))))
...
(assert
 (not
  (= (children (car (cdr (cdr (children (car (cdr (cdr x6)))))))) (cdr x6))))
(assert
 (not (= (children (car (cdr (cdr (children (car (cdr (cdr x6)))))))) x6)))
(assert
 (not
...
(assert
 (not
  (= (car (cdr (cdr (cdr (children (car (cdr (cdr x6))))))))
   (car (cdr (cdr x6))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (cdr (cdr x6))))))))
   (cdr (cdr (cdr (children (car (cdr (cdr x6))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (cdr (cdr x6))))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (cdr (cdr x6)))))))) (cdr (cdr x6)))))
(assert
 (not (= (cdr (cdr (cdr (cdr (children (car (cdr (cdr x6)))))))) (cdr x6))))
(assert (not (= (cdr (cdr (cdr (cdr (children (car (cdr (cdr x6)))))))) x6)))
(assert
...
(assert
 (not
  (= (pred (pred (pred (pred (data (car (cdr (cdr x6))))))))
   (pred (pred (pred (data (car (cdr (cdr x6))))))))))
(assert
 (not
  (= (pred (pred (pred (pred (data (car (cdr (cdr x6))))))))
...
(assert
 (not
  (= (car (children (car (children (car (cdr (cdr (cdr x6))))))))
   (car (children (car (cdr (cdr (cdr x6)))))))))
(assert
 (not
  (= (car (children (car (children (car (cdr (cdr (cdr x6))))))))
   (car (cdr (cdr (cdr x6)))))))
(assert
 (not
  (= (cdr (children (car (children (car (cdr (cdr (cdr x6))))))))
   (children (car (children (car (cdr (cdr (cdr x6))))))))))
(assert
 (not
  (= (cdr (children (car (children (car (cdr (cdr (cdr x6))))))))
...
(assert
 (not
  (= (cdr (children (car (children (car (cdr (cdr (cdr x6)))))))) (cdr x6))))
(assert
 (not (= (cdr (children (car (children (car (cdr (cdr (cdr x6)))))))) x6)))
(assert
 (not
  (= (pred (data (car (children (car (cdr (cdr (cdr x6))))))))
   (data (car (children (car (cdr (cdr (cdr x6))))))))))
(assert
 (not
...
(assert
 (not
  (= (children (car (cdr (children (car (cdr (cdr (cdr x6))))))))
   (cdr (children (car (cdr (cdr (cdr x6)))))))))
(assert
 (not
  (= (children (car (cdr (children (car (cdr (cdr (cdr x6))))))))
...
(assert
 (not
  (= (children (car (cdr (children (car (cdr (cdr (cdr x6)))))))) (cdr x6))))
(assert
 (not (= (children (car (cdr (children (car (cdr (cdr (cdr x6)))))))) x6)))
(assert
 (not
...
(assert
 (not
  (= (car (cdr (cdr (children (car (cdr (cdr (cdr x6))))))))
   (car (cdr (cdr (cdr x6)))))))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (cdr (cdr x6))))))))
   (cdr (cdr (children (car (cdr (cdr (cdr x6))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (cdr (cdr x6))))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (cdr (cdr x6)))))))) (cdr (cdr x6)))))
(assert
 (not (= (cdr (cdr (cdr (children (car (cdr (cdr (cdr x6)))))))) (cdr x6))))
(assert (not (= (cdr (cdr (cdr (children (car (cdr (cdr (cdr x6)))))))) x6)))
(assert
 (not
...
(assert
 (not
  (= (pred (pred (pred (data (car (cdr (cdr (cdr x6))))))))
   (pred (pred (data (car (cdr (cdr (cdr x6))))))))))
(assert
 (not
  (= (pred (pred (pred (data (car (cdr (cdr (cdr x6))))))))
...
(assert
 (not
  (= (children (car (children (car (cdr (cdr (cdr (cdr x6))))))))
...
(assert
 (not
  (= (children (car (children (car (cdr (cdr (cdr (cdr x6)))))))) (cdr x6))))
(assert
 (not (= (children (car (children (car (cdr (cdr (cdr (cdr x6)))))))) x6)))
(assert
 (not
...
(assert
 (not
  (= (car (cdr (children (car (cdr (cdr (cdr (cdr x6))))))))
   (car (cdr (cdr (cdr (cdr x6))))))))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (cdr (cdr x6))))))))
   (cdr (children (car (cdr (cdr (cdr (cdr x6))))))))))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (cdr (cdr x6))))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (cdr (cdr x6)))))))) (cdr (cdr x6)))))
(assert
 (not (= (cdr (cdr (children (car (cdr (cdr (cdr (cdr x6)))))))) (cdr x6))))
(assert (not (= (cdr (cdr (children (car (cdr (cdr (cdr (cdr x6)))))))) x6)))
(assert
 (not
...
(assert
 (not
  (= (pred (pred (data (car (cdr (cdr (cdr (cdr x6))))))))
   (pred (data (car (cdr (cdr (cdr (cdr x6))))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (cdr (cdr (cdr x6))))))))
...
(assert
 (not
  (= (car (children (car (cdr (cdr (cdr (cdr (cdr x6))))))))
   (car (cdr (cdr (cdr (cdr (cdr x6)))))))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (cdr (cdr x6))))))))
   (children (car (cdr (cdr (cdr (cdr (cdr x6))))))))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (cdr (cdr x6))))))))
...
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (cdr (cdr x6)))))))) (cdr (cdr x6)))))
(assert
 (not (= (cdr (children (car (cdr (cdr (cdr (cdr (cdr x6)))))))) (cdr x6))))
(assert (not (= (cdr (children (car (cdr (cdr (cdr (cdr (cdr x6)))))))) x6)))
(assert
 (not
  (= (pred (data (car (cdr (cdr (cdr (cdr (cdr x6))))))))
   (data (car (cdr (cdr (cdr (cdr (cdr x6))))))))))
(assert
 (not
...
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (cdr (cdr x6))))))))
...
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (cdr (cdr x6)))))))) (cdr (cdr x6)))))
(assert
 (not (= (children (car (cdr (cdr (cdr (cdr (cdr (cdr x6)))))))) (cdr x6))))
(assert (not (= (children (car (cdr (cdr (cdr (cdr (cdr (cdr x6)))))))) x6)))
(assert
 (not
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr (cdr x6))))))))
   (cdr (cdr (cdr (cdr (cdr (cdr (cdr x6))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr (cdr x6))))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr (cdr x6)))))))) (cdr (cdr (cdr x6))))))
(assert
 (not (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr (cdr x6)))))))) (cdr (cdr x6)))))
(assert (not (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr (cdr x6)))))))) (cdr x6))))
(assert (not (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr (cdr x6)))))))) x6)))
...
(assert
 (not
  (=
   (pred (pred (data (car (children (car (children contrived_variable5)))))))
   (pred (data (car (children (car (children contrived_variable5)))))))))
(assert
 (not
  (=
...
(assert
 (not
  (=
   (pred (data (car (cdr (children (car (children contrived_variable5)))))))
   (data (car (cdr (children (car (children contrived_variable5)))))))))
(assert
 (not
  (=
 ...
 (not
  (=
   (pred (data (car (cdr (cdr (children (car (children
    contrived_variable5))))))))
   (data (car (cdr (cdr (children (car (children contrived_variable5))))))))))
(assert
 (not
...
(assert
 (not
  (= (car (cdr (cdr (cdr (children (car (children contrived_variable5)))))))
   (car (children contrived_variable5)))))
(assert
 (not
  (= (car (cdr (cdr (cdr (children (car (children contrived_variable5)))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (children contrived_variable5)))))))
   (cdr (cdr (cdr (children (car (children contrived_variable5)))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (children contrived_variable5)))))))
...
(assert
 (not
  (= (pred (pred (pred (pred (data (car (children contrived_variable5)))))))
   (pred (pred (pred (data (car (children contrived_variable5)))))))))
(assert
 (not
  (= (pred (pred (pred (pred (data (car (children contrived_variable5)))))))
...
(assert
 (not
  (=
   (pred (data (car (children (car (cdr (children contrived_variable5)))))))
   (data (car (children (car (cdr (children contrived_variable5)))))))))
(assert
 (not
  (=
 ...
 (not
  (=
   (pred (data (car (cdr (children (car (cdr (children
    contrived_variable5))))))))
   (data (car (cdr (children (car (cdr (children contrived_variable5))))))))))
(assert
 (not
...
(assert
 (not
  (= (car (cdr (cdr (children (car (cdr (children contrived_variable5)))))))
   (car (cdr (children contrived_variable5))))))
(assert
 (not
  (= (car (cdr (cdr (children (car (cdr (children contrived_variable5)))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (children contrived_variable5)))))))
   (cdr (cdr (children (car (cdr (children contrived_variable5)))))))))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (children contrived_variable5)))))))
...
(assert
 (not
  (= (pred (pred (pred (data (car (cdr (children contrived_variable5)))))))
   (pred (pred (data (car (cdr (children contrived_variable5)))))))))
(assert
 (not
  (= (pred (pred (pred (data (car (cdr (children contrived_variable5)))))))
 ...
 (not
  (=
   (pred (data (car (children (car (cdr (cdr (children
    contrived_variable5))))))))
   (data (car (children (car (cdr (cdr (children contrived_variable5))))))))))
(assert
 (not
...
(assert
 (not
  (= (car (cdr (children (car (cdr (cdr (children contrived_variable5)))))))
   (car (cdr (cdr (children contrived_variable5)))))))
(assert
 (not
  (= (car (cdr (children (car (cdr (cdr (children contrived_variable5)))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (children contrived_variable5)))))))
   (cdr (children (car (cdr (cdr (children contrived_variable5)))))))))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (children contrived_variable5)))))))
...
(assert
 (not
  (= (pred (pred (data (car (cdr (cdr (children contrived_variable5)))))))
   (pred (data (car (cdr (cdr (children contrived_variable5)))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (cdr (children contrived_variable5)))))))
...
(assert
 (not
  (= (car (children (car (cdr (cdr (cdr (children contrived_variable5)))))))
   (car (cdr (cdr (cdr (children contrived_variable5))))))))
(assert
 (not
  (= (car (children (car (cdr (cdr (cdr (children contrived_variable5)))))))
...
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (children contrived_variable5)))))))
   (children (car (cdr (cdr (cdr (children contrived_variable5)))))))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (children contrived_variable5)))))))
...
(assert
 (not
  (= (pred (data (car (cdr (cdr (cdr (children contrived_variable5)))))))
   (data (car (cdr (cdr (cdr (children contrived_variable5)))))))))
(assert
 (not
  (=
   (pred (pred (data (car (cdr (cdr (cdr (children contrived_variable5))))))))
   (pred (data (car (cdr (cdr (cdr (children contrived_variable5))))))))))
(assert
 (not
  (=
...
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (children contrived_variable5)))))))
   (cdr (cdr (cdr (cdr (children contrived_variable5))))))))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (children contrived_variable5)))))))
...
(assert
 (not
  (=
   (pred (data (car (cdr (cdr (cdr (cdr (children contrived_variable5))))))))
   (data (car (cdr (cdr (cdr (cdr (children contrived_variable5))))))))))
(assert
 (not
...
(assert
 (not
  (= (car (cdr (cdr (cdr (cdr (cdr (children contrived_variable5)))))))
   contrived_variable5)))
(assert
 (not
  (=
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (children contrived_variable5)))))))
   (cdr (cdr (cdr (cdr (cdr (children contrived_variable5)))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (children contrived_variable5)))))))
...
(assert
 (not
  (= (car (cdr (cdr (cdr (cdr (cdr (cdr (children contrived_variable5))))))))
   contrived_variable5)))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr (children contrived_variable5))))))))
   (cdr (cdr (cdr (cdr (cdr (cdr (children contrived_variable5))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr (children contrived_variable5))))))))
...
(assert
 (not
  (= (pred (pred (pred (pred (pred (pred (data contrived_variable5)))))))
   (pred (pred (pred (pred (pred (data contrived_variable5)))))))))
(assert
 (not
  (= (pred (pred (pred (pred (pred (pred (data contrived_variable5)))))))
...
(assert
 (not
  (=
   (pred (pred (pred (pred (pred (pred (pred (data contrived_variable5))))))))
   (pred (pred (pred (pred (pred (pred (data contrived_variable5))))))))))
(assert
 (not
  (=
...
(assert
 (not
  (= (children (car (children (car (children contrived_variable3)))))
   (children (car (children contrived_variable3))))))
(assert
 (not
  (= (children (car (children (car (children contrived_variable3)))))
...
(assert
 (not
  (= (car (children (car (children (car (children contrived_variable3))))))
   (car (children (car (children contrived_variable3)))))))
(assert
 (not
  (= (car (children (car (children (car (children contrived_variable3))))))
...
(assert
 (not
  (= (cdr (children (car (children (car (children contrived_variable3))))))
   (children (car (children (car (children contrived_variable3))))))))
(assert
 (not
  (= (cdr (children (car (children (car (children contrived_variable3))))))
...
(assert
 (not
  (= (pred (data (car (children (car (children contrived_variable3))))))
   (data (car (children (car (children contrived_variable3))))))))
(assert
 (not
  (=
   (pred (pred (data (car (children (car (children contrived_variable3)))))))
   (pred (data (car (children (car (children contrived_variable3)))))))))
(assert
 (not
  (=
...
(assert
 (not
  (= (car (cdr (children (car (children contrived_variable3)))))
   (car (children contrived_variable3)))))
(assert
 (not
  (= (car (cdr (children (car (children contrived_variable3)))))
...
(assert
 (not
  (= (children (car (cdr (children (car (children contrived_variable3))))))
   (cdr (children (car (children contrived_variable3)))))))
(assert
 (not
  (= (children (car (cdr (children (car (children contrived_variable3))))))
...
(assert
 (not
  (=
   (pred (data (car (cdr (children (car (children contrived_variable3)))))))
   (data (car (cdr (children (car (children contrived_variable3)))))))))
(assert
 (not
  (=
   (pred (pred (data (car (cdr (children (car (children
...
(assert
 (not
  (= (cdr (cdr (children (car (children contrived_variable3)))))
   (cdr (children (car (children contrived_variable3)))))))
(assert
 (not
  (= (cdr (cdr (children (car (children contrived_variable3)))))
...
(assert
 (not
  (= (car (cdr (cdr (children (car (children contrived_variable3))))))
   (car (children contrived_variable3)))))
(assert
 (not
  (= (car (cdr (cdr (children (car (children contrived_variable3))))))
...
(assert
 (not
  (=
   (pred (data (car (cdr (cdr (children (car (children
    contrived_variable3))))))))
   (data (car (cdr (cdr (children (car (children contrived_variable3))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (children contrived_variable3))))))
   (cdr (cdr (children (car (children contrived_variable3))))))))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (children contrived_variable3))))))
...
(assert
 (not
  (= (car (cdr (cdr (cdr (children (car (children contrived_variable3)))))))
   (car (children contrived_variable3)))))
(assert
 (not
  (= (car (cdr (cdr (cdr (children (car (children contrived_variable3)))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (children contrived_variable3)))))))
   (cdr (cdr (cdr (children (car (children contrived_variable3)))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (children contrived_variable3)))))))
...
(assert
 (not
  (= (pred (pred (data (car (children contrived_variable3)))))
   (pred (data (car (children contrived_variable3)))))))
(assert
 (not
  (= (pred (pred (data (car (children contrived_variable3)))))
...
(assert
 (not
  (= (pred (pred (pred (data (car (children contrived_variable3))))))
   (pred (pred (data (car (children contrived_variable3))))))))
(assert
 (not
  (= (pred (pred (pred (data (car (children contrived_variable3))))))
...
(assert
 (not
  (= (pred (pred (pred (pred (data (car (children contrived_variable3)))))))
   (pred (pred (pred (data (car (children contrived_variable3)))))))))
(assert
 (not
  (= (pred (pred (pred (pred (data (car (children contrived_variable3)))))))
...
(assert
 (not
  (= (car (children (car (cdr (children contrived_variable3)))))
   (car (cdr (children contrived_variable3))))))
(assert
 (not
  (= (car (children (car (cdr (children contrived_variable3)))))
   contrived_variable3)))
(assert
 (not
  (= (children (car (children (car (cdr (children contrived_variable3))))))
   (children (car (cdr (children contrived_variable3)))))))
(assert
 (not
  (= (children (car (children (car (cdr (children contrived_variable3))))))
...
(assert
 (not
  (=
   (pred (data (car (children (car (cdr (children contrived_variable3)))))))
   (data (car (children (car (cdr (children contrived_variable3)))))))))
(assert
 (not
  (=
   (pred (pred (data (car (children (car (cdr (children
...
(assert
 (not
  (= (cdr (children (car (cdr (children contrived_variable3)))))
   (children (car (cdr (children contrived_variable3)))))))
(assert
 (not
  (= (cdr (children (car (cdr (children contrived_variable3)))))
...
(assert
 (not
  (= (car (cdr (children (car (cdr (children contrived_variable3))))))
   (car (cdr (children contrived_variable3))))))
(assert
 (not
  (= (car (cdr (children (car (cdr (children contrived_variable3))))))
...
(assert
 (not
  (=
   (pred (data (car (cdr (children (car (cdr (children
    contrived_variable3))))))))
   (data (car (cdr (children (car (cdr (children contrived_variable3))))))))))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (children contrived_variable3))))))
   (cdr (children (car (cdr (children contrived_variable3))))))))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (children contrived_variable3))))))
...
(assert
 (not
  (= (car (cdr (cdr (children (car (cdr (children contrived_variable3)))))))
   (car (cdr (children contrived_variable3))))))
(assert
 (not
  (= (car (cdr (cdr (children (car (cdr (children contrived_variable3)))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (children contrived_variable3)))))))
   (cdr (cdr (children (car (cdr (children contrived_variable3)))))))))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (children contrived_variable3)))))))
...
(assert
 (not
  (= (pred (data (car (cdr (children contrived_variable3)))))
   (data (car (cdr (children contrived_variable3)))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (children contrived_variable3))))))
   (pred (data (car (cdr (children contrived_variable3))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (children contrived_variable3))))))
...
(assert
 (not
  (= (pred (pred (pred (data (car (cdr (children contrived_variable3)))))))
   (pred (pred (data (car (cdr (children contrived_variable3)))))))))
(assert
 (not
  (= (pred (pred (pred (data (car (cdr (children contrived_variable3)))))))
...
(assert
 (not
  (= (children (car (cdr (cdr (children contrived_variable3)))))
   (cdr (cdr (children contrived_variable3))))))
(assert
 (not
  (= (children (car (cdr (cdr (children contrived_variable3)))))
...
(assert
 (not
  (= (car (children (car (cdr (cdr (children contrived_variable3))))))
   (car (cdr (cdr (children contrived_variable3)))))))
(assert
 (not
  (= (car (children (car (cdr (cdr (children contrived_variable3))))))
   contrived_variable3)))
...
(assert
 (not
  (=
   (pred (data (car (children (car (cdr (cdr (children
    contrived_variable3))))))))
   (data (car (children (car (cdr (cdr (children contrived_variable3))))))))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (children contrived_variable3))))))
   (children (car (cdr (cdr (children contrived_variable3))))))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (children contrived_variable3))))))
...
(assert
 (not
  (= (car (cdr (children (car (cdr (cdr (children contrived_variable3)))))))
   (car (cdr (cdr (children contrived_variable3)))))))
(assert
 (not
  (= (car (cdr (children (car (cdr (cdr (children contrived_variable3)))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (children contrived_variable3)))))))
   (cdr (children (car (cdr (cdr (children contrived_variable3)))))))))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (children contrived_variable3)))))))
...
(assert
 (not
  (= (pred (data (car (cdr (cdr (children contrived_variable3))))))
   (data (car (cdr (cdr (children contrived_variable3))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (cdr (children contrived_variable3)))))))
   (pred (data (car (cdr (cdr (children contrived_variable3)))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (cdr (children contrived_variable3)))))))
...
(assert
 (not
  (= (car (cdr (cdr (cdr (children contrived_variable3)))))
   contrived_variable3)))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (children contrived_variable3))))))
   (cdr (cdr (cdr (children contrived_variable3)))))))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (children contrived_variable3))))))
...
(assert
 (not
  (= (car (children (car (cdr (cdr (cdr (children contrived_variable3)))))))
   (car (cdr (cdr (cdr (children contrived_variable3))))))))
(assert
 (not
  (= (car (children (car (cdr (cdr (cdr (children contrived_variable3)))))))
...
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (children contrived_variable3)))))))
   (children (car (cdr (cdr (cdr (children contrived_variable3)))))))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (children contrived_variable3)))))))
...
(assert
 (not
  (= (pred (data (car (cdr (cdr (cdr (children contrived_variable3)))))))
   (data (car (cdr (cdr (cdr (children contrived_variable3)))))))))
(assert
 (not
  (=
   (pred (pred (data (car (cdr (cdr (cdr (children contrived_variable3))))))))
   (pred (data (car (cdr (cdr (cdr (children contrived_variable3))))))))))
(assert
 (not
  (=
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children contrived_variable3)))))
   (cdr (cdr (cdr (children contrived_variable3)))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children contrived_variable3)))))
...
(assert
 (not
  (= (car (cdr (cdr (cdr (cdr (children contrived_variable3))))))
   contrived_variable3)))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (children contrived_variable3)))))))
   (cdr (cdr (cdr (cdr (children contrived_variable3))))))))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (children contrived_variable3)))))))
...
(assert
 (not
  (=
   (pred (data (car (cdr (cdr (cdr (cdr (children contrived_variable3))))))))
   (data (car (cdr (cdr (cdr (cdr (children contrived_variable3))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (children contrived_variable3))))))
   (cdr (cdr (cdr (cdr (children contrived_variable3))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (children contrived_variable3))))))
...
(assert
 (not
  (= (car (cdr (cdr (cdr (cdr (cdr (children contrived_variable3)))))))
   contrived_variable3)))
(assert
 (not
  (=
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (children contrived_variable3)))))))
   (cdr (cdr (cdr (cdr (cdr (children contrived_variable3)))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (children contrived_variable3)))))))
...
(assert
 (not
  (= (car (cdr (cdr (cdr (cdr (cdr (cdr (children contrived_variable3))))))))
   contrived_variable3)))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr (children contrived_variable3))))))))
   (cdr (cdr (cdr (cdr (cdr (cdr (children contrived_variable3))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr (children contrived_variable3))))))))
...
(assert
 (not
  (= (pred (pred (pred (pred (data contrived_variable3)))))
   (pred (pred (pred (data contrived_variable3)))))))
(assert
 (not
  (= (pred (pred (pred (pred (data contrived_variable3)))))
...
(assert
 (not
  (= (pred (pred (pred (pred (pred (data contrived_variable3))))))
   (pred (pred (pred (pred (data contrived_variable3))))))))
(assert
 (not
  (= (pred (pred (pred (pred (pred (data contrived_variable3))))))
...
(assert
 (not
  (= (pred (pred (pred (pred (pred (pred (data contrived_variable3)))))))
   (pred (pred (pred (pred (pred (data contrived_variable3)))))))))
(assert
 (not
  (= (pred (pred (pred (pred (pred (pred (data contrived_variable3)))))))
...
(assert
 (not
  (=
   (pred (pred (pred (pred (pred (pred (pred (data contrived_variable3))))))))
   (pred (pred (pred (pred (pred (pred (data contrived_variable3))))))))))
(assert
 (not
  (=
...
(assert
 (not
  (=
   (pred (data (car (cdr (cdr (children (car (children
    contrived_variable0))))))))
   (data (car (cdr (cdr (children (car (children contrived_variable0))))))))))
(assert
 (not
...
(assert
 (not
  (=
   (pred (data (car (cdr (children (car (cdr (children
    contrived_variable0))))))))
   (data (car (cdr (children (car (cdr (children contrived_variable0))))))))))
(assert
 (not
...
(assert
 (not
  (=
   (pred (data (car (children (car (cdr (cdr (children
    contrived_variable0))))))))
   (data (car (children (car (cdr (cdr (children contrived_variable0))))))))))
(assert
 (not
...
(assert
 (not
  (=
   (pred (pred (data (car (cdr (cdr (cdr (children contrived_variable0))))))))
   (pred (data (car (cdr (cdr (cdr (children contrived_variable0))))))))))
(assert
 (not
  (=
...
(assert
 (not
  (=
   (pred (data (car (cdr (cdr (cdr (cdr (children contrived_variable0))))))))
   (data (car (cdr (cdr (cdr (cdr (children contrived_variable0))))))))))
(assert
 (not
...
(assert
 (not
  (= (car (cdr (cdr (cdr (cdr (cdr (cdr (children contrived_variable0))))))))
   contrived_variable0)))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr (children contrived_variable0))))))))
   (cdr (cdr (cdr (cdr (cdr (cdr (children contrived_variable0))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr (children contrived_variable0))))))))
...
(assert
 (not
  (=
   (pred (pred (pred (pred (pred (pred (pred (data contrived_variable0))))))))
   (pred (pred (pred (pred (pred (pred (data contrived_variable0))))))))))
(assert
 (not
  (=
...
(assert
 (not
  (= (car (children (car (children (car (children x15))))))
   (car (children (car (children x15)))))))
(assert
 (not
  (= (car (children (car (children (car (children x15))))))
   (car (children x15)))))
(assert (not (= (car (children (car (children (car (children x15)))))) x15)))
(assert
 (not
  (= (children (car (children (car (children (car (children x15)))))))
   (children (car (children (car (children x15))))))))
(assert
 (not
  (= (children (car (children (car (children (car (children x15)))))))
...
(assert
 (not
  (= (car (children (car (children (car (children (car (children x15))))))))
   (car (children (car (children (car (children x15)))))))))
(assert
 (not
  (= (car (children (car (children (car (children (car (children x15))))))))
...
(assert
 (not
  (= (cdr (children (car (children (car (children (car (children x15))))))))
   (children (car (children (car (children (car (children x15))))))))))
(assert
 (not
  (= (cdr (children (car (children (car (children (car (children x15))))))))
...
(assert
 (not
  (= (pred (data (car (children (car (children (car (children x15))))))))
   (data (car (children (car (children (car (children x15))))))))))
(assert
 (not
  (= (cdr (children (car (children (car (children x15))))))
   (children (car (children (car (children x15))))))))
(assert
 (not
  (= (cdr (children (car (children (car (children x15))))))
...
(assert
 (not
  (= (cdr (children (car (children (car (children x15)))))) (children x15))))
(assert
 (not
  (= (car (cdr (children (car (children (car (children x15)))))))
   (car (children (car (children x15)))))))
(assert
 (not
  (= (car (cdr (children (car (children (car (children x15)))))))
   (car (children x15)))))
(assert
 (not (= (car (cdr (children (car (children (car (children x15))))))) x15)))
(assert
 (not
  (= (children (car (cdr (children (car (children (car (children x15))))))))
   (cdr (children (car (children (car (children x15)))))))))
(assert
 (not
  (= (children (car (cdr (children (car (children (car (children x15))))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (children (car (children x15)))))))
   (cdr (children (car (children (car (children x15)))))))))
(assert
 (not
  (= (cdr (cdr (children (car (children (car (children x15)))))))
...
(assert
 (not
  (= (car (cdr (cdr (children (car (children (car (children x15))))))))
   (car (children (car (children x15)))))))
(assert
 (not
  (= (car (cdr (cdr (children (car (children (car (children x15))))))))
...
(assert
 (not
  (= (car (cdr (cdr (children (car (children (car (children x15)))))))) x15)))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (children (car (children x15))))))))
   (cdr (cdr (children (car (children (car (children x15))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (children (car (children x15))))))))
...
(assert
 (not
  (= (pred (data (car (children (car (children x15))))))
   (data (car (children (car (children x15))))))))
(assert
 (not
  (= (pred (pred (data (car (children (car (children x15)))))))
   (pred (data (car (children (car (children x15)))))))))
(assert
 (not
  (= (pred (pred (data (car (children (car (children x15)))))))
...
(assert
 (not
  (= (pred (pred (pred (data (car (children (car (children x15))))))))
   (pred (pred (data (car (children (car (children x15))))))))))
(assert
 (not
  (= (pred (pred (pred (data (car (children (car (children x15))))))))
...
(assert
 (not
  (= (children (car (cdr (children (car (children x15))))))
...
(assert
 (not
  (= (children (car (cdr (children (car (children x15)))))) (children x15))))
(assert
 (not
  (= (car (children (car (cdr (children (car (children x15)))))))
   (car (cdr (children (car (children x15))))))))
(assert
 (not
  (= (car (children (car (cdr (children (car (children x15)))))))
   (car (children x15)))))
(assert
 (not (= (car (children (car (cdr (children (car (children x15))))))) x15)))
(assert
 (not
  (= (children (car (children (car (cdr (children (car (children x15))))))))
   (children (car (cdr (children (car (children x15)))))))))
(assert
 (not
  (= (children (car (children (car (cdr (children (car (children x15))))))))
...
(assert
 (not
  (= (cdr (children (car (cdr (children (car (children x15)))))))
   (children (car (cdr (children (car (children x15)))))))))
(assert
 (not
  (= (cdr (children (car (cdr (children (car (children x15)))))))
...
(assert
 (not
  (= (car (cdr (children (car (cdr (children (car (children x15))))))))
   (car (cdr (children (car (children x15))))))))
(assert
 (not
  (= (car (cdr (children (car (cdr (children (car (children x15))))))))
...
(assert
 (not
  (= (car (cdr (children (car (cdr (children (car (children x15)))))))) x15)))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (children (car (children x15))))))))
   (cdr (children (car (cdr (children (car (children x15))))))))))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (children (car (children x15))))))))
...
(assert
 (not
  (= (pred (data (car (cdr (children (car (children x15)))))))
   (data (car (cdr (children (car (children x15)))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (children (car (children x15))))))))
   (pred (data (car (cdr (children (car (children x15))))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (children (car (children x15))))))))
...
(assert
 (not
  (= (car (cdr (cdr (children (car (children x15)))))) (car (children x15)))))
(assert (not (= (car (cdr (cdr (children (car (children x15)))))) x15)))
(assert
 (not
  (= (children (car (cdr (cdr (children (car (children x15)))))))
   (cdr (cdr (children (car (children x15))))))))
(assert
 (not
  (= (children (car (cdr (cdr (children (car (children x15)))))))
...
(assert
 (not
  (= (car (children (car (cdr (cdr (children (car (children x15))))))))
   (car (cdr (cdr (children (car (children x15)))))))))
(assert
 (not
  (= (car (children (car (cdr (cdr (children (car (children x15))))))))
   (car (children x15)))))
(assert
 (not
  (= (car (children (car (cdr (cdr (children (car (children x15)))))))) x15)))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (children (car (children x15))))))))
   (children (car (cdr (cdr (children (car (children x15))))))))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (children (car (children x15))))))))
...
(assert
 (not
  (= (pred (data (car (cdr (cdr (children (car (children x15))))))))
   (data (car (cdr (cdr (children (car (children x15))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (children x15))))))
   (cdr (cdr (children (car (children x15))))))))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (children x15))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (children (car (children x15))))))
   (children (car (children x15))))))
(assert
 (not (= (cdr (cdr (cdr (children (car (children x15)))))) (children x15))))
(assert
 (not
  (= (car (cdr (cdr (cdr (children (car (children x15)))))))
   (car (children x15)))))
(assert (not (= (car (cdr (cdr (cdr (children (car (children x15))))))) x15)))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (children (car (children x15))))))))
   (cdr (cdr (cdr (children (car (children x15)))))))))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (children (car (children x15))))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (children x15)))))))
   (cdr (cdr (cdr (children (car (children x15)))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (children x15)))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (children x15))))))) (children x15))))
(assert
 (not
  (= (car (cdr (cdr (cdr (cdr (children (car (children x15))))))))
   (car (children x15)))))
(assert
 (not (= (car (cdr (cdr (cdr (cdr (children (car (children x15)))))))) x15)))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (children (car (children x15))))))))
   (cdr (cdr (cdr (cdr (children (car (children x15))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (children (car (children x15))))))))
...
(assert
 (not
  (= (pred (pred (pred (data (car (children x15))))))
   (pred (pred (data (car (children x15))))))))
(assert
 (not
  (= (pred (pred (pred (data (car (children x15))))))
...
(assert
 (not
  (= (pred (pred (pred (data (car (children x15))))))
   (data (car (children x15))))))
(assert
 (not
  (= (pred (pred (pred (pred (data (car (children x15)))))))
   (pred (pred (pred (data (car (children x15)))))))))
(assert
 (not
  (= (pred (pred (pred (pred (data (car (children x15)))))))
...
(assert
 (not
  (= (pred (pred (pred (pred (pred (data (car (children x15))))))))
   (pred (pred (pred (pred (data (car (children x15))))))))))
(assert
 (not
  (= (pred (pred (pred (pred (pred (data (car (children x15))))))))
...
(assert
 (not
  (= (children (car (children (car (cdr (children x15))))))
...
(assert
 (not
  (= (children (car (children (car (cdr (children x15)))))) (children x15))))
(assert
 (not
  (= (car (children (car (children (car (cdr (children x15)))))))
   (car (children (car (cdr (children x15))))))))
(assert
 (not
  (= (car (children (car (children (car (cdr (children x15)))))))
   (car (cdr (children x15))))))
(assert
 (not (= (car (children (car (children (car (cdr (children x15))))))) x15)))
(assert
 (not
  (= (children (car (children (car (children (car (cdr (children x15))))))))
   (children (car (children (car (cdr (children x15)))))))))
(assert
 (not
  (= (children (car (children (car (children (car (cdr (children x15))))))))
...
(assert
 (not
  (= (cdr (children (car (children (car (cdr (children x15)))))))
   (children (car (children (car (cdr (children x15)))))))))
(assert
 (not
  (= (cdr (children (car (children (car (cdr (children x15)))))))
...
(assert
 (not
  (= (car (cdr (children (car (children (car (cdr (children x15))))))))
   (car (children (car (cdr (children x15))))))))
(assert
 (not
  (= (car (cdr (children (car (children (car (cdr (children x15))))))))
...
(assert
 (not
  (= (car (cdr (children (car (children (car (cdr (children x15)))))))) x15)))
(assert
 (not
  (= (cdr (cdr (children (car (children (car (cdr (children x15))))))))
   (cdr (children (car (children (car (cdr (children x15))))))))))
(assert
 (not
  (= (cdr (cdr (children (car (children (car (cdr (children x15))))))))
...
(assert
 (not
  (= (pred (data (car (children (car (cdr (children x15)))))))
   (data (car (children (car (cdr (children x15)))))))))
(assert
 (not
  (= (pred (pred (data (car (children (car (cdr (children x15))))))))
   (pred (data (car (children (car (cdr (children x15))))))))))
(assert
 (not
  (= (pred (pred (data (car (children (car (cdr (children x15))))))))
...
(assert
 (not
  (= (car (cdr (children (car (cdr (children x15))))))
   (car (cdr (children x15))))))
(assert (not (= (car (cdr (children (car (cdr (children x15)))))) x15)))
(assert
 (not
  (= (children (car (cdr (children (car (cdr (children x15)))))))
   (cdr (children (car (cdr (children x15))))))))
(assert
 (not
  (= (children (car (cdr (children (car (cdr (children x15)))))))
...
(assert
 (not
  (= (car (children (car (cdr (children (car (cdr (children x15))))))))
   (car (cdr (children (car (cdr (children x15)))))))))
(assert
 (not
  (= (car (children (car (cdr (children (car (cdr (children x15))))))))
...
(assert
 (not
  (= (car (children (car (cdr (children (car (cdr (children x15)))))))) x15)))
(assert
 (not
  (= (cdr (children (car (cdr (children (car (cdr (children x15))))))))
   (children (car (cdr (children (car (cdr (children x15))))))))))
(assert
 (not
  (= (cdr (children (car (cdr (children (car (cdr (children x15))))))))
...
(assert
 (not
  (= (pred (data (car (cdr (children (car (cdr (children x15))))))))
   (data (car (cdr (children (car (cdr (children x15))))))))))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (children x15))))))
   (cdr (children (car (cdr (children x15))))))))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (children x15))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (cdr (children x15)))))) (cdr (children x15)))))
(assert
 (not (= (cdr (cdr (children (car (cdr (children x15)))))) (children x15))))
(assert
 (not
  (= (car (cdr (cdr (children (car (cdr (children x15)))))))
   (car (cdr (children x15))))))
(assert (not (= (car (cdr (cdr (children (car (cdr (children x15))))))) x15)))
(assert
 (not
  (= (children (car (cdr (cdr (children (car (cdr (children x15))))))))
   (cdr (cdr (children (car (cdr (children x15)))))))))
(assert
 (not
  (= (children (car (cdr (cdr (children (car (cdr (children x15))))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (children x15)))))))
   (cdr (cdr (children (car (cdr (children x15)))))))))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (children x15)))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (children x15))))))) (children x15))))
(assert
 (not
  (= (car (cdr (cdr (cdr (children (car (cdr (children x15))))))))
   (car (cdr (children x15))))))
(assert
 (not (= (car (cdr (cdr (cdr (children (car (cdr (children x15)))))))) x15)))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (cdr (children x15))))))))
   (cdr (cdr (cdr (children (car (cdr (children x15))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (cdr (children x15))))))))
...
(assert
 (not
  (= (pred (pred (data (car (cdr (children x15))))))
   (pred (data (car (cdr (children x15))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (children x15))))))
...
(assert
 (not
  (= (pred (pred (pred (data (car (cdr (children x15)))))))
   (pred (pred (data (car (cdr (children x15)))))))))
(assert
 (not
  (= (pred (pred (pred (data (car (cdr (children x15)))))))
...
(assert
 (not
  (= (pred (pred (pred (pred (data (car (cdr (children x15))))))))
   (pred (pred (pred (data (car (cdr (children x15))))))))))
(assert
 (not
  (= (pred (pred (pred (pred (data (car (cdr (children x15))))))))
...
(assert
 (not
  (= (car (children (car (cdr (cdr (children x15))))))
   (car (cdr (cdr (children x15)))))))
(assert (not (= (car (children (car (cdr (cdr (children x15)))))) x15)))
(assert
 (not
  (= (children (car (children (car (cdr (cdr (children x15)))))))
   (children (car (cdr (cdr (children x15))))))))
(assert
 (not
  (= (children (car (children (car (cdr (cdr (children x15)))))))
   (cdr (cdr (children x15))))))
(assert
 (not
  (= (children (car (children (car (cdr (cdr (children x15)))))))
   (cdr (children x15)))))
...
(assert
 (not
  (= (car (children (car (children (car (cdr (cdr (children x15))))))))
   (car (children (car (cdr (cdr (children x15)))))))))
(assert
 (not
  (= (car (children (car (children (car (cdr (cdr (children x15))))))))
...
(assert
 (not
  (= (car (children (car (children (car (cdr (cdr (children x15)))))))) x15)))
(assert
 (not
  (= (cdr (children (car (children (car (cdr (cdr (children x15))))))))
   (children (car (children (car (cdr (cdr (children x15))))))))))
(assert
 (not
  (= (cdr (children (car (children (car (cdr (cdr (children x15))))))))
...
(assert
 (not
  (= (pred (data (car (children (car (cdr (cdr (children x15))))))))
   (data (car (children (car (cdr (cdr (children x15))))))))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (children x15))))))
   (children (car (cdr (cdr (children x15))))))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (children x15))))))
...
(assert
 (not
  (= (cdr (children (car (cdr (cdr (children x15)))))) (cdr (children x15)))))
(assert
 (not (= (cdr (children (car (cdr (cdr (children x15)))))) (children x15))))
(assert
 (not
  (= (car (cdr (children (car (cdr (cdr (children x15)))))))
   (car (cdr (cdr (children x15)))))))
(assert (not (= (car (cdr (children (car (cdr (cdr (children x15))))))) x15)))
(assert
 (not
  (= (children (car (cdr (children (car (cdr (cdr (children x15))))))))
   (cdr (children (car (cdr (cdr (children x15)))))))))
(assert
 (not
  (= (children (car (cdr (children (car (cdr (cdr (children x15))))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (children x15)))))))
   (cdr (children (car (cdr (cdr (children x15)))))))))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (children x15)))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (children x15))))))) (children x15))))
(assert
 (not
  (= (car (cdr (cdr (children (car (cdr (cdr (children x15))))))))
   (car (cdr (cdr (children x15)))))))
(assert
 (not (= (car (cdr (cdr (children (car (cdr (cdr (children x15)))))))) x15)))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (cdr (children x15))))))))
   (cdr (cdr (children (car (cdr (cdr (children x15))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (cdr (children x15))))))))
...
(assert
 (not
  (= (pred (data (car (cdr (cdr (children x15))))))
   (data (car (cdr (cdr (children x15))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (cdr (children x15)))))))
   (pred (data (car (cdr (cdr (children x15)))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (cdr (children x15)))))))
...
(assert
 (not
  (= (pred (pred (pred (data (car (cdr (cdr (children x15))))))))
   (pred (pred (data (car (cdr (cdr (children x15))))))))))
(assert
 (not
  (= (pred (pred (pred (data (car (cdr (cdr (children x15))))))))
...
(assert
 (not
  (= (children (car (cdr (cdr (cdr (children x15))))))
   (cdr (cdr (cdr (children x15)))))))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (children x15))))))
   (cdr (cdr (children x15))))))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (children x15)))))) (cdr (children x15)))))
(assert
 (not (= (children (car (cdr (cdr (cdr (children x15)))))) (children x15))))
(assert
 (not
  (= (car (children (car (cdr (cdr (cdr (children x15)))))))
   (car (cdr (cdr (cdr (children x15))))))))
(assert (not (= (car (children (car (cdr (cdr (cdr (children x15))))))) x15)))
(assert
 (not
  (= (children (car (children (car (cdr (cdr (cdr (children x15))))))))
   (children (car (cdr (cdr (cdr (children x15)))))))))
(assert
 (not
  (= (children (car (children (car (cdr (cdr (cdr (children x15))))))))
...
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (children x15)))))))
   (children (car (cdr (cdr (cdr (children x15)))))))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (children x15)))))))
...
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (children x15))))))) (children x15))))
(assert
 (not
  (= (car (cdr (children (car (cdr (cdr (cdr (children x15))))))))
   (car (cdr (cdr (cdr (children x15))))))))
(assert
 (not (= (car (cdr (children (car (cdr (cdr (cdr (children x15)))))))) x15)))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (cdr (children x15))))))))
   (cdr (children (car (cdr (cdr (cdr (children x15))))))))))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (cdr (children x15))))))))
...
(assert
 (not
  (= (pred (data (car (cdr (cdr (cdr (children x15)))))))
   (data (car (cdr (cdr (cdr (children x15)))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (cdr (cdr (children x15))))))))
   (pred (data (car (cdr (cdr (cdr (children x15))))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (cdr (cdr (children x15))))))))
...
(assert (not (= (car (cdr (cdr (cdr (cdr (children x15)))))) x15)))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (children x15)))))))
   (cdr (cdr (cdr (cdr (children x15))))))))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (children x15)))))))
   (cdr (cdr (cdr (children x15)))))))
...
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (children x15))))))) (children x15))))
(assert
 (not
  (= (car (children (car (cdr (cdr (cdr (cdr (children x15))))))))
   (car (cdr (cdr (cdr (cdr (children x15)))))))))
(assert
 (not (= (car (children (car (cdr (cdr (cdr (cdr (children x15)))))))) x15)))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (cdr (children x15))))))))
   (children (car (cdr (cdr (cdr (cdr (children x15))))))))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (cdr (children x15))))))))
...
(assert
 (not
  (= (pred (data (car (cdr (cdr (cdr (cdr (children x15))))))))
   (data (car (cdr (cdr (cdr (cdr (children x15))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (children x15))))))
   (cdr (cdr (cdr (cdr (children x15))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (children x15))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (children x15)))))) (cdr (cdr (children x15))))))
(assert
 (not (= (cdr (cdr (cdr (cdr (cdr (children x15)))))) (cdr (children x15)))))
(assert (not (= (cdr (cdr (cdr (cdr (cdr (children x15)))))) (children x15))))
(assert (not (= (car (cdr (cdr (cdr (cdr (cdr (children x15))))))) x15)))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (cdr (children x15))))))))
   (cdr (cdr (cdr (cdr (cdr (children x15)))))))))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (cdr (children x15))))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (children x15)))))))
   (cdr (cdr (cdr (cdr (cdr (children x15)))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (children x15)))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (children x15))))))) (cdr (children x15)))))
(assert
 (not (= (cdr (cdr (cdr (cdr (cdr (cdr (children x15))))))) (children x15))))
(assert
 (not (= (car (cdr (cdr (cdr (cdr (cdr (cdr (children x15)))))))) x15)))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr (children x15))))))))
   (cdr (cdr (cdr (cdr (cdr (cdr (children x15))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr (children x15))))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr (children x15)))))))) (children x15))))
...
(assert
 (not
  (= (pred (pred (pred (pred (pred (data x15))))))
   (pred (pred (pred (pred (data x15))))))))
(assert
 (not
  (= (pred (pred (pred (pred (pred (data x15))))))
   (pred (pred (pred (data x15)))))))
(assert
 (not
  (= (pred (pred (pred (pred (pred (data x15)))))) (pred (pred (data x15))))))
(assert
 (not (= (pred (pred (pred (pred (pred (data x15)))))) (pred (data x15)))))
(assert (not (= (pred (pred (pred (pred (pred (data x15)))))) (data x15))))
(assert
 (not
  (= (pred (pred (pred (pred (pred (pred (data x15)))))))
   (pred (pred (pred (pred (pred (data x15)))))))))
(assert
 (not
  (= (pred (pred (pred (pred (pred (pred (data x15)))))))
...
(assert
 (not
  (= (pred (pred (pred (pred (pred (pred (data x15))))))) (pred (data x15)))))
(assert
 (not (= (pred (pred (pred (pred (pred (pred (data x15))))))) (data x15))))
(assert
 (not
  (= (pred (pred (pred (pred (pred (pred (pred (data x15))))))))
   (pred (pred (pred (pred (pred (pred (data x15))))))))))
(assert
 (not
  (= (pred (pred (pred (pred (pred (pred (pred (data x15))))))))
...
(assert
 (not
  (= (pred (pred (pred (pred (pred (pred (pred (data x15)))))))) (data x15))))
...
(assert
 (not
  (= (car (children (car (children (car (children x14))))))
   (car (children (car (children x14)))))))
(assert
 (not
  (= (car (children (car (children (car (children x14))))))
   (car (children x14)))))
(assert (not (= (car (children (car (children (car (children x14)))))) x14)))
(assert
 (not
  (= (children (car (children (car (children (car (children x14)))))))
   (children (car (children (car (children x14))))))))
(assert
 (not
  (= (children (car (children (car (children (car (children x14)))))))
...
(assert
 (not
  (= (car (children (car (children (car (children (car (children x14))))))))
   (car (children (car (children (car (children x14)))))))))
(assert
 (not
  (= (car (children (car (children (car (children (car (children x14))))))))
...
(assert
 (not
  (= (cdr (children (car (children (car (children (car (children x14))))))))
   (children (car (children (car (children (car (children x14))))))))))
(assert
 (not
  (= (cdr (children (car (children (car (children (car (children x14))))))))
...
(assert
 (not
  (= (pred (data (car (children (car (children (car (children x14))))))))
   (data (car (children (car (children (car (children x14))))))))))
(assert
 (not
  (= (cdr (children (car (children (car (children x14))))))
   (children (car (children (car (children x14))))))))
(assert
 (not
  (= (cdr (children (car (children (car (children x14))))))
...
(assert
 (not
  (= (cdr (children (car (children (car (children x14)))))) (children x14))))
(assert
 (not
  (= (car (cdr (children (car (children (car (children x14)))))))
   (car (children (car (children x14)))))))
(assert
 (not
  (= (car (cdr (children (car (children (car (children x14)))))))
   (car (children x14)))))
(assert
 (not (= (car (cdr (children (car (children (car (children x14))))))) x14)))
(assert
 (not
  (= (children (car (cdr (children (car (children (car (children x14))))))))
   (cdr (children (car (children (car (children x14)))))))))
(assert
 (not
  (= (children (car (cdr (children (car (children (car (children x14))))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (children (car (children x14)))))))
   (cdr (children (car (children (car (children x14)))))))))
(assert
 (not
  (= (cdr (cdr (children (car (children (car (children x14)))))))
...
(assert
 (not
  (= (car (cdr (cdr (children (car (children (car (children x14))))))))
   (car (children (car (children x14)))))))
(assert
 (not
  (= (car (cdr (cdr (children (car (children (car (children x14))))))))
...
(assert
 (not
  (= (car (cdr (cdr (children (car (children (car (children x14)))))))) x14)))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (children (car (children x14))))))))
   (cdr (cdr (children (car (children (car (children x14))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (children (car (children x14))))))))
...
(assert
 (not
  (= (pred (data (car (children (car (children x14))))))
   (data (car (children (car (children x14))))))))
(assert
 (not
  (= (pred (pred (data (car (children (car (children x14)))))))
   (pred (data (car (children (car (children x14)))))))))
(assert
 (not
  (= (pred (pred (data (car (children (car (children x14)))))))
...
(assert
 (not
  (= (pred (pred (pred (data (car (children (car (children x14))))))))
   (pred (pred (data (car (children (car (children x14))))))))))
(assert
 (not
  (= (pred (pred (pred (data (car (children (car (children x14))))))))
...
(assert
 (not
  (= (children (car (cdr (children (car (children x14))))))
...
(assert
 (not
  (= (children (car (cdr (children (car (children x14)))))) (children x14))))
(assert
 (not
  (= (car (children (car (cdr (children (car (children x14)))))))
   (car (cdr (children (car (children x14))))))))
(assert
 (not
  (= (car (children (car (cdr (children (car (children x14)))))))
   (car (children x14)))))
(assert
 (not (= (car (children (car (cdr (children (car (children x14))))))) x14)))
(assert
 (not
  (= (children (car (children (car (cdr (children (car (children x14))))))))
   (children (car (cdr (children (car (children x14)))))))))
(assert
 (not
  (= (children (car (children (car (cdr (children (car (children x14))))))))
...
(assert
 (not
  (= (cdr (children (car (cdr (children (car (children x14)))))))
   (children (car (cdr (children (car (children x14)))))))))
(assert
 (not
  (= (cdr (children (car (cdr (children (car (children x14)))))))
...
(assert
 (not
  (= (car (cdr (children (car (cdr (children (car (children x14))))))))
   (car (cdr (children (car (children x14))))))))
(assert
 (not
  (= (car (cdr (children (car (cdr (children (car (children x14))))))))
...
(assert
 (not
  (= (car (cdr (children (car (cdr (children (car (children x14)))))))) x14)))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (children (car (children x14))))))))
   (cdr (children (car (cdr (children (car (children x14))))))))))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (children (car (children x14))))))))
...
(assert
 (not
  (= (pred (data (car (cdr (children (car (children x14)))))))
   (data (car (cdr (children (car (children x14)))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (children (car (children x14))))))))
   (pred (data (car (cdr (children (car (children x14))))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (children (car (children x14))))))))
...
(assert
 (not
  (= (car (cdr (cdr (children (car (children x14)))))) (car (children x14)))))
(assert (not (= (car (cdr (cdr (children (car (children x14)))))) x14)))
(assert
 (not
  (= (children (car (cdr (cdr (children (car (children x14)))))))
   (cdr (cdr (children (car (children x14))))))))
(assert
 (not
  (= (children (car (cdr (cdr (children (car (children x14)))))))
...
(assert
 (not
  (= (car (children (car (cdr (cdr (children (car (children x14))))))))
   (car (cdr (cdr (children (car (children x14)))))))))
(assert
 (not
  (= (car (children (car (cdr (cdr (children (car (children x14))))))))
   (car (children x14)))))
(assert
 (not
  (= (car (children (car (cdr (cdr (children (car (children x14)))))))) x14)))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (children (car (children x14))))))))
   (children (car (cdr (cdr (children (car (children x14))))))))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (children (car (children x14))))))))
...
(assert
 (not
  (= (pred (data (car (cdr (cdr (children (car (children x14))))))))
   (data (car (cdr (cdr (children (car (children x14))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (children x14))))))
   (cdr (cdr (children (car (children x14))))))))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (children x14))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (children (car (children x14))))))
   (children (car (children x14))))))
(assert
 (not (= (cdr (cdr (cdr (children (car (children x14)))))) (children x14))))
(assert
 (not
  (= (car (cdr (cdr (cdr (children (car (children x14)))))))
   (car (children x14)))))
(assert (not (= (car (cdr (cdr (cdr (children (car (children x14))))))) x14)))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (children (car (children x14))))))))
   (cdr (cdr (cdr (children (car (children x14)))))))))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (children (car (children x14))))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (children x14)))))))
   (cdr (cdr (cdr (children (car (children x14)))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (children x14)))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (children x14))))))) (children x14))))
(assert
 (not
  (= (car (cdr (cdr (cdr (cdr (children (car (children x14))))))))
   (car (children x14)))))
(assert
 (not (= (car (cdr (cdr (cdr (cdr (children (car (children x14)))))))) x14)))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (children (car (children x14))))))))
   (cdr (cdr (cdr (cdr (children (car (children x14))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (children (car (children x14))))))))
...
(assert
 (not
  (= (pred (pred (pred (data (car (children x14))))))
   (pred (pred (data (car (children x14))))))))
(assert
 (not
  (= (pred (pred (pred (data (car (children x14))))))
...
(assert
 (not
  (= (pred (pred (pred (data (car (children x14))))))
   (data (car (children x14))))))
(assert
 (not
  (= (pred (pred (pred (pred (data (car (children x14)))))))
   (pred (pred (pred (data (car (children x14)))))))))
(assert
 (not
  (= (pred (pred (pred (pred (data (car (children x14)))))))
...
(assert
 (not
  (= (pred (pred (pred (pred (pred (data (car (children x14))))))))
   (pred (pred (pred (pred (data (car (children x14))))))))))
(assert
 (not
  (= (pred (pred (pred (pred (pred (data (car (children x14))))))))
...
(assert
 (not
  (= (children (car (children (car (cdr (children x14))))))
...
(assert
 (not
  (= (children (car (children (car (cdr (children x14)))))) (children x14))))
(assert
 (not
  (= (car (children (car (children (car (cdr (children x14)))))))
   (car (children (car (cdr (children x14))))))))
(assert
 (not
  (= (car (children (car (children (car (cdr (children x14)))))))
   (car (cdr (children x14))))))
(assert
 (not (= (car (children (car (children (car (cdr (children x14))))))) x14)))
(assert
 (not
  (= (children (car (children (car (children (car (cdr (children x14))))))))
   (children (car (children (car (cdr (children x14)))))))))
(assert
 (not
  (= (children (car (children (car (children (car (cdr (children x14))))))))
...
(assert
 (not
  (= (cdr (children (car (children (car (cdr (children x14)))))))
   (children (car (children (car (cdr (children x14)))))))))
(assert
 (not
  (= (cdr (children (car (children (car (cdr (children x14)))))))
...
(assert
 (not
  (= (car (cdr (children (car (children (car (cdr (children x14))))))))
   (car (children (car (cdr (children x14))))))))
(assert
 (not
  (= (car (cdr (children (car (children (car (cdr (children x14))))))))
...
(assert
 (not
  (= (car (cdr (children (car (children (car (cdr (children x14)))))))) x14)))
(assert
 (not
  (= (cdr (cdr (children (car (children (car (cdr (children x14))))))))
   (cdr (children (car (children (car (cdr (children x14))))))))))
(assert
 (not
  (= (cdr (cdr (children (car (children (car (cdr (children x14))))))))
...
(assert
 (not
  (= (pred (data (car (children (car (cdr (children x14)))))))
   (data (car (children (car (cdr (children x14)))))))))
(assert
 (not
  (= (pred (pred (data (car (children (car (cdr (children x14))))))))
   (pred (data (car (children (car (cdr (children x14))))))))))
(assert
 (not
  (= (pred (pred (data (car (children (car (cdr (children x14))))))))
...
(assert
 (not
  (= (car (cdr (children (car (cdr (children x14))))))
   (car (cdr (children x14))))))
(assert (not (= (car (cdr (children (car (cdr (children x14)))))) x14)))
(assert
 (not
  (= (children (car (cdr (children (car (cdr (children x14)))))))
   (cdr (children (car (cdr (children x14))))))))
(assert
 (not
  (= (children (car (cdr (children (car (cdr (children x14)))))))
...
(assert
 (not
  (= (car (children (car (cdr (children (car (cdr (children x14))))))))
   (car (cdr (children (car (cdr (children x14)))))))))
(assert
 (not
  (= (car (children (car (cdr (children (car (cdr (children x14))))))))
...
(assert
 (not
  (= (car (children (car (cdr (children (car (cdr (children x14)))))))) x14)))
(assert
 (not
  (= (cdr (children (car (cdr (children (car (cdr (children x14))))))))
   (children (car (cdr (children (car (cdr (children x14))))))))))
(assert
 (not
  (= (cdr (children (car (cdr (children (car (cdr (children x14))))))))
...
(assert
 (not
  (= (pred (data (car (cdr (children (car (cdr (children x14))))))))
   (data (car (cdr (children (car (cdr (children x14))))))))))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (children x14))))))
   (cdr (children (car (cdr (children x14))))))))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (children x14))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (cdr (children x14)))))) (cdr (children x14)))))
(assert
 (not (= (cdr (cdr (children (car (cdr (children x14)))))) (children x14))))
(assert
 (not
  (= (car (cdr (cdr (children (car (cdr (children x14)))))))
   (car (cdr (children x14))))))
(assert (not (= (car (cdr (cdr (children (car (cdr (children x14))))))) x14)))
(assert
 (not
  (= (children (car (cdr (cdr (children (car (cdr (children x14))))))))
   (cdr (cdr (children (car (cdr (children x14)))))))))
(assert
 (not
  (= (children (car (cdr (cdr (children (car (cdr (children x14))))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (children x14)))))))
   (cdr (cdr (children (car (cdr (children x14)))))))))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (children x14)))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (children x14))))))) (children x14))))
(assert
 (not
  (= (car (cdr (cdr (cdr (children (car (cdr (children x14))))))))
   (car (cdr (children x14))))))
(assert
 (not (= (car (cdr (cdr (cdr (children (car (cdr (children x14)))))))) x14)))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (cdr (children x14))))))))
   (cdr (cdr (cdr (children (car (cdr (children x14))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (cdr (children x14))))))))
...
(assert
 (not
  (= (pred (pred (data (car (cdr (children x14))))))
   (pred (data (car (cdr (children x14))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (children x14))))))
...
(assert
 (not
  (= (pred (pred (pred (data (car (cdr (children x14)))))))
   (pred (pred (data (car (cdr (children x14)))))))))
(assert
 (not
  (= (pred (pred (pred (data (car (cdr (children x14)))))))
...
(assert
 (not
  (= (pred (pred (pred (pred (data (car (cdr (children x14))))))))
   (pred (pred (pred (data (car (cdr (children x14))))))))))
(assert
 (not
  (= (pred (pred (pred (pred (data (car (cdr (children x14))))))))
...
(assert
 (not
  (= (car (children (car (cdr (cdr (children x14))))))
   (car (cdr (cdr (children x14)))))))
(assert (not (= (car (children (car (cdr (cdr (children x14)))))) x14)))
(assert
 (not
  (= (children (car (children (car (cdr (cdr (children x14)))))))
   (children (car (cdr (cdr (children x14))))))))
(assert
 (not
  (= (children (car (children (car (cdr (cdr (children x14)))))))
   (cdr (cdr (children x14))))))
(assert
 (not
  (= (children (car (children (car (cdr (cdr (children x14)))))))
   (cdr (children x14)))))
...
(assert
 (not
  (= (car (children (car (children (car (cdr (cdr (children x14))))))))
   (car (children (car (cdr (cdr (children x14)))))))))
(assert
 (not
  (= (car (children (car (children (car (cdr (cdr (children x14))))))))
...
(assert
 (not
  (= (car (children (car (children (car (cdr (cdr (children x14)))))))) x14)))
(assert
 (not
  (= (cdr (children (car (children (car (cdr (cdr (children x14))))))))
   (children (car (children (car (cdr (cdr (children x14))))))))))
(assert
 (not
  (= (cdr (children (car (children (car (cdr (cdr (children x14))))))))
...
(assert
 (not
  (= (pred (data (car (children (car (cdr (cdr (children x14))))))))
   (data (car (children (car (cdr (cdr (children x14))))))))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (children x14))))))
   (children (car (cdr (cdr (children x14))))))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (children x14))))))
...
(assert
 (not
  (= (cdr (children (car (cdr (cdr (children x14)))))) (cdr (children x14)))))
(assert
 (not (= (cdr (children (car (cdr (cdr (children x14)))))) (children x14))))
(assert
 (not
  (= (car (cdr (children (car (cdr (cdr (children x14)))))))
   (car (cdr (cdr (children x14)))))))
(assert (not (= (car (cdr (children (car (cdr (cdr (children x14))))))) x14)))
(assert
 (not
  (= (children (car (cdr (children (car (cdr (cdr (children x14))))))))
   (cdr (children (car (cdr (cdr (children x14)))))))))
(assert
 (not
  (= (children (car (cdr (children (car (cdr (cdr (children x14))))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (children x14)))))))
   (cdr (children (car (cdr (cdr (children x14)))))))))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (children x14)))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (children x14))))))) (children x14))))
(assert
 (not
  (= (car (cdr (cdr (children (car (cdr (cdr (children x14))))))))
   (car (cdr (cdr (children x14)))))))
(assert
 (not (= (car (cdr (cdr (children (car (cdr (cdr (children x14)))))))) x14)))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (cdr (children x14))))))))
   (cdr (cdr (children (car (cdr (cdr (children x14))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (cdr (children x14))))))))
...
(assert
 (not
  (= (pred (data (car (cdr (cdr (children x14))))))
   (data (car (cdr (cdr (children x14))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (cdr (children x14)))))))
   (pred (data (car (cdr (cdr (children x14)))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (cdr (children x14)))))))
...
(assert
 (not
  (= (pred (pred (pred (data (car (cdr (cdr (children x14))))))))
   (pred (pred (data (car (cdr (cdr (children x14))))))))))
(assert
 (not
  (= (pred (pred (pred (data (car (cdr (cdr (children x14))))))))
...
(assert
 (not
  (= (children (car (cdr (cdr (cdr (children x14))))))
   (cdr (cdr (cdr (children x14)))))))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (children x14))))))
   (cdr (cdr (children x14))))))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (children x14)))))) (cdr (children x14)))))
(assert
 (not (= (children (car (cdr (cdr (cdr (children x14)))))) (children x14))))
(assert
 (not
  (= (car (children (car (cdr (cdr (cdr (children x14)))))))
   (car (cdr (cdr (cdr (children x14))))))))
(assert (not (= (car (children (car (cdr (cdr (cdr (children x14))))))) x14)))
(assert
 (not
  (= (children (car (children (car (cdr (cdr (cdr (children x14))))))))
   (children (car (cdr (cdr (cdr (children x14)))))))))
(assert
 (not
  (= (children (car (children (car (cdr (cdr (cdr (children x14))))))))
...
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (children x14)))))))
   (children (car (cdr (cdr (cdr (children x14)))))))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (children x14)))))))
...
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (children x14))))))) (children x14))))
(assert
 (not
  (= (car (cdr (children (car (cdr (cdr (cdr (children x14))))))))
   (car (cdr (cdr (cdr (children x14))))))))
(assert
 (not (= (car (cdr (children (car (cdr (cdr (cdr (children x14)))))))) x14)))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (cdr (children x14))))))))
   (cdr (children (car (cdr (cdr (cdr (children x14))))))))))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (cdr (children x14))))))))
...
(assert
 (not
  (= (pred (data (car (cdr (cdr (cdr (children x14)))))))
   (data (car (cdr (cdr (cdr (children x14)))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (cdr (cdr (children x14))))))))
   (pred (data (car (cdr (cdr (cdr (children x14))))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (cdr (cdr (children x14))))))))
...
(assert (not (= (car (cdr (cdr (cdr (cdr (children x14)))))) x14)))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (children x14)))))))
   (cdr (cdr (cdr (cdr (children x14))))))))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (children x14)))))))
   (cdr (cdr (cdr (children x14)))))))
...
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (children x14))))))) (children x14))))
(assert
 (not
  (= (car (children (car (cdr (cdr (cdr (cdr (children x14))))))))
   (car (cdr (cdr (cdr (cdr (children x14)))))))))
(assert
 (not (= (car (children (car (cdr (cdr (cdr (cdr (children x14)))))))) x14)))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (cdr (children x14))))))))
   (children (car (cdr (cdr (cdr (cdr (children x14))))))))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (cdr (children x14))))))))
...
(assert
 (not
  (= (pred (data (car (cdr (cdr (cdr (cdr (children x14))))))))
   (data (car (cdr (cdr (cdr (cdr (children x14))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (children x14))))))
   (cdr (cdr (cdr (cdr (children x14))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (children x14))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (children x14)))))) (cdr (cdr (children x14))))))
(assert
 (not (= (cdr (cdr (cdr (cdr (cdr (children x14)))))) (cdr (children x14)))))
(assert (not (= (cdr (cdr (cdr (cdr (cdr (children x14)))))) (children x14))))
(assert (not (= (car (cdr (cdr (cdr (cdr (cdr (children x14))))))) x14)))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (cdr (children x14))))))))
   (cdr (cdr (cdr (cdr (cdr (children x14)))))))))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (cdr (children x14))))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (children x14)))))))
   (cdr (cdr (cdr (cdr (cdr (children x14)))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (children x14)))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (children x14))))))) (cdr (children x14)))))
(assert
 (not (= (cdr (cdr (cdr (cdr (cdr (cdr (children x14))))))) (children x14))))
(assert
 (not (= (car (cdr (cdr (cdr (cdr (cdr (cdr (children x14)))))))) x14)))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr (children x14))))))))
   (cdr (cdr (cdr (cdr (cdr (cdr (children x14))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr (children x14))))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr (children x14)))))))) (children x14))))
...
(assert
 (not
  (= (pred (pred (pred (pred (pred (data x14))))))
   (pred (pred (pred (pred (data x14))))))))
(assert
 (not
  (= (pred (pred (pred (pred (pred (data x14))))))
   (pred (pred (pred (data x14)))))))
(assert
 (not
  (= (pred (pred (pred (pred (pred (data x14)))))) (pred (pred (data x14))))))
(assert
 (not (= (pred (pred (pred (pred (pred (data x14)))))) (pred (data x14)))))
(assert (not (= (pred (pred (pred (pred (pred (data x14)))))) (data x14))))
(assert
 (not
  (= (pred (pred (pred (pred (pred (pred (data x14)))))))
   (pred (pred (pred (pred (pred (data x14)))))))))
(assert
 (not
  (= (pred (pred (pred (pred (pred (pred (data x14)))))))
...
(assert
 (not
  (= (pred (pred (pred (pred (pred (pred (data x14))))))) (pred (data x14)))))
(assert
 (not (= (pred (pred (pred (pred (pred (pred (data x14))))))) (data x14))))
(assert
 (not
  (= (pred (pred (pred (pred (pred (pred (pred (data x14))))))))
   (pred (pred (pred (pred (pred (pred (data x14))))))))))
(assert
 (not
  (= (pred (pred (pred (pred (pred (pred (pred (data x14))))))))
...
(assert
 (not
  (= (pred (pred (pred (pred (pred (pred (pred (data x14)))))))) (data x14))))
...
(assert
 (not
  (= (car (children (car (children (car (children x13))))))
   (car (children (car (children x13)))))))
(assert
 (not
  (= (car (children (car (children (car (children x13))))))
   (car (children x13)))))
(assert (not (= (car (children (car (children (car (children x13)))))) x13)))
(assert
 (not
  (= (children (car (children (car (children (car (children x13)))))))
   (children (car (children (car (children x13))))))))
(assert
 (not
  (= (children (car (children (car (children (car (children x13)))))))
...
(assert
 (not
  (= (car (children (car (children (car (children (car (children x13))))))))
   (car (children (car (children (car (children x13)))))))))
(assert
 (not
  (= (car (children (car (children (car (children (car (children x13))))))))
...
(assert
 (not
  (= (cdr (children (car (children (car (children (car (children x13))))))))
   (children (car (children (car (children (car (children x13))))))))))
(assert
 (not
  (= (cdr (children (car (children (car (children (car (children x13))))))))
...
(assert
 (not
  (= (pred (data (car (children (car (children (car (children x13))))))))
   (data (car (children (car (children (car (children x13))))))))))
(assert
 (not
  (= (cdr (children (car (children (car (children x13))))))
   (children (car (children (car (children x13))))))))
(assert
 (not
  (= (cdr (children (car (children (car (children x13))))))
...
(assert
 (not
  (= (cdr (children (car (children (car (children x13)))))) (children x13))))
(assert
 (not
  (= (car (cdr (children (car (children (car (children x13)))))))
   (car (children (car (children x13)))))))
(assert
 (not
  (= (car (cdr (children (car (children (car (children x13)))))))
   (car (children x13)))))
(assert
 (not (= (car (cdr (children (car (children (car (children x13))))))) x13)))
(assert
 (not
  (= (children (car (cdr (children (car (children (car (children x13))))))))
   (cdr (children (car (children (car (children x13)))))))))
(assert
 (not
  (= (children (car (cdr (children (car (children (car (children x13))))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (children (car (children x13)))))))
   (cdr (children (car (children (car (children x13)))))))))
(assert
 (not
  (= (cdr (cdr (children (car (children (car (children x13)))))))
...
(assert
 (not
  (= (car (cdr (cdr (children (car (children (car (children x13))))))))
   (car (children (car (children x13)))))))
(assert
 (not
  (= (car (cdr (cdr (children (car (children (car (children x13))))))))
...
(assert
 (not
  (= (car (cdr (cdr (children (car (children (car (children x13)))))))) x13)))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (children (car (children x13))))))))
   (cdr (cdr (children (car (children (car (children x13))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (children (car (children x13))))))))
...
(assert
 (not
  (= (pred (data (car (children (car (children x13))))))
   (data (car (children (car (children x13))))))))
(assert
 (not
  (= (pred (pred (data (car (children (car (children x13)))))))
   (pred (data (car (children (car (children x13)))))))))
(assert
 (not
  (= (pred (pred (data (car (children (car (children x13)))))))
...
(assert
 (not
  (= (pred (pred (pred (data (car (children (car (children x13))))))))
   (pred (pred (data (car (children (car (children x13))))))))))
(assert
 (not
  (= (pred (pred (pred (data (car (children (car (children x13))))))))
...
(assert
 (not
  (= (children (car (cdr (children (car (children x13))))))
...
(assert
 (not
  (= (children (car (cdr (children (car (children x13)))))) (children x13))))
(assert
 (not
  (= (car (children (car (cdr (children (car (children x13)))))))
   (car (cdr (children (car (children x13))))))))
(assert
 (not
  (= (car (children (car (cdr (children (car (children x13)))))))
   (car (children x13)))))
(assert
 (not (= (car (children (car (cdr (children (car (children x13))))))) x13)))
(assert
 (not
  (= (children (car (children (car (cdr (children (car (children x13))))))))
   (children (car (cdr (children (car (children x13)))))))))
(assert
 (not
  (= (children (car (children (car (cdr (children (car (children x13))))))))
...
(assert
 (not
  (= (cdr (children (car (cdr (children (car (children x13)))))))
   (children (car (cdr (children (car (children x13)))))))))
(assert
 (not
  (= (cdr (children (car (cdr (children (car (children x13)))))))
...
(assert
 (not
  (= (car (cdr (children (car (cdr (children (car (children x13))))))))
   (car (cdr (children (car (children x13))))))))
(assert
 (not
  (= (car (cdr (children (car (cdr (children (car (children x13))))))))
...
(assert
 (not
  (= (car (cdr (children (car (cdr (children (car (children x13)))))))) x13)))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (children (car (children x13))))))))
   (cdr (children (car (cdr (children (car (children x13))))))))))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (children (car (children x13))))))))
...
(assert
 (not
  (= (pred (data (car (cdr (children (car (children x13)))))))
   (data (car (cdr (children (car (children x13)))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (children (car (children x13))))))))
   (pred (data (car (cdr (children (car (children x13))))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (children (car (children x13))))))))
...
(assert
 (not
  (= (car (cdr (cdr (children (car (children x13)))))) (car (children x13)))))
(assert (not (= (car (cdr (cdr (children (car (children x13)))))) x13)))
(assert
 (not
  (= (children (car (cdr (cdr (children (car (children x13)))))))
   (cdr (cdr (children (car (children x13))))))))
(assert
 (not
  (= (children (car (cdr (cdr (children (car (children x13)))))))
...
(assert
 (not
  (= (car (children (car (cdr (cdr (children (car (children x13))))))))
   (car (cdr (cdr (children (car (children x13)))))))))
(assert
 (not
  (= (car (children (car (cdr (cdr (children (car (children x13))))))))
   (car (children x13)))))
(assert
 (not
  (= (car (children (car (cdr (cdr (children (car (children x13)))))))) x13)))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (children (car (children x13))))))))
   (children (car (cdr (cdr (children (car (children x13))))))))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (children (car (children x13))))))))
...
(assert
 (not
  (= (pred (data (car (cdr (cdr (children (car (children x13))))))))
   (data (car (cdr (cdr (children (car (children x13))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (children x13))))))
   (cdr (cdr (children (car (children x13))))))))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (children x13))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (children (car (children x13))))))
   (children (car (children x13))))))
(assert
 (not (= (cdr (cdr (cdr (children (car (children x13)))))) (children x13))))
(assert
 (not
  (= (car (cdr (cdr (cdr (children (car (children x13)))))))
   (car (children x13)))))
(assert (not (= (car (cdr (cdr (cdr (children (car (children x13))))))) x13)))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (children (car (children x13))))))))
   (cdr (cdr (cdr (children (car (children x13)))))))))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (children (car (children x13))))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (children x13)))))))
   (cdr (cdr (cdr (children (car (children x13)))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (children x13)))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (children x13))))))) (children x13))))
(assert
 (not
  (= (car (cdr (cdr (cdr (cdr (children (car (children x13))))))))
   (car (children x13)))))
(assert
 (not (= (car (cdr (cdr (cdr (cdr (children (car (children x13)))))))) x13)))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (children (car (children x13))))))))
   (cdr (cdr (cdr (cdr (children (car (children x13))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (children (car (children x13))))))))
...
(assert
 (not
  (= (pred (pred (pred (data (car (children x13))))))
   (pred (pred (data (car (children x13))))))))
(assert
 (not
  (= (pred (pred (pred (data (car (children x13))))))
...
(assert
 (not
  (= (pred (pred (pred (data (car (children x13))))))
   (data (car (children x13))))))
(assert
 (not
  (= (pred (pred (pred (pred (data (car (children x13)))))))
   (pred (pred (pred (data (car (children x13)))))))))
(assert
 (not
  (= (pred (pred (pred (pred (data (car (children x13)))))))
...
(assert
 (not
  (= (pred (pred (pred (pred (pred (data (car (children x13))))))))
   (pred (pred (pred (pred (data (car (children x13))))))))))
(assert
 (not
  (= (pred (pred (pred (pred (pred (data (car (children x13))))))))
...
(assert
 (not
  (= (children (car (children (car (cdr (children x13))))))
...
(assert
 (not
  (= (children (car (children (car (cdr (children x13)))))) (children x13))))
(assert
 (not
  (= (car (children (car (children (car (cdr (children x13)))))))
   (car (children (car (cdr (children x13))))))))
(assert
 (not
  (= (car (children (car (children (car (cdr (children x13)))))))
   (car (cdr (children x13))))))
(assert
 (not (= (car (children (car (children (car (cdr (children x13))))))) x13)))
(assert
 (not
  (= (children (car (children (car (children (car (cdr (children x13))))))))
   (children (car (children (car (cdr (children x13)))))))))
(assert
 (not
  (= (children (car (children (car (children (car (cdr (children x13))))))))
...
(assert
 (not
  (= (cdr (children (car (children (car (cdr (children x13)))))))
   (children (car (children (car (cdr (children x13)))))))))
(assert
 (not
  (= (cdr (children (car (children (car (cdr (children x13)))))))
...
(assert
 (not
  (= (car (cdr (children (car (children (car (cdr (children x13))))))))
   (car (children (car (cdr (children x13))))))))
(assert
 (not
  (= (car (cdr (children (car (children (car (cdr (children x13))))))))
...
(assert
 (not
  (= (car (cdr (children (car (children (car (cdr (children x13)))))))) x13)))
(assert
 (not
  (= (cdr (cdr (children (car (children (car (cdr (children x13))))))))
   (cdr (children (car (children (car (cdr (children x13))))))))))
(assert
 (not
  (= (cdr (cdr (children (car (children (car (cdr (children x13))))))))
...
(assert
 (not
  (= (pred (data (car (children (car (cdr (children x13)))))))
   (data (car (children (car (cdr (children x13)))))))))
(assert
 (not
  (= (pred (pred (data (car (children (car (cdr (children x13))))))))
   (pred (data (car (children (car (cdr (children x13))))))))))
(assert
 (not
  (= (pred (pred (data (car (children (car (cdr (children x13))))))))
...
(assert
 (not
  (= (car (cdr (children (car (cdr (children x13))))))
   (car (cdr (children x13))))))
(assert (not (= (car (cdr (children (car (cdr (children x13)))))) x13)))
(assert
 (not
  (= (children (car (cdr (children (car (cdr (children x13)))))))
   (cdr (children (car (cdr (children x13))))))))
(assert
 (not
  (= (children (car (cdr (children (car (cdr (children x13)))))))
...
(assert
 (not
  (= (car (children (car (cdr (children (car (cdr (children x13))))))))
   (car (cdr (children (car (cdr (children x13)))))))))
(assert
 (not
  (= (car (children (car (cdr (children (car (cdr (children x13))))))))
...
(assert
 (not
  (= (car (children (car (cdr (children (car (cdr (children x13)))))))) x13)))
(assert
 (not
  (= (cdr (children (car (cdr (children (car (cdr (children x13))))))))
   (children (car (cdr (children (car (cdr (children x13))))))))))
(assert
 (not
  (= (cdr (children (car (cdr (children (car (cdr (children x13))))))))
...
(assert
 (not
  (= (pred (data (car (cdr (children (car (cdr (children x13))))))))
   (data (car (cdr (children (car (cdr (children x13))))))))))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (children x13))))))
   (cdr (children (car (cdr (children x13))))))))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (children x13))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (cdr (children x13)))))) (cdr (children x13)))))
(assert
 (not (= (cdr (cdr (children (car (cdr (children x13)))))) (children x13))))
(assert
 (not
  (= (car (cdr (cdr (children (car (cdr (children x13)))))))
   (car (cdr (children x13))))))
(assert (not (= (car (cdr (cdr (children (car (cdr (children x13))))))) x13)))
(assert
 (not
  (= (children (car (cdr (cdr (children (car (cdr (children x13))))))))
   (cdr (cdr (children (car (cdr (children x13)))))))))
(assert
 (not
  (= (children (car (cdr (cdr (children (car (cdr (children x13))))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (children x13)))))))
   (cdr (cdr (children (car (cdr (children x13)))))))))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (children x13)))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (children x13))))))) (children x13))))
(assert
 (not
  (= (car (cdr (cdr (cdr (children (car (cdr (children x13))))))))
   (car (cdr (children x13))))))
(assert
 (not (= (car (cdr (cdr (cdr (children (car (cdr (children x13)))))))) x13)))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (cdr (children x13))))))))
   (cdr (cdr (cdr (children (car (cdr (children x13))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (cdr (children x13))))))))
...
(assert
 (not
  (= (pred (pred (data (car (cdr (children x13))))))
   (pred (data (car (cdr (children x13))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (children x13))))))
...
(assert
 (not
  (= (pred (pred (pred (data (car (cdr (children x13)))))))
   (pred (pred (data (car (cdr (children x13)))))))))
(assert
 (not
  (= (pred (pred (pred (data (car (cdr (children x13)))))))
...
(assert
 (not
  (= (pred (pred (pred (pred (data (car (cdr (children x13))))))))
   (pred (pred (pred (data (car (cdr (children x13))))))))))
(assert
 (not
  (= (pred (pred (pred (pred (data (car (cdr (children x13))))))))
...
(assert
 (not
  (= (car (children (car (cdr (cdr (children x13))))))
   (car (cdr (cdr (children x13)))))))
(assert (not (= (car (children (car (cdr (cdr (children x13)))))) x13)))
(assert
 (not
  (= (children (car (children (car (cdr (cdr (children x13)))))))
   (children (car (cdr (cdr (children x13))))))))
(assert
 (not
  (= (children (car (children (car (cdr (cdr (children x13)))))))
   (cdr (cdr (children x13))))))
(assert
 (not
  (= (children (car (children (car (cdr (cdr (children x13)))))))
   (cdr (children x13)))))
...
(assert
 (not
  (= (car (children (car (children (car (cdr (cdr (children x13))))))))
   (car (children (car (cdr (cdr (children x13)))))))))
(assert
 (not
  (= (car (children (car (children (car (cdr (cdr (children x13))))))))
...
(assert
 (not
  (= (car (children (car (children (car (cdr (cdr (children x13)))))))) x13)))
(assert
 (not
  (= (cdr (children (car (children (car (cdr (cdr (children x13))))))))
   (children (car (children (car (cdr (cdr (children x13))))))))))
(assert
 (not
  (= (cdr (children (car (children (car (cdr (cdr (children x13))))))))
...
(assert
 (not
  (= (pred (data (car (children (car (cdr (cdr (children x13))))))))
   (data (car (children (car (cdr (cdr (children x13))))))))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (children x13))))))
   (children (car (cdr (cdr (children x13))))))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (children x13))))))
...
(assert
 (not
  (= (cdr (children (car (cdr (cdr (children x13)))))) (cdr (children x13)))))
(assert
 (not (= (cdr (children (car (cdr (cdr (children x13)))))) (children x13))))
(assert
 (not
  (= (car (cdr (children (car (cdr (cdr (children x13)))))))
   (car (cdr (cdr (children x13)))))))
(assert (not (= (car (cdr (children (car (cdr (cdr (children x13))))))) x13)))
(assert
 (not
  (= (children (car (cdr (children (car (cdr (cdr (children x13))))))))
   (cdr (children (car (cdr (cdr (children x13)))))))))
(assert
 (not
  (= (children (car (cdr (children (car (cdr (cdr (children x13))))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (children x13)))))))
   (cdr (children (car (cdr (cdr (children x13)))))))))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (children x13)))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (children x13))))))) (children x13))))
(assert
 (not
  (= (car (cdr (cdr (children (car (cdr (cdr (children x13))))))))
   (car (cdr (cdr (children x13)))))))
(assert
 (not (= (car (cdr (cdr (children (car (cdr (cdr (children x13)))))))) x13)))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (cdr (children x13))))))))
   (cdr (cdr (children (car (cdr (cdr (children x13))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (cdr (children x13))))))))
...
(assert
 (not
  (= (pred (data (car (cdr (cdr (children x13))))))
   (data (car (cdr (cdr (children x13))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (cdr (children x13)))))))
   (pred (data (car (cdr (cdr (children x13)))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (cdr (children x13)))))))
...
(assert
 (not
  (= (pred (pred (pred (data (car (cdr (cdr (children x13))))))))
   (pred (pred (data (car (cdr (cdr (children x13))))))))))
(assert
 (not
  (= (pred (pred (pred (data (car (cdr (cdr (children x13))))))))
...
(assert
 (not
  (= (children (car (cdr (cdr (cdr (children x13))))))
   (cdr (cdr (cdr (children x13)))))))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (children x13))))))
   (cdr (cdr (children x13))))))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (children x13)))))) (cdr (children x13)))))
(assert
 (not (= (children (car (cdr (cdr (cdr (children x13)))))) (children x13))))
(assert
 (not
  (= (car (children (car (cdr (cdr (cdr (children x13)))))))
   (car (cdr (cdr (cdr (children x13))))))))
(assert (not (= (car (children (car (cdr (cdr (cdr (children x13))))))) x13)))
(assert
 (not
  (= (children (car (children (car (cdr (cdr (cdr (children x13))))))))
   (children (car (cdr (cdr (cdr (children x13)))))))))
(assert
 (not
  (= (children (car (children (car (cdr (cdr (cdr (children x13))))))))
...
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (children x13)))))))
   (children (car (cdr (cdr (cdr (children x13)))))))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (children x13)))))))
...
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (children x13))))))) (children x13))))
(assert
 (not
  (= (car (cdr (children (car (cdr (cdr (cdr (children x13))))))))
   (car (cdr (cdr (cdr (children x13))))))))
(assert
 (not (= (car (cdr (children (car (cdr (cdr (cdr (children x13)))))))) x13)))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (cdr (children x13))))))))
   (cdr (children (car (cdr (cdr (cdr (children x13))))))))))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (cdr (children x13))))))))
...
(assert
 (not
  (= (pred (data (car (cdr (cdr (cdr (children x13)))))))
   (data (car (cdr (cdr (cdr (children x13)))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (cdr (cdr (children x13))))))))
   (pred (data (car (cdr (cdr (cdr (children x13))))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (cdr (cdr (children x13))))))))
...
(assert (not (= (car (cdr (cdr (cdr (cdr (children x13)))))) x13)))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (children x13)))))))
   (cdr (cdr (cdr (cdr (children x13))))))))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (children x13)))))))
   (cdr (cdr (cdr (children x13)))))))
...
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (children x13))))))) (children x13))))
(assert
 (not
  (= (car (children (car (cdr (cdr (cdr (cdr (children x13))))))))
   (car (cdr (cdr (cdr (cdr (children x13)))))))))
(assert
 (not (= (car (children (car (cdr (cdr (cdr (cdr (children x13)))))))) x13)))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (cdr (children x13))))))))
   (children (car (cdr (cdr (cdr (cdr (children x13))))))))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (cdr (children x13))))))))
...
(assert
 (not
  (= (pred (data (car (cdr (cdr (cdr (cdr (children x13))))))))
   (data (car (cdr (cdr (cdr (cdr (children x13))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (children x13))))))
   (cdr (cdr (cdr (cdr (children x13))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (children x13))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (children x13)))))) (cdr (cdr (children x13))))))
(assert
 (not (= (cdr (cdr (cdr (cdr (cdr (children x13)))))) (cdr (children x13)))))
(assert (not (= (cdr (cdr (cdr (cdr (cdr (children x13)))))) (children x13))))
(assert (not (= (car (cdr (cdr (cdr (cdr (cdr (children x13))))))) x13)))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (cdr (children x13))))))))
   (cdr (cdr (cdr (cdr (cdr (children x13)))))))))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (cdr (children x13))))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (children x13)))))))
   (cdr (cdr (cdr (cdr (cdr (children x13)))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (children x13)))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (children x13))))))) (cdr (children x13)))))
(assert
 (not (= (cdr (cdr (cdr (cdr (cdr (cdr (children x13))))))) (children x13))))
(assert
 (not (= (car (cdr (cdr (cdr (cdr (cdr (cdr (children x13)))))))) x13)))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr (children x13))))))))
   (cdr (cdr (cdr (cdr (cdr (cdr (children x13))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr (children x13))))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr (children x13)))))))) (children x13))))
...
(assert
 (not
  (= (pred (pred (pred (pred (pred (data x13))))))
   (pred (pred (pred (pred (data x13))))))))
(assert
 (not
  (= (pred (pred (pred (pred (pred (data x13))))))
   (pred (pred (pred (data x13)))))))
(assert
 (not
  (= (pred (pred (pred (pred (pred (data x13)))))) (pred (pred (data x13))))))
(assert
 (not (= (pred (pred (pred (pred (pred (data x13)))))) (pred (data x13)))))
(assert (not (= (pred (pred (pred (pred (pred (data x13)))))) (data x13))))
(assert
 (not
  (= (pred (pred (pred (pred (pred (pred (data x13)))))))
   (pred (pred (pred (pred (pred (data x13)))))))))
(assert
 (not
  (= (pred (pred (pred (pred (pred (pred (data x13)))))))
...
(assert
 (not
  (= (pred (pred (pred (pred (pred (pred (data x13))))))) (pred (data x13)))))
(assert
 (not (= (pred (pred (pred (pred (pred (pred (data x13))))))) (data x13))))
(assert
 (not
  (= (pred (pred (pred (pred (pred (pred (pred (data x13))))))))
   (pred (pred (pred (pred (pred (pred (data x13))))))))))
(assert
 (not
  (= (pred (pred (pred (pred (pred (pred (pred (data x13))))))))
...
(assert
 (not
  (= (pred (pred (pred (pred (pred (pred (pred (data x13)))))))) (data x13))))
...
(assert
 (not
  (= (car (children (car (children (car (children x12))))))
   (car (children (car (children x12)))))))
(assert
 (not
  (= (car (children (car (children (car (children x12))))))
   (car (children x12)))))
(assert (not (= (car (children (car (children (car (children x12)))))) x12)))
(assert
 (not
  (= (children (car (children (car (children (car (children x12)))))))
   (children (car (children (car (children x12))))))))
(assert
 (not
  (= (children (car (children (car (children (car (children x12)))))))
...
(assert
 (not
  (= (car (children (car (children (car (children (car (children x12))))))))
   (car (children (car (children (car (children x12)))))))))
(assert
 (not
  (= (car (children (car (children (car (children (car (children x12))))))))
...
(assert
 (not
  (= (cdr (children (car (children (car (children (car (children x12))))))))
   (children (car (children (car (children (car (children x12))))))))))
(assert
 (not
  (= (cdr (children (car (children (car (children (car (children x12))))))))
...
(assert
 (not
  (= (pred (data (car (children (car (children (car (children x12))))))))
   (data (car (children (car (children (car (children x12))))))))))
(assert
 (not
  (= (cdr (children (car (children (car (children x12))))))
   (children (car (children (car (children x12))))))))
(assert
 (not
  (= (cdr (children (car (children (car (children x12))))))
...
(assert
 (not
  (= (cdr (children (car (children (car (children x12)))))) (children x12))))
(assert
 (not
  (= (car (cdr (children (car (children (car (children x12)))))))
   (car (children (car (children x12)))))))
(assert
 (not
  (= (car (cdr (children (car (children (car (children x12)))))))
   (car (children x12)))))
(assert
 (not (= (car (cdr (children (car (children (car (children x12))))))) x12)))
(assert
 (not
  (= (children (car (cdr (children (car (children (car (children x12))))))))
   (cdr (children (car (children (car (children x12)))))))))
(assert
 (not
  (= (children (car (cdr (children (car (children (car (children x12))))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (children (car (children x12)))))))
   (cdr (children (car (children (car (children x12)))))))))
(assert
 (not
  (= (cdr (cdr (children (car (children (car (children x12)))))))
...
(assert
 (not
  (= (car (cdr (cdr (children (car (children (car (children x12))))))))
   (car (children (car (children x12)))))))
(assert
 (not
  (= (car (cdr (cdr (children (car (children (car (children x12))))))))
...
(assert
 (not
  (= (car (cdr (cdr (children (car (children (car (children x12)))))))) x12)))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (children (car (children x12))))))))
   (cdr (cdr (children (car (children (car (children x12))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (children (car (children x12))))))))
...
(assert
 (not
  (= (pred (data (car (children (car (children x12))))))
   (data (car (children (car (children x12))))))))
(assert
 (not
  (= (pred (pred (data (car (children (car (children x12)))))))
   (pred (data (car (children (car (children x12)))))))))
(assert
 (not
  (= (pred (pred (data (car (children (car (children x12)))))))
...
(assert
 (not
  (= (pred (pred (pred (data (car (children (car (children x12))))))))
   (pred (pred (data (car (children (car (children x12))))))))))
(assert
 (not
  (= (pred (pred (pred (data (car (children (car (children x12))))))))
...
(assert
 (not
  (= (children (car (cdr (children (car (children x12))))))
...
(assert
 (not
  (= (children (car (cdr (children (car (children x12)))))) (children x12))))
(assert
 (not
  (= (car (children (car (cdr (children (car (children x12)))))))
   (car (cdr (children (car (children x12))))))))
(assert
 (not
  (= (car (children (car (cdr (children (car (children x12)))))))
   (car (children x12)))))
(assert
 (not (= (car (children (car (cdr (children (car (children x12))))))) x12)))
(assert
 (not
  (= (children (car (children (car (cdr (children (car (children x12))))))))
   (children (car (cdr (children (car (children x12)))))))))
(assert
 (not
  (= (children (car (children (car (cdr (children (car (children x12))))))))
...
(assert
 (not
  (= (cdr (children (car (cdr (children (car (children x12)))))))
   (children (car (cdr (children (car (children x12)))))))))
(assert
 (not
  (= (cdr (children (car (cdr (children (car (children x12)))))))
...
(assert
 (not
  (= (car (cdr (children (car (cdr (children (car (children x12))))))))
   (car (cdr (children (car (children x12))))))))
(assert
 (not
  (= (car (cdr (children (car (cdr (children (car (children x12))))))))
...
(assert
 (not
  (= (car (cdr (children (car (cdr (children (car (children x12)))))))) x12)))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (children (car (children x12))))))))
   (cdr (children (car (cdr (children (car (children x12))))))))))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (children (car (children x12))))))))
...
(assert
 (not
  (= (pred (data (car (cdr (children (car (children x12)))))))
   (data (car (cdr (children (car (children x12)))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (children (car (children x12))))))))
   (pred (data (car (cdr (children (car (children x12))))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (children (car (children x12))))))))
...
(assert
 (not
  (= (car (cdr (cdr (children (car (children x12)))))) (car (children x12)))))
(assert (not (= (car (cdr (cdr (children (car (children x12)))))) x12)))
(assert
 (not
  (= (children (car (cdr (cdr (children (car (children x12)))))))
   (cdr (cdr (children (car (children x12))))))))
(assert
 (not
  (= (children (car (cdr (cdr (children (car (children x12)))))))
...
(assert
 (not
  (= (car (children (car (cdr (cdr (children (car (children x12))))))))
   (car (cdr (cdr (children (car (children x12)))))))))
(assert
 (not
  (= (car (children (car (cdr (cdr (children (car (children x12))))))))
   (car (children x12)))))
(assert
 (not
  (= (car (children (car (cdr (cdr (children (car (children x12)))))))) x12)))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (children (car (children x12))))))))
   (children (car (cdr (cdr (children (car (children x12))))))))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (children (car (children x12))))))))
...
(assert
 (not
  (= (pred (data (car (cdr (cdr (children (car (children x12))))))))
   (data (car (cdr (cdr (children (car (children x12))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (children x12))))))
   (cdr (cdr (children (car (children x12))))))))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (children x12))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (children (car (children x12))))))
   (children (car (children x12))))))
(assert
 (not (= (cdr (cdr (cdr (children (car (children x12)))))) (children x12))))
(assert
 (not
  (= (car (cdr (cdr (cdr (children (car (children x12)))))))
   (car (children x12)))))
(assert (not (= (car (cdr (cdr (cdr (children (car (children x12))))))) x12)))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (children (car (children x12))))))))
   (cdr (cdr (cdr (children (car (children x12)))))))))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (children (car (children x12))))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (children x12)))))))
   (cdr (cdr (cdr (children (car (children x12)))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (children x12)))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (children x12))))))) (children x12))))
(assert
 (not
  (= (car (cdr (cdr (cdr (cdr (children (car (children x12))))))))
   (car (children x12)))))
(assert
 (not (= (car (cdr (cdr (cdr (cdr (children (car (children x12)))))))) x12)))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (children (car (children x12))))))))
   (cdr (cdr (cdr (cdr (children (car (children x12))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (children (car (children x12))))))))
...
(assert
 (not
  (= (pred (pred (pred (data (car (children x12))))))
   (pred (pred (data (car (children x12))))))))
(assert
 (not
  (= (pred (pred (pred (data (car (children x12))))))
...
(assert
 (not
  (= (pred (pred (pred (data (car (children x12))))))
   (data (car (children x12))))))
(assert
 (not
  (= (pred (pred (pred (pred (data (car (children x12)))))))
   (pred (pred (pred (data (car (children x12)))))))))
(assert
 (not
  (= (pred (pred (pred (pred (data (car (children x12)))))))
...
(assert
 (not
  (= (pred (pred (pred (pred (pred (data (car (children x12))))))))
   (pred (pred (pred (pred (data (car (children x12))))))))))
(assert
 (not
  (= (pred (pred (pred (pred (pred (data (car (children x12))))))))
...
(assert
 (not
  (= (children (car (children (car (cdr (children x12))))))
...
(assert
 (not
  (= (children (car (children (car (cdr (children x12)))))) (children x12))))
(assert
 (not
  (= (car (children (car (children (car (cdr (children x12)))))))
   (car (children (car (cdr (children x12))))))))
(assert
 (not
  (= (car (children (car (children (car (cdr (children x12)))))))
   (car (cdr (children x12))))))
(assert
 (not (= (car (children (car (children (car (cdr (children x12))))))) x12)))
(assert
 (not
  (= (children (car (children (car (children (car (cdr (children x12))))))))
   (children (car (children (car (cdr (children x12)))))))))
(assert
 (not
  (= (children (car (children (car (children (car (cdr (children x12))))))))
...
(assert
 (not
  (= (cdr (children (car (children (car (cdr (children x12)))))))
   (children (car (children (car (cdr (children x12)))))))))
(assert
 (not
  (= (cdr (children (car (children (car (cdr (children x12)))))))
...
(assert
 (not
  (= (car (cdr (children (car (children (car (cdr (children x12))))))))
   (car (children (car (cdr (children x12))))))))
(assert
 (not
  (= (car (cdr (children (car (children (car (cdr (children x12))))))))
...
(assert
 (not
  (= (car (cdr (children (car (children (car (cdr (children x12)))))))) x12)))
(assert
 (not
  (= (cdr (cdr (children (car (children (car (cdr (children x12))))))))
   (cdr (children (car (children (car (cdr (children x12))))))))))
(assert
 (not
  (= (cdr (cdr (children (car (children (car (cdr (children x12))))))))
...
(assert
 (not
  (= (pred (data (car (children (car (cdr (children x12)))))))
   (data (car (children (car (cdr (children x12)))))))))
(assert
 (not
  (= (pred (pred (data (car (children (car (cdr (children x12))))))))
   (pred (data (car (children (car (cdr (children x12))))))))))
(assert
 (not
  (= (pred (pred (data (car (children (car (cdr (children x12))))))))
...
(assert
 (not
  (= (car (cdr (children (car (cdr (children x12))))))
   (car (cdr (children x12))))))
(assert (not (= (car (cdr (children (car (cdr (children x12)))))) x12)))
(assert
 (not
  (= (children (car (cdr (children (car (cdr (children x12)))))))
   (cdr (children (car (cdr (children x12))))))))
(assert
 (not
  (= (children (car (cdr (children (car (cdr (children x12)))))))
...
(assert
 (not
  (= (car (children (car (cdr (children (car (cdr (children x12))))))))
   (car (cdr (children (car (cdr (children x12)))))))))
(assert
 (not
  (= (car (children (car (cdr (children (car (cdr (children x12))))))))
...
(assert
 (not
  (= (car (children (car (cdr (children (car (cdr (children x12)))))))) x12)))
(assert
 (not
  (= (cdr (children (car (cdr (children (car (cdr (children x12))))))))
   (children (car (cdr (children (car (cdr (children x12))))))))))
(assert
 (not
  (= (cdr (children (car (cdr (children (car (cdr (children x12))))))))
...
(assert
 (not
  (= (pred (data (car (cdr (children (car (cdr (children x12))))))))
   (data (car (cdr (children (car (cdr (children x12))))))))))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (children x12))))))
   (cdr (children (car (cdr (children x12))))))))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (children x12))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (cdr (children x12)))))) (cdr (children x12)))))
(assert
 (not (= (cdr (cdr (children (car (cdr (children x12)))))) (children x12))))
(assert
 (not
  (= (car (cdr (cdr (children (car (cdr (children x12)))))))
   (car (cdr (children x12))))))
(assert (not (= (car (cdr (cdr (children (car (cdr (children x12))))))) x12)))
(assert
 (not
  (= (children (car (cdr (cdr (children (car (cdr (children x12))))))))
   (cdr (cdr (children (car (cdr (children x12)))))))))
(assert
 (not
  (= (children (car (cdr (cdr (children (car (cdr (children x12))))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (children x12)))))))
   (cdr (cdr (children (car (cdr (children x12)))))))))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (children x12)))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (children x12))))))) (children x12))))
(assert
 (not
  (= (car (cdr (cdr (cdr (children (car (cdr (children x12))))))))
   (car (cdr (children x12))))))
(assert
 (not (= (car (cdr (cdr (cdr (children (car (cdr (children x12)))))))) x12)))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (cdr (children x12))))))))
   (cdr (cdr (cdr (children (car (cdr (children x12))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (cdr (children x12))))))))
...
(assert
 (not
  (= (pred (pred (data (car (cdr (children x12))))))
   (pred (data (car (cdr (children x12))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (children x12))))))
...
(assert
 (not
  (= (pred (pred (pred (data (car (cdr (children x12)))))))
   (pred (pred (data (car (cdr (children x12)))))))))
(assert
 (not
  (= (pred (pred (pred (data (car (cdr (children x12)))))))
...
(assert
 (not
  (= (pred (pred (pred (pred (data (car (cdr (children x12))))))))
   (pred (pred (pred (data (car (cdr (children x12))))))))))
(assert
 (not
  (= (pred (pred (pred (pred (data (car (cdr (children x12))))))))
...
(assert
 (not
  (= (car (children (car (cdr (cdr (children x12))))))
   (car (cdr (cdr (children x12)))))))
(assert (not (= (car (children (car (cdr (cdr (children x12)))))) x12)))
(assert
 (not
  (= (children (car (children (car (cdr (cdr (children x12)))))))
   (children (car (cdr (cdr (children x12))))))))
(assert
 (not
  (= (children (car (children (car (cdr (cdr (children x12)))))))
   (cdr (cdr (children x12))))))
(assert
 (not
  (= (children (car (children (car (cdr (cdr (children x12)))))))
   (cdr (children x12)))))
...
(assert
 (not
  (= (car (children (car (children (car (cdr (cdr (children x12))))))))
   (car (children (car (cdr (cdr (children x12)))))))))
(assert
 (not
  (= (car (children (car (children (car (cdr (cdr (children x12))))))))
...
(assert
 (not
  (= (car (children (car (children (car (cdr (cdr (children x12)))))))) x12)))
(assert
 (not
  (= (cdr (children (car (children (car (cdr (cdr (children x12))))))))
   (children (car (children (car (cdr (cdr (children x12))))))))))
(assert
 (not
  (= (cdr (children (car (children (car (cdr (cdr (children x12))))))))
...
(assert
 (not
  (= (pred (data (car (children (car (cdr (cdr (children x12))))))))
   (data (car (children (car (cdr (cdr (children x12))))))))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (children x12))))))
   (children (car (cdr (cdr (children x12))))))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (children x12))))))
...
(assert
 (not
  (= (cdr (children (car (cdr (cdr (children x12)))))) (cdr (children x12)))))
(assert
 (not (= (cdr (children (car (cdr (cdr (children x12)))))) (children x12))))
(assert
 (not
  (= (car (cdr (children (car (cdr (cdr (children x12)))))))
   (car (cdr (cdr (children x12)))))))
(assert (not (= (car (cdr (children (car (cdr (cdr (children x12))))))) x12)))
(assert
 (not
  (= (children (car (cdr (children (car (cdr (cdr (children x12))))))))
   (cdr (children (car (cdr (cdr (children x12)))))))))
(assert
 (not
  (= (children (car (cdr (children (car (cdr (cdr (children x12))))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (children x12)))))))
   (cdr (children (car (cdr (cdr (children x12)))))))))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (children x12)))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (children x12))))))) (children x12))))
(assert
 (not
  (= (car (cdr (cdr (children (car (cdr (cdr (children x12))))))))
   (car (cdr (cdr (children x12)))))))
(assert
 (not (= (car (cdr (cdr (children (car (cdr (cdr (children x12)))))))) x12)))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (cdr (children x12))))))))
   (cdr (cdr (children (car (cdr (cdr (children x12))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (cdr (children x12))))))))
...
(assert
 (not
  (= (pred (data (car (cdr (cdr (children x12))))))
   (data (car (cdr (cdr (children x12))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (cdr (children x12)))))))
   (pred (data (car (cdr (cdr (children x12)))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (cdr (children x12)))))))
...
(assert
 (not
  (= (pred (pred (pred (data (car (cdr (cdr (children x12))))))))
   (pred (pred (data (car (cdr (cdr (children x12))))))))))
(assert
 (not
  (= (pred (pred (pred (data (car (cdr (cdr (children x12))))))))
...
(assert
 (not
  (= (children (car (cdr (cdr (cdr (children x12))))))
   (cdr (cdr (cdr (children x12)))))))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (children x12))))))
   (cdr (cdr (children x12))))))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (children x12)))))) (cdr (children x12)))))
(assert
 (not (= (children (car (cdr (cdr (cdr (children x12)))))) (children x12))))
(assert
 (not
  (= (car (children (car (cdr (cdr (cdr (children x12)))))))
   (car (cdr (cdr (cdr (children x12))))))))
(assert (not (= (car (children (car (cdr (cdr (cdr (children x12))))))) x12)))
(assert
 (not
  (= (children (car (children (car (cdr (cdr (cdr (children x12))))))))
   (children (car (cdr (cdr (cdr (children x12)))))))))
(assert
 (not
  (= (children (car (children (car (cdr (cdr (cdr (children x12))))))))
...
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (children x12)))))))
   (children (car (cdr (cdr (cdr (children x12)))))))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (children x12)))))))
...
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (children x12))))))) (children x12))))
(assert
 (not
  (= (car (cdr (children (car (cdr (cdr (cdr (children x12))))))))
   (car (cdr (cdr (cdr (children x12))))))))
(assert
 (not (= (car (cdr (children (car (cdr (cdr (cdr (children x12)))))))) x12)))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (cdr (children x12))))))))
   (cdr (children (car (cdr (cdr (cdr (children x12))))))))))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (cdr (children x12))))))))
...
(assert
 (not
  (= (pred (data (car (cdr (cdr (cdr (children x12)))))))
   (data (car (cdr (cdr (cdr (children x12)))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (cdr (cdr (children x12))))))))
   (pred (data (car (cdr (cdr (cdr (children x12))))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (cdr (cdr (children x12))))))))
...
(assert (not (= (car (cdr (cdr (cdr (cdr (children x12)))))) x12)))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (children x12)))))))
   (cdr (cdr (cdr (cdr (children x12))))))))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (children x12)))))))
   (cdr (cdr (cdr (children x12)))))))
...
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (children x12))))))) (children x12))))
(assert
 (not
  (= (car (children (car (cdr (cdr (cdr (cdr (children x12))))))))
   (car (cdr (cdr (cdr (cdr (children x12)))))))))
(assert
 (not (= (car (children (car (cdr (cdr (cdr (cdr (children x12)))))))) x12)))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (cdr (children x12))))))))
   (children (car (cdr (cdr (cdr (cdr (children x12))))))))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (cdr (children x12))))))))
...
(assert
 (not
  (= (pred (data (car (cdr (cdr (cdr (cdr (children x12))))))))
   (data (car (cdr (cdr (cdr (cdr (children x12))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (children x12))))))
   (cdr (cdr (cdr (cdr (children x12))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (children x12))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (children x12)))))) (cdr (cdr (children x12))))))
(assert
 (not (= (cdr (cdr (cdr (cdr (cdr (children x12)))))) (cdr (children x12)))))
(assert (not (= (cdr (cdr (cdr (cdr (cdr (children x12)))))) (children x12))))
(assert (not (= (car (cdr (cdr (cdr (cdr (cdr (children x12))))))) x12)))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (cdr (children x12))))))))
   (cdr (cdr (cdr (cdr (cdr (children x12)))))))))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (cdr (children x12))))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (children x12)))))))
   (cdr (cdr (cdr (cdr (cdr (children x12)))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (children x12)))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (children x12))))))) (cdr (children x12)))))
(assert
 (not (= (cdr (cdr (cdr (cdr (cdr (cdr (children x12))))))) (children x12))))
(assert
 (not (= (car (cdr (cdr (cdr (cdr (cdr (cdr (children x12)))))))) x12)))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr (children x12))))))))
   (cdr (cdr (cdr (cdr (cdr (cdr (children x12))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr (children x12))))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr (children x12)))))))) (children x12))))
...
(assert
 (not
  (= (pred (pred (pred (pred (pred (data x12))))))
   (pred (pred (pred (pred (data x12))))))))
(assert
 (not
  (= (pred (pred (pred (pred (pred (data x12))))))
   (pred (pred (pred (data x12)))))))
(assert
 (not
  (= (pred (pred (pred (pred (pred (data x12)))))) (pred (pred (data x12))))))
(assert
 (not (= (pred (pred (pred (pred (pred (data x12)))))) (pred (data x12)))))
(assert (not (= (pred (pred (pred (pred (pred (data x12)))))) (data x12))))
(assert
 (not
  (= (pred (pred (pred (pred (pred (pred (data x12)))))))
   (pred (pred (pred (pred (pred (data x12)))))))))
(assert
 (not
  (= (pred (pred (pred (pred (pred (pred (data x12)))))))
...
(assert
 (not
  (= (pred (pred (pred (pred (pred (pred (data x12))))))) (pred (data x12)))))
(assert
 (not (= (pred (pred (pred (pred (pred (pred (data x12))))))) (data x12))))
(assert
 (not
  (= (pred (pred (pred (pred (pred (pred (pred (data x12))))))))
   (pred (pred (pred (pred (pred (pred (data x12))))))))))
(assert
 (not
  (= (pred (pred (pred (pred (pred (pred (pred (data x12))))))))
...
(assert
 (not
  (= (pred (pred (pred (pred (pred (pred (pred (data x12)))))))) (data x12))))
...
(assert
 (not
  (= (car (children (car (children (car (children x11))))))
   (car (children (car (children x11)))))))
(assert
 (not
  (= (car (children (car (children (car (children x11))))))
   (car (children x11)))))
(assert (not (= (car (children (car (children (car (children x11)))))) x11)))
(assert
 (not
  (= (children (car (children (car (children (car (children x11)))))))
   (children (car (children (car (children x11))))))))
(assert
 (not
  (= (children (car (children (car (children (car (children x11)))))))
...
(assert
 (not
  (= (car (children (car (children (car (children (car (children x11))))))))
   (car (children (car (children (car (children x11)))))))))
(assert
 (not
  (= (car (children (car (children (car (children (car (children x11))))))))
...
(assert
 (not
  (= (cdr (children (car (children (car (children (car (children x11))))))))
   (children (car (children (car (children (car (children x11))))))))))
(assert
 (not
  (= (cdr (children (car (children (car (children (car (children x11))))))))
...
(assert
 (not
  (= (pred (data (car (children (car (children (car (children x11))))))))
   (data (car (children (car (children (car (children x11))))))))))
(assert
 (not
  (= (cdr (children (car (children (car (children x11))))))
   (children (car (children (car (children x11))))))))
(assert
 (not
  (= (cdr (children (car (children (car (children x11))))))
...
(assert
 (not
  (= (cdr (children (car (children (car (children x11)))))) (children x11))))
(assert
 (not
  (= (car (cdr (children (car (children (car (children x11)))))))
   (car (children (car (children x11)))))))
(assert
 (not
  (= (car (cdr (children (car (children (car (children x11)))))))
   (car (children x11)))))
(assert
 (not (= (car (cdr (children (car (children (car (children x11))))))) x11)))
(assert
 (not
  (= (children (car (cdr (children (car (children (car (children x11))))))))
   (cdr (children (car (children (car (children x11)))))))))
(assert
 (not
  (= (children (car (cdr (children (car (children (car (children x11))))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (children (car (children x11)))))))
   (cdr (children (car (children (car (children x11)))))))))
(assert
 (not
  (= (cdr (cdr (children (car (children (car (children x11)))))))
...
(assert
 (not
  (= (car (cdr (cdr (children (car (children (car (children x11))))))))
   (car (children (car (children x11)))))))
(assert
 (not
  (= (car (cdr (cdr (children (car (children (car (children x11))))))))
...
(assert
 (not
  (= (car (cdr (cdr (children (car (children (car (children x11)))))))) x11)))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (children (car (children x11))))))))
   (cdr (cdr (children (car (children (car (children x11))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (children (car (children x11))))))))
...
(assert
 (not
  (= (pred (data (car (children (car (children x11))))))
   (data (car (children (car (children x11))))))))
(assert
 (not
  (= (pred (pred (data (car (children (car (children x11)))))))
   (pred (data (car (children (car (children x11)))))))))
(assert
 (not
  (= (pred (pred (data (car (children (car (children x11)))))))
...
(assert
 (not
  (= (pred (pred (pred (data (car (children (car (children x11))))))))
   (pred (pred (data (car (children (car (children x11))))))))))
(assert
 (not
  (= (pred (pred (pred (data (car (children (car (children x11))))))))
...
(assert
 (not
  (= (children (car (cdr (children (car (children x11))))))
...
(assert
 (not
  (= (children (car (cdr (children (car (children x11)))))) (children x11))))
(assert
 (not
  (= (car (children (car (cdr (children (car (children x11)))))))
   (car (cdr (children (car (children x11))))))))
(assert
 (not
  (= (car (children (car (cdr (children (car (children x11)))))))
   (car (children x11)))))
(assert
 (not (= (car (children (car (cdr (children (car (children x11))))))) x11)))
(assert
 (not
  (= (children (car (children (car (cdr (children (car (children x11))))))))
   (children (car (cdr (children (car (children x11)))))))))
(assert
 (not
  (= (children (car (children (car (cdr (children (car (children x11))))))))
...
(assert
 (not
  (= (cdr (children (car (cdr (children (car (children x11)))))))
   (children (car (cdr (children (car (children x11)))))))))
(assert
 (not
  (= (cdr (children (car (cdr (children (car (children x11)))))))
...
(assert
 (not
  (= (car (cdr (children (car (cdr (children (car (children x11))))))))
   (car (cdr (children (car (children x11))))))))
(assert
 (not
  (= (car (cdr (children (car (cdr (children (car (children x11))))))))
...
(assert
 (not
  (= (car (cdr (children (car (cdr (children (car (children x11)))))))) x11)))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (children (car (children x11))))))))
   (cdr (children (car (cdr (children (car (children x11))))))))))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (children (car (children x11))))))))
...
(assert
 (not
  (= (pred (data (car (cdr (children (car (children x11)))))))
   (data (car (cdr (children (car (children x11)))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (children (car (children x11))))))))
   (pred (data (car (cdr (children (car (children x11))))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (children (car (children x11))))))))
...
(assert
 (not
  (= (car (cdr (cdr (children (car (children x11)))))) (car (children x11)))))
(assert (not (= (car (cdr (cdr (children (car (children x11)))))) x11)))
(assert
 (not
  (= (children (car (cdr (cdr (children (car (children x11)))))))
   (cdr (cdr (children (car (children x11))))))))
(assert
 (not
  (= (children (car (cdr (cdr (children (car (children x11)))))))
...
(assert
 (not
  (= (car (children (car (cdr (cdr (children (car (children x11))))))))
   (car (cdr (cdr (children (car (children x11)))))))))
(assert
 (not
  (= (car (children (car (cdr (cdr (children (car (children x11))))))))
   (car (children x11)))))
(assert
 (not
  (= (car (children (car (cdr (cdr (children (car (children x11)))))))) x11)))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (children (car (children x11))))))))
   (children (car (cdr (cdr (children (car (children x11))))))))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (children (car (children x11))))))))
...
(assert
 (not
  (= (pred (data (car (cdr (cdr (children (car (children x11))))))))
   (data (car (cdr (cdr (children (car (children x11))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (children x11))))))
   (cdr (cdr (children (car (children x11))))))))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (children x11))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (children (car (children x11))))))
   (children (car (children x11))))))
(assert
 (not (= (cdr (cdr (cdr (children (car (children x11)))))) (children x11))))
(assert
 (not
  (= (car (cdr (cdr (cdr (children (car (children x11)))))))
   (car (children x11)))))
(assert (not (= (car (cdr (cdr (cdr (children (car (children x11))))))) x11)))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (children (car (children x11))))))))
   (cdr (cdr (cdr (children (car (children x11)))))))))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (children (car (children x11))))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (children x11)))))))
   (cdr (cdr (cdr (children (car (children x11)))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (children x11)))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (children x11))))))) (children x11))))
(assert
 (not
  (= (car (cdr (cdr (cdr (cdr (children (car (children x11))))))))
   (car (children x11)))))
(assert
 (not (= (car (cdr (cdr (cdr (cdr (children (car (children x11)))))))) x11)))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (children (car (children x11))))))))
   (cdr (cdr (cdr (cdr (children (car (children x11))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (children (car (children x11))))))))
...
(assert
 (not
  (= (pred (pred (pred (data (car (children x11))))))
   (pred (pred (data (car (children x11))))))))
(assert
 (not
  (= (pred (pred (pred (data (car (children x11))))))
...
(assert
 (not
  (= (pred (pred (pred (data (car (children x11))))))
   (data (car (children x11))))))
(assert
 (not
  (= (pred (pred (pred (pred (data (car (children x11)))))))
   (pred (pred (pred (data (car (children x11)))))))))
(assert
 (not
  (= (pred (pred (pred (pred (data (car (children x11)))))))
...
(assert
 (not
  (= (pred (pred (pred (pred (pred (data (car (children x11))))))))
   (pred (pred (pred (pred (data (car (children x11))))))))))
(assert
 (not
  (= (pred (pred (pred (pred (pred (data (car (children x11))))))))
...
(assert
 (not
  (= (children (car (children (car (cdr (children x11))))))
...
(assert
 (not
  (= (children (car (children (car (cdr (children x11)))))) (children x11))))
(assert
 (not
  (= (car (children (car (children (car (cdr (children x11)))))))
   (car (children (car (cdr (children x11))))))))
(assert
 (not
  (= (car (children (car (children (car (cdr (children x11)))))))
   (car (cdr (children x11))))))
(assert
 (not (= (car (children (car (children (car (cdr (children x11))))))) x11)))
(assert
 (not
  (= (children (car (children (car (children (car (cdr (children x11))))))))
   (children (car (children (car (cdr (children x11)))))))))
(assert
 (not
  (= (children (car (children (car (children (car (cdr (children x11))))))))
...
(assert
 (not
  (= (cdr (children (car (children (car (cdr (children x11)))))))
   (children (car (children (car (cdr (children x11)))))))))
(assert
 (not
  (= (cdr (children (car (children (car (cdr (children x11)))))))
...
(assert
 (not
  (= (car (cdr (children (car (children (car (cdr (children x11))))))))
   (car (children (car (cdr (children x11))))))))
(assert
 (not
  (= (car (cdr (children (car (children (car (cdr (children x11))))))))
...
(assert
 (not
  (= (car (cdr (children (car (children (car (cdr (children x11)))))))) x11)))
(assert
 (not
  (= (cdr (cdr (children (car (children (car (cdr (children x11))))))))
   (cdr (children (car (children (car (cdr (children x11))))))))))
(assert
 (not
  (= (cdr (cdr (children (car (children (car (cdr (children x11))))))))
...
(assert
 (not
  (= (pred (data (car (children (car (cdr (children x11)))))))
   (data (car (children (car (cdr (children x11)))))))))
(assert
 (not
  (= (pred (pred (data (car (children (car (cdr (children x11))))))))
   (pred (data (car (children (car (cdr (children x11))))))))))
(assert
 (not
  (= (pred (pred (data (car (children (car (cdr (children x11))))))))
...
(assert
 (not
  (= (car (cdr (children (car (cdr (children x11))))))
   (car (cdr (children x11))))))
(assert (not (= (car (cdr (children (car (cdr (children x11)))))) x11)))
(assert
 (not
  (= (children (car (cdr (children (car (cdr (children x11)))))))
   (cdr (children (car (cdr (children x11))))))))
(assert
 (not
  (= (children (car (cdr (children (car (cdr (children x11)))))))
...
(assert
 (not
  (= (car (children (car (cdr (children (car (cdr (children x11))))))))
   (car (cdr (children (car (cdr (children x11)))))))))
(assert
 (not
  (= (car (children (car (cdr (children (car (cdr (children x11))))))))
...
(assert
 (not
  (= (car (children (car (cdr (children (car (cdr (children x11)))))))) x11)))
(assert
 (not
  (= (cdr (children (car (cdr (children (car (cdr (children x11))))))))
   (children (car (cdr (children (car (cdr (children x11))))))))))
(assert
 (not
  (= (cdr (children (car (cdr (children (car (cdr (children x11))))))))
...
(assert
 (not
  (= (pred (data (car (cdr (children (car (cdr (children x11))))))))
   (data (car (cdr (children (car (cdr (children x11))))))))))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (children x11))))))
   (cdr (children (car (cdr (children x11))))))))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (children x11))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (cdr (children x11)))))) (cdr (children x11)))))
(assert
 (not (= (cdr (cdr (children (car (cdr (children x11)))))) (children x11))))
(assert
 (not
  (= (car (cdr (cdr (children (car (cdr (children x11)))))))
   (car (cdr (children x11))))))
(assert (not (= (car (cdr (cdr (children (car (cdr (children x11))))))) x11)))
(assert
 (not
  (= (children (car (cdr (cdr (children (car (cdr (children x11))))))))
   (cdr (cdr (children (car (cdr (children x11)))))))))
(assert
 (not
  (= (children (car (cdr (cdr (children (car (cdr (children x11))))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (children x11)))))))
   (cdr (cdr (children (car (cdr (children x11)))))))))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (children x11)))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (children x11))))))) (children x11))))
(assert
 (not
  (= (car (cdr (cdr (cdr (children (car (cdr (children x11))))))))
   (car (cdr (children x11))))))
(assert
 (not (= (car (cdr (cdr (cdr (children (car (cdr (children x11)))))))) x11)))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (cdr (children x11))))))))
   (cdr (cdr (cdr (children (car (cdr (children x11))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (cdr (children x11))))))))
...
(assert
 (not
  (= (pred (pred (data (car (cdr (children x11))))))
   (pred (data (car (cdr (children x11))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (children x11))))))
...
(assert
 (not
  (= (pred (pred (pred (data (car (cdr (children x11)))))))
   (pred (pred (data (car (cdr (children x11)))))))))
(assert
 (not
  (= (pred (pred (pred (data (car (cdr (children x11)))))))
...
(assert
 (not
  (= (pred (pred (pred (pred (data (car (cdr (children x11))))))))
   (pred (pred (pred (data (car (cdr (children x11))))))))))
(assert
 (not
  (= (pred (pred (pred (pred (data (car (cdr (children x11))))))))
...
(assert
 (not
  (= (car (children (car (cdr (cdr (children x11))))))
   (car (cdr (cdr (children x11)))))))
(assert (not (= (car (children (car (cdr (cdr (children x11)))))) x11)))
(assert
 (not
  (= (children (car (children (car (cdr (cdr (children x11)))))))
   (children (car (cdr (cdr (children x11))))))))
(assert
 (not
  (= (children (car (children (car (cdr (cdr (children x11)))))))
   (cdr (cdr (children x11))))))
(assert
 (not
  (= (children (car (children (car (cdr (cdr (children x11)))))))
   (cdr (children x11)))))
...
(assert
 (not
  (= (car (children (car (children (car (cdr (cdr (children x11))))))))
   (car (children (car (cdr (cdr (children x11)))))))))
(assert
 (not
  (= (car (children (car (children (car (cdr (cdr (children x11))))))))
...
(assert
 (not
  (= (car (children (car (children (car (cdr (cdr (children x11)))))))) x11)))
(assert
 (not
  (= (cdr (children (car (children (car (cdr (cdr (children x11))))))))
   (children (car (children (car (cdr (cdr (children x11))))))))))
(assert
 (not
  (= (cdr (children (car (children (car (cdr (cdr (children x11))))))))
...
(assert
 (not
  (= (pred (data (car (children (car (cdr (cdr (children x11))))))))
   (data (car (children (car (cdr (cdr (children x11))))))))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (children x11))))))
   (children (car (cdr (cdr (children x11))))))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (children x11))))))
...
(assert
 (not
  (= (cdr (children (car (cdr (cdr (children x11)))))) (cdr (children x11)))))
(assert
 (not (= (cdr (children (car (cdr (cdr (children x11)))))) (children x11))))
(assert
 (not
  (= (car (cdr (children (car (cdr (cdr (children x11)))))))
   (car (cdr (cdr (children x11)))))))
(assert (not (= (car (cdr (children (car (cdr (cdr (children x11))))))) x11)))
(assert
 (not
  (= (children (car (cdr (children (car (cdr (cdr (children x11))))))))
   (cdr (children (car (cdr (cdr (children x11)))))))))
(assert
 (not
  (= (children (car (cdr (children (car (cdr (cdr (children x11))))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (children x11)))))))
   (cdr (children (car (cdr (cdr (children x11)))))))))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (children x11)))))))
...
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (children x11))))))) (children x11))))
(assert
 (not
  (= (car (cdr (cdr (children (car (cdr (cdr (children x11))))))))
   (car (cdr (cdr (children x11)))))))
(assert
 (not (= (car (cdr (cdr (children (car (cdr (cdr (children x11)))))))) x11)))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (cdr (children x11))))))))
   (cdr (cdr (children (car (cdr (cdr (children x11))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (cdr (children x11))))))))
...
(assert
 (not
  (= (pred (data (car (cdr (cdr (children x11))))))
   (data (car (cdr (cdr (children x11))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (cdr (children x11)))))))
   (pred (data (car (cdr (cdr (children x11)))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (cdr (children x11)))))))
...
(assert
 (not
  (= (pred (pred (pred (data (car (cdr (cdr (children x11))))))))
   (pred (pred (data (car (cdr (cdr (children x11))))))))))
(assert
 (not
  (= (pred (pred (pred (data (car (cdr (cdr (children x11))))))))
...
(assert
 (not
  (= (children (car (cdr (cdr (cdr (children x11))))))
   (cdr (cdr (cdr (children x11)))))))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (children x11))))))
   (cdr (cdr (children x11))))))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (children x11)))))) (cdr (children x11)))))
(assert
 (not (= (children (car (cdr (cdr (cdr (children x11)))))) (children x11))))
(assert
 (not
  (= (car (children (car (cdr (cdr (cdr (children x11)))))))
   (car (cdr (cdr (cdr (children x11))))))))
(assert (not (= (car (children (car (cdr (cdr (cdr (children x11))))))) x11)))
(assert
 (not
  (= (children (car (children (car (cdr (cdr (cdr (children x11))))))))
   (children (car (cdr (cdr (cdr (children x11)))))))))
(assert
 (not
  (= (children (car (children (car (cdr (cdr (cdr (children x11))))))))
...
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (children x11)))))))
   (children (car (cdr (cdr (cdr (children x11)))))))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (children x11)))))))
...
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (children x11))))))) (children x11))))
(assert
 (not
  (= (car (cdr (children (car (cdr (cdr (cdr (children x11))))))))
   (car (cdr (cdr (cdr (children x11))))))))
(assert
 (not (= (car (cdr (children (car (cdr (cdr (cdr (children x11)))))))) x11)))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (cdr (children x11))))))))
   (cdr (children (car (cdr (cdr (cdr (children x11))))))))))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (cdr (children x11))))))))
...
(assert
 (not
  (= (pred (data (car (cdr (cdr (cdr (children x11)))))))
   (data (car (cdr (cdr (cdr (children x11)))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (cdr (cdr (children x11))))))))
   (pred (data (car (cdr (cdr (cdr (children x11))))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (cdr (cdr (children x11))))))))
...
(assert (not (= (car (cdr (cdr (cdr (cdr (children x11)))))) x11)))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (children x11)))))))
   (cdr (cdr (cdr (cdr (children x11))))))))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (children x11)))))))
   (cdr (cdr (cdr (children x11)))))))
...
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (children x11))))))) (children x11))))
(assert
 (not
  (= (car (children (car (cdr (cdr (cdr (cdr (children x11))))))))
   (car (cdr (cdr (cdr (cdr (children x11)))))))))
(assert
 (not (= (car (children (car (cdr (cdr (cdr (cdr (children x11)))))))) x11)))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (cdr (children x11))))))))
   (children (car (cdr (cdr (cdr (cdr (children x11))))))))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (cdr (children x11))))))))
...
(assert
 (not
  (= (pred (data (car (cdr (cdr (cdr (cdr (children x11))))))))
   (data (car (cdr (cdr (cdr (cdr (children x11))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (children x11))))))
   (cdr (cdr (cdr (cdr (children x11))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (children x11))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (children x11)))))) (cdr (cdr (children x11))))))
(assert
 (not (= (cdr (cdr (cdr (cdr (cdr (children x11)))))) (cdr (children x11)))))
(assert (not (= (cdr (cdr (cdr (cdr (cdr (children x11)))))) (children x11))))
(assert (not (= (car (cdr (cdr (cdr (cdr (cdr (children x11))))))) x11)))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (cdr (children x11))))))))
   (cdr (cdr (cdr (cdr (cdr (children x11)))))))))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (cdr (children x11))))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (children x11)))))))
   (cdr (cdr (cdr (cdr (cdr (children x11)))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (children x11)))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (children x11))))))) (cdr (children x11)))))
(assert
 (not (= (cdr (cdr (cdr (cdr (cdr (cdr (children x11))))))) (children x11))))
(assert
 (not (= (car (cdr (cdr (cdr (cdr (cdr (cdr (children x11)))))))) x11)))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr (children x11))))))))
   (cdr (cdr (cdr (cdr (cdr (cdr (children x11))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr (children x11))))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr (children x11)))))))) (children x11))))
...
(assert
 (not
  (= (pred (pred (pred (pred (pred (data x11))))))
   (pred (pred (pred (pred (data x11))))))))
(assert
 (not
  (= (pred (pred (pred (pred (pred (data x11))))))
   (pred (pred (pred (data x11)))))))
(assert
 (not
  (= (pred (pred (pred (pred (pred (data x11)))))) (pred (pred (data x11))))))
(assert
 (not (= (pred (pred (pred (pred (pred (data x11)))))) (pred (data x11)))))
(assert (not (= (pred (pred (pred (pred (pred (data x11)))))) (data x11))))
(assert
 (not
  (= (pred (pred (pred (pred (pred (pred (data x11)))))))
   (pred (pred (pred (pred (pred (data x11)))))))))
(assert
 (not
  (= (pred (pred (pred (pred (pred (pred (data x11)))))))
...
(assert
 (not
  (= (pred (pred (pred (pred (pred (pred (data x11))))))) (pred (data x11)))))
(assert
 (not (= (pred (pred (pred (pred (pred (pred (data x11))))))) (data x11))))
(assert
 (not
  (= (pred (pred (pred (pred (pred (pred (pred (data x11))))))))
   (pred (pred (pred (pred (pred (pred (data x11))))))))))
(assert
 (not
  (= (pred (pred (pred (pred (pred (pred (pred (data x11))))))))
...
(assert
 (not
  (= (pred (pred (pred (pred (pred (pred (pred (data x11)))))))) (data x11))))
...
(assert
 (not
  (= (pred (pred (pred (pred (pred (pred (pred (pred (pred x5)))))))))
   (pred (pred (pred (pred (pred (pred (pred (pred x5)))))))))))
(assert
 (not
  (= (pred (pred (pred (pred (pred (pred (pred (pred (pred x5)))))))))
...
(assert
 (not
  (= (pred (pred (pred (pred (pred (pred (pred (pred (pred x5))))))))) x5)))
...
(assert
 (not
  (= (pred (pred (pred (pred (pred (pred (pred (pred (pred x4)))))))))
   (pred (pred (pred (pred (pred (pred (pred (pred x4)))))))))))
(assert
 (not
  (= (pred (pred (pred (pred (pred (pred (pred (pred (pred x4)))))))))
...
(assert
 (not
  (= (pred (pred (pred (pred (pred (pred (pred (pred (pred x4))))))))) x4)))
