...
(assert (is-null null))
(assert
 (and (and (and (= zero x4) (not ((_ is leaf) x14)))
  (not (= contrived_variable0 x5))) (not (= contrived_variable1 x11))))
(assert
 (and (= (node x8) contrived_variable1) (is-node contrived_variable1)
  (= (children contrived_variable1) x8)))
(assert
 (or
  (and ((_ is leaf) x11) (and (= (data x11) contrived_variable0)
   (= (leaf contrived_variable2) x11) (= (data x11) contrived_variable2)))
  (and (not ((_ is leaf) x11)) (= contrived_variable0 zero))))
(assert
