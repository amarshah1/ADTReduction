...
(assert (is-null null))
(assert
 (and (and (and (and (and (not (= contrived_variable0 x2)) (not (= x14 x14)))
  (not ((_ is null) x7))) (= x10 x9)) (not (= contrived_variable1 x11)))
  ((_ is zero) zero)))
(assert
...
(assert
 (or
  (and ((_ is succ) x4) (and (= (pred x4) contrived_variable0)
   (= (succ contrived_variable2) x4) (= (pred x4) contrived_variable2)))
  (and (not ((_ is succ) x4)) (= contrived_variable0 zero))))
(assert
