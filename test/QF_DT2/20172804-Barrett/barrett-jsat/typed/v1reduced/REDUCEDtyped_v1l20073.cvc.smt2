...
(assert
 (and (not ((_ is zero) contrived_variable0))
  ((_ is node) contrived_variable1)))
(assert
 (or
  (and ((_ is cons) contrived_variable3) (and
   (= (car contrived_variable2) contrived_variable1)
   (= (cons contrived_variable4 contrived_variable5) contrived_variable2)
   (= (car contrived_variable2) contrived_variable4)
   (= (cdr contrived_variable2) contrived_variable5)))
  (and (not ((_ is cons) contrived_variable3)) (and
   (= (leaf zero) contrived_variable1) (is-leaf contrived_variable1)
   (= (data contrived_variable1) zero)))))
(assert
 (or
  (and ((_ is succ) x1) (and (= (pred x1) contrived_variable0)
   (= (succ contrived_variable6) x1) (= (pred x1) contrived_variable6)))
  (and (not ((_ is succ) x1)) (= contrived_variable0 zero))))
(assert
 (or
  (and ((_ is node) x3) (and (= (children x3) contrived_variable3)
   (= (node contrived_variable7) x3) (= (children x3) contrived_variable7)))
  (and (not ((_ is node) x3)) (= contrived_variable3 null))))
(assert
 (or
  (and ((_ is node) x3) (and (= (children x3) contrived_variable2)
   (= (node contrived_variable8) x3) (= (children x3) contrived_variable8)))
  (and (not ((_ is node) x3)) (= contrived_variable2 null))))
(assert
