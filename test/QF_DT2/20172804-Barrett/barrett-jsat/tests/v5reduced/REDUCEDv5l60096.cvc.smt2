...
(assert (is-null null))
(assert
 (and (and (and (and (and (not (= contrived_variable1 contrived_variable0))
  (= x5 x3)) (= zero contrived_variable2))
  (not ((_ is succ) contrived_variable4))) (not (= x9 null)))
  (not ((_ is zero) contrived_variable5))))
(assert
 (and (= (succ x5) contrived_variable1) (is-succ contrived_variable1)
  (= (pred contrived_variable1) x5)))
(assert
 (and (= (pred zero) contrived_variable0) (= (succ contrived_variable6) zero)
  (= (pred zero) contrived_variable6)))
(assert
 (and (= (data x14) contrived_variable4) (= (leaf contrived_variable7) x14)
  (= (data x14) contrived_variable7)))
(assert
 (and (= (succ x4) contrived_variable3) (is-succ contrived_variable3)
  (= (pred contrived_variable3) x4)))
(assert
 (and (= (pred zero) contrived_variable5) (= (succ contrived_variable8) zero)
