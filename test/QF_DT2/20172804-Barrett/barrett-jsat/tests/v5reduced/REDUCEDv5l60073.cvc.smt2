...
(assert (is-null null))
(assert
 (and (and (and (and (and (= x12 x13) (= x11 x11)) (not (= x1 x3)))
  (= contrived_variable0 x14)) (= x9 x10)) ((_ is cons) x6)))
(assert
 (and (= (car x8) contrived_variable0)
  (= (cons contrived_variable1 contrived_variable2) x8)
  (= (car x8) contrived_variable1) (= (cdr x8) contrived_variable2)))
(assert
