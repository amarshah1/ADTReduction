...
(assert (is-null null))
(assert
 (and (not ((_ is cons) contrived_variable0)) (not ((_ is cons) null))))
(assert
 (and (= (children x14) contrived_variable0)
  (= (node contrived_variable1) x14) (= (children x14) contrived_variable1)))
(assert
