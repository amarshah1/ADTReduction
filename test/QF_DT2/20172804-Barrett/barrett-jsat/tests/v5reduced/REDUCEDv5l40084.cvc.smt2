...
(assert (is-null null))
(assert
 (and (and (and ((_ is null) null) (= x10 x8)) (= x9 x10))
  (= x7 contrived_variable0)))
(assert
 (and (= (cons contrived_variable2 x7) contrived_variable1)
  (is-cons contrived_variable1)
  (= (car contrived_variable1) contrived_variable2)
  (= (cdr contrived_variable1) x7)))
(assert
 (and (= (cons x15 contrived_variable1) contrived_variable0)
  (is-cons contrived_variable0) (= (car contrived_variable0) x15)
  (= (cdr contrived_variable0) contrived_variable1)))
(assert
 (and (= (leaf x2) contrived_variable2) (is-leaf contrived_variable2)
  (= (data contrived_variable2) x2)))
(assert
