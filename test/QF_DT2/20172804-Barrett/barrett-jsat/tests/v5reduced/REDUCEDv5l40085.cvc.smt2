...
(assert (is-null null))
(assert
 (and (and (and (= null contrived_variable0) (not ((_ is node) x13)))
  (not ((_ is zero) contrived_variable1))) (= x2 x1)))
(assert
 (and (= (data x12) contrived_variable1) (= (leaf contrived_variable2) x12)
  (= (data x12) contrived_variable2)))
(assert
 (and (= (cdr x10) contrived_variable0)
  (= (cons contrived_variable3 contrived_variable4) x10)
  (= (car x10) contrived_variable3) (= (cdr x10) contrived_variable4)))
(assert
