...
(assert (is-null null))
(assert
 (and (and ((_ is succ) contrived_variable0) ((_ is zero) x5))
  (not ((_ is zero) contrived_variable1))))
(assert
 (and (= (pred x4) contrived_variable1) (= (succ contrived_variable2) x4)
  (= (pred x4) contrived_variable2)))
(assert
 (and (= (pred x2) contrived_variable0) (= (succ contrived_variable3) x2)
  (= (pred x2) contrived_variable3)))
(assert
