...
(assert (is-zero zero))
(assert (is-null null))
(assert (and ((_ is cons) x8) (not (= contrived_variable0 x13))))
(assert
 (and (= (cons x13 x10) contrived_variable1) (is-cons contrived_variable1)
  (= (car contrived_variable1) x13) (= (cdr contrived_variable1) x10)))
(assert
