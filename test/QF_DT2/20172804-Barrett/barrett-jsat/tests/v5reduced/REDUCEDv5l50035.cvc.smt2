...
(assert (is-null null))
(assert
 (and (and (and (and (= x7 x9) (= contrived_variable0 x14))
  (= x12 contrived_variable1)) (not (= x3 contrived_variable2)))
  (not (= null null))))
(assert
 (and (= (node x10) contrived_variable1) (is-node contrived_variable1)
  (= (children contrived_variable1) x10)))
(assert
 (and (= (leaf zero) contrived_variable0) (is-leaf contrived_variable0)
  (= (data contrived_variable0) zero)))
(assert
 (and (= (succ zero) contrived_variable2) (is-succ contrived_variable2)
  (= (pred contrived_variable2) zero)))
(assert
