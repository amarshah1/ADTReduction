...
(assert (is-null null))
(assert
 (and (and (and (and (not (= x6 contrived_variable0)) (= x8 x6))
  ((_ is null) x10)) (is-leaf x14)) (is-leaf x11)))
(assert
 (and (= (node x7) contrived_variable1) (is-node contrived_variable1)
  (= (children contrived_variable1) x7)))
(assert
 (and (= (children contrived_variable1) contrived_variable0)
  (= (node contrived_variable2) contrived_variable1)
