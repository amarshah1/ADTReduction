...
(assert (is-null null))
(assert
 (and (and (and (= x12 x14) (not ((_ is succ) contrived_variable0)))
  (= x4 contrived_variable1)) (= x12 contrived_variable3)))
(assert
 (and (= (pred contrived_variable2) contrived_variable1)
  (= (succ contrived_variable4) contrived_variable2)
  (= (pred contrived_variable2) contrived_variable4)))
(assert
 (and (= (data x15) contrived_variable0) (= (leaf contrived_variable5) x15)
  (= (data x15) contrived_variable5)))
(assert
 (and (= (leaf zero) contrived_variable3) (is-leaf contrived_variable3)
  (= (data contrived_variable3) zero)))
(assert
 (and (= (data x13) contrived_variable2) (= (leaf contrived_variable6) x13)
  (= (data x13) contrived_variable6)))
(assert
