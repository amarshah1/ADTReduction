...
(assert (is-null null))
(assert
 (and (and (and (and ((_ is zero) contrived_variable0)
  (= x14 contrived_variable1)) ((_ is succ) contrived_variable2))
  (not (= contrived_variable3 x1))) (= x9 x9)))
(assert
 (and (= (node x6) contrived_variable1) (is-node contrived_variable1)
  (= (children contrived_variable1) x6)))
(assert
 (and (= (succ x1) contrived_variable0) (is-succ contrived_variable0)
  (= (pred contrived_variable0) x1)))
(assert
 (and (= (pred x4) contrived_variable3) (= (succ contrived_variable4) x4)
  (= (pred x4) contrived_variable4)))
(assert
 (and (= (data x12) contrived_variable2) (= (leaf contrived_variable5) x12)
  (= (data x12) contrived_variable5)))
(assert
