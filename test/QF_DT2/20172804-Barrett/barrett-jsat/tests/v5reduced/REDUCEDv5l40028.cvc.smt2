...
(assert (is-null null))
(assert
 (and (and (and (= x8 x10) (not ((_ is node) x14)))
  (not (= x12 contrived_variable0))) (not ((_ is succ) contrived_variable1))))
(assert
 (and (= (data contrived_variable2) contrived_variable1)
  (= (leaf contrived_variable5) contrived_variable2)
  (= (data contrived_variable2) contrived_variable5)))
(assert
 (and (= (node x10) contrived_variable0) (is-node contrived_variable0)
  (= (children contrived_variable0) x10)))
(assert
 (and (= (data x11) contrived_variable4) (= (leaf contrived_variable6) x11)
  (= (data x11) contrived_variable6)))
(assert
 (and (= (pred contrived_variable4) contrived_variable3)
  (= (succ contrived_variable7) contrived_variable4)
  (= (pred contrived_variable4) contrived_variable7)))
(assert
