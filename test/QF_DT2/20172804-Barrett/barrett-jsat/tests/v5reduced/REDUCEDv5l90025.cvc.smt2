...
(assert (is-null null))
(assert
 (and (and (and (and (and (and (and (and (not (= x7 x6)) (not (is-leaf x11)))
  (null x6)) (succ x3)) (succ x4)) (not (= x5 contrived_variable0)))
  (cons x10)) (not (= x8 contrived_variable1))) (succ contrived_variable3)))
(assert
 (and (= (children contrived_variable2) contrived_variable1)
  (= (node contrived_variable4) contrived_variable2)
  (= (children contrived_variable2) contrived_variable4)))
(assert
 (and (= (data x11) contrived_variable0) (= (leaf contrived_variable5) x11)
  (= (data x11) contrived_variable5)))
(assert
 (and (= (succ x1) contrived_variable3) (is-succ contrived_variable3)
  (= (pred contrived_variable3) x1)))
(assert
 (and (= (node x6) contrived_variable2) (is-node contrived_variable2)
  (= (children contrived_variable2) x6)))
(assert
