...
(assert (is-null null))
(assert
 (and (and (and (and (and (and (not (is-leaf x11)) (= x5 x2)) (= x3 x2))
  ((_ is succ) x3)) (= x5 contrived_variable0)) (= contrived_variable1 x12))
  (not ((_ is zero) x4))))
(assert
 (and (= (node contrived_variable2) contrived_variable1)
  (is-node contrived_variable1)
  (= (children contrived_variable1) contrived_variable2)))
(assert
 (and (= (succ x2) contrived_variable0) (is-succ contrived_variable0)
  (= (pred contrived_variable0) x2)))
(assert
 (and (= (cdr x7) contrived_variable2)
  (= (cons contrived_variable3 contrived_variable4) x7)
  (= (car x7) contrived_variable3) (= (cdr x7) contrived_variable4)))
(assert
