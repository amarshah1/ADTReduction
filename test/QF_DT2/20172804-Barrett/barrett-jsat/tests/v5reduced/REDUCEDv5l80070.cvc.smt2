...
(assert (is-null null))
(assert
 (and (and (and (and (and (and (and (not ((_ is succ) x2))
  (not (= contrived_variable0 x3))) (= contrived_variable1 x2))
  (not (= contrived_variable2 x15))) (not (= zero x3)))
  ((_ is succ) contrived_variable3)) ((_ is cons) x7))
  (not ((_ is cons) null))))
(assert
 (and (= (pred x3) contrived_variable1) (= (succ contrived_variable6) x3)
  (= (pred x3) contrived_variable6)))
(assert
 (and (= (succ x3) contrived_variable0) (is-succ contrived_variable0)
  (= (pred contrived_variable0) x3)))
(assert
 (and (= (pred contrived_variable5) contrived_variable4)
  (= (succ contrived_variable7) contrived_variable5)
  (= (pred contrived_variable5) contrived_variable7)))
(assert
...
(assert
 (and (= (succ zero) contrived_variable5) (is-succ contrived_variable5)
  (= (pred contrived_variable5) zero)))
(assert
 (and (= (car x7) contrived_variable2)
  (= (cons contrived_variable9 contrived_variable10) x7)
  (= (car x7) contrived_variable9) (= (cdr x7) contrived_variable10)))
(assert
 (or
