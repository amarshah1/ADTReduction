...
(assert (is-null null))
(assert
 (and (and (and (and (and (and (and (not (is-leaf x15)) (node x12))
  (null x7)) (is-leaf x12)) (cons contrived_variable0)) (succ x1))
  (node x15)) (succ contrived_variable1)))
(assert
 (and (= (pred x1) contrived_variable1) (= (succ contrived_variable2) x1)
  (= (pred x1) contrived_variable2)))
(assert
 (and (= (cdr x9) contrived_variable0)
  (= (cons contrived_variable3 contrived_variable4) x9)
  (= (car x9) contrived_variable3) (= (cdr x9) contrived_variable4)))
(assert
