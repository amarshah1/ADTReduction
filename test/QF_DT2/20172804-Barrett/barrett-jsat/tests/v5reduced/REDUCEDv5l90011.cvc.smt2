...
(assert (is-null null))
(assert
 (and (and (and (and (and (and (and (and (not (= x6 x7)) ((_ is null) x8))
  (not (= x1 contrived_variable0))) (not ((_ is succ) x3))) (= x7 x6))
  (not ((_ is node) contrived_variable2)))
  (not (= contrived_variable4 zero))) (= x12 x15))
  (not (= contrived_variable5 x12))))
(assert
...
(assert
 (and (= (succ x5) contrived_variable4) (is-succ contrived_variable4)
  (= (pred contrived_variable4) x5)))
(assert
 (and (= (pred zero) contrived_variable3) (= (succ contrived_variable8) zero)
  (= (pred zero) contrived_variable8)))
(assert
 (and (= (leaf contrived_variable6) contrived_variable5)
  (is-leaf contrived_variable5)
  (= (data contrived_variable5) contrived_variable6)))
(assert
