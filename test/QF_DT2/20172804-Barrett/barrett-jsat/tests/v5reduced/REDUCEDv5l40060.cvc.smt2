...
(assert (is-null null))
(assert
 (and (and (and (= contrived_variable3 contrived_variable0)
  (= x14 contrived_variable4)) (not (= x2 x3))) (= x5 x5)))
(assert
 (and (= (pred contrived_variable2) contrived_variable1)
  (= (succ contrived_variable5) contrived_variable2)
  (= (pred contrived_variable2) contrived_variable5)))
(assert
 (and (= (succ contrived_variable1) contrived_variable0)
  (is-succ contrived_variable0)
  (= (pred contrived_variable0) contrived_variable1)))
(assert
 (and (= (car x8) contrived_variable4)
  (= (cons contrived_variable6 contrived_variable7) x8)
  (= (car x8) contrived_variable6) (= (cdr x8) contrived_variable7)))
(assert
 (and (= (pred zero) contrived_variable3) (= (succ contrived_variable8) zero)
  (= (pred zero) contrived_variable8)))
(assert
 (and (= (pred zero) contrived_variable2) (= (succ contrived_variable9) zero)
  (= (pred zero) contrived_variable9)))
(assert
