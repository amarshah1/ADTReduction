...
(assert (is-null null))
(assert
 (and (and (and (and (and (and (and (and (is-leaf x14) (not (= zero x1)))
  (not (is-leaf x15))) (= x5 contrived_variable0))
  (= contrived_variable1 x9))
  (not (= contrived_variable4 contrived_variable3))) (not ((_ is cons) x10)))
  ((_ is null) x6)) (not ((_ is cons) x9))))
(assert
 (and (= (cons contrived_variable2 null) contrived_variable1)
  (is-cons contrived_variable1)
  (= (car contrived_variable1) contrived_variable2)
  (= (cdr contrived_variable1) null)))
(assert
 (and (= (pred x5) contrived_variable0) (= (succ contrived_variable6) x5)
  (= (pred x5) contrived_variable6)))
(assert
 (and (= (data contrived_variable5) contrived_variable4)
  (= (leaf contrived_variable7) contrived_variable5)
  (= (data contrived_variable5) contrived_variable7)))
(assert
 (and (= (succ x1) contrived_variable3) (is-succ contrived_variable3)
  (= (pred contrived_variable3) x1)))
(assert
 (and (= (node x10) contrived_variable5) (is-node contrived_variable5)
  (= (children contrived_variable5) x10)))
(assert
