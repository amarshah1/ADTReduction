...
(assert (is-null null))
(assert
 (and (and (and (and (and (and (not ((_ is null) x10)) (= zero zero))
  (= x11 x12)) ((_ is node) x11)) (not (= x13 x13))) (not (= x3 x5)))
  (not ((_ is cons) contrived_variable0))))
(assert
 (and (= (children x15) contrived_variable0)
  (= (node contrived_variable1) x15) (= (children x15) contrived_variable1)))
(assert
