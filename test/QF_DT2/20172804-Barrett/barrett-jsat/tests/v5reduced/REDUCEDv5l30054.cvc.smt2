...
(assert (is-null null))
(assert
 (and (and (not (= contrived_variable0 x4)) (is-leaf x12))
  (not (= contrived_variable2 contrived_variable1))))
(assert
 (and (= (leaf x2) contrived_variable1) (is-leaf contrived_variable1)
  (= (data contrived_variable1) x2)))
(assert
 (and (= (data x11) contrived_variable0) (= (leaf contrived_variable3) x11)
  (= (data x11) contrived_variable3)))
(assert
