...
(assert (is-zero zero))
(assert (is-null null))
(assert (and ((_ is null) contrived_variable0) (= x3 contrived_variable1)))
(assert
 (and (= (succ x3) contrived_variable1) (is-succ contrived_variable1)
  (= (pred contrived_variable1) x3)))
(assert
 (and (= (cdr x8) contrived_variable0)
  (= (cons contrived_variable2 contrived_variable3) x8)
  (= (car x8) contrived_variable2) (= (cdr x8) contrived_variable3)))
(assert
