...
(assert (is-null null))
(assert
 (and (and (and (not ((_ is null) x6)) (is-leaf contrived_variable0))
  (= x4 contrived_variable1)) ((_ is null) null)))
(assert
 (and (= (succ x4) contrived_variable1) (is-succ contrived_variable1)
  (= (pred contrived_variable1) x4)))
(assert
 (and (= (car x9) contrived_variable0)
  (= (cons contrived_variable2 contrived_variable3) x9)
  (= (car x9) contrived_variable2) (= (cdr x9) contrived_variable3)))
(assert
