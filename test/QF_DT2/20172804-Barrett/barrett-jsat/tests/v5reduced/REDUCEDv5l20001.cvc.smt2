...
(assert (is-zero zero))
(assert (is-null null))
(assert (and (not ((_ is null) x10)) (not (= contrived_variable0 x8))))
(assert
 (and (= (cdr x10) contrived_variable0)
  (= (cons contrived_variable1 contrived_variable2) x10)
  (= (car x10) contrived_variable1) (= (cdr x10) contrived_variable2)))
(assert
