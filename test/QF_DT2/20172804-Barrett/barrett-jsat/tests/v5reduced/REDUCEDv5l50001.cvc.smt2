...
(assert (is-null null))
(assert
 (and (and (and (and (not (= x5 contrived_variable0))
  (not (is-leaf contrived_variable2))) (not ((_ is succ) x1)))
  (= x15 x13)) (= x6 contrived_variable3)))
(assert
...
(assert
 (and (= (pred contrived_variable1) contrived_variable0)
  ...
  (= (pred contrived_variable1) contrived_variable4)))
(assert
 (and (= (cdr x7) contrived_variable3)
