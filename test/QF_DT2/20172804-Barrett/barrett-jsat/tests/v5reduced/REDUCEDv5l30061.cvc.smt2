...
(assert (is-null null))
(assert
 (and (and (not (= x12 contrived_variable0))
  ((_ is null) contrived_variable1)) (not ((_ is null) x7))))
(assert
 (and (= (children contrived_variable2) contrived_variable1)
  (= (node contrived_variable3) contrived_variable2)
  (= (children contrived_variable2) contrived_variable3)))
(assert
 (and (= (leaf zero) contrived_variable0) (is-leaf contrived_variable0)
  (= (data contrived_variable0) zero)))
(assert
