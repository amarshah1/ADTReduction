...
(assert (is-null null))
(assert
 (and (and (and (and (is-leaf contrived_variable0)
  (not (= contrived_variable2 x8))) (not (= x15 x15))) ((_ is null) x9))
  (not (= x8 x9))))
(assert
 (and (= (succ x5) contrived_variable1) (is-succ contrived_variable1)
  (= (pred contrived_variable1) x5)))
(assert
