...
(assert (is-null null))
(assert
 (and (and (and (not (= contrived_variable0 x9)) (= x1 contrived_variable1))
  (= contrived_variable2 x4)) ((_ is cons) x8)))
(assert
 (and (= (pred zero) contrived_variable1) (= (succ contrived_variable4) zero)
  (= (pred zero) contrived_variable4)))
(assert
 (and (= (children x13) contrived_variable0)
  (= (node contrived_variable5) x13) (= (children x13) contrived_variable5)))
(assert
 (and (= (pred x2) contrived_variable3) (= (succ contrived_variable6) x2)
  (= (pred x2) contrived_variable6)))
(assert
 ...
 (not
  (=
   (pred (data (car (cdr (children (car (children (car
    contrived_variable5))))))))
   (data (car (cdr (children (car (children (car contrived_variable5))))))))))
(assert
 (not
 ...
 (not
  (=
   (pred (data (car (children (car (cdr (children (car
    contrived_variable5))))))))
   (data (car (children (car (cdr (children (car contrived_variable5))))))))))
(assert
 (not
...
(assert
 (not
  (=
   (pred (pred (data (car (cdr (cdr (children (car contrived_variable5))))))))
   (pred (data (car (cdr (cdr (children (car contrived_variable5))))))))))
(assert
 (not
  (=
...
(assert
 (not
  (=
   (pred (data (car (cdr (cdr (cdr (children (car contrived_variable5))))))))
   (data (car (cdr (cdr (cdr (children (car contrived_variable5))))))))))
(assert
 (not
...
(assert
 (not
  (= (car (cdr (cdr (cdr (cdr (cdr (children (car contrived_variable5))))))))
   (car contrived_variable5))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (children (car contrived_variable5))))))))
   (cdr (cdr (cdr (cdr (cdr (children (car contrived_variable5))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (children (car contrived_variable5))))))))
...
(assert
 (not
  (=
   (pred (pred (pred (pred (pred (pred (data (car contrived_variable5))))))))
   (pred (pred (pred (pred (pred (data (car contrived_variable5))))))))))
(assert
 (not
  (=
 ...
 (not
  (=
   (pred (data (car (children (car (children (car (cdr
    contrived_variable5))))))))
   (data (car (children (car (children (car (cdr contrived_variable5))))))))))
(assert
 (not
...
(assert
 (not
  (=
   (pred (pred (data (car (cdr (children (car (cdr contrived_variable5))))))))
   (pred (data (car (cdr (children (car (cdr contrived_variable5))))))))))
(assert
 (not
  (=
...
(assert
 (not
  (=
   (pred (data (car (cdr (cdr (children (car (cdr contrived_variable5))))))))
   (data (car (cdr (cdr (children (car (cdr contrived_variable5))))))))))
(assert
 (not
...
(assert
 (not
  (= (car (cdr (cdr (cdr (cdr (children (car (cdr contrived_variable5))))))))
   (car (cdr contrived_variable5)))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (children (car (cdr contrived_variable5))))))))
   (cdr (cdr (cdr (cdr (children (car (cdr contrived_variable5))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (children (car (cdr contrived_variable5))))))))
...
(assert
 (not
  (=
   (pred (pred (pred (pred (pred (data (car (cdr contrived_variable5))))))))
   (pred (pred (pred (pred (data (car (cdr contrived_variable5))))))))))
(assert
 (not
  (=
...
(assert
 (not
  (=
   (pred (pred (data (car (children (car (cdr (cdr contrived_variable5))))))))
   (pred (data (car (children (car (cdr (cdr contrived_variable5))))))))))
(assert
 (not
  (=
...
(assert
 (not
  (=
   (pred (data (car (cdr (children (car (cdr (cdr contrived_variable5))))))))
   (data (car (cdr (children (car (cdr (cdr contrived_variable5))))))))))
(assert
 (not
...
(assert
 (not
  (= (car (cdr (cdr (cdr (children (car (cdr (cdr contrived_variable5))))))))
   (car (cdr (cdr contrived_variable5))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (cdr (cdr contrived_variable5))))))))
   (cdr (cdr (cdr (children (car (cdr (cdr contrived_variable5))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (children (car (cdr (cdr contrived_variable5))))))))
...
(assert
 (not
  (= (pred (pred (pred (pred (data (car (cdr (cdr contrived_variable5))))))))
   (pred (pred (pred (data (car (cdr (cdr contrived_variable5))))))))))
(assert
 (not
  (= (pred (pred (pred (pred (data (car (cdr (cdr contrived_variable5))))))))
...
(assert
 (not
  (=
   (pred (data (car (children (car (cdr (cdr (cdr contrived_variable5))))))))
   (data (car (children (car (cdr (cdr (cdr contrived_variable5))))))))))
(assert
 (not
...
(assert
 (not
  (= (car (cdr (cdr (children (car (cdr (cdr (cdr contrived_variable5))))))))
   (car (cdr (cdr (cdr contrived_variable5)))))))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (cdr (cdr contrived_variable5))))))))
   (cdr (cdr (children (car (cdr (cdr (cdr contrived_variable5))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (children (car (cdr (cdr (cdr contrived_variable5))))))))
...
(assert
 (not
  (= (pred (pred (pred (data (car (cdr (cdr (cdr contrived_variable5))))))))
   (pred (pred (data (car (cdr (cdr (cdr contrived_variable5))))))))))
(assert
 (not
  (= (pred (pred (pred (data (car (cdr (cdr (cdr contrived_variable5))))))))
...
(assert
 (not
  (= (car (cdr (children (car (cdr (cdr (cdr (cdr contrived_variable5))))))))
   (car (cdr (cdr (cdr (cdr contrived_variable5))))))))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (cdr (cdr contrived_variable5))))))))
   (cdr (children (car (cdr (cdr (cdr (cdr contrived_variable5))))))))))
(assert
 (not
  (= (cdr (cdr (children (car (cdr (cdr (cdr (cdr contrived_variable5))))))))
...
(assert
 (not
  (= (pred (pred (data (car (cdr (cdr (cdr (cdr contrived_variable5))))))))
   (pred (data (car (cdr (cdr (cdr (cdr contrived_variable5))))))))))
(assert
 (not
  (= (pred (pred (data (car (cdr (cdr (cdr (cdr contrived_variable5))))))))
...
(assert
 (not
  (= (car (children (car (cdr (cdr (cdr (cdr (cdr contrived_variable5))))))))
   (car (cdr (cdr (cdr (cdr (cdr contrived_variable5)))))))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (cdr (cdr contrived_variable5))))))))
   (children (car (cdr (cdr (cdr (cdr (cdr contrived_variable5))))))))))
(assert
 (not
  (= (cdr (children (car (cdr (cdr (cdr (cdr (cdr contrived_variable5))))))))
...
(assert
 (not
  (= (pred (data (car (cdr (cdr (cdr (cdr (cdr contrived_variable5))))))))
   (data (car (cdr (cdr (cdr (cdr (cdr contrived_variable5))))))))))
(assert
 (not
...
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (cdr (cdr contrived_variable5))))))))
   (cdr (cdr (cdr (cdr (cdr (cdr contrived_variable5)))))))))
(assert
 (not
  (= (children (car (cdr (cdr (cdr (cdr (cdr (cdr contrived_variable5))))))))
...
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr (cdr contrived_variable5))))))))
   (cdr (cdr (cdr (cdr (cdr (cdr (cdr contrived_variable5))))))))))
(assert
 (not
  (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr (cdr contrived_variable5))))))))
