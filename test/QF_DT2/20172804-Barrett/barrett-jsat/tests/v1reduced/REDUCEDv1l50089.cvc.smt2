...
(assert true)
(assert
 (and (and (and (and (not (is-cons contrived_variable0)) (is-cons x2))
  (not (= x1 x1))) (is-zero x1)) (not (= (pred x1) zero))))
(assert
 (and (= (cdr null) contrived_variable0)
  (= (cons contrived_variable1 contrived_variable2) null)
  (=> (is-cons null)
   (and (= (car null) contrived_variable1) (= (cdr null) contrived_variable2)))))
(assert
 (or (and (not (is-cons contrived_variable2)) (is-null contrived_variable2))
...
(assert
 (or (and (not (is-node contrived_variable1)) (is-leaf contrived_variable1))
...
(assert
 (=> (and (is-cons (cdr contrived_variable2)))
  (not (= (cdr (cdr contrived_variable2)) (cdr contrived_variable2)))))
(assert
 (=> (and (is-cons contrived_variable2) (is-cons (cdr contrived_variable2)))
  (not (= (cdr (cdr contrived_variable2)) contrived_variable2))))
(assert
 (=> (and (is-cons (cdr (cdr contrived_variable2))))
  (not
   (= (cdr (cdr (cdr contrived_variable2))) (cdr (cdr contrived_variable2))))))
(assert
 (=>
  (and (is-cons (cdr contrived_variable2))
   (is-cons (cdr (cdr contrived_variable2))))
  (not (= (cdr (cdr (cdr contrived_variable2))) (cdr contrived_variable2)))))
(assert
 (=>
  (and (is-cons contrived_variable2) (is-cons (cdr contrived_variable2))
   (is-cons (cdr (cdr contrived_variable2))))
  (not (= (cdr (cdr (cdr contrived_variable2))) contrived_variable2))))
(assert
 (=> (and (is-cons (cdr (cdr (cdr contrived_variable2)))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (cdr contrived_variable2)))
   (is-cons (cdr (cdr (cdr contrived_variable2)))))
  (not
   (= (cdr (cdr (cdr (cdr contrived_variable2))))
...
(assert
 (=> (and (is-cons (cdr (cdr (cdr (cdr contrived_variable2))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (cdr (cdr contrived_variable2))))
   (is-cons (cdr (cdr (cdr (cdr contrived_variable2))))))
  (not
   (= (cdr (cdr (cdr (cdr (cdr contrived_variable2)))))
    (cdr (cdr (cdr contrived_variable2)))))))
(assert
...
(assert
 (=> (and (is-cons (cdr (cdr (cdr (cdr (cdr contrived_variable2)))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (cdr (cdr (cdr contrived_variable2)))))
   (is-cons (cdr (cdr (cdr (cdr (cdr contrived_variable2)))))))
  (not
   (= (cdr (cdr (cdr (cdr (cdr (cdr contrived_variable2))))))
    (cdr (cdr (cdr (cdr contrived_variable2))))))))
(assert
 ...
 (=>
  ...
  (not
   (= (cdr (cdr (cdr (cdr (cdr (cdr contrived_variable2))))))
    contrived_variable2))))
(assert
 (=> (and (is-cons (cdr (cdr (cdr (cdr (cdr (cdr contrived_variable2))))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (cdr (cdr (cdr (cdr contrived_variable2))))))
   (is-cons (cdr (cdr (cdr (cdr (cdr (cdr contrived_variable2))))))))
  (not
   (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr contrived_variable2)))))))
    (cdr (cdr (cdr (cdr (cdr contrived_variable2)))))))))
(assert
...
(assert
 (=>
  (and (is-cons (cdr (cdr (cdr (cdr (cdr contrived_variable2))))))
   (is-node (car (cdr (cdr (cdr (cdr (cdr contrived_variable2))))))))
  (not
...
(assert
 (=>
  ...
  (not (= (cdr (cdr (cdr (cdr contrived_variable2)))) contrived_variable2))))
(assert
 (=> (and (is-succ (data (car (cdr (cdr (cdr (cdr contrived_variable2))))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (cdr (cdr (cdr contrived_variable2)))))
   (is-node (car (cdr (cdr (cdr (cdr contrived_variable2)))))))
  (not
...
(assert
 (=>
  (and (is-cons (children (car (cdr (cdr (cdr (cdr contrived_variable2))))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (cdr (cdr (cdr contrived_variable2)))))
   (is-node (car (cdr (cdr (cdr (cdr contrived_variable2))))))
   (is-cons (children (car (cdr (cdr (cdr (cdr contrived_variable2))))))))
  (not
   (= (cdr (children (car (cdr (cdr (cdr (cdr contrived_variable2)))))))
    (cdr (cdr (cdr (cdr contrived_variable2))))))))
(assert
...
(assert
 (=>
  (and (is-node (car (cdr (cdr (cdr (cdr contrived_variable2))))))
   (is-cons (children (car (cdr (cdr (cdr (cdr contrived_variable2))))))))
  (not
...
(assert
 (=>
  ...
  (not (= (cdr (cdr (cdr contrived_variable2))) contrived_variable2))))
(assert
 (=> (and (is-succ (data (car (cdr (cdr (cdr contrived_variable2)))))))
  (not
   (= (pred (data (car (cdr (cdr (cdr contrived_variable2))))))
    (data (car (cdr (cdr (cdr contrived_variable2)))))))))
(assert
 (=>
  (and (is-succ (pred (data (car (cdr (cdr (cdr contrived_variable2))))))))
  (not
...
(assert
 (=>
  (and (is-succ (data (car (cdr (cdr (cdr contrived_variable2))))))
   (is-succ (pred (data (car (cdr (cdr (cdr contrived_variable2))))))))
  (not
   (= (pred (pred (data (car (cdr (cdr (cdr contrived_variable2)))))))
    (data (car (cdr (cdr (cdr contrived_variable2)))))))))
(assert
...
(assert
 (=>
  (and (is-cons (cdr (cdr (cdr contrived_variable2))))
   (is-node (car (cdr (cdr (cdr contrived_variable2))))))
  (not
 ...
 (=>
  ...
  (not
   (= (children (car (cdr (cdr (cdr contrived_variable2)))))
    contrived_variable2))))
(assert
 (=> (and (is-cons (children (car (cdr (cdr (cdr contrived_variable2)))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (cdr (cdr contrived_variable2))))
   (is-node (car (cdr (cdr (cdr contrived_variable2)))))
   (is-cons (children (car (cdr (cdr (cdr contrived_variable2)))))))
  (not
   (= (cdr (children (car (cdr (cdr (cdr contrived_variable2))))))
    (cdr (cdr (cdr contrived_variable2)))))))
(assert
...
(assert
 (=>
  (and (is-cons (cdr (children (car (cdr (cdr (cdr contrived_variable2))))))))
  (not
...
(assert
 (=>
  (and (is-cons (children (car (cdr (cdr (cdr contrived_variable2))))))
   (is-cons (cdr (children (car (cdr (cdr (cdr contrived_variable2))))))))
  (not
   (= (cdr (cdr (children (car (cdr (cdr (cdr contrived_variable2)))))))
    (children (car (cdr (cdr (cdr contrived_variable2)))))))))
(assert
...
(assert
 (=>
  (and (is-node (car (cdr (cdr (cdr contrived_variable2)))))
   (is-cons (children (car (cdr (cdr (cdr contrived_variable2))))))
   (is-cons (cdr (children (car (cdr (cdr (cdr contrived_variable2))))))))
  (not
...
(assert
 (=>
  (and (is-cons (children (car (cdr (cdr (cdr contrived_variable2))))))
   (is-node (car (children (car (cdr (cdr (cdr contrived_variable2))))))))
  (not
...
(assert
 (=> (and (is-cons contrived_variable2) (is-cons (cdr contrived_variable2)))
  (not (= (cdr (cdr contrived_variable2)) contrived_variable2))))
(assert
 (=> (and (is-succ (data (car (cdr (cdr contrived_variable2))))))
  (not
   (= (pred (data (car (cdr (cdr contrived_variable2)))))
    (data (car (cdr (cdr contrived_variable2))))))))
(assert
 (=> (and (is-succ (pred (data (car (cdr (cdr contrived_variable2)))))))
  (not
...
(assert
 (=>
  (and (is-succ (data (car (cdr (cdr contrived_variable2)))))
   (is-succ (pred (data (car (cdr (cdr contrived_variable2)))))))
  (not
   (= (pred (pred (data (car (cdr (cdr contrived_variable2))))))
    (data (car (cdr (cdr contrived_variable2))))))))
(assert
 (=>
  (and (is-succ (pred (pred (data (car (cdr (cdr contrived_variable2))))))))
  (not
...
(assert
 (=>
  (and (is-succ (pred (data (car (cdr (cdr contrived_variable2))))))
   (is-succ (pred (pred (data (car (cdr (cdr contrived_variable2))))))))
  (not
   (= (pred (pred (pred (data (car (cdr (cdr contrived_variable2)))))))
    (pred (data (car (cdr (cdr contrived_variable2)))))))))
(assert
...
(assert
 (=>
  (and (is-cons (cdr (cdr contrived_variable2)))
   (is-node (car (cdr (cdr contrived_variable2)))))
  (not
...
(assert
 (=> (and (is-cons (children (car (cdr (cdr contrived_variable2))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (cdr contrived_variable2)))
   (is-node (car (cdr (cdr contrived_variable2))))
   (is-cons (children (car (cdr (cdr contrived_variable2))))))
  (not
   (= (cdr (children (car (cdr (cdr contrived_variable2)))))
    (cdr (cdr contrived_variable2))))))
(assert
 ...
 (=>
  ...
  (not
   (= (cdr (children (car (cdr (cdr contrived_variable2)))))
    contrived_variable2))))
(assert
 (=> (and (is-cons (cdr (children (car (cdr (cdr contrived_variable2)))))))
  (not
...
(assert
 (=>
  (and (is-cons (children (car (cdr (cdr contrived_variable2)))))
   (is-cons (cdr (children (car (cdr (cdr contrived_variable2)))))))
  (not
   (= (cdr (cdr (children (car (cdr (cdr contrived_variable2))))))
    (children (car (cdr (cdr contrived_variable2))))))))
(assert
...
(assert
 (=>
  (and (is-cons (cdr (cdr (children (car (cdr (cdr contrived_variable2))))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (children (car (cdr (cdr contrived_variable2))))))
   (is-cons (cdr (cdr (children (car (cdr (cdr contrived_variable2))))))))
  (not
   (= (cdr (cdr (cdr (children (car (cdr (cdr contrived_variable2)))))))
    (cdr (children (car (cdr (cdr contrived_variable2)))))))))
(assert
...
(assert
 (=>
  (and (is-node (car (cdr (cdr contrived_variable2))))
   (is-cons (children (car (cdr (cdr contrived_variable2)))))
   (is-cons (cdr (children (car (cdr (cdr contrived_variable2))))))
   (is-cons (cdr (cdr (children (car (cdr (cdr contrived_variable2))))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (children (car (cdr (cdr contrived_variable2))))))
   (is-node (car (cdr (children (car (cdr (cdr contrived_variable2))))))))
  (not
...
(assert
 (=>
  (and
   (is-succ (data (car (children (car (cdr (cdr contrived_variable2))))))))
  (not
...
(assert
 (=>
  (and (is-cons (children (car (cdr (cdr contrived_variable2)))))
   (is-node (car (children (car (cdr (cdr contrived_variable2)))))))
  (not
...
(assert
 (=>
  (and
   (is-cons (children (car (children (car (cdr (cdr contrived_variable2))))))))
  (not
...
(assert
 (=>
  (and (is-node (car (children (car (cdr (cdr contrived_variable2))))))
   (is-cons (children (car (children (car (cdr (cdr contrived_variable2))))))))
  (not
...
(assert
 (=> (and (is-cons contrived_variable2))
  (not (= (cdr contrived_variable2) contrived_variable2))))
(assert
 (=> (and (is-succ (data (car (cdr contrived_variable2)))))
  (not
   (= (pred (data (car (cdr contrived_variable2))))
    (data (car (cdr contrived_variable2)))))))
(assert
 (=> (and (is-succ (pred (data (car (cdr contrived_variable2))))))
  (not
...
(assert
 (=>
  (and (is-succ (data (car (cdr contrived_variable2))))
   (is-succ (pred (data (car (cdr contrived_variable2))))))
  (not
   (= (pred (pred (data (car (cdr contrived_variable2)))))
    (data (car (cdr contrived_variable2)))))))
(assert
 (=> (and (is-succ (pred (pred (data (car (cdr contrived_variable2)))))))
  (not
...
(assert
 (=>
  (and (is-succ (pred (data (car (cdr contrived_variable2)))))
   (is-succ (pred (pred (data (car (cdr contrived_variable2)))))))
  (not
   (= (pred (pred (pred (data (car (cdr contrived_variable2))))))
    (pred (data (car (cdr contrived_variable2))))))))
(assert
...
(assert
 (=>
  (and (is-succ (pred (pred (pred (data (car (cdr contrived_variable2))))))))
  (not
...
(assert
 (=>
  (and (is-succ (pred (pred (data (car (cdr contrived_variable2))))))
   (is-succ (pred (pred (pred (data (car (cdr contrived_variable2))))))))
  (not
   (= (pred (pred (pred (pred (data (car (cdr contrived_variable2)))))))
    (pred (pred (data (car (cdr contrived_variable2)))))))))
(assert
...
(assert
 (=>
  (and (is-cons (cdr contrived_variable2))
   (is-node (car (cdr contrived_variable2))))
  (not
...
(assert
 (=> (and (is-cons (children (car (cdr contrived_variable2)))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr contrived_variable2))
   (is-node (car (cdr contrived_variable2)))
   (is-cons (children (car (cdr contrived_variable2)))))
  (not
   (= (cdr (children (car (cdr contrived_variable2))))
    (cdr contrived_variable2)))))
(assert
...
(assert
 (=> (and (is-cons (cdr (children (car (cdr contrived_variable2))))))
  (not
...
(assert
 (=>
  (and (is-cons (children (car (cdr contrived_variable2))))
   (is-cons (cdr (children (car (cdr contrived_variable2))))))
  (not
   (= (cdr (cdr (children (car (cdr contrived_variable2)))))
    (children (car (cdr contrived_variable2)))))))
(assert
 ...
 (=>
  ...
  (not
   (= (cdr (cdr (children (car (cdr contrived_variable2)))))
    contrived_variable2))))
(assert
 (=> (and (is-cons (cdr (cdr (children (car (cdr contrived_variable2)))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (children (car (cdr contrived_variable2)))))
   (is-cons (cdr (cdr (children (car (cdr contrived_variable2)))))))
  (not
   (= (cdr (cdr (cdr (children (car (cdr contrived_variable2))))))
    (cdr (children (car (cdr contrived_variable2))))))))
(assert
...
(assert
 (=>
  (and (is-cons (cdr (cdr (cdr (children (car (cdr contrived_variable2))))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (cdr (children (car (cdr contrived_variable2))))))
   (is-cons (cdr (cdr (cdr (children (car (cdr contrived_variable2))))))))
  (not
   (= (cdr (cdr (cdr (cdr (children (car (cdr contrived_variable2)))))))
    (cdr (cdr (children (car (cdr contrived_variable2)))))))))
(assert
...
(assert
 (=>
  (and (is-node (car (cdr contrived_variable2)))
   (is-cons (children (car (cdr contrived_variable2))))
   (is-cons (cdr (children (car (cdr contrived_variable2)))))
   (is-cons (cdr (cdr (children (car (cdr contrived_variable2))))))
   (is-cons (cdr (cdr (cdr (children (car (cdr contrived_variable2))))))))
...
(assert
 (=>
  (and (is-cons (cdr (cdr (children (car (cdr contrived_variable2))))))
   (is-node (car (cdr (cdr (children (car (cdr contrived_variable2))))))))
  (not
...
(assert
 (=>
  (and
   (is-succ (data (car (cdr (children (car (cdr contrived_variable2))))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (children (car (cdr contrived_variable2)))))
   (is-node (car (cdr (children (car (cdr contrived_variable2)))))))
  (not
...
(assert
 (=>
  (and
   (is-cons (children (car (cdr (children (car (cdr contrived_variable2))))))))
  (not
...
(assert
 (=>
  (and (is-node (car (cdr (children (car (cdr contrived_variable2))))))
   (is-cons (children (car (cdr (children (car (cdr contrived_variable2))))))))
  (not
 ...
 (=>
  ...
  (not
   (= (car (children (car (cdr contrived_variable2))))
    (car (cdr contrived_variable2))))))
(assert
 (=> (and (is-succ (data (car (children (car (cdr contrived_variable2)))))))
  (not
...
(assert
 (=>
  (and
   (is-succ (pred (data (car (children (car (cdr contrived_variable2))))))))
  (not
...
(assert
 (=>
  (and (is-cons (children (car (cdr contrived_variable2))))
   (is-node (car (children (car (cdr contrived_variable2))))))
  (not
...
(assert
 (=>
  (and (is-cons (children (car (children (car (cdr contrived_variable2)))))))
  (not
...
(assert
 (=>
  (and (is-cons (children (car (cdr contrived_variable2))))
   (is-node (car (children (car (cdr contrived_variable2)))))
   (is-cons (children (car (children (car (cdr contrived_variable2)))))))
  (not
   (= (cdr (children (car (children (car (cdr contrived_variable2))))))
    (children (car (cdr contrived_variable2)))))))
(assert
...
(assert
 (=>
  (and
   (is-cons (cdr (children (car (children (car (cdr contrived_variable2))))))))
  (not
...
(assert
 (=>
  (and (is-node (car (children (car (cdr contrived_variable2)))))
   (is-cons (children (car (children (car (cdr contrived_variable2))))))
   (is-cons (cdr (children (car (children (car (cdr contrived_variable2))))))))
  (not
...
(assert
 (=>
  (and (is-cons (children (car (children (car (cdr contrived_variable2))))))
   (is-node (car (children (car (children (car (cdr contrived_variable2))))))))
  (not
   (=
...
(assert
 (=> (and (is-cons contrived_variable2))
  (not (= (cdr contrived_variable2) contrived_variable2))))
(assert
 (=> (and (is-succ (data (car contrived_variable2))))
  (not
   (= (pred (data (car contrived_variable2)))
    (data (car contrived_variable2))))))
(assert
 (=> (and (is-succ (pred (data (car contrived_variable2)))))
  (not
...
(assert
 (=>
  (and (is-succ (data (car contrived_variable2)))
   (is-succ (pred (data (car contrived_variable2)))))
  (not
   (= (pred (pred (data (car contrived_variable2))))
    (data (car contrived_variable2))))))
(assert
 (=> (and (is-succ (pred (pred (data (car contrived_variable2))))))
  (not
...
(assert
 (=>
  (and (is-succ (pred (data (car contrived_variable2))))
   (is-succ (pred (pred (data (car contrived_variable2))))))
  (not
   (= (pred (pred (pred (data (car contrived_variable2)))))
    (pred (data (car contrived_variable2)))))))
(assert
 (=>
  ...
  (not
   (= (pred (pred (pred (data (car contrived_variable2)))))
    (data (car contrived_variable2))))))
(assert
 (=> (and (is-succ (pred (pred (pred (data (car contrived_variable2)))))))
  (not
...
(assert
 (=>
  (and (is-succ (pred (pred (data (car contrived_variable2)))))
   (is-succ (pred (pred (pred (data (car contrived_variable2)))))))
  (not
   (= (pred (pred (pred (pred (data (car contrived_variable2))))))
    (pred (pred (data (car contrived_variable2))))))))
(assert
...
(assert
 (=>
  (and (is-succ (pred (pred (pred (pred (data (car contrived_variable2))))))))
  (not
...
(assert
 (=>
  (and (is-succ (pred (pred (pred (data (car contrived_variable2))))))
   (is-succ (pred (pred (pred (pred (data (car contrived_variable2))))))))
  (not
   (= (pred (pred (pred (pred (pred (data (car contrived_variable2)))))))
    (pred (pred (pred (data (car contrived_variable2)))))))))
(assert
 ...
 (=> (and (is-succ (data (car contrived_variable2))))
  (not
   (= (pred (data (car contrived_variable2)))
    (data (car contrived_variable2))))))
(assert
 (=> (and (is-cons contrived_variable2) (is-node (car contrived_variable2)))
  (not (= (children (car contrived_variable2)) contrived_variable2))))
(assert
 (=> (and (is-cons (children (car contrived_variable2))))
  (not
...
(assert
 (=>
  (and (is-cons contrived_variable2) (is-node (car contrived_variable2))
   (is-cons (children (car contrived_variable2))))
  (not (= (cdr (children (car contrived_variable2))) contrived_variable2))))
(assert
 (=> (and (is-cons (cdr (children (car contrived_variable2)))))
  (not
...
(assert
 (=>
  (and (is-cons (children (car contrived_variable2)))
   (is-cons (cdr (children (car contrived_variable2)))))
  (not
   (= (cdr (cdr (children (car contrived_variable2))))
    (children (car contrived_variable2))))))
(assert
...
(assert
 (=> (and (is-cons (cdr (cdr (children (car contrived_variable2))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (children (car contrived_variable2))))
   (is-cons (cdr (cdr (children (car contrived_variable2))))))
  (not
   (= (cdr (cdr (cdr (children (car contrived_variable2)))))
    (cdr (children (car contrived_variable2)))))))
(assert
 ...
 (=>
  ...
  (not
   (= (cdr (cdr (cdr (children (car contrived_variable2)))))
    contrived_variable2))))
(assert
 (=> (and (is-cons (cdr (cdr (cdr (children (car contrived_variable2)))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (cdr (children (car contrived_variable2)))))
   (is-cons (cdr (cdr (cdr (children (car contrived_variable2)))))))
  (not
   (= (cdr (cdr (cdr (cdr (children (car contrived_variable2))))))
    (cdr (cdr (children (car contrived_variable2))))))))
(assert
...
(assert
 (=>
  (and (is-cons (cdr (cdr (cdr (cdr (children (car contrived_variable2))))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (cdr (cdr (children (car contrived_variable2))))))
   (is-cons (cdr (cdr (cdr (cdr (children (car contrived_variable2))))))))
  (not
   (= (cdr (cdr (cdr (cdr (cdr (children (car contrived_variable2)))))))
    (cdr (cdr (cdr (children (car contrived_variable2)))))))))
(assert
...
(assert
 (=>
  (and (is-node (car contrived_variable2))
   (is-cons (children (car contrived_variable2)))
   (is-cons (cdr (children (car contrived_variable2))))
   (is-cons (cdr (cdr (children (car contrived_variable2)))))
   (is-cons (cdr (cdr (cdr (children (car contrived_variable2))))))
...
(assert
 (=>
  (and (is-cons (cdr (cdr (cdr (children (car contrived_variable2))))))
   (is-node (car (cdr (cdr (cdr (children (car contrived_variable2))))))))
  (not
...
(assert
 (=>
  (and
   (is-succ (data (car (cdr (cdr (children (car contrived_variable2))))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (cdr (children (car contrived_variable2)))))
   (is-node (car (cdr (cdr (children (car contrived_variable2)))))))
  (not
...
(assert
 (=>
  (and
   (is-cons (children (car (cdr (cdr (children (car contrived_variable2))))))))
  (not
...
(assert
 (=>
  (and (is-node (car (cdr (cdr (children (car contrived_variable2))))))
   (is-cons (children (car (cdr (cdr (children (car contrived_variable2))))))))
  (not
 ...
 (=>
  ...
  (not
   (= (car (cdr (children (car contrived_variable2))))
    (car contrived_variable2)))))
(assert
 (=> (and (is-succ (data (car (cdr (children (car contrived_variable2)))))))
  (not
...
(assert
 (=>
  (and
   (is-succ (pred (data (car (cdr (children (car contrived_variable2))))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (children (car contrived_variable2))))
   (is-node (car (cdr (children (car contrived_variable2))))))
  (not
...
(assert
 (=>
  (and (is-cons (children (car (cdr (children (car contrived_variable2)))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (children (car contrived_variable2))))
   (is-node (car (cdr (children (car contrived_variable2)))))
   (is-cons (children (car (cdr (children (car contrived_variable2)))))))
  (not
   (= (cdr (children (car (cdr (children (car contrived_variable2))))))
    (cdr (children (car contrived_variable2)))))))
(assert
...
(assert
 (=>
  (and
   (is-cons (cdr (children (car (cdr (children (car contrived_variable2))))))))
  (not
...
(assert
 (=>
  (and (is-node (car (cdr (children (car contrived_variable2)))))
   (is-cons (children (car (cdr (children (car contrived_variable2))))))
   (is-cons (cdr (children (car (cdr (children (car contrived_variable2))))))))
  (not
...
(assert
 (=>
  (and (is-cons (children (car (cdr (children (car contrived_variable2))))))
   (is-node (car (children (car (cdr (children (car contrived_variable2))))))))
  (not
   (=
...
(assert
 (=> (and (is-succ (data (car (children (car contrived_variable2))))))
  (not
   (= (pred (data (car (children (car contrived_variable2)))))
    (data (car (children (car contrived_variable2))))))))
(assert
 (=> (and (is-succ (pred (data (car (children (car contrived_variable2)))))))
  (not
...
(assert
 (=>
  (and (is-succ (data (car (children (car contrived_variable2)))))
   (is-succ (pred (data (car (children (car contrived_variable2)))))))
  (not
   (= (pred (pred (data (car (children (car contrived_variable2))))))
    (data (car (children (car contrived_variable2))))))))
(assert
 (=>
  (and
   (is-succ (pred (pred (data (car (children (car contrived_variable2))))))))
  (not
...
(assert
 (=>
  (and (is-cons (children (car contrived_variable2)))
   (is-node (car (children (car contrived_variable2)))))
  (not
 ...
 (=>
  ...
  (not
   (= (children (car (children (car contrived_variable2))))
    contrived_variable2))))
(assert
 (=> (and (is-cons (children (car (children (car contrived_variable2))))))
  (not
...
(assert
 (=>
  (and (is-cons (children (car contrived_variable2)))
   (is-node (car (children (car contrived_variable2))))
   (is-cons (children (car (children (car contrived_variable2))))))
  (not
   (= (cdr (children (car (children (car contrived_variable2)))))
    (children (car contrived_variable2))))))
(assert
...
(assert
 (=>
  (and (is-cons (cdr (children (car (children (car contrived_variable2)))))))
  (not
...
(assert
 (=>
  (and (is-cons (children (car (children (car contrived_variable2)))))
   (is-cons (cdr (children (car (children (car contrived_variable2)))))))
  (not
   (= (cdr (cdr (children (car (children (car contrived_variable2))))))
    (children (car (children (car contrived_variable2))))))))
(assert
...
(assert
 (=>
  (and
   (is-cons (cdr (cdr (children (car (children (car contrived_variable2))))))))
  (not
...
(assert
 (=>
  (and (is-node (car (children (car contrived_variable2))))
   (is-cons (children (car (children (car contrived_variable2)))))
   (is-cons (cdr (children (car (children (car contrived_variable2))))))
   (is-cons (cdr (cdr (children (car (children (car contrived_variable2))))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (children (car (children (car contrived_variable2))))))
   (is-node (car (cdr (children (car (children (car contrived_variable2))))))))
  (not
   (=
...
(assert
 (=>
  (and
   (is-succ (data (car (children (car (children (car
    contrived_variable2))))))))
  (not
   (=
...
(assert
 (=>
  (and (is-cons (children (car (children (car contrived_variable2)))))
   (is-node (car (children (car (children (car contrived_variable2)))))))
  (not
...
(assert
 (=>
  (and
   (is-cons (children (car (children (car (children (car
    contrived_variable2))))))))
  (not
   (=
...
(assert
 (=>
  (and (is-node (car (children (car (children (car contrived_variable2))))))
   (is-cons (children (car (children (car (children (car
    contrived_variable2))))))))
  (not
   (=
...
(assert
 (=> (and (is-cons (cdr contrived_variable0)))
  (not (= (cdr (cdr contrived_variable0)) (cdr contrived_variable0)))))
(assert
 (=> (and (is-cons contrived_variable0) (is-cons (cdr contrived_variable0)))
  (not (= (cdr (cdr contrived_variable0)) contrived_variable0))))
(assert
 (=> (and (is-cons (cdr (cdr contrived_variable0))))
  (not
   (= (cdr (cdr (cdr contrived_variable0))) (cdr (cdr contrived_variable0))))))
(assert
 (=>
  (and (is-cons (cdr contrived_variable0))
   (is-cons (cdr (cdr contrived_variable0))))
  (not (= (cdr (cdr (cdr contrived_variable0))) (cdr contrived_variable0)))))
(assert
 (=>
  (and (is-cons contrived_variable0) (is-cons (cdr contrived_variable0))
   (is-cons (cdr (cdr contrived_variable0))))
  (not (= (cdr (cdr (cdr contrived_variable0))) contrived_variable0))))
(assert
 (=> (and (is-cons (cdr (cdr (cdr contrived_variable0)))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (cdr contrived_variable0)))
   (is-cons (cdr (cdr (cdr contrived_variable0)))))
  (not
   (= (cdr (cdr (cdr (cdr contrived_variable0))))
...
(assert
 (=> (and (is-cons (cdr (cdr (cdr (cdr contrived_variable0))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (cdr (cdr contrived_variable0))))
   (is-cons (cdr (cdr (cdr (cdr contrived_variable0))))))
  (not
   (= (cdr (cdr (cdr (cdr (cdr contrived_variable0)))))
    (cdr (cdr (cdr contrived_variable0)))))))
(assert
...
(assert
 (=> (and (is-cons (cdr (cdr (cdr (cdr (cdr contrived_variable0)))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (cdr (cdr (cdr contrived_variable0)))))
   (is-cons (cdr (cdr (cdr (cdr (cdr contrived_variable0)))))))
  (not
   (= (cdr (cdr (cdr (cdr (cdr (cdr contrived_variable0))))))
    (cdr (cdr (cdr (cdr contrived_variable0))))))))
(assert
 ...
 (=>
  ...
  (not
   (= (cdr (cdr (cdr (cdr (cdr (cdr contrived_variable0))))))
    contrived_variable0))))
(assert
 (=> (and (is-cons (cdr (cdr (cdr (cdr (cdr (cdr contrived_variable0))))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (cdr (cdr (cdr (cdr contrived_variable0))))))
   (is-cons (cdr (cdr (cdr (cdr (cdr (cdr contrived_variable0))))))))
  (not
   (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr contrived_variable0)))))))
    (cdr (cdr (cdr (cdr (cdr contrived_variable0)))))))))
(assert
...
(assert
 (=>
  (and (is-cons (cdr (cdr (cdr (cdr (cdr contrived_variable0))))))
   (is-node (car (cdr (cdr (cdr (cdr (cdr contrived_variable0))))))))
  (not
...
(assert
 (=>
  ...
  (not (= (cdr (cdr (cdr (cdr contrived_variable0)))) contrived_variable0))))
(assert
 (=> (and (is-succ (data (car (cdr (cdr (cdr (cdr contrived_variable0))))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (cdr (cdr (cdr contrived_variable0)))))
   (is-node (car (cdr (cdr (cdr (cdr contrived_variable0)))))))
  (not
...
(assert
 (=>
  (and (is-cons (children (car (cdr (cdr (cdr (cdr contrived_variable0))))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (cdr (cdr (cdr contrived_variable0)))))
   (is-node (car (cdr (cdr (cdr (cdr contrived_variable0))))))
   (is-cons (children (car (cdr (cdr (cdr (cdr contrived_variable0))))))))
  (not
   (= (cdr (children (car (cdr (cdr (cdr (cdr contrived_variable0)))))))
    (cdr (cdr (cdr (cdr contrived_variable0))))))))
(assert
...
(assert
 (=>
  (and (is-node (car (cdr (cdr (cdr (cdr contrived_variable0))))))
   (is-cons (children (car (cdr (cdr (cdr (cdr contrived_variable0))))))))
  (not
...
(assert
 (=>
  ...
  (not (= (cdr (cdr (cdr contrived_variable0))) contrived_variable0))))
(assert
 (=> (and (is-succ (data (car (cdr (cdr (cdr contrived_variable0)))))))
  (not
   (= (pred (data (car (cdr (cdr (cdr contrived_variable0))))))
    (data (car (cdr (cdr (cdr contrived_variable0)))))))))
(assert
 (=>
  (and (is-succ (pred (data (car (cdr (cdr (cdr contrived_variable0))))))))
  (not
...
(assert
 (=>
  (and (is-succ (data (car (cdr (cdr (cdr contrived_variable0))))))
   (is-succ (pred (data (car (cdr (cdr (cdr contrived_variable0))))))))
  (not
   (= (pred (pred (data (car (cdr (cdr (cdr contrived_variable0)))))))
    (data (car (cdr (cdr (cdr contrived_variable0)))))))))
(assert
...
(assert
 (=>
  (and (is-cons (cdr (cdr (cdr contrived_variable0))))
   (is-node (car (cdr (cdr (cdr contrived_variable0))))))
  (not
 ...
 (=>
  ...
  (not
   (= (children (car (cdr (cdr (cdr contrived_variable0)))))
    contrived_variable0))))
(assert
 (=> (and (is-cons (children (car (cdr (cdr (cdr contrived_variable0)))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (cdr (cdr contrived_variable0))))
   (is-node (car (cdr (cdr (cdr contrived_variable0)))))
   (is-cons (children (car (cdr (cdr (cdr contrived_variable0)))))))
  (not
   (= (cdr (children (car (cdr (cdr (cdr contrived_variable0))))))
    (cdr (cdr (cdr contrived_variable0)))))))
(assert
...
(assert
 (=>
  (and (is-cons (cdr (children (car (cdr (cdr (cdr contrived_variable0))))))))
  (not
...
(assert
 (=>
  (and (is-cons (children (car (cdr (cdr (cdr contrived_variable0))))))
   (is-cons (cdr (children (car (cdr (cdr (cdr contrived_variable0))))))))
  (not
   (= (cdr (cdr (children (car (cdr (cdr (cdr contrived_variable0)))))))
    (children (car (cdr (cdr (cdr contrived_variable0)))))))))
(assert
...
(assert
 (=>
  (and (is-node (car (cdr (cdr (cdr contrived_variable0)))))
   (is-cons (children (car (cdr (cdr (cdr contrived_variable0))))))
   (is-cons (cdr (children (car (cdr (cdr (cdr contrived_variable0))))))))
  (not
...
(assert
 (=>
  (and (is-cons (children (car (cdr (cdr (cdr contrived_variable0))))))
   (is-node (car (children (car (cdr (cdr (cdr contrived_variable0))))))))
  (not
...
(assert
 (=> (and (is-cons contrived_variable0) (is-cons (cdr contrived_variable0)))
  (not (= (cdr (cdr contrived_variable0)) contrived_variable0))))
(assert
 (=> (and (is-succ (data (car (cdr (cdr contrived_variable0))))))
  (not
   (= (pred (data (car (cdr (cdr contrived_variable0)))))
    (data (car (cdr (cdr contrived_variable0))))))))
(assert
 (=> (and (is-succ (pred (data (car (cdr (cdr contrived_variable0)))))))
  (not
...
(assert
 (=>
  (and (is-succ (data (car (cdr (cdr contrived_variable0)))))
   (is-succ (pred (data (car (cdr (cdr contrived_variable0)))))))
  (not
   (= (pred (pred (data (car (cdr (cdr contrived_variable0))))))
    (data (car (cdr (cdr contrived_variable0))))))))
(assert
 (=>
  (and (is-succ (pred (pred (data (car (cdr (cdr contrived_variable0))))))))
  (not
...
(assert
 (=>
  (and (is-succ (pred (data (car (cdr (cdr contrived_variable0))))))
   (is-succ (pred (pred (data (car (cdr (cdr contrived_variable0))))))))
  (not
   (= (pred (pred (pred (data (car (cdr (cdr contrived_variable0)))))))
    (pred (data (car (cdr (cdr contrived_variable0)))))))))
(assert
...
(assert
 (=>
  (and (is-cons (cdr (cdr contrived_variable0)))
   (is-node (car (cdr (cdr contrived_variable0)))))
  (not
...
(assert
 (=> (and (is-cons (children (car (cdr (cdr contrived_variable0))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (cdr contrived_variable0)))
   (is-node (car (cdr (cdr contrived_variable0))))
   (is-cons (children (car (cdr (cdr contrived_variable0))))))
  (not
   (= (cdr (children (car (cdr (cdr contrived_variable0)))))
    (cdr (cdr contrived_variable0))))))
(assert
 ...
 (=>
  ...
  (not
   (= (cdr (children (car (cdr (cdr contrived_variable0)))))
    contrived_variable0))))
(assert
 (=> (and (is-cons (cdr (children (car (cdr (cdr contrived_variable0)))))))
  (not
...
(assert
 (=>
  (and (is-cons (children (car (cdr (cdr contrived_variable0)))))
   (is-cons (cdr (children (car (cdr (cdr contrived_variable0)))))))
  (not
   (= (cdr (cdr (children (car (cdr (cdr contrived_variable0))))))
    (children (car (cdr (cdr contrived_variable0))))))))
(assert
...
(assert
 (=>
  (and (is-cons (cdr (cdr (children (car (cdr (cdr contrived_variable0))))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (children (car (cdr (cdr contrived_variable0))))))
   (is-cons (cdr (cdr (children (car (cdr (cdr contrived_variable0))))))))
  (not
   (= (cdr (cdr (cdr (children (car (cdr (cdr contrived_variable0)))))))
    (cdr (children (car (cdr (cdr contrived_variable0)))))))))
(assert
...
(assert
 (=>
  (and (is-node (car (cdr (cdr contrived_variable0))))
   (is-cons (children (car (cdr (cdr contrived_variable0)))))
   (is-cons (cdr (children (car (cdr (cdr contrived_variable0))))))
   (is-cons (cdr (cdr (children (car (cdr (cdr contrived_variable0))))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (children (car (cdr (cdr contrived_variable0))))))
   (is-node (car (cdr (children (car (cdr (cdr contrived_variable0))))))))
  (not
...
(assert
 (=>
  (and
   (is-succ (data (car (children (car (cdr (cdr contrived_variable0))))))))
  (not
...
(assert
 (=>
  (and (is-cons (children (car (cdr (cdr contrived_variable0)))))
   (is-node (car (children (car (cdr (cdr contrived_variable0)))))))
  (not
...
(assert
 (=>
  (and
   (is-cons (children (car (children (car (cdr (cdr contrived_variable0))))))))
  (not
...
(assert
 (=>
  (and (is-node (car (children (car (cdr (cdr contrived_variable0))))))
   (is-cons (children (car (children (car (cdr (cdr contrived_variable0))))))))
  (not
...
(assert
 (=> (and (is-cons contrived_variable0))
  (not (= (cdr contrived_variable0) contrived_variable0))))
(assert
 (=> (and (is-succ (data (car (cdr contrived_variable0)))))
  (not
   (= (pred (data (car (cdr contrived_variable0))))
    (data (car (cdr contrived_variable0)))))))
(assert
 (=> (and (is-succ (pred (data (car (cdr contrived_variable0))))))
  (not
...
(assert
 (=>
  (and (is-succ (data (car (cdr contrived_variable0))))
   (is-succ (pred (data (car (cdr contrived_variable0))))))
  (not
   (= (pred (pred (data (car (cdr contrived_variable0)))))
    (data (car (cdr contrived_variable0)))))))
(assert
 (=> (and (is-succ (pred (pred (data (car (cdr contrived_variable0)))))))
  (not
...
(assert
 (=>
  (and (is-succ (pred (data (car (cdr contrived_variable0)))))
   (is-succ (pred (pred (data (car (cdr contrived_variable0)))))))
  (not
   (= (pred (pred (pred (data (car (cdr contrived_variable0))))))
    (pred (data (car (cdr contrived_variable0))))))))
(assert
...
(assert
 (=>
  (and (is-succ (pred (pred (pred (data (car (cdr contrived_variable0))))))))
  (not
...
(assert
 (=>
  (and (is-succ (pred (pred (data (car (cdr contrived_variable0))))))
   (is-succ (pred (pred (pred (data (car (cdr contrived_variable0))))))))
  (not
   (= (pred (pred (pred (pred (data (car (cdr contrived_variable0)))))))
    (pred (pred (data (car (cdr contrived_variable0)))))))))
(assert
...
(assert
 (=>
  (and (is-cons (cdr contrived_variable0))
   (is-node (car (cdr contrived_variable0))))
  (not
...
(assert
 (=> (and (is-cons (children (car (cdr contrived_variable0)))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr contrived_variable0))
   (is-node (car (cdr contrived_variable0)))
   (is-cons (children (car (cdr contrived_variable0)))))
  (not
   (= (cdr (children (car (cdr contrived_variable0))))
    (cdr contrived_variable0)))))
(assert
...
(assert
 (=> (and (is-cons (cdr (children (car (cdr contrived_variable0))))))
  (not
...
(assert
 (=>
  (and (is-cons (children (car (cdr contrived_variable0))))
   (is-cons (cdr (children (car (cdr contrived_variable0))))))
  (not
   (= (cdr (cdr (children (car (cdr contrived_variable0)))))
    (children (car (cdr contrived_variable0)))))))
(assert
 ...
 (=>
  ...
  (not
   (= (cdr (cdr (children (car (cdr contrived_variable0)))))
    contrived_variable0))))
(assert
 (=> (and (is-cons (cdr (cdr (children (car (cdr contrived_variable0)))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (children (car (cdr contrived_variable0)))))
   (is-cons (cdr (cdr (children (car (cdr contrived_variable0)))))))
  (not
   (= (cdr (cdr (cdr (children (car (cdr contrived_variable0))))))
    (cdr (children (car (cdr contrived_variable0))))))))
(assert
...
(assert
 (=>
  (and (is-cons (cdr (cdr (cdr (children (car (cdr contrived_variable0))))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (cdr (children (car (cdr contrived_variable0))))))
   (is-cons (cdr (cdr (cdr (children (car (cdr contrived_variable0))))))))
  (not
   (= (cdr (cdr (cdr (cdr (children (car (cdr contrived_variable0)))))))
    (cdr (cdr (children (car (cdr contrived_variable0)))))))))
(assert
...
(assert
 (=>
  (and (is-node (car (cdr contrived_variable0)))
   (is-cons (children (car (cdr contrived_variable0))))
   (is-cons (cdr (children (car (cdr contrived_variable0)))))
   (is-cons (cdr (cdr (children (car (cdr contrived_variable0))))))
   (is-cons (cdr (cdr (cdr (children (car (cdr contrived_variable0))))))))
...
(assert
 (=>
  (and (is-cons (cdr (cdr (children (car (cdr contrived_variable0))))))
   (is-node (car (cdr (cdr (children (car (cdr contrived_variable0))))))))
  (not
...
(assert
 (=>
  (and
   (is-succ (data (car (cdr (children (car (cdr contrived_variable0))))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (children (car (cdr contrived_variable0)))))
   (is-node (car (cdr (children (car (cdr contrived_variable0)))))))
  (not
...
(assert
 (=>
  (and
   (is-cons (children (car (cdr (children (car (cdr contrived_variable0))))))))
  (not
...
(assert
 (=>
  (and (is-node (car (cdr (children (car (cdr contrived_variable0))))))
   (is-cons (children (car (cdr (children (car (cdr contrived_variable0))))))))
  (not
 ...
 (=>
  ...
  (not
   (= (car (children (car (cdr contrived_variable0))))
    (car (cdr contrived_variable0))))))
(assert
 (=> (and (is-succ (data (car (children (car (cdr contrived_variable0)))))))
  (not
...
(assert
 (=>
  (and
   (is-succ (pred (data (car (children (car (cdr contrived_variable0))))))))
  (not
...
(assert
 (=>
  (and (is-cons (children (car (cdr contrived_variable0))))
   (is-node (car (children (car (cdr contrived_variable0))))))
  (not
...
(assert
 (=>
  (and (is-cons (children (car (children (car (cdr contrived_variable0)))))))
  (not
...
(assert
 (=>
  (and (is-cons (children (car (cdr contrived_variable0))))
   (is-node (car (children (car (cdr contrived_variable0)))))
   (is-cons (children (car (children (car (cdr contrived_variable0)))))))
  (not
   (= (cdr (children (car (children (car (cdr contrived_variable0))))))
    (children (car (cdr contrived_variable0)))))))
(assert
...
(assert
 (=>
  (and
   (is-cons (cdr (children (car (children (car (cdr contrived_variable0))))))))
  (not
...
(assert
 (=>
  (and (is-node (car (children (car (cdr contrived_variable0)))))
   (is-cons (children (car (children (car (cdr contrived_variable0))))))
   (is-cons (cdr (children (car (children (car (cdr contrived_variable0))))))))
  (not
...
(assert
 (=>
  (and (is-cons (children (car (children (car (cdr contrived_variable0))))))
   (is-node (car (children (car (children (car (cdr contrived_variable0))))))))
  (not
   (=
    (children (car (children (car (children (car (cdr
     contrived_variable0)))))))
...
(assert
 (=> (and (is-cons contrived_variable0))
  (not (= (cdr contrived_variable0) contrived_variable0))))
(assert
 (=> (and (is-succ (data (car contrived_variable0))))
  (not
   (= (pred (data (car contrived_variable0)))
    (data (car contrived_variable0))))))
(assert
 (=> (and (is-succ (pred (data (car contrived_variable0)))))
  (not
...
(assert
 (=>
  (and (is-succ (data (car contrived_variable0)))
   (is-succ (pred (data (car contrived_variable0)))))
  (not
   (= (pred (pred (data (car contrived_variable0))))
    (data (car contrived_variable0))))))
(assert
 (=> (and (is-succ (pred (pred (data (car contrived_variable0))))))
  (not
...
(assert
 (=>
  (and (is-succ (pred (data (car contrived_variable0))))
   (is-succ (pred (pred (data (car contrived_variable0))))))
  (not
   (= (pred (pred (pred (data (car contrived_variable0)))))
    (pred (data (car contrived_variable0)))))))
(assert
 (=>
  ...
  (not
   (= (pred (pred (pred (data (car contrived_variable0)))))
    (data (car contrived_variable0))))))
(assert
 (=> (and (is-succ (pred (pred (pred (data (car contrived_variable0)))))))
  (not
...
(assert
 (=>
  (and (is-succ (pred (pred (data (car contrived_variable0)))))
   (is-succ (pred (pred (pred (data (car contrived_variable0)))))))
  (not
   (= (pred (pred (pred (pred (data (car contrived_variable0))))))
    (pred (pred (data (car contrived_variable0))))))))
(assert
...
(assert
 (=>
  (and (is-succ (pred (pred (pred (pred (data (car contrived_variable0))))))))
  (not
...
(assert
 (=>
  (and (is-succ (pred (pred (pred (data (car contrived_variable0))))))
   (is-succ (pred (pred (pred (pred (data (car contrived_variable0))))))))
  (not
   (= (pred (pred (pred (pred (pred (data (car contrived_variable0)))))))
    (pred (pred (pred (data (car contrived_variable0)))))))))
(assert
 ...
 (=> (and (is-succ (data (car contrived_variable0))))
  (not
   (= (pred (data (car contrived_variable0)))
    (data (car contrived_variable0))))))
(assert
 (=> (and (is-cons contrived_variable0) (is-node (car contrived_variable0)))
  (not (= (children (car contrived_variable0)) contrived_variable0))))
(assert
 (=> (and (is-cons (children (car contrived_variable0))))
  (not
...
(assert
 (=>
  (and (is-cons contrived_variable0) (is-node (car contrived_variable0))
   (is-cons (children (car contrived_variable0))))
  (not (= (cdr (children (car contrived_variable0))) contrived_variable0))))
(assert
 (=> (and (is-cons (cdr (children (car contrived_variable0)))))
  (not
...
(assert
 (=>
  (and (is-cons (children (car contrived_variable0)))
   (is-cons (cdr (children (car contrived_variable0)))))
  (not
   (= (cdr (cdr (children (car contrived_variable0))))
    (children (car contrived_variable0))))))
(assert
...
(assert
 (=> (and (is-cons (cdr (cdr (children (car contrived_variable0))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (children (car contrived_variable0))))
   (is-cons (cdr (cdr (children (car contrived_variable0))))))
  (not
   (= (cdr (cdr (cdr (children (car contrived_variable0)))))
    (cdr (children (car contrived_variable0)))))))
(assert
 ...
 (=>
  ...
  (not
   (= (cdr (cdr (cdr (children (car contrived_variable0)))))
    contrived_variable0))))
(assert
 (=> (and (is-cons (cdr (cdr (cdr (children (car contrived_variable0)))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (cdr (children (car contrived_variable0)))))
   (is-cons (cdr (cdr (cdr (children (car contrived_variable0)))))))
  (not
   (= (cdr (cdr (cdr (cdr (children (car contrived_variable0))))))
    (cdr (cdr (children (car contrived_variable0))))))))
(assert
...
(assert
 (=>
  (and (is-cons (cdr (cdr (cdr (cdr (children (car contrived_variable0))))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (cdr (cdr (children (car contrived_variable0))))))
   (is-cons (cdr (cdr (cdr (cdr (children (car contrived_variable0))))))))
  (not
   (= (cdr (cdr (cdr (cdr (cdr (children (car contrived_variable0)))))))
    (cdr (cdr (cdr (children (car contrived_variable0)))))))))
(assert
...
(assert
 (=>
  (and (is-node (car contrived_variable0))
   (is-cons (children (car contrived_variable0)))
   (is-cons (cdr (children (car contrived_variable0))))
   (is-cons (cdr (cdr (children (car contrived_variable0)))))
   (is-cons (cdr (cdr (cdr (children (car contrived_variable0))))))
...
(assert
 (=>
  (and (is-cons (cdr (cdr (cdr (children (car contrived_variable0))))))
   (is-node (car (cdr (cdr (cdr (children (car contrived_variable0))))))))
  (not
...
(assert
 (=>
  (and
   (is-succ (data (car (cdr (cdr (children (car contrived_variable0))))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (cdr (children (car contrived_variable0)))))
   (is-node (car (cdr (cdr (children (car contrived_variable0)))))))
  (not
...
(assert
 (=>
  (and
   (is-cons (children (car (cdr (cdr (children (car contrived_variable0))))))))
  (not
...
(assert
 (=>
  (and (is-node (car (cdr (cdr (children (car contrived_variable0))))))
   (is-cons (children (car (cdr (cdr (children (car contrived_variable0))))))))
  (not
 ...
 (=>
  ...
  (not
   (= (car (cdr (children (car contrived_variable0))))
    (car contrived_variable0)))))
(assert
 (=> (and (is-succ (data (car (cdr (children (car contrived_variable0)))))))
  (not
...
(assert
 (=>
  (and
   (is-succ (pred (data (car (cdr (children (car contrived_variable0))))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (children (car contrived_variable0))))
   (is-node (car (cdr (children (car contrived_variable0))))))
  (not
...
(assert
 (=>
  (and (is-cons (children (car (cdr (children (car contrived_variable0)))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (children (car contrived_variable0))))
   (is-node (car (cdr (children (car contrived_variable0)))))
   (is-cons (children (car (cdr (children (car contrived_variable0)))))))
  (not
   (= (cdr (children (car (cdr (children (car contrived_variable0))))))
    (cdr (children (car contrived_variable0)))))))
(assert
...
(assert
 (=>
  (and
   (is-cons (cdr (children (car (cdr (children (car contrived_variable0))))))))
  (not
...
(assert
 (=>
  (and (is-node (car (cdr (children (car contrived_variable0)))))
   (is-cons (children (car (cdr (children (car contrived_variable0))))))
   (is-cons (cdr (children (car (cdr (children (car contrived_variable0))))))))
  (not
...
(assert
 (=>
  (and (is-cons (children (car (cdr (children (car contrived_variable0))))))
   (is-node (car (children (car (cdr (children (car contrived_variable0))))))))
  (not
   (=
    (children (car (children (car (cdr (children (car
     contrived_variable0)))))))
...
(assert
 (=> (and (is-succ (data (car (children (car contrived_variable0))))))
  (not
   (= (pred (data (car (children (car contrived_variable0)))))
    (data (car (children (car contrived_variable0))))))))
(assert
 (=> (and (is-succ (pred (data (car (children (car contrived_variable0)))))))
  (not
...
(assert
 (=>
  (and (is-succ (data (car (children (car contrived_variable0)))))
   (is-succ (pred (data (car (children (car contrived_variable0)))))))
  (not
   (= (pred (pred (data (car (children (car contrived_variable0))))))
    (data (car (children (car contrived_variable0))))))))
(assert
 (=>
  (and
   (is-succ (pred (pred (data (car (children (car contrived_variable0))))))))
  (not
...
(assert
 (=>
  (and (is-cons (children (car contrived_variable0)))
   (is-node (car (children (car contrived_variable0)))))
  (not
 ...
 (=>
  ...
  (not
   (= (children (car (children (car contrived_variable0))))
    contrived_variable0))))
(assert
 (=> (and (is-cons (children (car (children (car contrived_variable0))))))
  (not
...
(assert
 (=>
  (and (is-cons (children (car contrived_variable0)))
   (is-node (car (children (car contrived_variable0))))
   (is-cons (children (car (children (car contrived_variable0))))))
  (not
   (= (cdr (children (car (children (car contrived_variable0)))))
    (children (car contrived_variable0))))))
(assert
...
(assert
 (=>
  (and (is-cons (cdr (children (car (children (car contrived_variable0)))))))
  (not
...
(assert
 (=>
  (and (is-cons (children (car (children (car contrived_variable0)))))
   (is-cons (cdr (children (car (children (car contrived_variable0)))))))
  (not
   (= (cdr (cdr (children (car (children (car contrived_variable0))))))
    (children (car (children (car contrived_variable0))))))))
(assert
...
(assert
 (=>
  (and
   (is-cons (cdr (cdr (children (car (children (car contrived_variable0))))))))
  (not
...
(assert
 (=>
  (and (is-node (car (children (car contrived_variable0))))
   (is-cons (children (car (children (car contrived_variable0)))))
   (is-cons (cdr (children (car (children (car contrived_variable0))))))
   (is-cons (cdr (cdr (children (car (children (car contrived_variable0))))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (children (car (children (car contrived_variable0))))))
   (is-node (car (cdr (children (car (children (car contrived_variable0))))))))
  (not
   (=
    (children (car (cdr (children (car (children (car
     contrived_variable0)))))))
...
(assert
 (=>
  (and (is-cons (children (car (children (car contrived_variable0)))))
   (is-node (car (children (car (children (car contrived_variable0)))))))
  (not
...
(assert
 (=>
  (and (is-node (car (children (car (children (car contrived_variable0))))))
   (is-cons (children (car (children (car (children (car
    contrived_variable0))))))))
  (not
   (=
...
(assert
 (=> (and (is-cons (cdr (cdr (cdr (cdr (cdr (cdr x2))))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (cdr (cdr (cdr (cdr x2))))))
   (is-cons (cdr (cdr (cdr (cdr (cdr (cdr x2))))))))
  (not
   (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr x2)))))))
...
(assert
 (=>
  (and (is-cons (cdr (cdr x2))) (is-cons (cdr (cdr (cdr x2))))
   ...
   (is-cons (cdr (cdr (cdr (cdr (cdr x2))))))
   (is-cons (cdr (cdr (cdr (cdr (cdr (cdr x2))))))))
  (not (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr x2))))))) (cdr (cdr x2))))))
(assert
 (=>
  (and (is-cons (cdr x2)) (is-cons (cdr (cdr x2)))
   (is-cons (cdr (cdr (cdr x2)))) (is-cons (cdr (cdr (cdr (cdr x2)))))
   (is-cons (cdr (cdr (cdr (cdr (cdr x2))))))
   (is-cons (cdr (cdr (cdr (cdr (cdr (cdr x2))))))))
  (not (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr x2))))))) (cdr x2)))))
(assert
 (=>
  (and (is-cons x2) (is-cons (cdr x2)) (is-cons (cdr (cdr x2)))
   (is-cons (cdr (cdr (cdr x2)))) (is-cons (cdr (cdr (cdr (cdr x2)))))
   (is-cons (cdr (cdr (cdr (cdr (cdr x2))))))
   (is-cons (cdr (cdr (cdr (cdr (cdr (cdr x2))))))))
  (not (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr x2))))))) x2))))
(assert
 (=> (and (is-cons (cdr (cdr (cdr (cdr (cdr x2)))))))
  (not
   (= (cdr (cdr (cdr (cdr (cdr (cdr x2)))))) (cdr (cdr (cdr (cdr (cdr x2)))))))))
...
(assert
 (=>
  (and (is-cons (cdr (cdr (cdr (cdr (cdr x2))))))
   (is-node (car (cdr (cdr (cdr (cdr (cdr x2))))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr x2)) (is-cons (cdr (cdr x2)))
   ...
   (is-cons (cdr (cdr (cdr (cdr (cdr x2))))))
   (is-node (car (cdr (cdr (cdr (cdr (cdr x2))))))))
  (not (= (children (car (cdr (cdr (cdr (cdr (cdr x2))))))) (cdr x2)))))
(assert
 (=>
  (and (is-cons x2) (is-cons (cdr x2)) (is-cons (cdr (cdr x2)))
   (is-cons (cdr (cdr (cdr x2)))) (is-cons (cdr (cdr (cdr (cdr x2)))))
   (is-cons (cdr (cdr (cdr (cdr (cdr x2))))))
   (is-node (car (cdr (cdr (cdr (cdr (cdr x2))))))))
  (not (= (children (car (cdr (cdr (cdr (cdr (cdr x2))))))) x2))))
(assert
 (=> (and (is-cons (cdr (cdr (cdr (cdr x2))))))
  (not (= (cdr (cdr (cdr (cdr (cdr x2))))) (cdr (cdr (cdr (cdr x2))))))))
(assert
...
(assert
 (=>
  ...
  (not (= (cdr (cdr (cdr (cdr x2)))) x2))))
(assert
 (=> (and (is-succ (data (car (cdr (cdr (cdr (cdr x2))))))))
  (not
...
(assert
 (=> (and (is-cons (children (car (cdr (cdr (cdr (cdr x2))))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (cdr (cdr (cdr x2)))))
   (is-node (car (cdr (cdr (cdr (cdr x2))))))
   (is-cons (children (car (cdr (cdr (cdr (cdr x2))))))))
  (not
   (= (cdr (children (car (cdr (cdr (cdr (cdr x2)))))))
    (cdr (cdr (cdr (cdr x2))))))))
(assert
...
(assert
 (=>
  (and (is-cons (cdr x2)) (is-cons (cdr (cdr x2)))
   ...
   (is-node (car (cdr (cdr (cdr (cdr x2))))))
   (is-cons (children (car (cdr (cdr (cdr (cdr x2))))))))
  (not (= (cdr (children (car (cdr (cdr (cdr (cdr x2))))))) (cdr x2)))))
(assert
 (=>
  (and (is-cons x2) (is-cons (cdr x2)) (is-cons (cdr (cdr x2)))
   (is-cons (cdr (cdr (cdr x2)))) (is-cons (cdr (cdr (cdr (cdr x2)))))
   (is-node (car (cdr (cdr (cdr (cdr x2))))))
   (is-cons (children (car (cdr (cdr (cdr (cdr x2))))))))
  (not (= (cdr (children (car (cdr (cdr (cdr (cdr x2))))))) x2))))
(assert
 (=>
  (and (is-cons (cdr (cdr (cdr (cdr x2)))))
   (is-node (car (cdr (cdr (cdr (cdr x2)))))))
...
(assert
 (=>
  (and (is-node (car (cdr (cdr (cdr (cdr x2))))))
   (is-cons (children (car (cdr (cdr (cdr (cdr x2))))))))
  (not
...
(assert
 (=> (and (is-succ (pred (data (car (cdr (cdr (cdr x2))))))))
  (not
...
(assert
 (=>
  (and (is-succ (data (car (cdr (cdr (cdr x2))))))
   (is-succ (pred (data (car (cdr (cdr (cdr x2))))))))
  (not
   (= (pred (pred (data (car (cdr (cdr (cdr x2)))))))
    (data (car (cdr (cdr (cdr x2)))))))))
(assert
...
(assert
 (=> (and (is-cons (cdr (children (car (cdr (cdr (cdr x2))))))))
  (not
...
(assert
 (=>
  (and (is-cons (children (car (cdr (cdr (cdr x2))))))
   (is-cons (cdr (children (car (cdr (cdr (cdr x2))))))))
  (not
   (= (cdr (cdr (children (car (cdr (cdr (cdr x2)))))))
    (children (car (cdr (cdr (cdr x2)))))))))
(assert
...
(assert
 (=>
  (and (is-cons (cdr x2)) (is-cons (cdr (cdr x2)))
   ...
   (is-cons (children (car (cdr (cdr (cdr x2))))))
   (is-cons (cdr (children (car (cdr (cdr (cdr x2))))))))
  (not (= (cdr (cdr (children (car (cdr (cdr (cdr x2))))))) (cdr x2)))))
(assert
 (=>
  (and (is-cons x2) (is-cons (cdr x2)) (is-cons (cdr (cdr x2)))
   (is-cons (cdr (cdr (cdr x2)))) (is-node (car (cdr (cdr (cdr x2)))))
   (is-cons (children (car (cdr (cdr (cdr x2))))))
   (is-cons (cdr (children (car (cdr (cdr (cdr x2))))))))
  (not (= (cdr (cdr (children (car (cdr (cdr (cdr x2))))))) x2))))
(assert
 (=> (and (is-cons (children (car (cdr (cdr (cdr x2)))))))
  (not
   (= (cdr (children (car (cdr (cdr (cdr x2))))))
...
(assert
 (=>
  (and (is-cons (children (car (cdr (cdr (cdr x2))))))
   (is-node (car (children (car (cdr (cdr (cdr x2))))))))
  (not
...
(assert
 (=>
  (and (is-cons x2) (is-cons (cdr x2)) (is-cons (cdr (cdr x2)))
   ...
   (is-cons (children (car (cdr (cdr (cdr x2))))))
   (is-node (car (children (car (cdr (cdr (cdr x2))))))))
  (not (= (children (car (children (car (cdr (cdr (cdr x2))))))) x2))))
(assert
 (=>
  (and (is-node (car (cdr (cdr (cdr x2)))))
   (is-cons (children (car (cdr (cdr (cdr x2)))))))
...
(assert
 (=> (and (is-succ (pred (pred (data (car (cdr (cdr x2))))))))
  (not
...
(assert
 (=>
  (and (is-succ (pred (data (car (cdr (cdr x2))))))
   (is-succ (pred (pred (data (car (cdr (cdr x2))))))))
  (not
   (= (pred (pred (pred (data (car (cdr (cdr x2)))))))
    (pred (data (car (cdr (cdr x2)))))))))
(assert
...
(assert
 (=> (and (is-cons (cdr (cdr (children (car (cdr (cdr x2))))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (children (car (cdr (cdr x2))))))
   (is-cons (cdr (cdr (children (car (cdr (cdr x2))))))))
  (not
   (= (cdr (cdr (cdr (children (car (cdr (cdr x2)))))))
    (cdr (children (car (cdr (cdr x2)))))))))
(assert
...
(assert
 (=>
  (and (is-cons (cdr x2)) (is-cons (cdr (cdr x2)))
   ...
   (is-cons (cdr (children (car (cdr (cdr x2))))))
   (is-cons (cdr (cdr (children (car (cdr (cdr x2))))))))
  (not (= (cdr (cdr (cdr (children (car (cdr (cdr x2))))))) (cdr x2)))))
(assert
 (=>
  (and (is-cons x2) (is-cons (cdr x2)) (is-cons (cdr (cdr x2)))
   (is-node (car (cdr (cdr x2)))) (is-cons (children (car (cdr (cdr x2)))))
   (is-cons (cdr (children (car (cdr (cdr x2))))))
   (is-cons (cdr (cdr (children (car (cdr (cdr x2))))))))
  (not (= (cdr (cdr (cdr (children (car (cdr (cdr x2))))))) x2))))
(assert
 (=> (and (is-cons (cdr (children (car (cdr (cdr x2)))))))
  (not
   (= (cdr (cdr (children (car (cdr (cdr x2))))))
...
(assert
 (=>
  (and (is-cons (cdr (children (car (cdr (cdr x2))))))
   (is-node (car (cdr (children (car (cdr (cdr x2))))))))
  (not
...
(assert
 (=>
  (and (is-cons x2) (is-cons (cdr x2)) (is-cons (cdr (cdr x2)))
   ...
   (is-cons (cdr (children (car (cdr (cdr x2))))))
   (is-node (car (cdr (children (car (cdr (cdr x2))))))))
  (not (= (children (car (cdr (children (car (cdr (cdr x2))))))) x2))))
(assert
 (=>
  (and (is-node (car (cdr (cdr x2))))
   (is-cons (children (car (cdr (cdr x2)))))
...
(assert
 (=> (and (is-succ (data (car (children (car (cdr (cdr x2))))))))
  (not
...
(assert
 (=> (and (is-cons (children (car (children (car (cdr (cdr x2))))))))
  (not
...
(assert
 (=>
  (and (is-cons (children (car (cdr (cdr x2)))))
   (is-node (car (children (car (cdr (cdr x2))))))
   (is-cons (children (car (children (car (cdr (cdr x2))))))))
  (not
   (= (cdr (children (car (children (car (cdr (cdr x2)))))))
    (children (car (cdr (cdr x2))))))))
(assert
...
(assert
 (=>
  (and (is-cons x2) (is-cons (cdr x2)) (is-cons (cdr (cdr x2)))
   ...
   (is-node (car (children (car (cdr (cdr x2))))))
   (is-cons (children (car (children (car (cdr (cdr x2))))))))
  (not (= (cdr (children (car (children (car (cdr (cdr x2))))))) x2))))
(assert
 (=>
  (and (is-cons (children (car (cdr (cdr x2)))))
   (is-node (car (children (car (cdr (cdr x2)))))))
...
(assert
 (=>
  (and (is-node (car (children (car (cdr (cdr x2))))))
   (is-cons (children (car (children (car (cdr (cdr x2))))))))
  (not
...
(assert
 (=> (and (is-succ (pred (pred (pred (data (car (cdr x2))))))))
  (not
...
(assert
 (=>
  (and (is-succ (pred (pred (data (car (cdr x2))))))
   (is-succ (pred (pred (pred (data (car (cdr x2))))))))
  (not
   (= (pred (pred (pred (pred (data (car (cdr x2)))))))
    (pred (pred (data (car (cdr x2)))))))))
(assert
...
(assert
 (=> (and (is-cons (cdr (cdr (cdr (children (car (cdr x2))))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (cdr (children (car (cdr x2))))))
   (is-cons (cdr (cdr (cdr (children (car (cdr x2))))))))
  (not
   (= (cdr (cdr (cdr (cdr (children (car (cdr x2)))))))
    (cdr (cdr (children (car (cdr x2)))))))))
(assert
...
(assert
 (=>
  (and (is-cons (cdr x2)) (is-node (car (cdr x2)))
   ...
   (is-cons (cdr (cdr (children (car (cdr x2))))))
   (is-cons (cdr (cdr (cdr (children (car (cdr x2))))))))
  (not (= (cdr (cdr (cdr (cdr (children (car (cdr x2))))))) (cdr x2)))))
(assert
 (=>
  (and (is-cons x2) (is-cons (cdr x2)) (is-node (car (cdr x2)))
   (is-cons (children (car (cdr x2))))
   ...
   (is-cons (cdr (cdr (children (car (cdr x2))))))
   (is-cons (cdr (cdr (cdr (children (car (cdr x2))))))))
  (not (= (cdr (cdr (cdr (cdr (children (car (cdr x2))))))) x2))))
(assert
 (=> (and (is-cons (cdr (cdr (children (car (cdr x2)))))))
  (not
   (= (cdr (cdr (cdr (children (car (cdr x2))))))
...
(assert
 (=>
  (and (is-cons (cdr (cdr (children (car (cdr x2))))))
   (is-node (car (cdr (cdr (children (car (cdr x2))))))))
  (not
...
(assert
 (=>
  (and (is-cons x2) (is-cons (cdr x2)) (is-node (car (cdr x2)))
   ...
   (is-cons (cdr (cdr (children (car (cdr x2))))))
   (is-node (car (cdr (cdr (children (car (cdr x2))))))))
  (not (= (children (car (cdr (cdr (children (car (cdr x2))))))) x2))))
(assert
 (=>
  (and (is-node (car (cdr x2))) (is-cons (children (car (cdr x2))))
   (is-cons (cdr (children (car (cdr x2)))))
...
(assert
 (=> (and (is-succ (data (car (cdr (children (car (cdr x2))))))))
  (not
...
(assert
 (=> (and (is-cons (children (car (cdr (children (car (cdr x2))))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (children (car (cdr x2)))))
   (is-node (car (cdr (children (car (cdr x2))))))
   (is-cons (children (car (cdr (children (car (cdr x2))))))))
  (not
   (= (cdr (children (car (cdr (children (car (cdr x2)))))))
    (cdr (children (car (cdr x2))))))))
(assert
...
(assert
 (=>
  (and (is-cons x2) (is-cons (cdr x2)) (is-node (car (cdr x2)))
   ...
   (is-node (car (cdr (children (car (cdr x2))))))
   (is-cons (children (car (cdr (children (car (cdr x2))))))))
  (not (= (cdr (children (car (cdr (children (car (cdr x2))))))) x2))))
(assert
 (=>
  (and (is-cons (cdr (children (car (cdr x2)))))
   (is-node (car (cdr (children (car (cdr x2)))))))
...
(assert
 (=>
  (and (is-node (car (cdr (children (car (cdr x2))))))
   (is-cons (children (car (cdr (children (car (cdr x2))))))))
  (not
...
(assert
 (=> (and (is-succ (pred (data (car (children (car (cdr x2))))))))
  (not
...
(assert
 (=>
  (and (is-succ (data (car (children (car (cdr x2))))))
   (is-succ (pred (data (car (children (car (cdr x2))))))))
  (not
   (= (pred (pred (data (car (children (car (cdr x2)))))))
    (data (car (children (car (cdr x2)))))))))
(assert
...
(assert
 (=> (and (is-cons (cdr (children (car (children (car (cdr x2))))))))
  (not
...
(assert
 (=>
  (and (is-cons (children (car (children (car (cdr x2))))))
   (is-cons (cdr (children (car (children (car (cdr x2))))))))
  (not
   (= (cdr (cdr (children (car (children (car (cdr x2)))))))
    (children (car (children (car (cdr x2)))))))))
(assert
...
(assert
 (=>
  (and (is-cons x2) (is-cons (cdr x2)) (is-node (car (cdr x2)))
   ...
   (is-cons (children (car (children (car (cdr x2))))))
   (is-cons (cdr (children (car (children (car (cdr x2))))))))
  (not (= (cdr (cdr (children (car (children (car (cdr x2))))))) x2))))
(assert
 (=> (and (is-cons (children (car (children (car (cdr x2)))))))
  (not
   (= (cdr (children (car (children (car (cdr x2))))))
...
(assert
 (=>
  (and (is-cons (children (car (children (car (cdr x2))))))
   (is-node (car (children (car (children (car (cdr x2))))))))
  (not
...
(assert
 (=> (and (is-succ (pred (pred (pred (pred (data (car x2))))))))
  (not
...
(assert
 (=>
  (and (is-succ (pred (pred (pred (data (car x2))))))
   (is-succ (pred (pred (pred (pred (data (car x2))))))))
  (not
   (= (pred (pred (pred (pred (pred (data (car x2)))))))
    (pred (pred (pred (data (car x2)))))))))
(assert
...
(assert
 (=> (and (is-cons (cdr (cdr (cdr (cdr (children (car x2))))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (cdr (cdr (children (car x2))))))
   (is-cons (cdr (cdr (cdr (cdr (children (car x2))))))))
  (not
   (= (cdr (cdr (cdr (cdr (cdr (children (car x2)))))))
    (cdr (cdr (cdr (children (car x2)))))))))
(assert
...
(assert
 (=>
  (and (is-cons x2) (is-node (car x2)) (is-cons (children (car x2)))
   ...
   (is-cons (cdr (cdr (cdr (children (car x2))))))
   (is-cons (cdr (cdr (cdr (cdr (children (car x2))))))))
  (not (= (cdr (cdr (cdr (cdr (cdr (children (car x2))))))) x2))))
(assert
 (=> (and (is-cons (cdr (cdr (cdr (children (car x2)))))))
  (not
   (= (cdr (cdr (cdr (cdr (children (car x2))))))
...
(assert
 (=>
  (and (is-node (car x2)) (is-cons (children (car x2)))
   ...
   (is-cons (cdr (cdr (cdr (children (car x2))))))
   (is-cons (cdr (cdr (cdr (cdr (children (car x2))))))))
  (not (= (car (cdr (cdr (cdr (cdr (children (car x2))))))) (car x2)))))
(assert
 (=> (and (is-cons (cdr (cdr (cdr (children (car x2)))))))
  (not
   (= (cdr (cdr (cdr (cdr (children (car x2))))))
...
(assert
 (=>
  (and (is-cons (cdr (cdr (cdr (children (car x2))))))
   (is-node (car (cdr (cdr (cdr (children (car x2))))))))
  (not
...
(assert
 (=>
  (and (is-cons x2) (is-node (car x2)) (is-cons (children (car x2)))
   ...
   (is-cons (cdr (cdr (cdr (children (car x2))))))
   (is-node (car (cdr (cdr (cdr (children (car x2))))))))
  (not (= (children (car (cdr (cdr (cdr (children (car x2))))))) x2))))
(assert
 (=>
  (and (is-node (car x2)) (is-cons (children (car x2)))
   (is-cons (cdr (children (car x2))))
...
(assert
 (=> (and (is-succ (data (car (cdr (cdr (children (car x2))))))))
  (not
...
(assert
 (=> (and (is-cons (children (car (cdr (cdr (children (car x2))))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (cdr (children (car x2)))))
   (is-node (car (cdr (cdr (children (car x2))))))
   (is-cons (children (car (cdr (cdr (children (car x2))))))))
  (not
   (= (cdr (children (car (cdr (cdr (children (car x2)))))))
    (cdr (cdr (children (car x2))))))))
(assert
...
(assert
 (=>
  (and (is-cons x2) (is-node (car x2)) (is-cons (children (car x2)))
   ...
   (is-node (car (cdr (cdr (children (car x2))))))
   (is-cons (children (car (cdr (cdr (children (car x2))))))))
  (not (= (cdr (children (car (cdr (cdr (children (car x2))))))) x2))))
(assert
 (=>
  (and (is-cons (cdr (cdr (children (car x2)))))
   (is-node (car (cdr (cdr (children (car x2)))))))
...
(assert
 (=>
  (and (is-node (car (cdr (cdr (children (car x2))))))
   (is-cons (children (car (cdr (cdr (children (car x2))))))))
  (not
...
(assert
 (=> (and (is-succ (pred (data (car (cdr (children (car x2))))))))
  (not
...
(assert
 (=>
  (and (is-succ (data (car (cdr (children (car x2))))))
   (is-succ (pred (data (car (cdr (children (car x2))))))))
  (not
   (= (pred (pred (data (car (cdr (children (car x2)))))))
    (data (car (cdr (children (car x2)))))))))
(assert
...
(assert
 (=> (and (is-cons (cdr (children (car (cdr (children (car x2))))))))
  (not
...
(assert
 (=>
  (and (is-cons (children (car (cdr (children (car x2))))))
   (is-cons (cdr (children (car (cdr (children (car x2))))))))
  (not
   (= (cdr (cdr (children (car (cdr (children (car x2)))))))
    (children (car (cdr (children (car x2)))))))))
(assert
...
(assert
 (=>
  (and (is-cons x2) (is-node (car x2)) (is-cons (children (car x2)))
   ...
   (is-cons (children (car (cdr (children (car x2))))))
   (is-cons (cdr (children (car (cdr (children (car x2))))))))
  (not (= (cdr (cdr (children (car (cdr (children (car x2))))))) x2))))
(assert
 (=> (and (is-cons (children (car (cdr (children (car x2)))))))
  (not
   (= (cdr (children (car (cdr (children (car x2))))))
...
(assert
 (=>
  (and (is-cons (children (car (cdr (children (car x2))))))
   (is-node (car (children (car (cdr (children (car x2))))))))
  (not
 ...
 (=>
  ...
  (not
   (= (pred (pred (data (car (children (car x2))))))
    (data (car (children (car x2))))))))
(assert
 (=> (and (is-succ (pred (pred (data (car (children (car x2))))))))
  (not
...
(assert
 (=>
  (and (is-succ (pred (data (car (children (car x2))))))
   (is-succ (pred (pred (data (car (children (car x2))))))))
  (not
   (= (pred (pred (pred (data (car (children (car x2)))))))
    (pred (data (car (children (car x2)))))))))
(assert
...
(assert
 (=> (and (is-cons (cdr (cdr (children (car (children (car x2))))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (children (car (children (car x2))))))
   (is-cons (cdr (cdr (children (car (children (car x2))))))))
  (not
   (= (cdr (cdr (cdr (children (car (children (car x2)))))))
    (cdr (children (car (children (car x2)))))))))
(assert
...
(assert
 (=>
  (and (is-cons x2) (is-node (car x2)) (is-cons (children (car x2)))
   ...
   (is-cons (cdr (children (car (children (car x2))))))
   (is-cons (cdr (cdr (children (car (children (car x2))))))))
  (not (= (cdr (cdr (cdr (children (car (children (car x2))))))) x2))))
(assert
 (=> (and (is-cons (cdr (children (car (children (car x2)))))))
  (not
   (= (cdr (cdr (children (car (children (car x2))))))
...
(assert
 (=>
  (and (is-cons (cdr (children (car (children (car x2))))))
   (is-node (car (cdr (children (car (children (car x2))))))))
  (not
...
(assert
 (=> (and (is-succ (data (car (children (car (children (car x2))))))))
  (not
...
(assert
 (=> (and (is-cons (children (car (children (car (children (car x2))))))))
  (not
...
(assert
 (=>
  (and (is-cons (children (car (children (car x2)))))
   (is-node (car (children (car (children (car x2))))))
   (is-cons (children (car (children (car (children (car x2))))))))
  (not
   (= (cdr (children (car (children (car (children (car x2)))))))
    (children (car (children (car x2))))))))
(assert
...
(assert
 (=>
  (and (is-node (car (children (car (children (car x2))))))
   (is-cons (children (car (children (car (children (car x2))))))))
  (not
...
(assert
 (=> (and (is-cons (cdr (cdr (cdr (cdr (cdr (cdr null))))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (cdr (cdr (cdr (cdr null))))))
   (is-cons (cdr (cdr (cdr (cdr (cdr (cdr null))))))))
  (not
   (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr null)))))))
    (cdr (cdr (cdr (cdr (cdr null)))))))))
(assert
...
(assert
 (=>
  (and (is-cons (cdr null)) (is-cons (cdr (cdr null)))
   ...
   (is-cons (cdr (cdr (cdr (cdr (cdr null))))))
   (is-cons (cdr (cdr (cdr (cdr (cdr (cdr null))))))))
  (not (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr null))))))) (cdr null)))))
(assert
 (=>
  (and (is-cons null) (is-cons (cdr null)) (is-cons (cdr (cdr null)))
   (is-cons (cdr (cdr (cdr null)))) (is-cons (cdr (cdr (cdr (cdr null)))))
   (is-cons (cdr (cdr (cdr (cdr (cdr null))))))
   (is-cons (cdr (cdr (cdr (cdr (cdr (cdr null))))))))
  (not (= (cdr (cdr (cdr (cdr (cdr (cdr (cdr null))))))) null))))
(assert
 (=> (and (is-cons (cdr (cdr (cdr (cdr (cdr null)))))))
  (not
   (= (cdr (cdr (cdr (cdr (cdr (cdr null))))))
...
(assert
 (=>
  (and (is-cons (cdr (cdr (cdr (cdr (cdr null))))))
   (is-node (car (cdr (cdr (cdr (cdr (cdr null))))))))
  (not
...
(assert
 (=>
  (and (is-cons null) (is-cons (cdr null)) (is-cons (cdr (cdr null)))
   ...
   (is-cons (cdr (cdr (cdr (cdr (cdr null))))))
   (is-node (car (cdr (cdr (cdr (cdr (cdr null))))))))
  (not (= (children (car (cdr (cdr (cdr (cdr (cdr null))))))) null))))
(assert
 (=> (and (is-cons (cdr (cdr (cdr (cdr null))))))
  (not (= (cdr (cdr (cdr (cdr (cdr null))))) (cdr (cdr (cdr (cdr null))))))))
(assert
...
(assert
 (=>
  ...
  (not (= (cdr (cdr (cdr (cdr null)))) null))))
(assert
 (=> (and (is-succ (data (car (cdr (cdr (cdr (cdr null))))))))
  (not
...
(assert
 (=> (and (is-cons (children (car (cdr (cdr (cdr (cdr null))))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (cdr (cdr (cdr null)))))
   (is-node (car (cdr (cdr (cdr (cdr null))))))
   (is-cons (children (car (cdr (cdr (cdr (cdr null))))))))
  (not
   (= (cdr (children (car (cdr (cdr (cdr (cdr null)))))))
    (cdr (cdr (cdr (cdr null))))))))
(assert
...
(assert
 (=>
  (and (is-cons null) (is-cons (cdr null)) (is-cons (cdr (cdr null)))
   ...
   (is-node (car (cdr (cdr (cdr (cdr null))))))
   (is-cons (children (car (cdr (cdr (cdr (cdr null))))))))
  (not (= (cdr (children (car (cdr (cdr (cdr (cdr null))))))) null))))
(assert
 (=>
  (and (is-cons (cdr (cdr (cdr (cdr null)))))
   (is-node (car (cdr (cdr (cdr (cdr null)))))))
...
(assert
 (=>
  (and (is-node (car (cdr (cdr (cdr (cdr null))))))
   (is-cons (children (car (cdr (cdr (cdr (cdr null))))))))
  (not
...
(assert
 (=> (and (is-succ (pred (data (car (cdr (cdr (cdr null))))))))
  (not
...
(assert
 (=>
  (and (is-succ (data (car (cdr (cdr (cdr null))))))
   (is-succ (pred (data (car (cdr (cdr (cdr null))))))))
  (not
   (= (pred (pred (data (car (cdr (cdr (cdr null)))))))
    (data (car (cdr (cdr (cdr null)))))))))
(assert
...
(assert
 (=> (and (is-cons (cdr (children (car (cdr (cdr (cdr null))))))))
  (not
...
(assert
 (=>
  (and (is-cons (children (car (cdr (cdr (cdr null))))))
   (is-cons (cdr (children (car (cdr (cdr (cdr null))))))))
  (not
   (= (cdr (cdr (children (car (cdr (cdr (cdr null)))))))
    (children (car (cdr (cdr (cdr null)))))))))
(assert
...
(assert
 (=>
  (and (is-cons null) (is-cons (cdr null)) (is-cons (cdr (cdr null)))
   ...
   (is-cons (children (car (cdr (cdr (cdr null))))))
   (is-cons (cdr (children (car (cdr (cdr (cdr null))))))))
  (not (= (cdr (cdr (children (car (cdr (cdr (cdr null))))))) null))))
(assert
 (=> (and (is-cons (children (car (cdr (cdr (cdr null)))))))
  (not
   (= (cdr (children (car (cdr (cdr (cdr null))))))
...
(assert
 (=>
  (and (is-cons (children (car (cdr (cdr (cdr null))))))
   (is-node (car (children (car (cdr (cdr (cdr null))))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr null)) (is-cons (cdr (cdr null)))
   ...
   (is-node (car (children (car (cdr (cdr (cdr null))))))))
  (not
   (= (children (car (children (car (cdr (cdr (cdr null))))))) (cdr null)))))
(assert
 (=>
  (and (is-cons null) (is-cons (cdr null)) (is-cons (cdr (cdr null)))
   (is-cons (cdr (cdr (cdr null)))) (is-node (car (cdr (cdr (cdr null)))))
...
(assert
 (=> (and (is-succ (pred (pred (data (car (cdr (cdr null))))))))
  (not
...
(assert
 (=>
  (and (is-succ (pred (data (car (cdr (cdr null))))))
   (is-succ (pred (pred (data (car (cdr (cdr null))))))))
  (not
   (= (pred (pred (pred (data (car (cdr (cdr null)))))))
    (pred (data (car (cdr (cdr null)))))))))
(assert
...
(assert
 (=> (and (is-cons (cdr (cdr (children (car (cdr (cdr null))))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (children (car (cdr (cdr null))))))
   (is-cons (cdr (cdr (children (car (cdr (cdr null))))))))
  (not
   (= (cdr (cdr (cdr (children (car (cdr (cdr null)))))))
    (cdr (children (car (cdr (cdr null)))))))))
(assert
...
(assert
 (=>
  (and (is-cons null) (is-cons (cdr null)) (is-cons (cdr (cdr null)))
   ...
   (is-cons (cdr (children (car (cdr (cdr null))))))
   (is-cons (cdr (cdr (children (car (cdr (cdr null))))))))
  (not (= (cdr (cdr (cdr (children (car (cdr (cdr null))))))) null))))
(assert
 (=> (and (is-cons (cdr (children (car (cdr (cdr null)))))))
  (not
   (= (cdr (cdr (children (car (cdr (cdr null))))))
...
(assert
 (=>
  (and (is-cons (cdr (children (car (cdr (cdr null))))))
   (is-node (car (cdr (children (car (cdr (cdr null))))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr null)) (is-cons (cdr (cdr null)))
   ...
   (is-node (car (cdr (children (car (cdr (cdr null))))))))
  (not
   (= (children (car (cdr (children (car (cdr (cdr null))))))) (cdr null)))))
(assert
 (=>
  (and (is-cons null) (is-cons (cdr null)) (is-cons (cdr (cdr null)))
   (is-node (car (cdr (cdr null))))
...
(assert
 (=> (and (is-succ (data (car (children (car (cdr (cdr null))))))))
  (not
...
(assert
 (=> (and (is-cons (children (car (children (car (cdr (cdr null))))))))
  (not
...
(assert
 (=>
  (and (is-cons (children (car (cdr (cdr null)))))
   (is-node (car (children (car (cdr (cdr null))))))
   (is-cons (children (car (children (car (cdr (cdr null))))))))
  (not
   (= (cdr (children (car (children (car (cdr (cdr null)))))))
    (children (car (cdr (cdr null))))))))
(assert
...
(assert
 (=>
  (and (is-cons (cdr null)) (is-cons (cdr (cdr null)))
   ...
   (is-cons (children (car (children (car (cdr (cdr null))))))))
  (not
   (= (cdr (children (car (children (car (cdr (cdr null))))))) (cdr null)))))
(assert
 (=>
  (and (is-cons null) (is-cons (cdr null)) (is-cons (cdr (cdr null)))
   (is-node (car (cdr (cdr null))))
...
(assert
 (=>
  (and (is-node (car (children (car (cdr (cdr null))))))
   (is-cons (children (car (children (car (cdr (cdr null))))))))
  (not
...
(assert
 (=> (and (is-succ (pred (pred (pred (data (car (cdr null))))))))
  (not
...
(assert
 (=>
  (and (is-succ (pred (pred (data (car (cdr null))))))
   (is-succ (pred (pred (pred (data (car (cdr null))))))))
  (not
   (= (pred (pred (pred (pred (data (car (cdr null)))))))
    (pred (pred (data (car (cdr null)))))))))
(assert
...
(assert
 (=> (and (is-cons (cdr (cdr (cdr (children (car (cdr null))))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (cdr (children (car (cdr null))))))
   (is-cons (cdr (cdr (cdr (children (car (cdr null))))))))
  (not
   (= (cdr (cdr (cdr (cdr (children (car (cdr null)))))))
    (cdr (cdr (children (car (cdr null)))))))))
(assert
...
(assert
 (=>
  (and (is-cons null) (is-cons (cdr null)) (is-node (car (cdr null)))
   ...
   (is-cons (cdr (cdr (children (car (cdr null))))))
   (is-cons (cdr (cdr (cdr (children (car (cdr null))))))))
  (not (= (cdr (cdr (cdr (cdr (children (car (cdr null))))))) null))))
(assert
 (=> (and (is-cons (cdr (cdr (children (car (cdr null)))))))
  (not
   (= (cdr (cdr (cdr (children (car (cdr null))))))
...
(assert
 (=>
  (and (is-cons (cdr (cdr (children (car (cdr null))))))
   (is-node (car (cdr (cdr (children (car (cdr null))))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr null)) (is-node (car (cdr null)))
   ...
   (is-node (car (cdr (cdr (children (car (cdr null))))))))
  (not
   (= (children (car (cdr (cdr (children (car (cdr null))))))) (cdr null)))))
(assert
 (=>
  (and (is-cons null) (is-cons (cdr null)) (is-node (car (cdr null)))
   (is-cons (children (car (cdr null))))
...
(assert
 (=> (and (is-succ (data (car (cdr (children (car (cdr null))))))))
  (not
...
(assert
 (=> (and (is-cons (children (car (cdr (children (car (cdr null))))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (children (car (cdr null)))))
   (is-node (car (cdr (children (car (cdr null))))))
   (is-cons (children (car (cdr (children (car (cdr null))))))))
  (not
   (= (cdr (children (car (cdr (children (car (cdr null)))))))
    (cdr (children (car (cdr null))))))))
(assert
...
(assert
 (=>
  (and (is-cons (cdr null)) (is-node (car (cdr null)))
   ...
   (is-cons (children (car (cdr (children (car (cdr null))))))))
  (not
   (= (cdr (children (car (cdr (children (car (cdr null))))))) (cdr null)))))
(assert
 (=>
  (and (is-cons null) (is-cons (cdr null)) (is-node (car (cdr null)))
   (is-cons (children (car (cdr null))))
...
(assert
 (=>
  (and (is-node (car (cdr (children (car (cdr null))))))
   (is-cons (children (car (cdr (children (car (cdr null))))))))
  (not
...
(assert
 (=> (and (is-succ (pred (data (car (children (car (cdr null))))))))
  (not
...
(assert
 (=>
  (and (is-succ (data (car (children (car (cdr null))))))
   (is-succ (pred (data (car (children (car (cdr null))))))))
  (not
   (= (pred (pred (data (car (children (car (cdr null)))))))
    (data (car (children (car (cdr null)))))))))
(assert
...
(assert
 (=> (and (is-cons (cdr (children (car (children (car (cdr null))))))))
  (not
...
(assert
 (=>
  (and (is-cons (children (car (children (car (cdr null))))))
   (is-cons (cdr (children (car (children (car (cdr null))))))))
  (not
   (= (cdr (cdr (children (car (children (car (cdr null)))))))
    (children (car (children (car (cdr null)))))))))
(assert
...
(assert
 (=>
  (and (is-cons (cdr null)) (is-node (car (cdr null)))
   ...
   (is-cons (cdr (children (car (children (car (cdr null))))))))
  (not
   (= (cdr (cdr (children (car (children (car (cdr null))))))) (cdr null)))))
(assert
 (=>
  (and (is-cons null) (is-cons (cdr null)) (is-node (car (cdr null)))
   (is-cons (children (car (cdr null))))
...
(assert
 (=>
  (and (is-cons (children (car (children (car (cdr null))))))
   (is-node (car (children (car (children (car (cdr null))))))))
  (not
...
(assert
 (=> (and (is-succ (pred (pred (pred (pred (data (car null))))))))
  (not
...
(assert
 (=>
  (and (is-succ (pred (pred (pred (data (car null))))))
   (is-succ (pred (pred (pred (pred (data (car null))))))))
  (not
   (= (pred (pred (pred (pred (pred (data (car null)))))))
    (pred (pred (pred (data (car null)))))))))
(assert
...
(assert
 (=> (and (is-cons (cdr (cdr (cdr (cdr (children (car null))))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (cdr (cdr (children (car null))))))
   (is-cons (cdr (cdr (cdr (cdr (children (car null))))))))
  (not
   (= (cdr (cdr (cdr (cdr (cdr (children (car null)))))))
    (cdr (cdr (cdr (children (car null)))))))))
(assert
...
(assert
 (=>
  (and (is-cons null) (is-node (car null)) (is-cons (children (car null)))
   ...
   (is-cons (cdr (cdr (cdr (children (car null))))))
   (is-cons (cdr (cdr (cdr (cdr (children (car null))))))))
  (not (= (cdr (cdr (cdr (cdr (cdr (children (car null))))))) null))))
(assert
 (=> (and (is-cons (cdr (cdr (cdr (children (car null)))))))
  (not
   (= (cdr (cdr (cdr (cdr (children (car null))))))
...
(assert
 (=>
  (and (is-cons (cdr (cdr (cdr (children (car null))))))
   (is-node (car (cdr (cdr (cdr (children (car null))))))))
  (not
...
(assert
 (=> (and (is-succ (data (car (cdr (cdr (children (car null))))))))
  (not
...
(assert
 (=> (and (is-cons (children (car (cdr (cdr (children (car null))))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (cdr (children (car null)))))
   (is-node (car (cdr (cdr (children (car null))))))
   (is-cons (children (car (cdr (cdr (children (car null))))))))
  (not
   (= (cdr (children (car (cdr (cdr (children (car null)))))))
    (cdr (cdr (children (car null))))))))
(assert
...
(assert
 (=>
  (and (is-node (car (cdr (cdr (children (car null))))))
   (is-cons (children (car (cdr (cdr (children (car null))))))))
  (not
...
(assert
 (=>
  (and (is-node (car null)) (is-cons (children (car null)))
   ...
   (is-cons (children (car (cdr (cdr (children (car null))))))))
  (not
   (= (car (children (car (cdr (cdr (children (car null))))))) (car null)))))
(assert
 (=>
  (and (is-cons (cdr (cdr (children (car null)))))
   (is-node (car (cdr (cdr (children (car null)))))))
...
(assert
 (=> (and (is-succ (pred (data (car (cdr (children (car null))))))))
  (not
...
(assert
 (=>
  (and (is-succ (data (car (cdr (children (car null))))))
   (is-succ (pred (data (car (cdr (children (car null))))))))
  (not
   (= (pred (pred (data (car (cdr (children (car null)))))))
    (data (car (cdr (children (car null)))))))))
(assert
...
(assert
 (=> (and (is-cons (cdr (children (car (cdr (children (car null))))))))
  (not
...
(assert
 (=>
  (and (is-cons (children (car (cdr (children (car null))))))
   (is-cons (cdr (children (car (cdr (children (car null))))))))
  (not
   (= (cdr (cdr (children (car (cdr (children (car null)))))))
    (children (car (cdr (children (car null)))))))))
(assert
...
(assert
 (=>
  (and (is-node (car null)) (is-cons (children (car null)))
   ...
   (is-cons (cdr (children (car (cdr (children (car null))))))))
  (not
   (= (car (cdr (children (car (cdr (children (car null))))))) (car null)))))
(assert
 (=> (and (is-cons (children (car (cdr (children (car null)))))))
  (not
   (= (cdr (children (car (cdr (children (car null))))))
...
(assert
 (=>
  (and (is-cons (children (car (cdr (children (car null))))))
   (is-node (car (children (car (cdr (children (car null))))))))
  (not
 ...
 (=>
  ...
  (not
   (= (pred (pred (data (car (children (car null))))))
    (data (car (children (car null))))))))
(assert
 (=> (and (is-succ (pred (pred (data (car (children (car null))))))))
  (not
...
(assert
 (=>
  (and (is-succ (pred (data (car (children (car null))))))
   (is-succ (pred (pred (data (car (children (car null))))))))
  (not
   (= (pred (pred (pred (data (car (children (car null)))))))
    (pred (data (car (children (car null)))))))))
(assert
...
(assert
 (=> (and (is-cons (cdr (cdr (children (car (children (car null))))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (children (car (children (car null))))))
   (is-cons (cdr (cdr (children (car (children (car null))))))))
  (not
   (= (cdr (cdr (cdr (children (car (children (car null)))))))
    (cdr (children (car (children (car null)))))))))
(assert
...
(assert
 (=>
  (and (is-node (car null)) (is-cons (children (car null)))
   ...
   (is-cons (cdr (cdr (children (car (children (car null))))))))
  (not
   (= (car (cdr (cdr (children (car (children (car null))))))) (car null)))))
(assert
 (=> (and (is-cons (cdr (children (car (children (car null)))))))
  (not
   (= (cdr (cdr (children (car (children (car null))))))
...
(assert
 (=>
  (and (is-cons (cdr (children (car (children (car null))))))
   (is-node (car (cdr (children (car (children (car null))))))))
  (not
...
(assert
 (=> (and (is-succ (data (car (children (car (children (car null))))))))
  (not
...
(assert
 (=> (and (is-cons (children (car (children (car (children (car null))))))))
  (not
...
(assert
 (=>
  (and (is-cons (children (car (children (car null)))))
   (is-node (car (children (car (children (car null))))))
   (is-cons (children (car (children (car (children (car null))))))))
  (not
   (= (cdr (children (car (children (car (children (car null)))))))
    (children (car (children (car null))))))))
(assert
...
(assert
 (=>
  (and (is-node (car (children (car (children (car null))))))
   (is-cons (children (car (children (car (children (car null))))))))
  (not
...
(assert
 (=> (and (is-cons null) (is-node (car null)))
  (not (= (children (car null)) null))))
(assert
 (=> (and (is-succ (data contrived_variable1)))
  (not (= (pred (data contrived_variable1)) (data contrived_variable1)))))
(assert
 (=> (and (is-succ (pred (data contrived_variable1))))
  (not
...
(assert
 (=>
  (and (is-succ (data contrived_variable1))
   (is-succ (pred (data contrived_variable1))))
  (not
   (= (pred (pred (data contrived_variable1))) (data contrived_variable1)))))
(assert
 (=> (and (is-succ (pred (pred (data contrived_variable1)))))
  (not
...
(assert
 (=>
  (and (is-succ (pred (data contrived_variable1)))
   (is-succ (pred (pred (data contrived_variable1)))))
  (not
   (= (pred (pred (pred (data contrived_variable1))))
    (pred (data contrived_variable1))))))
(assert
...
(assert
 (=> (and (is-succ (pred (pred (pred (data contrived_variable1))))))
  (not
...
(assert
 (=>
  (and (is-succ (pred (pred (data contrived_variable1))))
   (is-succ (pred (pred (pred (data contrived_variable1))))))
  (not
   (= (pred (pred (pred (pred (data contrived_variable1)))))
    (pred (pred (data contrived_variable1)))))))
(assert
 ...
 (=>
  ...
  (not
   (= (pred (pred (pred (pred (data contrived_variable1)))))
    (data contrived_variable1)))))
(assert
 (=> (and (is-succ (pred (pred (pred (pred (data contrived_variable1)))))))
  (not
...
(assert
 (=>
  (and (is-succ (pred (pred (pred (data contrived_variable1)))))
   (is-succ (pred (pred (pred (pred (data contrived_variable1)))))))
  (not
   (= (pred (pred (pred (pred (pred (data contrived_variable1))))))
    (pred (pred (pred (data contrived_variable1))))))))
(assert
...
(assert
 (=>
  (and
   (is-succ (pred (pred (pred (pred (pred (data contrived_variable1))))))))
  (not
...
(assert
 (=> (and (is-succ (data contrived_variable1)))
  (not (= (pred (data contrived_variable1)) (data contrived_variable1)))))
(assert
 (=> (and (is-cons (children contrived_variable1)))
  (not
   (= (cdr (children contrived_variable1)) (children contrived_variable1)))))
(assert
 (=> (and (is-cons (cdr (children contrived_variable1))))
  (not
...
(assert
 (=>
  (and (is-cons (children contrived_variable1))
   (is-cons (cdr (children contrived_variable1))))
  (not
   (= (cdr (cdr (children contrived_variable1)))
    (children contrived_variable1)))))
(assert
 (=> (and (is-cons (cdr (cdr (children contrived_variable1)))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (children contrived_variable1)))
   (is-cons (cdr (cdr (children contrived_variable1)))))
  (not
   (= (cdr (cdr (cdr (children contrived_variable1))))
    (cdr (children contrived_variable1))))))
(assert
 (=>
  ...
  (not
   (= (cdr (cdr (cdr (children contrived_variable1))))
    (children contrived_variable1)))))
(assert
 (=> (and (is-cons (cdr (cdr (cdr (children contrived_variable1))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (cdr (children contrived_variable1))))
   (is-cons (cdr (cdr (cdr (children contrived_variable1))))))
  (not
   (= (cdr (cdr (cdr (cdr (children contrived_variable1)))))
    (cdr (cdr (children contrived_variable1)))))))
(assert
 ...
 (=>
  ...
  (not
   (= (cdr (cdr (cdr (cdr (children contrived_variable1)))))
    (children contrived_variable1)))))
(assert
 (=> (and (is-cons (cdr (cdr (cdr (cdr (children contrived_variable1)))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (cdr (cdr (children contrived_variable1)))))
   (is-cons (cdr (cdr (cdr (cdr (children contrived_variable1)))))))
  (not
   (= (cdr (cdr (cdr (cdr (cdr (children contrived_variable1))))))
    (cdr (cdr (cdr (children contrived_variable1))))))))
(assert
...
(assert
 (=>
  (and (is-cons (cdr (cdr (cdr (cdr (cdr (children contrived_variable1))))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (cdr (cdr (cdr (children contrived_variable1))))))
   (is-cons (cdr (cdr (cdr (cdr (cdr (children contrived_variable1))))))))
  (not
   (= (cdr (cdr (cdr (cdr (cdr (cdr (children contrived_variable1)))))))
    (cdr (cdr (cdr (cdr (children contrived_variable1)))))))))
(assert
...
(assert
 (=>
  (and (is-node contrived_variable1) (is-cons (children contrived_variable1))
   (is-cons (cdr (children contrived_variable1)))
   (is-cons (cdr (cdr (children contrived_variable1))))
   (is-cons (cdr (cdr (cdr (children contrived_variable1)))))
   (is-cons (cdr (cdr (cdr (cdr (children contrived_variable1))))))
...
(assert
 (=>
  (and (is-cons (cdr (cdr (cdr (cdr (children contrived_variable1))))))
   (is-node (car (cdr (cdr (cdr (cdr (children contrived_variable1))))))))
  (not
...
(assert
 (=>
  (and
   (is-succ (data (car (cdr (cdr (cdr (children contrived_variable1))))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (cdr (cdr (children contrived_variable1)))))
   (is-node (car (cdr (cdr (cdr (children contrived_variable1)))))))
  (not
...
(assert
 (=>
  (and
   (is-cons (children (car (cdr (cdr (cdr (children contrived_variable1))))))))
  (not
...
(assert
 (=>
  (and (is-node (car (cdr (cdr (cdr (children contrived_variable1))))))
   (is-cons (children (car (cdr (cdr (cdr (children contrived_variable1))))))))
  (not
...
(assert
 (=> (and (is-succ (data (car (cdr (cdr (children contrived_variable1)))))))
  (not
...
(assert
 (=>
  (and
   (is-succ (pred (data (car (cdr (cdr (children contrived_variable1))))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (cdr (children contrived_variable1))))
   (is-node (car (cdr (cdr (children contrived_variable1))))))
  (not
...
(assert
 (=>
  (and (is-cons (children (car (cdr (cdr (children contrived_variable1)))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (cdr (children contrived_variable1))))
   (is-node (car (cdr (cdr (children contrived_variable1)))))
   (is-cons (children (car (cdr (cdr (children contrived_variable1)))))))
  (not
   (= (cdr (children (car (cdr (cdr (children contrived_variable1))))))
    (cdr (cdr (children contrived_variable1)))))))
(assert
...
(assert
 (=>
  (and
   (is-cons (cdr (children (car (cdr (cdr (children contrived_variable1))))))))
  (not
...
(assert
 (=>
  (and (is-node (car (cdr (cdr (children contrived_variable1)))))
   (is-cons (children (car (cdr (cdr (children contrived_variable1))))))
   (is-cons (cdr (children (car (cdr (cdr (children contrived_variable1))))))))
  (not
...
(assert
 (=>
  (and (is-cons (children (car (cdr (cdr (children contrived_variable1))))))
   (is-node (car (children (car (cdr (cdr (children contrived_variable1))))))))
  (not
   (=
...
(assert
 (=> (and (is-succ (data (car (cdr (children contrived_variable1))))))
  (not
   (= (pred (data (car (cdr (children contrived_variable1)))))
    (data (car (cdr (children contrived_variable1))))))))
(assert
 (=> (and (is-succ (pred (data (car (cdr (children contrived_variable1)))))))
  (not
...
(assert
 (=>
  (and (is-succ (data (car (cdr (children contrived_variable1)))))
   (is-succ (pred (data (car (cdr (children contrived_variable1)))))))
  (not
   (= (pred (pred (data (car (cdr (children contrived_variable1))))))
    (data (car (cdr (children contrived_variable1))))))))
(assert
 (=>
  (and
   (is-succ (pred (pred (data (car (cdr (children contrived_variable1))))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (children contrived_variable1)))
   (is-node (car (cdr (children contrived_variable1)))))
  (not
 ...
 (=>
  ...
  (not
   (= (children (car (cdr (children contrived_variable1))))
    (children contrived_variable1)))))
(assert
 (=> (and (is-cons (children (car (cdr (children contrived_variable1))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (children contrived_variable1)))
   (is-node (car (cdr (children contrived_variable1))))
   (is-cons (children (car (cdr (children contrived_variable1))))))
  (not
   (= (cdr (children (car (cdr (children contrived_variable1)))))
    (cdr (children contrived_variable1))))))
(assert
...
(assert
 (=>
  (and (is-cons (cdr (children (car (cdr (children contrived_variable1)))))))
  (not
...
(assert
 (=>
  (and (is-cons (children (car (cdr (children contrived_variable1)))))
   (is-cons (cdr (children (car (cdr (children contrived_variable1)))))))
  (not
   (= (cdr (cdr (children (car (cdr (children contrived_variable1))))))
    (children (car (cdr (children contrived_variable1))))))))
(assert
...
(assert
 (=>
  (and
   (is-cons (cdr (cdr (children (car (cdr (children contrived_variable1))))))))
  (not
...
(assert
 (=>
  (and (is-node (car (cdr (children contrived_variable1))))
   (is-cons (children (car (cdr (children contrived_variable1)))))
   (is-cons (cdr (children (car (cdr (children contrived_variable1))))))
   (is-cons (cdr (cdr (children (car (cdr (children contrived_variable1))))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (children (car (cdr (children contrived_variable1))))))
   (is-node (car (cdr (children (car (cdr (children contrived_variable1))))))))
  (not
   (=
...
(assert
 (=>
  (and
   (is-succ (data (car (children (car (cdr (children
    contrived_variable1))))))))
  (not
   (=
...
(assert
 (=>
  (and (is-cons (children (car (cdr (children contrived_variable1)))))
   (is-node (car (children (car (cdr (children contrived_variable1)))))))
  (not
...
(assert
 (=>
  (and
   (is-cons (children (car (children (car (cdr (children
    contrived_variable1))))))))
  (not
   (=
...
(assert
 (=>
  (and (is-node (car (children (car (cdr (children contrived_variable1))))))
   (is-cons (children (car (children (car (cdr (children
    contrived_variable1))))))))
  (not
   (=
...
(assert
 (=>
  (and (is-node contrived_variable1) (is-cons (children contrived_variable1)))
  (not (= (car (children contrived_variable1)) contrived_variable1))))
(assert
 (=> (and (is-succ (data (car (children contrived_variable1)))))
  (not
   (= (pred (data (car (children contrived_variable1))))
    (data (car (children contrived_variable1)))))))
(assert
 (=> (and (is-succ (pred (data (car (children contrived_variable1))))))
  (not
...
(assert
 (=>
  (and (is-succ (data (car (children contrived_variable1))))
   (is-succ (pred (data (car (children contrived_variable1))))))
  (not
   (= (pred (pred (data (car (children contrived_variable1)))))
    (data (car (children contrived_variable1)))))))
(assert
 (=>
  (and (is-succ (pred (pred (data (car (children contrived_variable1)))))))
  (not
...
(assert
 (=>
  (and (is-succ (pred (data (car (children contrived_variable1)))))
   (is-succ (pred (pred (data (car (children contrived_variable1)))))))
  (not
   (= (pred (pred (pred (data (car (children contrived_variable1))))))
    (pred (data (car (children contrived_variable1))))))))
(assert
...
(assert
 (=>
  (and
   (is-succ (pred (pred (pred (data (car (children contrived_variable1))))))))
  (not
...
(assert
 (=>
  (and (is-cons (children contrived_variable1))
   (is-node (car (children contrived_variable1))))
  (not
   (= (children (car (children contrived_variable1)))
    (children contrived_variable1)))))
(assert
 (=> (and (is-cons (children (car (children contrived_variable1)))))
  (not
...
(assert
 (=>
  (and (is-cons (children contrived_variable1))
   (is-node (car (children contrived_variable1)))
   (is-cons (children (car (children contrived_variable1)))))
  (not
   (= (cdr (children (car (children contrived_variable1))))
    (children contrived_variable1)))))
(assert
 (=> (and (is-cons (cdr (children (car (children contrived_variable1))))))
  (not
...
(assert
 (=>
  (and (is-cons (children (car (children contrived_variable1))))
   (is-cons (cdr (children (car (children contrived_variable1))))))
  (not
   (= (cdr (cdr (children (car (children contrived_variable1)))))
    (children (car (children contrived_variable1)))))))
(assert
...
(assert
 (=>
  (and (is-cons (cdr (cdr (children (car (children contrived_variable1)))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (children (car (children contrived_variable1)))))
   (is-cons (cdr (cdr (children (car (children contrived_variable1)))))))
  (not
   (= (cdr (cdr (cdr (children (car (children contrived_variable1))))))
    (cdr (children (car (children contrived_variable1))))))))
(assert
...
(assert
 (=>
  (and
   (is-cons (cdr (cdr (cdr (children (car (children contrived_variable1))))))))
  (not
...
(assert
 (=>
  (and (is-node (car (children contrived_variable1)))
   (is-cons (children (car (children contrived_variable1))))
   (is-cons (cdr (children (car (children contrived_variable1)))))
   (is-cons (cdr (cdr (children (car (children contrived_variable1))))))
   (is-cons (cdr (cdr (cdr (children (car (children contrived_variable1))))))))
...
(assert
 (=>
  (and (is-cons (cdr (cdr (children (car (children contrived_variable1))))))
   (is-node (car (cdr (cdr (children (car (children contrived_variable1))))))))
  (not
   (=
...
(assert
 (=>
  (and
   (is-succ (data (car (cdr (children (car (children
    contrived_variable1))))))))
  (not
   (=
...
(assert
 (=>
  (and (is-cons (cdr (children (car (children contrived_variable1)))))
   (is-node (car (cdr (children (car (children contrived_variable1)))))))
  (not
...
(assert
 (=>
  (and
   (is-cons (children (car (cdr (children (car (children
    contrived_variable1))))))))
  (not
   (=
...
(assert
 (=>
  (and (is-node (car (cdr (children (car (children contrived_variable1))))))
   (is-cons (children (car (cdr (children (car (children
    contrived_variable1))))))))
  (not
   (=
...
(assert
 (=>
  (and (is-succ (data (car (children (car (children contrived_variable1)))))))
  (not
...
(assert
 (=>
  (and
   (is-succ (pred (data (car (children (car (children
    contrived_variable1))))))))
  (not
   (=
...
(assert
 (=>
  (and (is-cons (children (car (children contrived_variable1))))
   (is-node (car (children (car (children contrived_variable1))))))
  (not
...
(assert
 (=>
  (and
   (is-cons (children (car (children (car (children contrived_variable1)))))))
  (not
...
(assert
 (=>
  (and
   (is-cons (cdr (children (car (children (car (children
    contrived_variable1))))))))
  (not
   (=
...
(assert
 (=>
  (and (is-node (car (children (car (children contrived_variable1)))))
   (is-cons (children (car (children (car (children contrived_variable1))))))
   (is-cons (cdr (children (car (children (car (children
    contrived_variable1))))))))
  (not
...
(assert
 (=>
  (and
   (is-cons (children (car (children (car (children contrived_variable1))))))
   (is-node (car (children (car (children (car (children
    contrived_variable1))))))))
  (not
   (=
...
(assert
 (=> (and (is-succ (pred (pred (pred (pred (pred (data x3))))))))
  (not
   (= (pred (pred (pred (pred (pred (pred (data x3)))))))
    (pred (pred (pred (pred (pred (data x3))))))))))
(assert
 (=>
  (and (is-succ (pred (pred (pred (pred (data x3))))))
   (is-succ (pred (pred (pred (pred (pred (data x3))))))))
  (not
   (= (pred (pred (pred (pred (pred (pred (data x3)))))))
    (pred (pred (pred (pred (data x3)))))))))
(assert
...
(assert
 (=>
  (and (is-succ (pred (data x3))) (is-succ (pred (pred (data x3))))
   ...
   (is-succ (pred (pred (pred (pred (pred (data x3))))))))
  (not
   (= (pred (pred (pred (pred (pred (pred (data x3))))))) (pred (data x3))))))
(assert
 (=>
  (and (is-succ (data x3)) (is-succ (pred (data x3)))
   (is-succ (pred (pred (data x3)))) (is-succ (pred (pred (pred (data x3)))))
   (is-succ (pred (pred (pred (pred (data x3))))))
   (is-succ (pred (pred (pred (pred (pred (data x3))))))))
  (not (= (pred (pred (pred (pred (pred (pred (data x3))))))) (data x3)))))
(assert
 (=> (and (is-succ (pred (pred (pred (pred (data x3)))))))
  (not
   (= (pred (pred (pred (pred (pred (data x3))))))
...
(assert
 (=> (and (is-cons (cdr (cdr (cdr (cdr (cdr (children x3))))))))
  (not
   (= (cdr (cdr (cdr (cdr (cdr (cdr (children x3)))))))
    (cdr (cdr (cdr (cdr (cdr (children x3))))))))))
(assert
 (=>
  (and (is-cons (cdr (cdr (cdr (cdr (children x3))))))
   (is-cons (cdr (cdr (cdr (cdr (cdr (children x3))))))))
  (not
   (= (cdr (cdr (cdr (cdr (cdr (cdr (children x3)))))))
    (cdr (cdr (cdr (cdr (children x3)))))))))
(assert
...
(assert
 (=>
  (and (is-cons (cdr (children x3))) (is-cons (cdr (cdr (children x3))))
   ...
   (is-cons (cdr (cdr (cdr (cdr (cdr (children x3))))))))
  (not
   (= (cdr (cdr (cdr (cdr (cdr (cdr (children x3))))))) (cdr (children x3))))))
(assert
 (=>
  (and (is-cons (children x3)) (is-cons (cdr (children x3)))
   (is-cons (cdr (cdr (children x3))))
   ...
   (is-cons (cdr (cdr (cdr (cdr (children x3))))))
   (is-cons (cdr (cdr (cdr (cdr (cdr (children x3))))))))
  (not (= (cdr (cdr (cdr (cdr (cdr (cdr (children x3))))))) (children x3)))))
(assert
 (=> (and (is-cons (cdr (cdr (cdr (cdr (children x3)))))))
  (not
   (= (cdr (cdr (cdr (cdr (cdr (children x3))))))
...
(assert
 (=>
  (and (is-node x3) (is-cons (children x3)) (is-cons (cdr (children x3)))
   ...
   (is-cons (cdr (cdr (cdr (cdr (children x3))))))
   (is-cons (cdr (cdr (cdr (cdr (cdr (children x3))))))))
  (not (= (car (cdr (cdr (cdr (cdr (cdr (children x3))))))) x3))))
(assert
 (=> (and (is-cons (cdr (cdr (cdr (cdr (children x3)))))))
  (not
   (= (cdr (cdr (cdr (cdr (cdr (children x3))))))
...
(assert
 (=>
  (and (is-cons (cdr (cdr (cdr (cdr (children x3))))))
   (is-node (car (cdr (cdr (cdr (cdr (children x3))))))))
  (not
   (= (children (car (cdr (cdr (cdr (cdr (children x3)))))))
    (cdr (cdr (cdr (cdr (children x3)))))))))
(assert
 (=>
  (and (is-cons (cdr (cdr (cdr (children x3)))))
...
(assert
 (=>
  (and (is-cons (children x3)) (is-cons (cdr (children x3)))
   ...
   (is-node (car (cdr (cdr (cdr (cdr (children x3))))))))
  (not
   (= (children (car (cdr (cdr (cdr (cdr (children x3))))))) (children x3)))))
(assert
 (=>
  (and (is-node x3) (is-cons (children x3)) (is-cons (cdr (children x3)))
   (is-cons (cdr (cdr (children x3))))
...
(assert
 (=> (and (is-succ (data (car (cdr (cdr (cdr (children x3))))))))
  (not
   (= (pred (data (car (cdr (cdr (cdr (children x3)))))))
    (data (car (cdr (cdr (cdr (children x3))))))))))
(assert
 (=>
  (and (is-node x3) (is-cons (children x3)) (is-cons (cdr (children x3)))
   (is-cons (cdr (cdr (children x3))))
...
(assert
 (=> (and (is-cons (children (car (cdr (cdr (cdr (children x3))))))))
  (not
   (= (cdr (children (car (cdr (cdr (cdr (children x3)))))))
    (children (car (cdr (cdr (cdr (children x3))))))))))
(assert
 (=>
  (and (is-cons (cdr (cdr (cdr (children x3)))))
   (is-node (car (cdr (cdr (cdr (children x3))))))
   (is-cons (children (car (cdr (cdr (cdr (children x3))))))))
  (not
   (= (cdr (children (car (cdr (cdr (cdr (children x3)))))))
    (cdr (cdr (cdr (children x3))))))))
(assert
...
(assert
 (=>
  (and (is-cons (children x3)) (is-cons (cdr (children x3)))
   ...
   (is-cons (children (car (cdr (cdr (cdr (children x3))))))))
  (not
   (= (cdr (children (car (cdr (cdr (cdr (children x3))))))) (children x3)))))
(assert
 (=>
  (and (is-cons (cdr (cdr (cdr (children x3)))))
   (is-node (car (cdr (cdr (cdr (children x3)))))))
...
(assert
 (=>
  (and (is-node (car (cdr (cdr (cdr (children x3))))))
   (is-cons (children (car (cdr (cdr (cdr (children x3))))))))
  (not
   (= (car (children (car (cdr (cdr (cdr (children x3)))))))
    (car (cdr (cdr (cdr (children x3)))))))))
(assert
 (=>
  (and (is-node x3) (is-cons (children x3)) (is-cons (cdr (children x3)))
   (is-cons (cdr (cdr (children x3))))
   ...
   (is-node (car (cdr (cdr (cdr (children x3))))))
   (is-cons (children (car (cdr (cdr (cdr (children x3))))))))
  (not (= (car (children (car (cdr (cdr (cdr (children x3))))))) x3))))
(assert
 (=>
  (and (is-cons (cdr (cdr (cdr (children x3)))))
   (is-node (car (cdr (cdr (cdr (children x3)))))))
...
(assert
 (=> (and (is-succ (pred (data (car (cdr (cdr (children x3))))))))
  (not
   (= (pred (pred (data (car (cdr (cdr (children x3)))))))
    (pred (data (car (cdr (cdr (children x3))))))))))
(assert
 (=>
  (and (is-succ (data (car (cdr (cdr (children x3))))))
   (is-succ (pred (data (car (cdr (cdr (children x3))))))))
  (not
   (= (pred (pred (data (car (cdr (cdr (children x3)))))))
    (data (car (cdr (cdr (children x3)))))))))
(assert
...
(assert
 (=> (and (is-cons (cdr (children (car (cdr (cdr (children x3))))))))
  (not
   (= (cdr (cdr (children (car (cdr (cdr (children x3)))))))
    (cdr (children (car (cdr (cdr (children x3))))))))))
(assert
 (=>
  (and (is-cons (children (car (cdr (cdr (children x3))))))
   (is-cons (cdr (children (car (cdr (cdr (children x3))))))))
  (not
   (= (cdr (cdr (children (car (cdr (cdr (children x3)))))))
    (children (car (cdr (cdr (children x3)))))))))
(assert
...
(assert
 (=>
  (and (is-cons (children x3)) (is-cons (cdr (children x3)))
   ...
   (is-cons (cdr (children (car (cdr (cdr (children x3))))))))
  (not
   (= (cdr (cdr (children (car (cdr (cdr (children x3))))))) (children x3)))))
(assert
 (=> (and (is-cons (children (car (cdr (cdr (children x3)))))))
  (not
   (= (cdr (children (car (cdr (cdr (children x3))))))
...
(assert
 (=>
  (and (is-node (car (cdr (cdr (children x3)))))
   ...
   (is-cons (cdr (children (car (cdr (cdr (children x3))))))))
  (not
   (= (car (cdr (children (car (cdr (cdr (children x3)))))))
...
(assert
 (=>
  (and (is-node x3) (is-cons (children x3)) (is-cons (cdr (children x3)))
   ...
   (is-cons (children (car (cdr (cdr (children x3))))))
   (is-cons (cdr (children (car (cdr (cdr (children x3))))))))
  (not (= (car (cdr (children (car (cdr (cdr (children x3))))))) x3))))
(assert
 (=> (and (is-cons (children (car (cdr (cdr (children x3)))))))
  (not
   (= (cdr (children (car (cdr (cdr (children x3))))))
...
(assert
 (=>
  (and (is-cons (children (car (cdr (cdr (children x3))))))
   (is-node (car (children (car (cdr (cdr (children x3))))))))
  (not
   (= (children (car (children (car (cdr (cdr (children x3)))))))
    (children (car (cdr (cdr (children x3)))))))))
(assert
 (=>
  (and (is-cons (cdr (cdr (children x3))))
 ...
 (=>
  ...
  (not
   (= (pred (pred (data (car (cdr (children x3))))))
    (data (car (cdr (children x3))))))))
(assert
 (=> (and (is-succ (pred (pred (data (car (cdr (children x3))))))))
  (not
   (= (pred (pred (pred (data (car (cdr (children x3)))))))
    (pred (pred (data (car (cdr (children x3))))))))))
(assert
 (=>
  (and (is-succ (pred (data (car (cdr (children x3))))))
   (is-succ (pred (pred (data (car (cdr (children x3))))))))
  (not
   (= (pred (pred (pred (data (car (cdr (children x3)))))))
    (pred (data (car (cdr (children x3)))))))))
(assert
...
(assert
 (=> (and (is-cons (cdr (cdr (children (car (cdr (children x3))))))))
  (not
   (= (cdr (cdr (cdr (children (car (cdr (children x3)))))))
    (cdr (cdr (children (car (cdr (children x3))))))))))
(assert
 (=>
  (and (is-cons (cdr (children (car (cdr (children x3))))))
   (is-cons (cdr (cdr (children (car (cdr (children x3))))))))
  (not
   (= (cdr (cdr (cdr (children (car (cdr (children x3)))))))
    (cdr (children (car (cdr (children x3)))))))))
(assert
...
(assert
 (=>
  (and (is-cons (children x3)) (is-cons (cdr (children x3)))
   ...
   (is-cons (cdr (cdr (children (car (cdr (children x3))))))))
  (not
   (= (cdr (cdr (cdr (children (car (cdr (children x3))))))) (children x3)))))
(assert
 (=> (and (is-cons (cdr (children (car (cdr (children x3)))))))
  (not
   (= (cdr (cdr (children (car (cdr (children x3))))))
...
(assert
 (=>
  (and (is-node (car (cdr (children x3))))
   ...
   (is-cons (cdr (cdr (children (car (cdr (children x3))))))))
  (not
   (= (car (cdr (cdr (children (car (cdr (children x3)))))))
    (car (cdr (children x3)))))))
(assert
 (=>
  (and (is-node x3) (is-cons (children x3)) (is-cons (cdr (children x3)))
   ...
   (is-cons (cdr (children (car (cdr (children x3))))))
   (is-cons (cdr (cdr (children (car (cdr (children x3))))))))
  (not (= (car (cdr (cdr (children (car (cdr (children x3))))))) x3))))
(assert
 (=> (and (is-cons (cdr (children (car (cdr (children x3)))))))
  (not
   (= (cdr (cdr (children (car (cdr (children x3))))))
...
(assert
 (=>
  (and (is-cons (cdr (children (car (cdr (children x3))))))
   (is-node (car (cdr (children (car (cdr (children x3))))))))
  (not
   (= (children (car (cdr (children (car (cdr (children x3)))))))
    (cdr (children (car (cdr (children x3)))))))))
(assert
 (=>
  (and (is-cons (children (car (cdr (children x3)))))
...
(assert
 (=> (and (is-succ (data (car (children (car (cdr (children x3))))))))
  (not
   (= (pred (data (car (children (car (cdr (children x3)))))))
    (data (car (children (car (cdr (children x3))))))))))
(assert
 (=>
  (and (is-node (car (cdr (children x3))))
   (is-cons (children (car (cdr (children x3))))))
...
(assert
 (=> (and (is-cons (children (car (children (car (cdr (children x3))))))))
  (not
   (= (cdr (children (car (children (car (cdr (children x3)))))))
    (children (car (children (car (cdr (children x3))))))))))
(assert
 (=>
  (and (is-cons (children (car (cdr (children x3)))))
   (is-node (car (children (car (cdr (children x3))))))
   (is-cons (children (car (children (car (cdr (children x3))))))))
  (not
   (= (cdr (children (car (children (car (cdr (children x3)))))))
    (children (car (cdr (children x3))))))))
(assert
...
(assert
 (=>
  (and (is-node (car (children (car (cdr (children x3))))))
   (is-cons (children (car (children (car (cdr (children x3))))))))
  (not
   (= (car (children (car (children (car (cdr (children x3)))))))
    (car (children (car (cdr (children x3)))))))))
(assert
 (=>
  (and (is-node (car (cdr (children x3))))
   (is-cons (children (car (cdr (children x3)))))
...
(assert
 (=>
  (and (is-node x3) (is-cons (children x3)) (is-cons (cdr (children x3)))
   ...
   (is-node (car (children (car (cdr (children x3))))))
   (is-cons (children (car (children (car (cdr (children x3))))))))
  (not (= (car (children (car (children (car (cdr (children x3))))))) x3))))
(assert
 (=>
  (and (is-cons (children (car (cdr (children x3)))))
   (is-node (car (children (car (cdr (children x3)))))))
...
(assert
 (=> (and (is-succ (pred (pred (pred (data (car (children x3))))))))
  (not
   (= (pred (pred (pred (pred (data (car (children x3)))))))
    (pred (pred (pred (data (car (children x3))))))))))
(assert
 (=>
  (and (is-succ (pred (pred (data (car (children x3))))))
   (is-succ (pred (pred (pred (data (car (children x3))))))))
  (not
   (= (pred (pred (pred (pred (data (car (children x3)))))))
    (pred (pred (data (car (children x3)))))))))
(assert
...
(assert
 (=> (and (is-cons (cdr (cdr (cdr (children (car (children x3))))))))
  (not
   (= (cdr (cdr (cdr (cdr (children (car (children x3)))))))
    (cdr (cdr (cdr (children (car (children x3))))))))))
(assert
 (=>
  (and (is-cons (cdr (cdr (children (car (children x3))))))
   (is-cons (cdr (cdr (cdr (children (car (children x3))))))))
  (not
   (= (cdr (cdr (cdr (cdr (children (car (children x3)))))))
    (cdr (cdr (children (car (children x3)))))))))
(assert
...
(assert
 (=>
  (and (is-cons (children x3)) (is-node (car (children x3)))
   ...
   (is-cons (cdr (cdr (cdr (children (car (children x3))))))))
  (not
   (= (cdr (cdr (cdr (cdr (children (car (children x3))))))) (children x3)))))
(assert
 (=> (and (is-cons (cdr (cdr (children (car (children x3)))))))
  (not
   (= (cdr (cdr (cdr (children (car (children x3))))))
...
(assert
 (=>
  (and (is-node (car (children x3))) (is-cons (children (car (children x3))))
   ...
   (is-cons (cdr (cdr (cdr (children (car (children x3))))))))
  (not
   (= (car (cdr (cdr (cdr (children (car (children x3)))))))
    (car (children x3))))))
(assert
 (=>
  (and (is-node x3) (is-cons (children x3)) (is-node (car (children x3)))
   ...
   (is-cons (cdr (cdr (children (car (children x3))))))
   (is-cons (cdr (cdr (cdr (children (car (children x3))))))))
  (not (= (car (cdr (cdr (cdr (children (car (children x3))))))) x3))))
(assert
 (=> (and (is-cons (cdr (cdr (children (car (children x3)))))))
  (not
   (= (cdr (cdr (cdr (children (car (children x3))))))
...
(assert
 (=>
  (and (is-cons (cdr (cdr (children (car (children x3))))))
   (is-node (car (cdr (cdr (children (car (children x3))))))))
  (not
   (= (children (car (cdr (cdr (children (car (children x3)))))))
    (cdr (cdr (children (car (children x3)))))))))
(assert
 (=>
  (and (is-cons (cdr (children (car (children x3)))))
...
(assert
 (=> (and (is-succ (data (car (cdr (children (car (children x3))))))))
  (not
   (= (pred (data (car (cdr (children (car (children x3)))))))
    (data (car (cdr (children (car (children x3))))))))))
(assert
 (=>
  (and (is-node (car (children x3))) (is-cons (children (car (children x3))))
   (is-cons (cdr (children (car (children x3))))))
...
(assert
 (=> (and (is-cons (children (car (cdr (children (car (children x3))))))))
  (not
   (= (cdr (children (car (cdr (children (car (children x3)))))))
    (children (car (cdr (children (car (children x3))))))))))
(assert
 (=>
  (and (is-cons (cdr (children (car (children x3)))))
   (is-node (car (cdr (children (car (children x3))))))
   (is-cons (children (car (cdr (children (car (children x3))))))))
  (not
   (= (cdr (children (car (cdr (children (car (children x3)))))))
    (cdr (children (car (children x3))))))))
(assert
...
(assert
 (=>
  (and (is-node (car (cdr (children (car (children x3))))))
   (is-cons (children (car (cdr (children (car (children x3))))))))
  (not
   (= (car (children (car (cdr (children (car (children x3)))))))
    (car (cdr (children (car (children x3)))))))))
(assert
 (=>
  (and (is-node (car (children x3))) (is-cons (children (car (children x3))))
   (is-cons (cdr (children (car (children x3)))))
...
(assert
 (=>
  (and (is-node x3) (is-cons (children x3)) (is-node (car (children x3)))
   ...
   (is-node (car (cdr (children (car (children x3))))))
   (is-cons (children (car (cdr (children (car (children x3))))))))
  (not (= (car (children (car (cdr (children (car (children x3))))))) x3))))
(assert
 (=>
  (and (is-cons (cdr (children (car (children x3)))))
   (is-node (car (cdr (children (car (children x3)))))))
...
(assert
 (=> (and (is-succ (pred (data (car (children (car (children x3))))))))
  (not
   (= (pred (pred (data (car (children (car (children x3)))))))
    (pred (data (car (children (car (children x3))))))))))
(assert
 (=>
  (and (is-succ (data (car (children (car (children x3))))))
   (is-succ (pred (data (car (children (car (children x3))))))))
  (not
   (= (pred (pred (data (car (children (car (children x3)))))))
    (data (car (children (car (children x3)))))))))
(assert
...
(assert
 (=> (and (is-cons (cdr (children (car (children (car (children x3))))))))
  (not
   (= (cdr (cdr (children (car (children (car (children x3)))))))
    (cdr (children (car (children (car (children x3))))))))))
(assert
 (=>
  (and (is-cons (children (car (children (car (children x3))))))
   (is-cons (cdr (children (car (children (car (children x3))))))))
  (not
   (= (cdr (cdr (children (car (children (car (children x3)))))))
    (children (car (children (car (children x3)))))))))
(assert
...
(assert
 (=>
  (and (is-node (car (children (car (children x3)))))
   ...
   (is-cons (cdr (children (car (children (car (children x3))))))))
  (not
   (= (car (cdr (children (car (children (car (children x3)))))))
...
(assert
 (=>
  (and (is-node x3) (is-cons (children x3)) (is-node (car (children x3)))
   ...
   (is-cons (children (car (children (car (children x3))))))
   (is-cons (cdr (children (car (children (car (children x3))))))))
  (not (= (car (cdr (children (car (children (car (children x3))))))) x3))))
(assert
 (=> (and (is-cons (children (car (children (car (children x3)))))))
  (not
   (= (cdr (children (car (children (car (children x3))))))
...
(assert
 (=>
  (and (is-cons (children (car (children (car (children x3))))))
   (is-node (car (children (car (children (car (children x3))))))))
  (not
   (= (children (car (children (car (children (car (children x3)))))))
    (children (car (children (car (children x3)))))))))
(assert
 (=>
  (and (is-cons (children (car (children x3))))
