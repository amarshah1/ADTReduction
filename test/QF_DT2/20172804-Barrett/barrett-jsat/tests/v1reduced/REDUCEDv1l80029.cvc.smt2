...
(assert true)
(assert
 (and (and (and (and (and (and (and true (is-leaf x3)) (not false))
  (not (is-null x2))) (is-node x3)) (and (= (pred x1) (pred zero))
  (= (succ contrived_variable0) x1)
  (=> (is-succ x1) (and (= (pred x1) contrived_variable0))))) true)
  (not false)))
(assert
