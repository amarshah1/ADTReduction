...
(assert true)
(assert
 (and (and (and (and (and (and (and true (and (= (leaf x1) (leaf x1))
  (is-leaf (leaf x1)) (= (data (leaf x1)) x1))) (and (= (data x3) x1)
  (= (leaf contrived_variable3) x3)
  (=> (is-leaf x3) (and (= (data x3) contrived_variable3))))) true)
  (not false)) (and (= (data contrived_variable0) x1)
  (= (leaf contrived_variable4) contrived_variable0)
  (=> (is-leaf contrived_variable0)
   (and (= (data contrived_variable0) contrived_variable4)))))
  (not (= (children contrived_variable1) (children x3)))) (and
  (= (data contrived_variable2) zero)
  (= (leaf contrived_variable5) contrived_variable2)
  (=> (is-leaf contrived_variable2)
   (and (= (data contrived_variable2) contrived_variable5))))))
(assert
...
(assert
 (and (= (node x2) contrived_variable2) (is-node contrived_variable2)
  (= (children contrived_variable2) x2)))
(assert
...
(assert
 (or (and (not (is-node contrived_variable2)) (is-leaf contrived_variable2))
  (and (is-node contrived_variable2) (not (is-leaf contrived_variable2)))))
(assert
...
(assert
 (or (and (not (is-succ contrived_variable5)) (is-zero contrived_variable5))
...
(assert
 (=> (and (is-cons null) (is-node (car null)))
  (not (= (children (car null)) null))))
(assert
 (=> (and (is-succ (data contrived_variable2)))
  (not (= (pred (data contrived_variable2)) (data contrived_variable2)))))
(assert
 (=> (and (is-succ (pred (data contrived_variable2))))
  (not
...
(assert
 (=>
  (and (is-succ (data contrived_variable2))
   (is-succ (pred (data contrived_variable2))))
  (not
   (= (pred (pred (data contrived_variable2))) (data contrived_variable2)))))
(assert
 (=> (and (is-succ (pred (pred (data contrived_variable2)))))
  (not
...
(assert
 (=>
  (and (is-succ (pred (data contrived_variable2)))
   (is-succ (pred (pred (data contrived_variable2)))))
  (not
   (= (pred (pred (pred (data contrived_variable2))))
    (pred (data contrived_variable2))))))
(assert
...
(assert
 (=> (and (is-succ (pred (pred (pred (data contrived_variable2))))))
  (not
...
(assert
 (=>
  (and (is-succ (pred (pred (data contrived_variable2))))
   (is-succ (pred (pred (pred (data contrived_variable2))))))
  (not
   (= (pred (pred (pred (pred (data contrived_variable2)))))
    (pred (pred (data contrived_variable2)))))))
(assert
 ...
 (=>
  ...
  (not
   (= (pred (pred (pred (pred (data contrived_variable2)))))
    (data contrived_variable2)))))
(assert
 (=> (and (is-succ (pred (pred (pred (pred (data contrived_variable2)))))))
  (not
...
(assert
 (=>
  (and (is-succ (pred (pred (pred (data contrived_variable2)))))
   (is-succ (pred (pred (pred (pred (data contrived_variable2)))))))
  (not
   (= (pred (pred (pred (pred (pred (data contrived_variable2))))))
    (pred (pred (pred (data contrived_variable2))))))))
(assert
...
(assert
 (=>
  (and
   (is-succ (pred (pred (pred (pred (pred (data contrived_variable2))))))))
  (not
...
(assert
 (=> (and (is-succ (data contrived_variable2)))
  (not (= (pred (data contrived_variable2)) (data contrived_variable2)))))
(assert
 (=> (and (is-cons (children contrived_variable2)))
  (not
   (= (cdr (children contrived_variable2)) (children contrived_variable2)))))
(assert
 (=> (and (is-cons (cdr (children contrived_variable2))))
  (not
...
(assert
 (=>
  (and (is-cons (children contrived_variable2))
   (is-cons (cdr (children contrived_variable2))))
  (not
   (= (cdr (cdr (children contrived_variable2)))
    (children contrived_variable2)))))
(assert
 (=> (and (is-cons (cdr (cdr (children contrived_variable2)))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (children contrived_variable2)))
   (is-cons (cdr (cdr (children contrived_variable2)))))
  (not
   (= (cdr (cdr (cdr (children contrived_variable2))))
    (cdr (children contrived_variable2))))))
(assert
 (=>
  ...
  (not
   (= (cdr (cdr (cdr (children contrived_variable2))))
    (children contrived_variable2)))))
(assert
 (=> (and (is-cons (cdr (cdr (cdr (children contrived_variable2))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (cdr (children contrived_variable2))))
   (is-cons (cdr (cdr (cdr (children contrived_variable2))))))
  (not
   (= (cdr (cdr (cdr (cdr (children contrived_variable2)))))
    (cdr (cdr (children contrived_variable2)))))))
(assert
 ...
 (=>
  ...
  (not
   (= (cdr (cdr (cdr (cdr (children contrived_variable2)))))
    (children contrived_variable2)))))
(assert
 (=> (and (is-cons (cdr (cdr (cdr (cdr (children contrived_variable2)))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (cdr (cdr (children contrived_variable2)))))
   (is-cons (cdr (cdr (cdr (cdr (children contrived_variable2)))))))
  (not
   (= (cdr (cdr (cdr (cdr (cdr (children contrived_variable2))))))
    (cdr (cdr (cdr (children contrived_variable2))))))))
(assert
...
(assert
 (=>
  (and (is-cons (cdr (cdr (cdr (cdr (cdr (children contrived_variable2))))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (cdr (cdr (cdr (children contrived_variable2))))))
   (is-cons (cdr (cdr (cdr (cdr (cdr (children contrived_variable2))))))))
  (not
   (= (cdr (cdr (cdr (cdr (cdr (cdr (children contrived_variable2)))))))
    (cdr (cdr (cdr (cdr (children contrived_variable2)))))))))
(assert
...
(assert
 (=>
  (and (is-node contrived_variable2) (is-cons (children contrived_variable2))
   (is-cons (cdr (children contrived_variable2)))
   (is-cons (cdr (cdr (children contrived_variable2))))
   (is-cons (cdr (cdr (cdr (children contrived_variable2)))))
   (is-cons (cdr (cdr (cdr (cdr (children contrived_variable2))))))
...
(assert
 (=>
  (and (is-cons (cdr (cdr (cdr (cdr (children contrived_variable2))))))
   (is-node (car (cdr (cdr (cdr (cdr (children contrived_variable2))))))))
  (not
...
(assert
 (=>
  (and
   (is-succ (data (car (cdr (cdr (cdr (children contrived_variable2))))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (cdr (cdr (children contrived_variable2)))))
   (is-node (car (cdr (cdr (cdr (children contrived_variable2)))))))
  (not
...
(assert
 (=>
  (and
   (is-cons (children (car (cdr (cdr (cdr (children contrived_variable2))))))))
  (not
...
(assert
 (=>
  (and (is-node (car (cdr (cdr (cdr (children contrived_variable2))))))
   (is-cons (children (car (cdr (cdr (cdr (children contrived_variable2))))))))
  (not
...
(assert
 (=> (and (is-succ (data (car (cdr (cdr (children contrived_variable2)))))))
  (not
...
(assert
 (=>
  (and
   (is-succ (pred (data (car (cdr (cdr (children contrived_variable2))))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (cdr (children contrived_variable2))))
   (is-node (car (cdr (cdr (children contrived_variable2))))))
  (not
...
(assert
 (=>
  (and (is-cons (children (car (cdr (cdr (children contrived_variable2)))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (cdr (children contrived_variable2))))
   (is-node (car (cdr (cdr (children contrived_variable2)))))
   (is-cons (children (car (cdr (cdr (children contrived_variable2)))))))
  (not
   (= (cdr (children (car (cdr (cdr (children contrived_variable2))))))
    (cdr (cdr (children contrived_variable2)))))))
(assert
...
(assert
 (=>
  (and
   (is-cons (cdr (children (car (cdr (cdr (children contrived_variable2))))))))
  (not
...
(assert
 (=>
  (and (is-node (car (cdr (cdr (children contrived_variable2)))))
   (is-cons (children (car (cdr (cdr (children contrived_variable2))))))
   (is-cons (cdr (children (car (cdr (cdr (children contrived_variable2))))))))
  (not
...
(assert
 (=>
  (and (is-cons (children (car (cdr (cdr (children contrived_variable2))))))
   (is-node (car (children (car (cdr (cdr (children contrived_variable2))))))))
  (not
   (=
...
(assert
 (=> (and (is-succ (data (car (cdr (children contrived_variable2))))))
  (not
   (= (pred (data (car (cdr (children contrived_variable2)))))
    (data (car (cdr (children contrived_variable2))))))))
(assert
 (=> (and (is-succ (pred (data (car (cdr (children contrived_variable2)))))))
  (not
...
(assert
 (=>
  (and (is-succ (data (car (cdr (children contrived_variable2)))))
   (is-succ (pred (data (car (cdr (children contrived_variable2)))))))
  (not
   (= (pred (pred (data (car (cdr (children contrived_variable2))))))
    (data (car (cdr (children contrived_variable2))))))))
(assert
 (=>
  (and
   (is-succ (pred (pred (data (car (cdr (children contrived_variable2))))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (children contrived_variable2)))
   (is-node (car (cdr (children contrived_variable2)))))
  (not
 ...
 (=>
  ...
  (not
   (= (children (car (cdr (children contrived_variable2))))
    (children contrived_variable2)))))
(assert
 (=> (and (is-cons (children (car (cdr (children contrived_variable2))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (children contrived_variable2)))
   (is-node (car (cdr (children contrived_variable2))))
   (is-cons (children (car (cdr (children contrived_variable2))))))
  (not
   (= (cdr (children (car (cdr (children contrived_variable2)))))
    (cdr (children contrived_variable2))))))
(assert
...
(assert
 (=>
  (and (is-cons (cdr (children (car (cdr (children contrived_variable2)))))))
  (not
...
(assert
 (=>
  (and (is-cons (children (car (cdr (children contrived_variable2)))))
   (is-cons (cdr (children (car (cdr (children contrived_variable2)))))))
  (not
   (= (cdr (cdr (children (car (cdr (children contrived_variable2))))))
    (children (car (cdr (children contrived_variable2))))))))
(assert
...
(assert
 (=>
  (and
   (is-cons (cdr (cdr (children (car (cdr (children contrived_variable2))))))))
  (not
...
(assert
 (=>
  (and (is-node (car (cdr (children contrived_variable2))))
   (is-cons (children (car (cdr (children contrived_variable2)))))
   (is-cons (cdr (children (car (cdr (children contrived_variable2))))))
   (is-cons (cdr (cdr (children (car (cdr (children contrived_variable2))))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (children (car (cdr (children contrived_variable2))))))
   (is-node (car (cdr (children (car (cdr (children contrived_variable2))))))))
  (not
   (=
...
(assert
 (=>
  (and (is-cons (children (car (cdr (children contrived_variable2)))))
   (is-node (car (children (car (cdr (children contrived_variable2)))))))
  (not
...
(assert
 (=>
  (and (is-node (car (children (car (cdr (children contrived_variable2))))))
   (is-cons (children (car (children (car (cdr (children
    contrived_variable2))))))))
  (not
   (=
...
(assert
 (=>
  (and (is-node contrived_variable2) (is-cons (children contrived_variable2)))
  (not (= (car (children contrived_variable2)) contrived_variable2))))
(assert
 (=> (and (is-succ (data (car (children contrived_variable2)))))
  (not
   (= (pred (data (car (children contrived_variable2))))
    (data (car (children contrived_variable2)))))))
(assert
 (=> (and (is-succ (pred (data (car (children contrived_variable2))))))
  (not
...
(assert
 (=>
  (and (is-succ (data (car (children contrived_variable2))))
   (is-succ (pred (data (car (children contrived_variable2))))))
  (not
   (= (pred (pred (data (car (children contrived_variable2)))))
    (data (car (children contrived_variable2)))))))
(assert
 (=>
  (and (is-succ (pred (pred (data (car (children contrived_variable2)))))))
  (not
...
(assert
 (=>
  (and (is-succ (pred (data (car (children contrived_variable2)))))
   (is-succ (pred (pred (data (car (children contrived_variable2)))))))
  (not
   (= (pred (pred (pred (data (car (children contrived_variable2))))))
    (pred (data (car (children contrived_variable2))))))))
(assert
...
(assert
 (=>
  (and
   (is-succ (pred (pred (pred (data (car (children contrived_variable2))))))))
  (not
...
(assert
 (=>
  (and (is-cons (children contrived_variable2))
   (is-node (car (children contrived_variable2))))
  (not
   (= (children (car (children contrived_variable2)))
    (children contrived_variable2)))))
(assert
 (=> (and (is-cons (children (car (children contrived_variable2)))))
  (not
...
(assert
 (=>
  (and (is-cons (children contrived_variable2))
   (is-node (car (children contrived_variable2)))
   (is-cons (children (car (children contrived_variable2)))))
  (not
   (= (cdr (children (car (children contrived_variable2))))
    (children contrived_variable2)))))
(assert
 (=> (and (is-cons (cdr (children (car (children contrived_variable2))))))
  (not
...
(assert
 (=>
  (and (is-cons (children (car (children contrived_variable2))))
   (is-cons (cdr (children (car (children contrived_variable2))))))
  (not
   (= (cdr (cdr (children (car (children contrived_variable2)))))
    (children (car (children contrived_variable2)))))))
(assert
...
(assert
 (=>
  (and (is-cons (cdr (cdr (children (car (children contrived_variable2)))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (children (car (children contrived_variable2)))))
   (is-cons (cdr (cdr (children (car (children contrived_variable2)))))))
  (not
   (= (cdr (cdr (cdr (children (car (children contrived_variable2))))))
    (cdr (children (car (children contrived_variable2))))))))
(assert
...
(assert
 (=>
  (and
   (is-cons (cdr (cdr (cdr (children (car (children contrived_variable2))))))))
  (not
...
(assert
 (=>
  (and (is-node (car (children contrived_variable2)))
   (is-cons (children (car (children contrived_variable2))))
   (is-cons (cdr (children (car (children contrived_variable2)))))
   (is-cons (cdr (cdr (children (car (children contrived_variable2))))))
   (is-cons (cdr (cdr (cdr (children (car (children contrived_variable2))))))))
...
(assert
 (=>
  (and (is-cons (cdr (cdr (children (car (children contrived_variable2))))))
   (is-node (car (cdr (cdr (children (car (children contrived_variable2))))))))
  (not
   (=
...
(assert
 (=>
  (and (is-cons (cdr (children (car (children contrived_variable2)))))
   (is-node (car (cdr (children (car (children contrived_variable2)))))))
  (not
...
(assert
 (=>
  (and (is-node (car (cdr (children (car (children contrived_variable2))))))
   (is-cons (children (car (cdr (children (car (children
    contrived_variable2))))))))
  (not
   (=
...
(assert
 (=>
  (and (is-succ (data (car (children (car (children contrived_variable2)))))))
  (not
...
(assert
 (=>
  (and (is-cons (children (car (children contrived_variable2))))
   (is-node (car (children (car (children contrived_variable2))))))
  (not
...
(assert
 (=>
  (and
   (is-cons (children (car (children (car (children contrived_variable2)))))))
  (not
...
(assert
 (=>
  (and (is-node (car (children (car (children contrived_variable2)))))
   (is-cons (children (car (children (car (children contrived_variable2))))))
   (is-cons (cdr (children (car (children (car (children
    contrived_variable2))))))))
  (not
...
(assert
 (=>
  (and
   (is-succ (pred (pred (pred (pred (pred (data contrived_variable0))))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (cdr (cdr (cdr (cdr (children contrived_variable0))))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (cdr (cdr (cdr (children contrived_variable0))))))
   (is-cons (cdr (cdr (cdr (cdr (cdr (children contrived_variable0))))))))
  (not
   (= (cdr (cdr (cdr (cdr (cdr (cdr (children contrived_variable0)))))))
    (cdr (cdr (cdr (cdr (children contrived_variable0)))))))))
(assert
...
(assert
 (=>
  (and (is-cons (cdr (cdr (cdr (cdr (children contrived_variable0))))))
   (is-node (car (cdr (cdr (cdr (cdr (children contrived_variable0))))))))
  (not
...
(assert
 (=>
  (and
   (is-succ (data (car (cdr (cdr (cdr (children contrived_variable0))))))))
  (not
...
(assert
 (=>
  (and
   (is-cons (children (car (cdr (cdr (cdr (children contrived_variable0))))))))
  (not
...
(assert
 (=>
  (and (is-node (car (cdr (cdr (cdr (children contrived_variable0))))))
   (is-cons (children (car (cdr (cdr (cdr (children contrived_variable0))))))))
  (not
...
(assert
 (=>
  (and
   (is-succ (pred (data (car (cdr (cdr (children contrived_variable0))))))))
  (not
...
(assert
 (=>
  (and
   (is-cons (cdr (children (car (cdr (cdr (children contrived_variable0))))))))
  (not
...
(assert
 (=>
  (and (is-cons (children (car (cdr (cdr (children contrived_variable0))))))
   (is-node (car (children (car (cdr (cdr (children contrived_variable0))))))))
  (not
   (=
    (children (car (children (car (cdr (cdr (children
     contrived_variable0)))))))
...
(assert
 (=>
  (and
   (is-succ (pred (pred (data (car (cdr (children contrived_variable0))))))))
  (not
...
(assert
 (=>
  (and
   (is-cons (cdr (cdr (children (car (cdr (children contrived_variable0))))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (children (car (cdr (children contrived_variable0))))))
   (is-node (car (cdr (children (car (cdr (children contrived_variable0))))))))
  (not
   (=
    (children (car (cdr (children (car (cdr (children
     contrived_variable0)))))))
...
(assert
 (=>
  (and (is-node (car (children (car (cdr (children contrived_variable0))))))
   (is-cons (children (car (children (car (cdr (children
    contrived_variable0))))))))
  (not
   (=
...
(assert
 (=>
  (and
   (is-succ (pred (pred (pred (data (car (children contrived_variable0))))))))
  (not
...
(assert
 (=>
  (and
   (is-cons (cdr (cdr (cdr (children (car (children contrived_variable0))))))))
  (not
...
(assert
 (=>
  (and (is-cons (cdr (cdr (children (car (children contrived_variable0))))))
   (is-node (car (cdr (cdr (children (car (children contrived_variable0))))))))
  (not
   (=
    (children (car (cdr (cdr (children (car (children
     contrived_variable0)))))))
...
(assert
 (=>
  (and (is-node (car (cdr (children (car (children contrived_variable0))))))
   (is-cons (children (car (cdr (children (car (children
    contrived_variable0))))))))
  (not
   (=
...
(assert
 (=> (and (is-node x3) (is-cons (children x3)))
  (not (= (car (children x3)) x3))))
(assert
 (=> (and (is-succ contrived_variable5))
  (not (= (pred contrived_variable5) contrived_variable5))))
(assert
 (=> (and (is-succ (pred contrived_variable5)))
  (not (= (pred (pred contrived_variable5)) (pred contrived_variable5)))))
(assert
 (=> (and (is-succ contrived_variable5) (is-succ (pred contrived_variable5)))
  (not (= (pred (pred contrived_variable5)) contrived_variable5))))
(assert
 (=> (and (is-succ (pred (pred contrived_variable5))))
  (not
...
(assert
 (=>
  (and (is-succ (pred contrived_variable5))
   (is-succ (pred (pred contrived_variable5))))
  (not
   (= (pred (pred (pred contrived_variable5))) (pred contrived_variable5)))))
(assert
 (=>
  (and (is-succ contrived_variable5) (is-succ (pred contrived_variable5))
   (is-succ (pred (pred contrived_variable5))))
...
(assert
 (=> (and (is-succ (pred (pred (pred contrived_variable5)))))
  (not
...
(assert
 (=>
  (and (is-succ (pred (pred contrived_variable5)))
   (is-succ (pred (pred (pred contrived_variable5)))))
  (not
   (= (pred (pred (pred (pred contrived_variable5))))
    (pred (pred contrived_variable5))))))
(assert
...
(assert
 (=>
  (and (is-succ contrived_variable5) (is-succ (pred contrived_variable5))
   ...
   (is-succ (pred (pred (pred contrived_variable5)))))
  (not
   (= (pred (pred (pred (pred contrived_variable5)))) contrived_variable5))))
(assert
 (=> (and (is-succ (pred (pred (pred (pred contrived_variable5))))))
  (not
...
(assert
 (=>
  (and (is-succ (pred (pred (pred contrived_variable5))))
   (is-succ (pred (pred (pred (pred contrived_variable5))))))
  (not
   (= (pred (pred (pred (pred (pred contrived_variable5)))))
    (pred (pred (pred contrived_variable5)))))))
(assert
 ...
 (=>
  ...
  (not
   (= (pred (pred (pred (pred (pred contrived_variable5)))))
    contrived_variable5))))
(assert
 (=> (and (is-succ (pred (pred (pred (pred (pred contrived_variable5)))))))
  (not
...
(assert
 (=>
  (and (is-succ (pred (pred (pred (pred contrived_variable5)))))
   (is-succ (pred (pred (pred (pred (pred contrived_variable5)))))))
  (not
   (= (pred (pred (pred (pred (pred (pred contrived_variable5))))))
    (pred (pred (pred (pred contrived_variable5))))))))
(assert
