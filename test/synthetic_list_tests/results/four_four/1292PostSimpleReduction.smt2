...
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l1 Nil) (is-Nil l1)) (and (= l1 l2)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (not (= l2 Nil))) )
(assert (and (or (and (is-Nil l0) (= l0 Nil)) (and (= l2 l1)) (and (= l3 Nil) (is-Nil l3)) (and (= l3 l1)))) )
