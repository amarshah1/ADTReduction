...
(assert (and (and (and (= l1 l0)) (and (= l2 Nil) (is-Nil l2)) (and (is-Nil l0) (= l0 Nil)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l0 Nil) (is-Nil l0)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons l2) (= l2 (Cons cv0 cv1)) (= cv0 (Head l2)) (= cv1 (Tail l2))))) )
(assert (and (or (and (= l3 l3)) (and (= l1 Nil) (is-Nil l1)) (and (= l2 l1)) (and (= l0 Nil) (is-Nil l0)))) )
