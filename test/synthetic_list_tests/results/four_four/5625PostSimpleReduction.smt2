...
(assert (and (or (and (= l0 l3)) (and (= l2 Nil) (is-Nil l2)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (not (is-Cons Nil))) )
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l3 l3)) (and (= l3 l0)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))))) )
