...
(assert (and (and (and (= l0 l2)) (and (= l2 Nil) (is-Nil l2)) (and (= l3 l1)) (and (= l3 l0)))) )
(assert (and (is-Nil l2) (= l2 Nil)) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l3 l3)) (and (= l1 Nil) (is-Nil l1)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (= l1 l1)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))))) )
