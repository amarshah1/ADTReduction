...
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (= l0 Nil) (is-Nil l0)) (and (= l1 l3)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (is-Cons l1) (= l1 (Cons cv0 cv1)) (= cv0 (Head l1)) (= cv1 (Tail l1))) )
(assert (and (not (is-Cons Nil))) )
(assert (and (or (and (= l0 l3)) (and (= l1 l2)) (and (= l2 l1)) (and (= l2 Nil) (is-Nil l2)))) )
