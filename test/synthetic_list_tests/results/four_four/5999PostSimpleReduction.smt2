...
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l2 Nil) (is-Nil l2)) (and (= l3 l1)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (or (and (= l0 l1)) (and (is-Nil Nil) (= Nil Nil)) (and (= l0 l1)) (and (= l3 l0)))) )
