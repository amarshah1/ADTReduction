...
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l3 l2)) (and (= l3 l3)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil l1) (= l1 Nil)))) )
(assert (and (or (and (is-Nil l2) (= l2 Nil)) (and (= l0 l1)) (and (= l1 l2)) (and (= l0 Nil) (is-Nil l0)))) )
