...
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (is-Cons l2) (= l2 (Cons cv0 cv1)) (= cv0 (Head l2)) (= cv1 (Tail l2))) (and (= l2 l0)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (not (is-Nil l0))) )
(assert (and (not (= l3 l2))) )
(assert (and (and (and (= l2 l3)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (is-Cons l2) (= l2 (Cons cv4 cv5)) (= cv4 (Head l2)) (= cv5 (Tail l2))) (and (is-Nil l3) (= l3 Nil)))) )
