...
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (= l2 l2)) (and (is-Nil Nil) (= Nil Nil)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l2 l3)) (and (= l0 Nil) (is-Nil l0)) (and (= l2 l3)))) )
