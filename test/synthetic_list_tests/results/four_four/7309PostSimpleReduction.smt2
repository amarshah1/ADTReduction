...
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l0 Nil) (is-Nil l0)) (and (= l0 l2)))) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (= l3 Nil) (is-Nil l3)) )
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l3 Nil) (is-Nil l3)) (and (= l3 l3)) (and (= l1 Nil) (is-Nil l1)))) )
