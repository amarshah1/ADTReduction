...
(assert (and (or (and (= l0 l3)) (and (= l2 Nil) (is-Nil l2)) (and (is-Nil l1) (= l1 Nil)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))))) )
(assert (and (is-Cons l3) (= l3 (Cons cv2 cv3)) (= cv2 (Head l3)) (= cv3 (Tail l3))) )
(assert (and (is-Nil l0) (= l0 Nil)) )
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l2 l2)) (and (= l1 Nil) (is-Nil l1)) (and (= l1 l2)))) )
