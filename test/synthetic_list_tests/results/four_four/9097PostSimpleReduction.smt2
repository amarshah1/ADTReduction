...
(assert (and (or (and (is-Nil l0) (= l0 Nil)) (and (= l1 l0)) (and (= l0 l2)))) )
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (is-Nil l3) (= l3 Nil)) (and (= l0 l2)))) )
(assert (and (or (and (is-Nil l3) (= l3 Nil)) (and (= l0 l0)))) )
(assert (and (= l3 l2)) )
