...
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (is-Nil l3) (= l3 Nil)) (and (is-Nil l1) (= l1 Nil)))) )
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (= l2 l1)) (and (= l1 l1)) (and (is-Cons l3) (= l3 (Cons cv0 cv1)) (= cv0 (Head l3)) (= cv1 (Tail l3))))) )
