...
(assert (and (and (and (= l3 l2)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l2 Nil) (is-Nil l2)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (= l2 l2)) )
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (= l2 l1)) (and (= l1 l1)))) )
