...
(assert (and (and (and (= l0 l0)) (and (is-Nil l1) (= l1 Nil)) (and (is-Nil l1) (= l1 Nil)))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (not (= l1 l2))) )
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l2 l3)) (and (is-Cons l0) (= l0 (Cons cv0 cv1)) (= cv0 (Head l0)) (= cv1 (Tail l0))))) )
