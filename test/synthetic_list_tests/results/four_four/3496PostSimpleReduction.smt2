...
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l1 l2)) (and (is-Nil Nil) (= Nil Nil)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (and (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l0 l1)) (and (= l1 Nil) (is-Nil l1)) (and (= l3 l0)))) )
