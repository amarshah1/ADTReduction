...
(assert (and (and (and (= l1 l0)) (and (= l2 Nil) (is-Nil l2)) (and (= l2 l2)))) )
(assert (and (= l0 Nil) (is-Nil l0)) )
(assert (and (and (and (= l2 l0)) (and (= l1 l2)) (and (= l3 l0)) (and (is-Cons l2) (= l2 (Cons cv0 cv1)) (= cv0 (Head l2)) (= cv1 (Tail l2))))) )
