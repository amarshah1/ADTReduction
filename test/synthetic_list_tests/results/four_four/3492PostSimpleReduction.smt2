...
(assert (and (and (and (= l0 l0)) (and (is-Nil l0) (= l0 Nil)) (and (= l0 Nil) (is-Nil l0)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))))) )
(assert (and (is-Nil l1) (= l1 Nil)) )
(assert (and (or (and (is-Nil l0) (= l0 Nil)) (and (= l1 l1)) (and (= l0 Nil) (is-Nil l0)))) )
