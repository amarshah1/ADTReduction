...
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (is-Nil l0) (= l0 Nil)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l1 l2)))) )
(assert (and (= l0 Nil) (is-Nil l0)) )
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (is-Nil l1) (= l1 Nil)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (= l2 l3)) )
