...
(assert (and (or (and (= l2 l3)) (and (= l2 Nil) (is-Nil l2)) (and (= l2 l0)) (and (= l2 l3)))) )
(assert (and (is-Nil l1) (= l1 Nil)) )
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l3 l2)) (and (= l2 Nil) (is-Nil l2)) (and (is-Nil Nil) (= Nil Nil)))) )
