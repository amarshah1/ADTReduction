...
(assert (and (and (and (= l0 l2)) (and (is-Cons l2) (= l2 (Cons cv0 cv1)) (= cv0 (Head l2)) (= cv1 (Tail l2))) (and (is-Nil l3) (= l3 Nil)))) )
(assert (and (not (is-Nil Nil))) )
(assert (and (= l2 Nil) (is-Nil l2)) )
(assert (and (or (and (= l2 l0)) (and (= l3 Nil) (is-Nil l3)) (and (= l1 Nil) (is-Nil l1)))) )
