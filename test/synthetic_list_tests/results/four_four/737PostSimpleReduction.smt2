...
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (is-Nil l2) (= l2 Nil)) (and (= l1 l3)))) )
(assert (and (= l2 Nil) (is-Nil l2)) )
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l2 l3)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (= l2 Nil) (is-Nil l2)) )
