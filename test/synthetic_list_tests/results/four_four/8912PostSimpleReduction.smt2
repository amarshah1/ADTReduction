...
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (= l3 Nil) (is-Nil l3)) (and (is-Cons l2) (= l2 (Cons cv0 cv1)) (= cv0 (Head l2)) (= cv1 (Tail l2))) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (= l2 l1)) )
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l0 l0)) (and (is-Nil l0) (= l0 Nil)))) )
