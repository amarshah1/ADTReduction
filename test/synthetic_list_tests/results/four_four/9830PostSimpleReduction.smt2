...
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (= l1 Nil) (is-Nil l1)) (and (= l1 l3)) (and (= l1 l0)))) )
(assert (and (or (and (= l1 l1)) (and (= l0 l1)) (and (= l0 Nil) (is-Nil l0)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (= l0 l2)) )
