...
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l3 Nil) (is-Nil l3)) (and (= l3 l2)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (or (and (= l1 l2)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (not (is-Cons Nil))) )
(assert (and (or (and (is-Nil l0) (= l0 Nil)) (and (= l3 Nil) (is-Nil l3)) (and (= l1 Nil) (is-Nil l1)) (and (= l0 l0)))) )
