...
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l0 l2)) (and (is-Cons l0) (= l0 (Cons cv0 cv1)) (= cv0 (Head l0)) (= cv1 (Tail l0))) (and (= l2 l2)))) )
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (is-Cons l1) (= l1 (Cons cv2 cv3)) (= cv2 (Head l1)) (= cv3 (Tail l1))) (and (is-Nil Nil) (= Nil Nil)))) )
