...
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l0 l0)) (and (= l1 l2)))) )
(assert (and (= l0 Nil) (is-Nil l0)) )
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l2 l3)) (and (is-Nil l3) (= l3 Nil)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))))) )
