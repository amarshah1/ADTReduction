...
(assert (and (or (and (is-Nil l2) (= l2 Nil)) (and (is-Cons l2) (= l2 (Cons cv0 cv1)) (= cv0 (Head l2)) (= cv1 (Tail l2))) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (or (and (= l2 l2)) (and (is-Nil Nil) (= Nil Nil)) (and (= l3 l0)) (and (is-Nil l2) (= l2 Nil)))) )
(assert (and (= l3 l2)) )
