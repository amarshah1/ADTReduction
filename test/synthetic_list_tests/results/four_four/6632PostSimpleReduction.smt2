...
(assert (and (and (and (= l1 l2)) (and (= l2 l0)) (and (is-Cons l3) (= l3 (Cons cv0 cv1)) (= cv0 (Head l3)) (= cv1 (Tail l3))))) )
(assert (and (= l1 Nil) (is-Nil l1)) )
(assert (and (= l0 Nil) (is-Nil l0)) )
(assert (and (and (and (= l3 l2)) (and (= l1 Nil) (is-Nil l1)) (and (= l1 Nil) (is-Nil l1)) (and (= l2 l2)))) )
