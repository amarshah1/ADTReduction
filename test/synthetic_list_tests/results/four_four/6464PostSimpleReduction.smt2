...
(assert (and (and (and (= l1 l3)) (and (is-Nil l3) (= l3 Nil)) (and (= l3 l2)))) )
(assert (and (or (and (= l0 l0)) (and (= l3 l3)) (and (= l3 Nil) (is-Nil l3)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (not (= l1 Nil))) )
(assert (and (or (and (= l2 l0)) (and (= l2 l2)))) )
