...
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (= l2 Nil) (is-Nil l2)) (and (= l1 l1)) (and (= l2 l1)))) )
(assert (and (not (is-Nil Nil))) )
(assert (and (or (and (= l3 l2)) (and (is-Nil l0) (= l0 Nil)) (and (is-Nil l1) (= l1 Nil)) (and (= l0 l3)))) )
