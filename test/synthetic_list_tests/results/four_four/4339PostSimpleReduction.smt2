...
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l3 Nil) (is-Nil l3)) (and (= l0 l3)) (and (= l3 Nil) (is-Nil l3)))) )
...
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l1 l0)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))))) )
