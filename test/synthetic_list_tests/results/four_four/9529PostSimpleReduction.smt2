...
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l2 l2)) (and (= l0 l2)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (or (and (is-Cons l3) (= l3 (Cons cv0 cv1)) (= cv0 (Head l3)) (= cv1 (Tail l3))) (and (= l3 Nil) (is-Nil l3)))) )
