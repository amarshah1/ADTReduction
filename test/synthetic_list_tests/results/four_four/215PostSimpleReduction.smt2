...
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (is-Nil Nil) (= Nil Nil)) (and (= l3 Nil) (is-Nil l3)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (not (= l0 l0))) )
(assert (and (not (is-Cons Nil))) )
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (= l3 l1)) (and (= l0 l0)))) )
