...
(assert (and (or (and (is-Nil l2) (= l2 Nil)) (and (= l3 l1)) (and (= l3 Nil) (is-Nil l3)) (and (= l3 l0)))) )
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (is-Nil l3) (= l3 Nil)))) )
(assert (and (or (and (= l2 l3)) (and (= l0 Nil) (is-Nil l0)) (and (= l1 Nil) (is-Nil l1)) (and (= l2 Nil) (is-Nil l2)))) )
