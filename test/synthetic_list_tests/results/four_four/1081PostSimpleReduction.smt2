...
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l1 l0)) (and (= l3 l2)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l0 l1)) (and (= l1 l2)) (and (= l2 Nil) (is-Nil l2)))) )
