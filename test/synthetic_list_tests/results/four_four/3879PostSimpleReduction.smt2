...
(assert (and (or (and (is-Nil l2) (= l2 Nil)) (and (= l0 l3)) (and (= l2 l3)))) )
(assert (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) )
(assert (and (not (is-Nil l1))) )
(assert (and (or (and (= l0 l0)) (and (is-Cons l2) (= l2 (Cons cv2 cv3)) (= cv2 (Head l2)) (= cv3 (Tail l2))) (and (= l3 Nil) (is-Nil l3)))) )
