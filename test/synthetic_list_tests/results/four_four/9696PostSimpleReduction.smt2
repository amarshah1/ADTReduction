...
(assert (and (or (and (= l1 l0)) (and (= l2 Nil) (is-Nil l2)) (and (= l1 Nil) (is-Nil l1)) (and (is-Cons l3) (= l3 (Cons cv0 cv1)) (= cv0 (Head l3)) (= cv1 (Tail l3))))) )
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (is-Nil l2) (= l2 Nil)))) )
(assert (and (not (is-Cons l0))) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l1 Nil) (is-Nil l1)) (and (is-Cons l0) (= l0 (Cons cv2 cv3)) (= cv2 (Head l0)) (= cv3 (Tail l0))) (and (= l2 l1)))) )
