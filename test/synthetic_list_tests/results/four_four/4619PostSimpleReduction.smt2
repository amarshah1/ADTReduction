...
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l2 l0)) (and (= l1 l1)))) )
(assert (and (not (= l2 Nil))) )
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l1 l1)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (is-Nil Nil) (= Nil Nil)))) )
