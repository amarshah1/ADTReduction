...
(assert (and (or (and (= l2 l2)) (and (= l3 l3)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (not (is-Cons l3))) )
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (is-Nil Nil) (= Nil Nil)) (and (= l1 Nil) (is-Nil l1)) (and (= l2 Nil) (is-Nil l2)))) )
