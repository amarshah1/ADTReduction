...
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l3 l3)) (and (= l3 l1)) (and (= l0 l3)))) )
(assert (and (= l3 Nil) (is-Nil l3)) )
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (is-Cons l1) (= l1 (Cons cv2 cv3)) (= cv2 (Head l1)) (= cv3 (Tail l1))) (and (is-Cons l1) (= l1 (Cons cv4 cv5)) (= cv4 (Head l1)) (= cv5 (Tail l1))) (and (= l1 Nil) (is-Nil l1)))) )
