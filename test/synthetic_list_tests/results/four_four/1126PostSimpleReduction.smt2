...
(assert (and (and (and (= l2 l2)) (and (= l3 l1)) (and (= l3 Nil) (is-Nil l3)) (and (= l0 l1)))) )
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l0 l1)) (and (is-Nil l3) (= l3 Nil)))) )
