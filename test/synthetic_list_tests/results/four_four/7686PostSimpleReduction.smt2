...
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l0 l3)) (and (is-Nil l1) (= l1 Nil)) (and (= l1 l0)))) )
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l2 Nil) (is-Nil l2)) (and (= l1 Nil) (is-Nil l1)) (and (= l0 l3)))) )
