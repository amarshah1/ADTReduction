...
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l2 l0)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l2 l0)))) )
(assert (and (and (and (is-Cons l1) (= l1 (Cons cv2 cv3)) (= cv2 (Head l1)) (= cv3 (Tail l1))) (and (= l1 l3)) (and (= l1 l0)))) )
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l2 l2)) (and (is-Nil Nil) (= Nil Nil)))) )
