...
(assert (and (or (and (is-Nil l1) (= l1 Nil)) (and (= l2 l0)) (and (is-Nil l1) (= l1 Nil)) (and (is-Cons l2) (= l2 (Cons cv2 cv3)) (= cv2 (Head l2)) (= cv3 (Tail l2))))) )
(assert (and (or (and (= l1 l0)) (and (= l3 l1)) (and (= l2 Nil) (is-Nil l2)) (and (= l1 Nil) (is-Nil l1)))) )
