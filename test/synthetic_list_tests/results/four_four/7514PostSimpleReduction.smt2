...
(assert (and (and (and (is-Nil l3) (= l3 Nil)) (and (= l2 l3)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (not (is-Nil Nil))) )
(assert (and (is-Nil l1) (= l1 Nil)) )
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (= l3 Nil) (is-Nil l3)) (and (= l2 l1)) (and (= l2 Nil) (is-Nil l2)))) )
