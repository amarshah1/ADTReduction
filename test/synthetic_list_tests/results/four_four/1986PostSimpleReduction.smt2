...
(assert (and (or (and (is-Nil l2) (= l2 Nil)) (and (= l2 l2)) (and (= l2 Nil) (is-Nil l2)) (and (= l0 l1)))) )
(assert (and (and (and (is-Nil l3) (= l3 Nil)) (and (= l3 l0)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (= l1 l2)) (and (= l3 Nil) (is-Nil l3)))) )
