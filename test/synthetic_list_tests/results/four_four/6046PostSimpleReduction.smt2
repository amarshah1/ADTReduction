...
(assert (and (and (and (= l3 l1)) (and (is-Nil l1) (= l1 Nil)) (and (= l1 l1)) (and (is-Cons l2) (= l2 (Cons cv0 cv1)) (= cv0 (Head l2)) (= cv1 (Tail l2))))) )
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (= l2 l0)) (and (= l3 Nil) (is-Nil l3)) (and (= l3 l2)))) )
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l1 l1)))) )
