...
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l0 l3)) (and (= l3 Nil) (is-Nil l3)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (not (= l1 Nil))) )
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l0 Nil) (is-Nil l0)) (and (= l3 l0)) (and (is-Nil Nil) (= Nil Nil)))) )
