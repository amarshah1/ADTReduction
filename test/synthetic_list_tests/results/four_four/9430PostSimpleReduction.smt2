...
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (is-Nil Nil) (= Nil Nil)) (and (= l0 Nil) (is-Nil l0)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))))) )
(assert (and (not (is-Nil l0))) )
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l1 l3)) (and (= l0 Nil) (is-Nil l0)))) )
