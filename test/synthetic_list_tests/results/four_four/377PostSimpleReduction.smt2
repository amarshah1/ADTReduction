...
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l3 Nil) (is-Nil l3)) (and (= l1 Nil) (is-Nil l1)) (and (= l2 l3)))) )
(assert (and (not (= l1 l3))) )
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l3 l0)))) )
(assert (and (or (and (= l1 l2)) (and (is-Nil l3) (= l3 Nil)) (and (= l2 l1)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))))) )
