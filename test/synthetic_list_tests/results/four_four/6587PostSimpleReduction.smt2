...
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l1 l3)) (and (= l0 Nil) (is-Nil l0)) (and (= l3 l2)))) )
...
(assert (and (or (and (is-Cons l0) (= l0 (Cons cv4 cv5)) (= cv4 (Head l0)) (= cv5 (Tail l0))) (and (= l0 l1)))) )
