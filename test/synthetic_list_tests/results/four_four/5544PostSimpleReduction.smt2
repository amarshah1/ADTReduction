...
(assert (and (or (and (is-Nil l3) (= l3 Nil)) (and (= l3 l0)) (and (= l1 l2)) (and (= l2 Nil) (is-Nil l2)))) )
...
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons l3) (= l3 (Cons cv2 cv3)) (= cv2 (Head l3)) (= cv3 (Tail l3))) (and (= l1 l3)))) )
