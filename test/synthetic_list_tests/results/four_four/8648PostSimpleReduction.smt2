...
(assert (and (and (and (is-Nil l3) (= l3 Nil)) (and (= l2 l2)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (and (and (is-Cons l2) (= l2 (Cons cv0 cv1)) (= cv0 (Head l2)) (= cv1 (Tail l2))) (and (= l0 l0)) (and (is-Nil l0) (= l0 Nil)) (and (= l2 Nil) (is-Nil l2)))) )
