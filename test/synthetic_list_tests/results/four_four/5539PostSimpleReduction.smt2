...
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l1 Nil) (is-Nil l1)) (and (= l3 Nil) (is-Nil l3)) (and (= l0 l2)))) )
(assert (and (and (and (= l3 l3)) (and (is-Nil l0) (= l0 Nil)) (and (= l1 l0)) (and (= l1 l3)))) )
(assert (and (and (and (is-Nil l1) (= l1 Nil)) (and (= l2 Nil) (is-Nil l2)) (and (is-Nil l3) (= l3 Nil)))) )
