...
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (is-Cons l0) (= l0 (Cons cv0 cv1)) (= cv0 (Head l0)) (= cv1 (Tail l0))) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))))) )
(assert (and (not (is-Nil Nil))) )
(assert (and (not (= l0 Nil))) )
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l0 l1)) (and (is-Nil Nil) (= Nil Nil)))) )
