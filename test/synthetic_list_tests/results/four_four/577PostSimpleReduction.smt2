...
(assert (and (or (and (is-Nil l3) (= l3 Nil)) (and (= l1 l0)) (and (= l0 Nil) (is-Nil l0)) (and (= l3 l0)))) )
(assert (and (= l3 Nil) (is-Nil l3)) )
(assert (and (not (is-Nil l0))) )
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l1 l2)) (and (= l3 Nil) (is-Nil l3)) (and (= l1 Nil) (is-Nil l1)))) )
