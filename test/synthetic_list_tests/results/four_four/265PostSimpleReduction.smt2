...
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l2 l2)) (and (is-Nil Nil) (= Nil Nil)) (and (= l1 l2)))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (= l2 Nil) (is-Nil l2)) (and (= l1 l1)))) )
(assert (and (or (and (= l3 l0)) (and (= l1 l0)) (and (= l1 l3)) (and (= l1 l1)))) )
