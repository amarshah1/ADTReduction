...
(assert (and (or (and (is-Nil l1) (= l1 Nil)) (and (is-Nil l2) (= l2 Nil)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (or (and (= l1 l0)) (and (= l0 l0)) (and (= l2 Nil) (is-Nil l2)) (and (is-Nil Nil) (= Nil Nil)))) )
