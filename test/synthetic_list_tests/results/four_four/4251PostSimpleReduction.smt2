...
(assert (and (= l3 l2)) )
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (is-Nil Nil) (= Nil Nil)) (and (= l2 l1)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l0 l1)) (and (= l1 Nil) (is-Nil l1)) (and (is-Nil Nil) (= Nil Nil)))) )
