...
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (= l1 l3)) (and (= l3 l0)))) )
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons l3) (= l3 (Cons cv0 cv1)) (= cv0 (Head l3)) (= cv1 (Tail l3))))) )
