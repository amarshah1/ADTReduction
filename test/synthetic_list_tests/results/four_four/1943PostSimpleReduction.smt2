...
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (is-Nil Nil) (= Nil Nil)) (and (= l1 Nil) (is-Nil l1)) (and (= l3 l1)))) )
(assert (and (or (and (is-Nil l0) (= l0 Nil)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (is-Nil l0) (= l0 Nil)) (and (is-Nil l3) (= l3 Nil)) (and (is-Nil Nil) (= Nil Nil)))) )
