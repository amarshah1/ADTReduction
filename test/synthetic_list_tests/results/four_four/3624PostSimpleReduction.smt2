...
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l2 l2)) (and (= l1 Nil) (is-Nil l1)) (and (= l3 l0)))) )
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l2 Nil) (is-Nil l2)) (and (= l3 Nil) (is-Nil l3)) (and (= l3 l1)))) )
