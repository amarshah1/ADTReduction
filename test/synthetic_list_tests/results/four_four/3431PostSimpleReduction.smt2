...
(assert (and (or (and (= l2 l0)) (and (= l3 l3)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))))) )
(assert (and (= l3 Nil) (is-Nil l3)) )
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (= l1 l1)) (and (is-Nil l3) (= l3 Nil)))) )
