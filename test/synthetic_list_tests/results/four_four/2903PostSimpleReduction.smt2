...
(assert (and (or (and (= l2 l3)) (and (= l2 Nil) (is-Nil l2)) (and (= l0 l2)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (or (and (= l2 l1)) (and (= l2 Nil) (is-Nil l2)) (and (is-Cons l0) (= l0 (Cons cv0 cv1)) (= cv0 (Head l0)) (= cv1 (Tail l0))))) )
