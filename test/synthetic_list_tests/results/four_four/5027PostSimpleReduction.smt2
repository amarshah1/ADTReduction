...
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l2 l3)) (and (= l2 Nil) (is-Nil l2)) (and (= l0 Nil) (is-Nil l0)))) )
...
(assert (and (or (and (= l1 l2)) (and (is-Nil l3) (= l3 Nil)) (and (= l2 Nil) (is-Nil l2)))) )
