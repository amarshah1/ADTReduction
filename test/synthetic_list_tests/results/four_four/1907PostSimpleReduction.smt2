...
(assert (and (and (and (= l1 l3)) (and (= l1 Nil) (is-Nil l1)) (and (= l0 l1)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (not (is-Nil Nil))) )
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l0 Nil) (is-Nil l0)) (and (is-Cons l3) (= l3 (Cons cv0 cv1)) (= cv0 (Head l3)) (= cv1 (Tail l3))) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))))) )
