...
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l1 Nil) (is-Nil l1)) (and (= l1 l0)) (and (= l2 l3)))) )
(assert (and (not (= l0 l0))) )
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (is-Nil Nil) (= Nil Nil)) (and (= l2 l0)) (and (= l0 Nil) (is-Nil l0)))) )
