...
(assert (and (or (and (= l2 l0)) (and (is-Nil l3) (= l3 Nil)))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (= l1 l3)) )
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (= l0 Nil) (is-Nil l0)) (and (is-Cons l3) (= l3 (Cons cv0 cv1)) (= cv0 (Head l3)) (= cv1 (Tail l3))))) )
