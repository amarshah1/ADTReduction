...
(assert (and (or (and (= l0 l2)) (and (is-Nil Nil) (= Nil Nil)) (and (= l2 l0)) (and (is-Nil l3) (= l3 Nil)))) )
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l0 Nil) (is-Nil l0)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (and (and (is-Nil l3) (= l3 Nil)) (and (is-Nil l3) (= l3 Nil)) (and (= l0 l0)) (and (= l0 Nil) (is-Nil l0)))) )
