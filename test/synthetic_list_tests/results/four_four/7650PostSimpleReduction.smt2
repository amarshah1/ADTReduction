...
(assert (and (or (and (= l1 l3)) (and (= l1 Nil) (is-Nil l1)) (and (= l0 l1)) (and (= l2 l0)))) )
(assert (and (not (= l0 Nil))) )
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (= l2 Nil) (is-Nil l2)) (and (= l2 Nil) (is-Nil l2)) (and (= l2 l0)))) )
