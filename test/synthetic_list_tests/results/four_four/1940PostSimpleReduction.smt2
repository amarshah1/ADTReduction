...
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (= l1 l0)) (and (is-Nil l2) (= l2 Nil)) (and (= l1 l0)))) )
(assert (and (= l1 Nil) (is-Nil l1)) )
(assert (and (= l0 Nil) (is-Nil l0)) )
(assert (and (and (and (= l0 l1)) (and (is-Cons l2) (= l2 (Cons cv0 cv1)) (= cv0 (Head l2)) (= cv1 (Tail l2))))) )
