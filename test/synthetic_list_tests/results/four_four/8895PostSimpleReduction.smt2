...
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (is-Nil l1) (= l1 Nil)) (and (= l3 l3)))) )
(assert (and (= l1 Nil) (is-Nil l1)) )
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l2 l3)) (and (= l3 l3)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))))) )
