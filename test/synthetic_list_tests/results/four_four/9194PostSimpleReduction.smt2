...
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (= l3 l2)) (and (= l0 l0)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l3 Nil) (is-Nil l3)) (and (= l1 Nil) (is-Nil l1)) (and (= l3 Nil) (is-Nil l3)))) )
