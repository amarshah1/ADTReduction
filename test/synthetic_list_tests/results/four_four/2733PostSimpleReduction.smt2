...
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (= l3 l2)) (and (= l2 l3)))) )
(assert (and (not (is-Nil Nil))) )
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l2 Nil) (is-Nil l2)) (and (= l1 l1)) (and (is-Nil l2) (= l2 Nil)))) )
