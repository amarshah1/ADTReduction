...
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l1 l0)) (and (= l1 Nil) (is-Nil l1)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (is-Nil l2) (= l2 Nil)) )
(assert (and (not (is-Nil l3))) )
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l0 l3)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))))) )
