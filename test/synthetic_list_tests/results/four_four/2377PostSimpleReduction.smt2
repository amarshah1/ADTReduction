...
(assert (and (and (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (is-Nil l1) (= l1 Nil)))) )
(assert (and (not (= l3 l3))) )
(assert (and (and (and (= l0 l3)) (and (= l1 l0)) (and (= l0 Nil) (is-Nil l0)) (and (is-Nil l2) (= l2 Nil)))) )
(assert (and (and (and (is-Nil l2) (= l2 Nil)) (and (= l0 l1)) (and (= l0 Nil) (is-Nil l0)))) )
