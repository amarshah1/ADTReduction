...
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (= l3 l2)) (and (= l1 l2)) (and (= l0 l3)))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (and (and (= l3 l3)) (and (is-Nil l1) (= l1 Nil)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l0 l0)))) )
