...
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l3 l3)) (and (= l2 l2)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (not (= l1 l3))) )
(assert (and (or (and (= l0 l3)) (and (= l1 Nil) (is-Nil l1)) (and (= l0 l1)) (and (= l1 Nil) (is-Nil l1)))) )
