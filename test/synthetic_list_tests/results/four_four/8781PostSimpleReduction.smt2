...
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l0 Nil) (is-Nil l0)) (and (= l3 Nil) (is-Nil l3)) (and (is-Nil l1) (= l1 Nil)))) )
(assert (and (not (= l0 Nil))) )
(assert (and (and (and (= l2 l0)) (and (= l1 l0)) (and (= l0 Nil) (is-Nil l0)))) )
