...
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (= l0 l0)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (and (and (= l0 l2)) (and (= l0 Nil) (is-Nil l0)) (and (is-Nil l1) (= l1 Nil)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l1 l0)) (and (= l2 Nil) (is-Nil l2)))) )
