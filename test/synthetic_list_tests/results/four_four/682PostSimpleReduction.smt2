...
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (= l3 l0)) (and (= l1 Nil) (is-Nil l1)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (is-Cons l3) (= l3 (Cons cv4 cv5)) (= cv4 (Head l3)) (= cv5 (Tail l3))) (and (= l2 Nil) (is-Nil l2)))) )
