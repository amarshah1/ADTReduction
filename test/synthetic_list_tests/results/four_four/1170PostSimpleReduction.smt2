...
(assert (and (and (and (= l0 l2)) (and (= l3 Nil) (is-Nil l3)) (and (= l0 l1)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (and (and (= l2 l2)) (and (= l1 l0)) (and (is-Cons l2) (= l2 (Cons cv2 cv3)) (= cv2 (Head l2)) (= cv3 (Tail l2))))) )
