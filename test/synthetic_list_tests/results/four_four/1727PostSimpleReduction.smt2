...
(assert (and (or (and (is-Cons l2) (= l2 (Cons cv0 cv1)) (= cv0 (Head l2)) (= cv1 (Tail l2))) (and (= l1 Nil) (is-Nil l1)) (and (is-Nil l0) (= l0 Nil)))) )
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l2 l2)) (and (is-Nil Nil) (= Nil Nil)) (and (= l1 l0)))) )
(assert (and (= l2 l1)) )
