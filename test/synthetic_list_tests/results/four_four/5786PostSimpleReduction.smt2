...
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l1 l2)) (and (= l1 l0)))) )
(assert (and (or (and (= l3 l0)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l1 l3)))) )
