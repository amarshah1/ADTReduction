...
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l3 l3)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l1 Nil) (is-Nil l1)) (and (= l1 Nil) (is-Nil l1)) (and (= l1 l1)))) )
