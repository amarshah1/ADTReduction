...
(assert (and (and (and (= l3 l2)) (and (= l3 Nil) (is-Nil l3)) (and (is-Nil l3) (= l3 Nil)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (or (and (is-Nil l1) (= l1 Nil)) (and (= l2 l3)) (and (= l1 Nil) (is-Nil l1)))) )
