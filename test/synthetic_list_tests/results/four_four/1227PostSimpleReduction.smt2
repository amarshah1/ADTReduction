...
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l0 l3)) (and (= l2 l3)))) )
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l0 l3)) (and (is-Nil l3) (= l3 Nil)) (and (= l0 l0)))) )
(assert (and (not (is-Nil Nil))) )
(assert (and (or (and (is-Nil l1) (= l1 Nil)) (and (= l3 l0)) (and (is-Nil Nil) (= Nil Nil)))) )
