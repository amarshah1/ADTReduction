...
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l2 l2)) (and (is-Nil Nil) (= Nil Nil)) (and (= l2 l1)))) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l1 Nil) (is-Nil l1)) (and (= l3 Nil) (is-Nil l3)) (and (= l3 l0)))) )
