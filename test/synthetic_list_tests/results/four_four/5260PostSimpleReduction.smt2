...
(assert (and (= l3 l1)) )
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil l2) (= l2 Nil)) (and (= l0 l0)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (not (is-Nil Nil))) )
(assert (and (or (and (= l3 l2)) (and (= l1 l3)) (and (= l1 Nil) (is-Nil l1)) (and (is-Nil Nil) (= Nil Nil)))) )
