...
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l2 l2)) (and (= l1 l0)) (and (= l0 l3)))) )
(assert (and (and (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l3 Nil) (is-Nil l3)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (not (= l0 Nil))) )
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (= l2 l3)) (and (= l1 l2)) (and (is-Nil l1) (= l1 Nil)))) )
