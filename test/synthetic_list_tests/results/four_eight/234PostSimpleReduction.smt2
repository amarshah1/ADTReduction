...
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (is-Cons l0) (= l0 (Cons cv0 cv1)) (= cv0 (Head l0)) (= cv1 (Tail l0))) (and (is-Nil Nil) (= Nil Nil)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (not (is-Cons Nil))) )
(assert (and (= l1 Nil) (is-Nil l1)) )
(assert (and (= l3 Nil) (is-Nil l3)) )
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l1 l2)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (= l3 Nil) (is-Nil l3)) )
