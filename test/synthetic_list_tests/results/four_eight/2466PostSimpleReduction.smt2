...
(assert (and (or (and (= l2 l2)) (and (= l2 Nil) (is-Nil l2)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (or (and (is-Nil l3) (= l3 Nil)) (and (is-Cons l0) (= l0 (Cons cv6 cv7)) (= cv6 (Head l0)) (= cv7 (Tail l0))) (and (= l0 Nil) (is-Nil l0)) (and (= l0 l1)))) )
