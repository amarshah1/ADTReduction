...
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (is-Nil Nil) (= Nil Nil)) (and (= l2 l0)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (= l1 Nil) (is-Nil l1)) )
(assert (and (or (and (is-Nil l0) (= l0 Nil)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (= l0 l2)) (and (is-Nil l2) (= l2 Nil)) (and (= l1 Nil) (is-Nil l1)))) )
