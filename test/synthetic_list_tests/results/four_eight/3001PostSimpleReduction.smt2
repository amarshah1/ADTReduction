...
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (= l3 Nil) (is-Nil l3)) (and (= l1 l3)) (and (= l0 l1)))) )
(assert (and (is-Nil l3) (= l3 Nil)) )
(assert (and (is-Cons l3) (= l3 (Cons cv2 cv3)) (= cv2 (Head l3)) (= cv3 (Tail l3))) )
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l0 Nil) (is-Nil l0)) (and (= l3 l3)) (and (= l3 Nil) (is-Nil l3)))) )
