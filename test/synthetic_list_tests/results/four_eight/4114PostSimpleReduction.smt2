...
(assert (and (or (and (= l3 l1)) (and (is-Nil l1) (= l1 Nil)) (and (= l0 l3)))) )
(assert (and (and (and (= l1 l1)) (and (is-Nil l2) (= l2 Nil)) (and (= l3 l3)) (and (= l2 Nil) (is-Nil l2)))) )
...
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) (and (= l1 Nil) (is-Nil l1)))) )
