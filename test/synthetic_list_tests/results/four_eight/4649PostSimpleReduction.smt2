...
(assert (and (= l0 l0)) )
(assert (and (and (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (is-Nil l3) (= l3 Nil)) (and (= l1 Nil) (is-Nil l1)))) )
...
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (= l3 l2)) (and (= l1 l2)) (and (= l3 Nil) (is-Nil l3)))) )
