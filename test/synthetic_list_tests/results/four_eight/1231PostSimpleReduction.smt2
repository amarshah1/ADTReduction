...
(assert (and (and (and (= l2 l0)) (and (is-Nil l3) (= l3 Nil)) (and (is-Cons l1) (= l1 (Cons cv0 cv1)) (= cv0 (Head l1)) (= cv1 (Tail l1))) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (or (and (= l3 l3)) (and (= l2 Nil) (is-Nil l2)) (and (= l2 Nil) (is-Nil l2)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (not (is-Nil l0))) )
(assert (and (and (and (= l2 l3)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil l1) (= l1 Nil)))) )
