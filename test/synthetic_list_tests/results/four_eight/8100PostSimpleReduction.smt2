...
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l3 l0)) (and (= l3 l2)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) )
(assert (and (not (= l1 Nil))) )
(assert (and (and (and (= l2 l2)) (and (= l0 l2)))) )
(assert (and (and (and (= l3 l3)) (and (is-Nil Nil) (= Nil Nil)) (and (= l1 Nil) (is-Nil l1)) (and (is-Cons l1) (= l1 (Cons cv6 cv7)) (= cv6 (Head l1)) (= cv7 (Tail l1))))) )
