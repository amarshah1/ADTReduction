...
(assert (and (or (and (= l2 l3)) (and (= l0 Nil) (is-Nil l0)) (and (is-Nil Nil) (= Nil Nil)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (or (and (is-Nil l3) (= l3 Nil)) (and (= l1 l1)) (and (is-Nil l1) (= l1 Nil)))) )
