...
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l3 l1)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))))) )
(assert (and (not (is-Nil l2))) )
(assert (and (or (and (= l1 l3)) (and (= l2 Nil) (is-Nil l2)) (and (= l3 l2)))) )
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l3 l0)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (is-Cons l3) (= l3 (Cons cv2 cv3)) (= cv2 (Head l3)) (= cv3 (Tail l3))) )
(assert (and (and (and (is-Cons l2) (= l2 (Cons cv4 cv5)) (= cv4 (Head l2)) (= cv5 (Tail l2))) (and (= l0 Nil) (is-Nil l0)) (and (= l3 Nil) (is-Nil l3)) (and (= l0 Nil) (is-Nil l0)))) )
