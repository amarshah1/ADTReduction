...
(assert (and (and (and (= l2 l0)) (and (is-Cons Nil) (= Nil (Cons cv8 cv9)) (= cv8 (Head Nil)) (= cv9 (Tail Nil))) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (is-Nil l0) (= l0 Nil)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons l1) (= l1 (Cons cv10 cv11)) (= cv10 (Head l1)) (= cv11 (Tail l1))))) )
