...
(assert (and (and (and (= l3 l2)) (and (is-Cons l1) (= l1 (Cons cv0 cv1)) (= cv0 (Head l1)) (= cv1 (Tail l1))) (and (= l3 l3)))) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l3 l0)) (and (= l2 l3)))) )
...
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (is-Cons Nil) (= Nil (Cons cv8 cv9)) (= cv8 (Head Nil)) (= cv9 (Tail Nil))) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (= l1 Nil) (is-Nil l1)) )
(assert (and (is-Cons Nil) (= Nil (Cons cv10 cv11)) (= cv10 (Head Nil)) (= cv11 (Tail Nil))) )
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (= l2 l3)) (and (= l1 Nil) (is-Nil l1)) (and (= l2 Nil) (is-Nil l2)))) )
