...
(assert (and (and (and (= l1 l2)) (and (is-Cons l2) (= l2 (Cons cv0 cv1)) (= cv0 (Head l2)) (= cv1 (Tail l2))) (and (= l1 l3)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (= l0 Nil) (is-Nil l0)) )
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (is-Nil l2) (= l2 Nil)) (and (= l0 l0)))) )
(assert (and (not (is-Cons Nil))) )
(assert (and (is-Nil l3) (= l3 Nil)) )
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l1 l1)) (and (is-Nil Nil) (= Nil Nil)) (and (= l2 Nil) (is-Nil l2)))) )
