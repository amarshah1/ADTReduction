...
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l3 Nil) (is-Nil l3)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l1 l2)))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (= l2 Nil) (is-Nil l2)) )
(assert (and (is-Nil l0) (= l0 Nil)) )
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (is-Cons l3) (= l3 (Cons cv2 cv3)) (= cv2 (Head l3)) (= cv3 (Tail l3))) (and (is-Nil Nil) (= Nil Nil)) (and (= l2 Nil) (is-Nil l2)))) )
