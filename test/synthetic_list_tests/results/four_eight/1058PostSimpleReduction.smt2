...
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l2 Nil) (is-Nil l2)) (and (= l3 l1)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (not (is-Cons Nil))) )
(assert (and (not (is-Nil Nil))) )
(assert (and (and (and (is-Cons l2) (= l2 (Cons cv0 cv1)) (= cv0 (Head l2)) (= cv1 (Tail l2))) (and (= l1 l2)) (and (= l3 l1)))) )
