...
(assert (and (or (and (= l1 l1)) (and (= l3 Nil) (is-Nil l3)) (and (= l2 l2)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (is-Nil Nil) (= Nil Nil)) (and (= l2 Nil) (is-Nil l2)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))))) )
