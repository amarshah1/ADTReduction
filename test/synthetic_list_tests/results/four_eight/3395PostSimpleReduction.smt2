...
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l0 l0)) (and (= l1 Nil) (is-Nil l1)))) )
...
(assert (and (or (and (= l1 l0)) (and (is-Cons l2) (= l2 (Cons cv2 cv3)) (= cv2 (Head l2)) (= cv3 (Tail l2))) (and (= l0 Nil) (is-Nil l0)) (and (is-Cons l1) (= l1 (Cons cv4 cv5)) (= cv4 (Head l1)) (= cv5 (Tail l1))))) )
