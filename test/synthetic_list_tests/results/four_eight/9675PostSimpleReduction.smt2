...
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (= l0 l1)) )
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (is-Cons l3) (= l3 (Cons cv4 cv5)) (= cv4 (Head l3)) (= cv5 (Tail l3))) (and (is-Cons l0) (= l0 (Cons cv6 cv7)) (= cv6 (Head l0)) (= cv7 (Tail l0))) (and (= l1 Nil) (is-Nil l1)))) )
