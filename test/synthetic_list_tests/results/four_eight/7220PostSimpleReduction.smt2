...
(assert (and (or (and (= l0 l1)) (and (= l0 l0)) (and (is-Nil Nil) (= Nil Nil)) (and (= l3 l2)))) )
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l2 l3)) (and (= l3 Nil) (is-Nil l3)) (and (is-Nil Nil) (= Nil Nil)))) )
