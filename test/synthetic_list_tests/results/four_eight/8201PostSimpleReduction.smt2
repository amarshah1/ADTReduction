...
(assert (and (and (and (is-Cons l3) (= l3 (Cons cv0 cv1)) (= cv0 (Head l3)) (= cv1 (Tail l3))) (and (= l0 Nil) (is-Nil l0)) (and (= l2 l2)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (= l3 Nil) (is-Nil l3)) )
(assert (and (and (and (is-Nil l0) (= l0 Nil)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (= l0 Nil) (is-Nil l0)) )
(assert (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) )
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l1 l3)) (and (= l3 Nil) (is-Nil l3)))) )
