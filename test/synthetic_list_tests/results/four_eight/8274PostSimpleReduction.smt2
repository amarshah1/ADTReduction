...
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (= l3 Nil) (is-Nil l3)) (and (= l3 l3)) (and (= l1 l2)))) )
...
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (is-Cons l0) (= l0 (Cons cv2 cv3)) (= cv2 (Head l0)) (= cv3 (Tail l0))) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (or (and (= l2 l3)) (and (= l1 l1)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (and (and (= l2 l1)) (and (is-Nil l2) (= l2 Nil)) (and (= l0 Nil) (is-Nil l0)) (and (= l1 Nil) (is-Nil l1)))) )
