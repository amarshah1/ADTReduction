...
(assert (and (or (and (= l2 l2)) (and (is-Nil l0) (= l0 Nil)) (and (= l3 l3)))) )
(assert (and (is-Nil l2) (= l2 Nil)) )
(assert (and (= l0 Nil) (is-Nil l0)) )
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (is-Cons l2) (= l2 (Cons cv0 cv1)) (= cv0 (Head l2)) (= cv1 (Tail l2))) (and (= l1 l1)))) )
