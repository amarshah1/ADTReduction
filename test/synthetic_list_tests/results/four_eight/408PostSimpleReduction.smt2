...
(assert (and (or (and (= l1 l3)) (and (= l3 l0)) (and (= l0 Nil) (is-Nil l0)) (and (is-Nil l2) (= l2 Nil)))) )
(assert (and (or (and (is-Cons l2) (= l2 (Cons cv0 cv1)) (= cv0 (Head l2)) (= cv1 (Tail l2))) (and (= l2 l1)) (and (= l3 l3)) (and (= l1 l1)))) )
