...
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l3 l2)))) )
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l0 l2)) (and (= l1 l3)) (and (= l1 l1)))) )
(assert (and (= l0 Nil) (is-Nil l0)) )
(assert (and (or (and (= l2 l3)) (and (= l1 l3)) (and (is-Nil Nil) (= Nil Nil)) (and (= l1 Nil) (is-Nil l1)))) )
