...
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (is-Cons l2) (= l2 (Cons cv4 cv5)) (= cv4 (Head l2)) (= cv5 (Tail l2))) (and (= l3 l2)))) )
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l3 l0)))) )
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l0 l3)) (and (is-Cons l1) (= l1 (Cons cv6 cv7)) (= cv6 (Head l1)) (= cv7 (Tail l1))))) )
