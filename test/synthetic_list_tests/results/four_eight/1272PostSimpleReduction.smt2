...
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (= l2 l0)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l0 l1)))) )
(assert (and (is-Nil l2) (= l2 Nil)) )
(assert (and (and (and (= l0 l3)) (and (= l1 l0)) (and (is-Nil Nil) (= Nil Nil)) (and (= l0 l0)))) )
