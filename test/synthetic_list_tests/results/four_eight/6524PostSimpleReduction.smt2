...
(assert (and (or (and (= l3 l2)) (and (= l1 l1)) (and (= l1 Nil) (is-Nil l1)))) )
...
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (is-Nil l0) (= l0 Nil)) (and (= l2 Nil) (is-Nil l2)) (and (is-Cons Nil) (= Nil (Cons cv8 cv9)) (= cv8 (Head Nil)) (= cv9 (Tail Nil))))) )
