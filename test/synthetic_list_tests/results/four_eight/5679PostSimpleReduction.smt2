...
(assert (and (and (and (is-Nil l0) (= l0 Nil)) (and (= l1 Nil) (is-Nil l1)) (and (= l0 l0)))) )
(assert (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) )
(assert (and (not (= l0 Nil))) )
(assert (and (is-Nil l0) (= l0 Nil)) )
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l3 Nil) (is-Nil l3)) (and (= l3 Nil) (is-Nil l3)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))))) )
