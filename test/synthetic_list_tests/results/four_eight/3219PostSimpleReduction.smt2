...
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l2 Nil) (is-Nil l2)) (and (= l0 l2)) (and (= l0 l0)))) )
...
(assert (and (and (and (is-Nil l1) (= l1 Nil)) (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) (and (= l3 l1)) (and (is-Nil Nil) (= Nil Nil)))) )
