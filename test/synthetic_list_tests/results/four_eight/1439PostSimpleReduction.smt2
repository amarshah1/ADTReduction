...
(assert (and (= l2 Nil) (is-Nil l2)) )
(assert (and (or (and (= l0 l2)) (and (= l1 Nil) (is-Nil l1)) (and (= l0 Nil) (is-Nil l0)) (and (is-Cons l3) (= l3 (Cons cv0 cv1)) (= cv0 (Head l3)) (= cv1 (Tail l3))))) )
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil l3) (= l3 Nil)) (and (= l3 Nil) (is-Nil l3)) (and (= l3 Nil) (is-Nil l3)))) )
