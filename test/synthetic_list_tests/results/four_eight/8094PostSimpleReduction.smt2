...
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (= l3 l0)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))))) )
(assert (and (not (= l0 l3))) )
(assert (and (= l0 Nil) (is-Nil l0)) )
(assert (and (and (and (= l0 l3)) (and (is-Nil l0) (= l0 Nil)))) )
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l1 l0)) (and (is-Cons l2) (= l2 (Cons cv2 cv3)) (= cv2 (Head l2)) (= cv3 (Tail l2))) (and (= l0 l0)))) )
(assert (and (= l3 l3)) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
