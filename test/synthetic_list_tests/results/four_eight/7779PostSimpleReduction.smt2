...
(assert (and (or (and (= l0 l1)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l3 l3)) (and (= l0 l3)))) )
(assert (and (not (= l2 Nil))) )
(assert (and (= l2 Nil) (is-Nil l2)) )
(assert (and (= l2 l2)) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (and (and (is-Cons l3) (= l3 (Cons cv2 cv3)) (= cv2 (Head l3)) (= cv3 (Tail l3))) (and (= l3 l0)))) )
