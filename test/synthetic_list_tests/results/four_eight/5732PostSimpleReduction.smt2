...
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l2 l1)) (and (= l1 Nil) (is-Nil l1)) (and (= l0 l0)))) )
...
(assert (and (or (and (is-Cons l3) (= l3 (Cons cv2 cv3)) (= cv2 (Head l3)) (= cv3 (Tail l3))) (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))))) )
