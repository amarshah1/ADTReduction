...
(assert (and (or (and (= l2 l2)) (and (= l2 l2)) (and (= l1 l1)))) )
(assert (and (not (= l1 Nil))) )
(assert (and (not (is-Nil Nil))) )
(assert (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) )
(assert (and (not (= l1 Nil))) )
(assert (and (or (and (= l0 l3)) (and (is-Cons l2) (= l2 (Cons cv6 cv7)) (= cv6 (Head l2)) (= cv7 (Tail l2))) (and (is-Cons Nil) (= Nil (Cons cv8 cv9)) (= cv8 (Head Nil)) (= cv9 (Tail Nil))))) )
