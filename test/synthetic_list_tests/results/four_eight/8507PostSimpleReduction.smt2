...
(assert (and (= l0 l3)) )
(assert (and (or (and (= l3 l1)) (and (= l1 l0)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (and (and (= l3 l0)) (and (= l0 l3)) (and (= l3 Nil) (is-Nil l3)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (and (and (= l2 l0)) (and (= l1 Nil) (is-Nil l1)) (and (= l3 Nil) (is-Nil l3)) (and (= l0 Nil) (is-Nil l0)))) )
