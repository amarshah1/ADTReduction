...
(assert (and (and (and (is-Nil l2) (= l2 Nil)) (and (is-Nil Nil) (= Nil Nil)) (and (= l0 l3)))) )
(assert (and (or (and (= l2 l3)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l1 l1)) (and (= l3 l1)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))))) )
