...
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (= l0 l1)) (and (= l1 Nil) (is-Nil l1)) (and (is-Cons Nil) (= Nil (Cons cv8 cv9)) (= cv8 (Head Nil)) (= cv9 (Tail Nil))))) )
(assert (and (is-Cons l2) (= l2 (Cons cv10 cv11)) (= cv10 (Head l2)) (= cv11 (Tail l2))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l1 l2)) (and (is-Cons Nil) (= Nil (Cons cv12 cv13)) (= cv12 (Head Nil)) (= cv13 (Tail Nil))) (and (= l1 Nil) (is-Nil l1)))) )
