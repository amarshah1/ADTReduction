...
(assert (and (or (and (= l0 l0)) (and (= l1 Nil) (is-Nil l1)) (and (= l2 Nil) (is-Nil l2)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (is-Cons l0) (= l0 (Cons cv2 cv3)) (= cv2 (Head l0)) (= cv3 (Tail l0))) )
(assert (and (= l3 Nil) (is-Nil l3)) )
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (= l2 l0)) (and (= l3 l1)) (and (= l2 l2)))) )
