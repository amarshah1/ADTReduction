...
(assert (and (and (and (= l3 l1)) (and (= l1 Nil) (is-Nil l1)) (and (is-Cons l0) (= l0 (Cons cv0 cv1)) (= cv0 (Head l0)) (= cv1 (Tail l0))))) )
...
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l1 l0)) (and (= l1 l2)))) )
