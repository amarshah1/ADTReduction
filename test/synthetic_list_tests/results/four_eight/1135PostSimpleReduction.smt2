...
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil Nil) (= Nil Nil)) (and (= l2 l1)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (or (and (= l1 l2)) (and (is-Nil l0) (= l0 Nil)) (and (is-Nil l3) (= l3 Nil)))) )
(assert (and (= l2 Nil) (is-Nil l2)) )
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (is-Cons l0) (= l0 (Cons cv2 cv3)) (= cv2 (Head l0)) (= cv3 (Tail l0))))) )
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l2 Nil) (is-Nil l2)) (and (= l2 l2)) (and (= l2 Nil) (is-Nil l2)))) )
