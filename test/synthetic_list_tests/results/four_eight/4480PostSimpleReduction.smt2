...
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (is-Nil l1) (= l1 Nil)) (and (= l2 l1)))) )
(assert (and (= l0 Nil) (is-Nil l0)) )
(assert (and (or (and (is-Cons l2) (= l2 (Cons cv2 cv3)) (= cv2 (Head l2)) (= cv3 (Tail l2))) (and (= l0 l2)) (and (is-Nil Nil) (= Nil Nil)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (is-Nil l1) (= l1 Nil)) )
(assert (and (or (and (= l3 l0)) (and (= l0 l3)) (and (= l2 l3)))) )
