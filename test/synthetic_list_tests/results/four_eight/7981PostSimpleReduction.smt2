...
(assert (and (and (and (= l1 l3)) (and (= l1 Nil) (is-Nil l1)) (and (= l3 l2)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (is-Nil l3) (= l3 Nil)) )
(assert (and (and (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l0 Nil) (is-Nil l0)) (and (is-Cons l3) (= l3 (Cons cv2 cv3)) (= cv2 (Head l3)) (= cv3 (Tail l3))))) )
...
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l1 Nil) (is-Nil l1)) (and (is-Cons Nil) (= Nil (Cons cv8 cv9)) (= cv8 (Head Nil)) (= cv9 (Tail Nil))) (and (= l1 Nil) (is-Nil l1)))) )
