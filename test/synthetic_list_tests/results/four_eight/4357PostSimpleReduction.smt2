...
(assert (and (and (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l3 Nil) (is-Nil l3)) (and (= l3 l0)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (and (and (is-Nil l3) (= l3 Nil)) (and (= l0 Nil) (is-Nil l0)) (and (= l1 l0)))) )
(assert (and (= l0 l0)) )
