...
(assert (and (or (and (= l0 l2)) (and (= l2 l0)) (and (= l1 Nil) (is-Nil l1)))) )
...
(assert (and (or (and (= l2 l2)) (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) (and (= l3 l1)) (and (= l1 Nil) (is-Nil l1)))) )
