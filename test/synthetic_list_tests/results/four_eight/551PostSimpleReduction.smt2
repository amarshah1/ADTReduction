...
(assert (and (or (and (= l2 l2)) (and (is-Cons l1) (= l1 (Cons cv0 cv1)) (= cv0 (Head l1)) (= cv1 (Tail l1))) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (= l2 l1)) )
(assert (and (not (= l0 l2))) )
(assert (and (is-Nil l3) (= l3 Nil)) )
(assert (and (is-Nil l2) (= l2 Nil)) )
(assert (and (and (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l2 Nil) (is-Nil l2)) (and (is-Nil l0) (= l0 Nil)) (and (= l0 Nil) (is-Nil l0)))) )
