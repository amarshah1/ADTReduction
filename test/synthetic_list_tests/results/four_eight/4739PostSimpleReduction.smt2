...
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (or (and (is-Cons l1) (= l1 (Cons cv4 cv5)) (= cv4 (Head l1)) (= cv5 (Tail l1))) (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons Nil) (= Nil (Cons cv6 cv7)) (= cv6 (Head Nil)) (= cv7 (Tail Nil))) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (= l3 l2)) )
