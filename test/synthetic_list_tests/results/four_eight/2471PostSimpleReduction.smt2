...
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (= l0 l0)) (and (is-Nil Nil) (= Nil Nil)) (and (= l1 l3)))) )
(assert (and (or (and (is-Cons l2) (= l2 (Cons cv2 cv3)) (= cv2 (Head l2)) (= cv3 (Tail l2))) (and (= l2 Nil) (is-Nil l2)) (and (= l2 l3)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (not (is-Cons Nil))) )
