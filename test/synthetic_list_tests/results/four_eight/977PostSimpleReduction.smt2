...
(assert (and (or (and (is-Nil l3) (= l3 Nil)) (and (= l1 Nil) (is-Nil l1)) (and (= l1 l2)) (and (= l2 l2)))) )
(assert (and (not (is-Cons Nil))) )
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l3 l2)) (and (= l3 Nil) (is-Nil l3)))) )
