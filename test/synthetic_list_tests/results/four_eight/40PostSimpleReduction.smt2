...
(assert (and (= l2 l3)) )
(assert (and (or (and (= l2 l1)) (and (is-Nil l1) (= l1 Nil)) (and (= l3 Nil) (is-Nil l3)) (and (= l2 l3)))) )
(assert (and (and (and (is-Nil l3) (= l3 Nil)) (and (is-Cons l1) (= l1 (Cons cv0 cv1)) (= cv0 (Head l1)) (= cv1 (Tail l1))) (and (= l3 Nil) (is-Nil l3)) (and (= l3 Nil) (is-Nil l3)))) )
