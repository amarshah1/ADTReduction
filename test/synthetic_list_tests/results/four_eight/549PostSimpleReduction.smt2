...
(assert (and (or (and (= l3 l3)) (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) (and (= l1 Nil) (is-Nil l1)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (not (= l2 Nil))) )
(assert (and (not (= l2 Nil))) )
(assert (and (or (and (= l2 l0)) (and (is-Nil l1) (= l1 Nil)) (and (= l3 l3)))) )
