...
(assert (and (and (and (= l1 l0)) (and (= l3 Nil) (is-Nil l3)) (and (= l0 Nil) (is-Nil l0)) (and (= l0 l2)))) )
...
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l3 l3)) (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))))) )
