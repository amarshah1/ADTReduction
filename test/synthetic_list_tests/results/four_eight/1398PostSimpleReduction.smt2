...
(assert (and (or (and (= l2 l3)) (and (= l0 l3)) (and (= l1 Nil) (is-Nil l1)))) )
...
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons l2) (= l2 (Cons cv2 cv3)) (= cv2 (Head l2)) (= cv3 (Tail l2))) (and (is-Cons l0) (= l0 (Cons cv4 cv5)) (= cv4 (Head l0)) (= cv5 (Tail l0))))) )
(assert (and (= l3 Nil) (is-Nil l3)) )
