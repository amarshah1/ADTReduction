...
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (is-Nil Nil) (= Nil Nil)) (and (= l1 Nil) (is-Nil l1)) (and (= l1 l1)))) )
(assert (and (and (and (is-Nil l1) (= l1 Nil)) (and (= l3 l0)) (and (= l2 l3)) (and (= l0 Nil) (is-Nil l0)))) )
