...
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (= l3 l2)) (and (= l1 l2)))) )
(assert (and (or (and (is-Nil l3) (= l3 Nil)) (and (= l3 l1)))) )
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l2 Nil) (is-Nil l2)) (and (= l3 Nil) (is-Nil l3)) (and (is-Nil l0) (= l0 Nil)))) )
(assert (and (= l0 l2)) )
