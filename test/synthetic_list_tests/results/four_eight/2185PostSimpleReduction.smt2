...
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil l2) (= l2 Nil)) (and (= l1 Nil) (is-Nil l1)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (is-Cons l1) (= l1 (Cons cv4 cv5)) (= cv4 (Head l1)) (= cv5 (Tail l1))) (and (is-Nil Nil) (= Nil Nil)))) )
