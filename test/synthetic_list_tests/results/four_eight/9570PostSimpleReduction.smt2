...
(assert (and (and (and (= l2 l2)) (and (is-Cons l0) (= l0 (Cons cv4 cv5)) (= cv4 (Head l0)) (= cv5 (Tail l0))) (and (= l2 l3)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (and (and (is-Cons l2) (= l2 (Cons cv6 cv7)) (= cv6 (Head l2)) (= cv7 (Tail l2))) (and (= l3 Nil) (is-Nil l3)) (and (= l0 l2)) (and (is-Nil Nil) (= Nil Nil)))) )
