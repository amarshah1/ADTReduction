...
(assert (and (and (and (= l0 l0)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil l1) (= l1 Nil)))) )
(assert (and (and (and (= l3 l3)) (and (= l1 l2)) (and (= l3 l3)) (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))))) )
(assert (and (or (and (= l2 l2)) (and (is-Cons Nil) (= Nil (Cons cv6 cv7)) (= cv6 (Head Nil)) (= cv7 (Tail Nil))) (and (= l0 l0)) (and (= l0 Nil) (is-Nil l0)))) )
