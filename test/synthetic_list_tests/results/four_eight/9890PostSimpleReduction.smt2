...
(assert (and (or (and (is-Nil l0) (= l0 Nil)) (and (= l0 l0)) (and (= l3 l3)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (and (and (= l3 l3)) (and (is-Cons l3) (= l3 (Cons cv2 cv3)) (= cv2 (Head l3)) (= cv3 (Tail l3))) (and (is-Cons l2) (= l2 (Cons cv4 cv5)) (= cv4 (Head l2)) (= cv5 (Tail l2))) (and (= l1 l0)))) )
