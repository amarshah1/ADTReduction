...
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l0 l3)) (and (= l0 Nil) (is-Nil l0)) (and (= l0 l1)))) )
(assert (and (= l0 Nil) (is-Nil l0)) )
(assert (and (and (and (= l2 l3)) (and (= l1 l2)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l0 l2)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l0 Nil) (is-Nil l0)) (and (= l0 Nil) (is-Nil l0)))) )
