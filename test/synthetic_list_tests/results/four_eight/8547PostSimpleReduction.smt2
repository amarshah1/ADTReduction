...
(assert (and (or (and (= l1 l0)) (and (= l0 Nil) (is-Nil l0)) (and (is-Nil Nil) (= Nil Nil)) (and (= l1 l3)))) )
(assert (and (= l3 Nil) (is-Nil l3)) )
(assert (and (not (= l1 Nil))) )
(assert (and (not (is-Cons l0))) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l1 Nil) (is-Nil l1)) (and (= l1 Nil) (is-Nil l1)))) )
