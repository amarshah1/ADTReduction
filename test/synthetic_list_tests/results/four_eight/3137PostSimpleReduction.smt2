...
(assert (and (and (and (is-Cons l1) (= l1 (Cons cv8 cv9)) (= cv8 (Head l1)) (= cv9 (Tail l1))) (and (= l2 Nil) (is-Nil l2)) (and (is-Cons l3) (= l3 (Cons cv10 cv11)) (= cv10 (Head l3)) (= cv11 (Tail l3))) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
