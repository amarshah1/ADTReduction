...
(assert (and (or (and (= l2 l1)) (and (= l3 Nil) (is-Nil l3)) (and (is-Nil Nil) (= Nil Nil)))) )
...
(assert (and (or (and (is-Nil l0) (= l0 Nil)) (and (= l1 l3)) (and (is-Nil l2) (= l2 Nil)) (and (= l3 Nil) (is-Nil l3)))) )
