...
(assert (and (or (and (= l0 l1)) (and (is-Nil l0) (= l0 Nil)) (and (is-Cons l0) (= l0 (Cons cv0 cv1)) (= cv0 (Head l0)) (= cv1 (Tail l0))) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (or (and (= l1 l1)) (and (= l2 l0)) (and (= l1 l3)))) )
...
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons Nil) (= Nil (Cons cv8 cv9)) (= cv8 (Head Nil)) (= cv9 (Tail Nil))) (and (is-Cons l3) (= l3 (Cons cv10 cv11)) (= cv10 (Head l3)) (= cv11 (Tail l3))) (and (= l3 Nil) (is-Nil l3)))) )
