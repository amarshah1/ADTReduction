...
(assert (and (and (and (= l1 l0)) (and (= l1 l2)) (and (is-Nil l3) (= l3 Nil)) (and (= l0 l3)))) )
(assert (and (is-Nil l1) (= l1 Nil)) )
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l1 Nil) (is-Nil l1)) (and (= l2 Nil) (is-Nil l2)) (and (= l0 l0)))) )
