...
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l1 l1)) (and (= l2 Nil) (is-Nil l2)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (is-Nil l1) (= l1 Nil)) )
(assert (and (and (and (is-Nil l2) (= l2 Nil)) (and (= l1 l0)) (and (= l2 l3)))) )
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil l1) (= l1 Nil)) (and (= l1 Nil) (is-Nil l1)) (and (is-Nil l0) (= l0 Nil)))) )
