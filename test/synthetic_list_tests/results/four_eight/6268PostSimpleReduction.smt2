...
(assert (and (or (and (= l1 l2)) (and (= l2 Nil) (is-Nil l2)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))))) )
(assert (and (= l0 Nil) (is-Nil l0)) )
(assert (and (or (and (is-Nil l2) (= l2 Nil)) (and (= l0 l2)) (and (= l1 l3)) (and (is-Nil Nil) (= Nil Nil)))) )
