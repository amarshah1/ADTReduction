...
(assert (and (or (and (= l0 l1)) (and (is-Nil l3) (= l3 Nil)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (not (= l1 l0))) )
(assert (and (= l1 l2)) )
(assert (and (and (and (= l3 l2)) (and (is-Nil Nil) (= Nil Nil)) (and (= l2 Nil) (is-Nil l2)) (and (is-Cons l3) (= l3 (Cons cv0 cv1)) (= cv0 (Head l3)) (= cv1 (Tail l3))))) )
