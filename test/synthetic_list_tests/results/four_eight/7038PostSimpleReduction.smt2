...
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l2 Nil) (is-Nil l2)) (and (= l1 Nil) (is-Nil l1)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil l1) (= l1 Nil)))) )
(assert (and (is-Nil l1) (= l1 Nil)) )
(assert (and (is-Nil l2) (= l2 Nil)) )
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l0 l0)) (and (= l3 Nil) (is-Nil l3)) (and (= l1 Nil) (is-Nil l1)))) )
