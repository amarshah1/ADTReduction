...
(assert (and (or (and (= l2 l2)) (and (= l1 l3)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))))) )
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l3 l0)) (and (= l1 l1)) (and (= l3 Nil) (is-Nil l3)))) )
