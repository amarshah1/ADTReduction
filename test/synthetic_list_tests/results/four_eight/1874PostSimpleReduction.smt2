...
(assert (and (and (and (is-Nil l3) (= l3 Nil)) (and (= l1 l0)) (and (= l3 Nil) (is-Nil l3)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (not (is-Nil Nil))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (not (= l3 Nil))) )
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l2 Nil) (is-Nil l2)) (and (= l0 l3)))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
