...
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (= l0 l2)) (and (= l1 l3)))) )
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l0 l3)) (and (= l2 Nil) (is-Nil l2)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (is-Nil Nil) (= Nil Nil)) (and (= l0 l3)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (= l2 l2)) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
