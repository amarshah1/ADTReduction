...
(assert (and (= l3 l0)) )
(assert (and (and (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l2 l3)) (and (= l1 l0)) (and (= l3 Nil) (is-Nil l3)))) )
...
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l3 Nil) (is-Nil l3)) (and (is-Cons Nil) (= Nil (Cons cv6 cv7)) (= cv6 (Head Nil)) (= cv7 (Tail Nil))))) )
