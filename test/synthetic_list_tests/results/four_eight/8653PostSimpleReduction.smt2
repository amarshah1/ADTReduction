...
(assert (and (or (and (is-Cons l2) (= l2 (Cons cv2 cv3)) (= cv2 (Head l2)) (= cv3 (Tail l2))) (and (is-Cons l3) (= l3 (Cons cv4 cv5)) (= cv4 (Head l3)) (= cv5 (Tail l3))) (and (= l0 Nil) (is-Nil l0)) (and (= l1 l0)))) )
(assert (and (not (is-Nil l1))) )
(assert (and (is-Nil l1) (= l1 Nil)) )
(assert (and (is-Cons l2) (= l2 (Cons cv6 cv7)) (= cv6 (Head l2)) (= cv7 (Tail l2))) )
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l0 l3)) (and (= l0 Nil) (is-Nil l0)) (and (= l1 l2)))) )
