...
(assert (and (or (and (= l3 l3)) (and (= l2 Nil) (is-Nil l2)) (and (is-Nil Nil) (= Nil Nil)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (not (= l1 Nil))) )
(assert (and (= l0 Nil) (is-Nil l0)) )
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (= l1 l2)) (and (= l0 l1)) (and (is-Nil l3) (= l3 Nil)))) )
