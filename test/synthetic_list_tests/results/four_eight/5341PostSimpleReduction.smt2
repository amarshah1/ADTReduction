...
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (= l0 l3)) (and (= l2 Nil) (is-Nil l2)))) )
...
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l1 l2)) (and (= l3 l3)) (and (is-Cons l3) (= l3 (Cons cv4 cv5)) (= cv4 (Head l3)) (= cv5 (Tail l3))))) )
(assert (and (= l1 Nil) (is-Nil l1)) )
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv6 cv7)) (= cv6 (Head Nil)) (= cv7 (Tail Nil))) (and (is-Cons Nil) (= Nil (Cons cv8 cv9)) (= cv8 (Head Nil)) (= cv9 (Tail Nil))) (and (= l1 l2)) (and (is-Cons Nil) (= Nil (Cons cv10 cv11)) (= cv10 (Head Nil)) (= cv11 (Tail Nil))))) )
