...
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l0 l1)) (and (= l0 l0)))) )
(assert (and (is-Nil l3) (= l3 Nil)) )
(assert (and (or (and (= l1 l3)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (and (and (is-Nil l1) (= l1 Nil)) (and (is-Cons l0) (= l0 (Cons cv0 cv1)) (= cv0 (Head l0)) (= cv1 (Tail l0))) (and (is-Cons l1) (= l1 (Cons cv2 cv3)) (= cv2 (Head l1)) (= cv3 (Tail l1))))) )
