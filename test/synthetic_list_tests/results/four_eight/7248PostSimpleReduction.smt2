...
(assert (and (and (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l0 l3)) (and (= l2 l3)))) )
(assert (and (not (is-Cons Nil))) )
(assert (and (= l2 Nil) (is-Nil l2)) )
(assert (and (not (= l3 l0))) )
(assert (and (or (and (is-Nil l2) (= l2 Nil)) (and (= l0 l1)) (and (= l2 Nil) (is-Nil l2)))) )
