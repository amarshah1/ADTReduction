...
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l0 l2)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (is-Nil l3) (= l3 Nil)) )
(assert (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) )
(assert (and (not (= l1 Nil))) )
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l1 Nil) (is-Nil l1)) (and (= l1 Nil) (is-Nil l1)) (and (= l0 l2)))) )
