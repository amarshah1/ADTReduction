...
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l0 l1)) (and (= l1 l3)))) )
...
(assert (and (or (and (is-Cons l2) (= l2 (Cons cv4 cv5)) (= cv4 (Head l2)) (= cv5 (Tail l2))) (and (is-Nil l1) (= l1 Nil)) (and (= l1 Nil) (is-Nil l1)))) )
