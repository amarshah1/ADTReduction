...
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (is-Cons l1) (= l1 (Cons cv0 cv1)) (= cv0 (Head l1)) (= cv1 (Tail l1))) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (not (= l0 Nil))) )
(assert (and (= l1 Nil) (is-Nil l1)) )
(assert (and (or (and (is-Nil l2) (= l2 Nil)) (and (= l3 l3)) (and (= l1 Nil) (is-Nil l1)) (and (= l0 Nil) (is-Nil l0)))) )
