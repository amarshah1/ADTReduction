...
(assert (and (or (and (is-Nil l2) (= l2 Nil)) (and (= l1 l3)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (or (and (= l3 l1)) (and (= l3 l3)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (and (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l2 l3)) (and (= l1 Nil) (is-Nil l1)) (and (= l3 Nil) (is-Nil l3)))) )
...
(assert (and (and (and (is-Cons Nil) (= Nil (Cons cv6 cv7)) (= cv6 (Head Nil)) (= cv7 (Tail Nil))) (and (is-Cons l3) (= l3 (Cons cv8 cv9)) (= cv8 (Head l3)) (= cv9 (Tail l3))) (and (= l1 Nil) (is-Nil l1)))) )
