...
(assert (and (and (and (= l0 l3)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (not (is-Nil l3))) )
(assert (and (= l1 l1)) )
(assert (and (and (and (is-Nil l1) (= l1 Nil)) (and (= l2 l2)) (and (= l0 Nil) (is-Nil l0)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))))) )
