...
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil l0) (= l0 Nil)) (and (= l0 l1)))) )
(assert (and (= l3 Nil) (is-Nil l3)) )
(assert (and (or (and (= l1 l3)) (and (= l0 l2)))) )
(assert (and (or (and (is-Nil l2) (= l2 Nil)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil l0) (= l0 Nil)) (and (is-Cons l1) (= l1 (Cons cv2 cv3)) (= cv2 (Head l1)) (= cv3 (Tail l1))))) )
