...
(assert (and (or (and (is-Cons l3) (= l3 (Cons cv2 cv3)) (= cv2 (Head l3)) (= cv3 (Tail l3))) (and (= l0 l1)) (and (= l2 Nil) (is-Nil l2)))) )
...
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l2 l1)) (and (is-Nil l0) (= l0 Nil)))) )
