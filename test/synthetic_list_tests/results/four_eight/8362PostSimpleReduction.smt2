...
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l1 l2)) (and (= l2 Nil) (is-Nil l2)) (and (= l1 l0)))) )
(assert (and (not (= l1 Nil))) )
(assert (and (not (= l1 l1))) )
(assert (and (= l2 Nil) (is-Nil l2)) )
(assert (and (not (= l1 Nil))) )
(assert (and (and (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l1 Nil) (is-Nil l1)) (and (= l2 l3)))) )
