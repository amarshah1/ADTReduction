...
(assert (and (or (and (is-Nil l3) (= l3 Nil)) (and (= l1 l0)) (and (= l1 l1)) (and (is-Nil Nil) (= Nil Nil)))) )
...
(assert (and (= l3 l0)) )
(assert (and (and (and (is-Cons l0) (= l0 (Cons cv4 cv5)) (= cv4 (Head l0)) (= cv5 (Tail l0))) (and (is-Nil Nil) (= Nil Nil)) (and (= l3 Nil) (is-Nil l3)))) )
