...
(assert (and (or (and (= l3 l0)) (and (is-Nil l2) (= l2 Nil)) (and (= l0 Nil) (is-Nil l0)) (and (= l3 l0)))) )
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (= l1 Nil) (is-Nil l1)) )
(assert (and (or (and (= l3 l0)) (and (= l3 l0)) (and (= l1 Nil) (is-Nil l1)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (not (= l2 Nil))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (and (and (= l1 l3)) (and (is-Nil Nil) (= Nil Nil)) (and (= l0 Nil) (is-Nil l0)))) )
