...
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l2 Nil) (is-Nil l2)) (and (= l2 Nil) (is-Nil l2)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (not (= l3 Nil))) )
(assert (and (not (= l3 l3))) )
(assert (and (= l3 Nil) (is-Nil l3)) )
(assert (and (or (and (is-Nil l3) (= l3 Nil)) (and (= l1 l0)) (and (= l1 l3)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))))) )
