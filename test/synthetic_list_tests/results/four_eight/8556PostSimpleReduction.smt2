...
(assert (and (or (and (is-Nil l2) (= l2 Nil)) (and (= l2 l3)) (and (= l0 Nil) (is-Nil l0)) (and (= l1 l3)))) )
...
(assert (and (and (and (is-Cons l1) (= l1 (Cons cv4 cv5)) (= cv4 (Head l1)) (= cv5 (Tail l1))) (and (= l2 l3)))) )
