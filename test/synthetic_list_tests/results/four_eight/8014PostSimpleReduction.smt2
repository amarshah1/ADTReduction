...
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l1 l3)) (and (= l0 Nil) (is-Nil l0)) (and (is-Cons l1) (= l1 (Cons cv2 cv3)) (= cv2 (Head l1)) (= cv3 (Tail l1))))) )
(assert (and (or (and (= l3 l0)) (and (= l1 l3)) (and (is-Cons l1) (= l1 (Cons cv4 cv5)) (= cv4 (Head l1)) (= cv5 (Tail l1))))) )
(assert (and (and (and (= l2 l3)) (and (= l3 Nil) (is-Nil l3)) (and (= l3 l2)))) )
(assert (and (and (and (= l0 l2)) (and (= l1 Nil) (is-Nil l1)) (and (= l0 Nil) (is-Nil l0)))) )
