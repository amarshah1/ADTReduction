...
(assert (and (or (and (= l1 l1)) (and (= l0 l2)) (and (is-Nil l3) (= l3 Nil)) (and (is-Nil l1) (= l1 Nil)))) )
(assert (and (is-Nil l1) (= l1 Nil)) )
(assert (and (not (= l2 Nil))) )
(assert (and (and (and (= l3 l2)) (and (is-Cons l3) (= l3 (Cons cv0 cv1)) (= cv0 (Head l3)) (= cv1 (Tail l3))))) )
