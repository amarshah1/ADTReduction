...
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l2 l1)) (and (= l2 Nil) (is-Nil l2)))) )
...
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons l3) (= l3 (Cons cv2 cv3)) (= cv2 (Head l3)) (= cv3 (Tail l3))) (and (= l2 l1)))) )
