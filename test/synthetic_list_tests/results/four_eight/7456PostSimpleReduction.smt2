...
(assert (and (or (and (is-Nil l3) (= l3 Nil)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l0 l1)))) )
(assert (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) )
(assert (and (and (and (= l1 l3)) (and (= l0 l2)))) )
(assert (and (or (and (is-Nil l1) (= l1 Nil)) (and (= l0 l3)) (and (= l1 Nil) (is-Nil l1)))) )
