...
(assert (and (and (and (= l1 l3)) (and (= l1 Nil) (is-Nil l1)) (and (= l3 Nil) (is-Nil l3)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (not (= l1 Nil))) )
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l1 l3)) (and (= l0 Nil) (is-Nil l0)) (and (= l2 Nil) (is-Nil l2)))) )
