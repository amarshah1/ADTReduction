...
(assert (and (or (and (= l1 l1)) (and (= l3 l2)) (and (is-Cons l1) (= l1 (Cons cv0 cv1)) (= cv0 (Head l1)) (= cv1 (Tail l1))))) )
(assert (and (not (is-Cons Nil))) )
(assert (and (= l3 Nil) (is-Nil l3)) )
(assert (and (= l0 Nil) (is-Nil l0)) )
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (is-Nil Nil) (= Nil Nil)) (and (= l1 l0)) (and (= l3 Nil) (is-Nil l3)))) )
