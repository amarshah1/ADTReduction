...
(assert (and (or (and (is-Nil l2) (= l2 Nil)) (and (= l2 l3)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (and (and (= l0 l0)) (and (= l3 Nil) (is-Nil l3)) (and (= l3 Nil) (is-Nil l3)) (and (is-Nil Nil) (= Nil Nil)))) )
