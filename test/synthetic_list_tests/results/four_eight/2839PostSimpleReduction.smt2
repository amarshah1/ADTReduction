...
(assert (and (or (and (= l1 l2)) (and (= l1 Nil) (is-Nil l1)) (and (is-Nil l0) (= l0 Nil)))) )
(assert (and (= l3 l3)) )
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (= l1 l0)) (and (= l1 l2)))) )
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (is-Nil l0) (= l0 Nil)) (and (= l0 Nil) (is-Nil l0)) (and (= l0 l1)))) )
