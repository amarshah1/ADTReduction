...
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l3 l3)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))))) )
(assert (and (= l3 Nil) (is-Nil l3)) )
(assert (and (not (is-Cons l3))) )
(assert (and (is-Nil l3) (= l3 Nil)) )
(assert (and (= l1 l1)) )
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l1 l1)) (and (= l0 l3)))) )
