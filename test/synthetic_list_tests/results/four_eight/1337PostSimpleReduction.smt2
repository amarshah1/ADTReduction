...
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l1 l3)) (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) (and (= l0 l0)))) )
(assert (and (= l0 l2)) )
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (= l0 Nil) (is-Nil l0)) (and (= l0 l0)) (and (= l0 Nil) (is-Nil l0)))) )
