...
(assert (and (and (and (is-Nil l1) (= l1 Nil)) (and (= l2 Nil) (is-Nil l2)) (and (= l3 l1)) (and (= l0 l1)))) )
(assert (and (= l2 Nil) (is-Nil l2)) )
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (and (and (= l3 l0)) (and (is-Nil Nil) (= Nil Nil)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (or (and (is-Nil l2) (= l2 Nil)) (and (is-Nil l0) (= l0 Nil)) (and (is-Nil l3) (= l3 Nil)))) )
(assert (and (and (and (= l0 l3)) (and (= l1 l2)) (and (= l3 l3)))) )
