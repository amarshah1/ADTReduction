...
(assert (and (or (and (is-Nil l2) (= l2 Nil)) (and (is-Nil Nil) (= Nil Nil)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (is-Cons l2) (= l2 (Cons cv0 cv1)) (= cv0 (Head l2)) (= cv1 (Tail l2))) )
(assert (and (or (and (= l2 l2)) (and (is-Nil l0) (= l0 Nil)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (is-Nil l3) (= l3 Nil)) )
(assert (and (= l0 l3)) )
(assert (and (or (and (= l3 l0)) (and (= l3 Nil) (is-Nil l3)) (and (is-Nil l2) (= l2 Nil)) (and (= l0 Nil) (is-Nil l0)))) )
