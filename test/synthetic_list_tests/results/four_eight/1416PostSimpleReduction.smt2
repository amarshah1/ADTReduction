...
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil l1) (= l1 Nil)) (and (= l1 l0)))) )
...
(assert (and (= l1 l3)) )
(assert (and (or (and (= l0 l2)) (and (is-Nil l2) (= l2 Nil)) (and (= l2 l3)))) )
(assert (and (and (and (= l0 l1)) (and (= l3 l1)))) )
