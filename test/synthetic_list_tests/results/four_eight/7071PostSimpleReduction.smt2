...
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l0 Nil) (is-Nil l0)) (and (= l1 l0)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (or (and (= l1 l1)) (and (= l1 l3)) (and (= l0 Nil) (is-Nil l0)) (and (= l1 Nil) (is-Nil l1)))) )
...
(assert (and (and (and (is-Cons l3) (= l3 (Cons cv4 cv5)) (= cv4 (Head l3)) (= cv5 (Tail l3))) (and (is-Nil l2) (= l2 Nil)) (and (= l0 Nil) (is-Nil l0)) (and (is-Cons l3) (= l3 (Cons cv6 cv7)) (= cv6 (Head l3)) (= cv7 (Tail l3))))) )
