...
(assert (and (and (and (is-Nil l2) (= l2 Nil)) (and (= l1 l0)) (and (= l3 l1)))) )
...
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) (and (= l2 l0)) (and (= l0 Nil) (is-Nil l0)) (and (= l2 l2)))) )
