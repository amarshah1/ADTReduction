...
(assert (and (and (and (= l2 l1)) (and (= l2 Nil) (is-Nil l2)) (and (= l3 l3)))) )
...
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l0 Nil) (is-Nil l0)) (and (= l2 l0)) (and (= l3 l0)))) )
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons l3) (= l3 (Cons cv4 cv5)) (= cv4 (Head l3)) (= cv5 (Tail l3))) (and (is-Nil Nil) (= Nil Nil)))) )
