...
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (is-Cons l3) (= l3 (Cons cv2 cv3)) (= cv2 (Head l3)) (= cv3 (Tail l3))) (and (= l2 l3)) (and (= l0 l3)))) )
(assert (and (or (and (= l1 l0)) (and (= l1 l2)) (and (= l1 l3)))) )
