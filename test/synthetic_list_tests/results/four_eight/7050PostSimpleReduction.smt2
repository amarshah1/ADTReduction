...
(assert (and (and (and (= l0 l3)) (and (= l0 Nil) (is-Nil l0)) (and (= l3 l1)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (= l3 Nil) (is-Nil l3)) (and (= l0 l3)) (and (= l2 Nil) (is-Nil l2)))) )
