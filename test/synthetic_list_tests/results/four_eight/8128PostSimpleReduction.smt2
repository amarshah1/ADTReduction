...
(assert (and (or (and (= l0 l2)) (and (= l1 Nil) (is-Nil l1)) (and (= l0 Nil) (is-Nil l0)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (or (and (is-Nil l2) (= l2 Nil)) (and (= l1 Nil) (is-Nil l1)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (not (is-Nil l3))) )
(assert (and (is-Nil l0) (= l0 Nil)) )
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l3 l2)) (and (is-Cons l3) (= l3 (Cons cv0 cv1)) (= cv0 (Head l3)) (= cv1 (Tail l3))) (and (= l0 Nil) (is-Nil l0)))) )
