...
(assert (and (or (and (is-Cons l0) (= l0 (Cons cv0 cv1)) (= cv0 (Head l0)) (= cv1 (Tail l0))) (and (= l0 Nil) (is-Nil l0)) (and (is-Nil l0) (= l0 Nil)) (and (= l1 l1)))) )
(assert (and (= l2 l0)) )
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (is-Nil Nil) (= Nil Nil)) (and (= l0 l2)) (and (= l3 l3)))) )
