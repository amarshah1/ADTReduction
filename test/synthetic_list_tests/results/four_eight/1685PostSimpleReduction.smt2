...
(assert (and (and (and (is-Cons l3) (= l3 (Cons cv2 cv3)) (= cv2 (Head l3)) (= cv3 (Tail l3))) (and (= l3 l1)) (and (= l2 Nil) (is-Nil l2)) (and (= l2 l3)))) )
(assert (and (= l3 Nil) (is-Nil l3)) )
(assert (and (and (and (= l1 l2)) (and (= l2 Nil) (is-Nil l2)) (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) (and (= l1 l2)))) )
