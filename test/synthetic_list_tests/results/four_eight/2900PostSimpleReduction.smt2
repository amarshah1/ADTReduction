...
(assert (and (or (and (is-Cons l0) (= l0 (Cons cv2 cv3)) (= cv2 (Head l0)) (= cv3 (Tail l0))) (and (= l2 l1)) (and (= l1 l0)) (and (= l2 l1)))) )
(assert (and (not (is-Nil Nil))) )
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (= l2 l0)) (and (= l1 l1)))) )
