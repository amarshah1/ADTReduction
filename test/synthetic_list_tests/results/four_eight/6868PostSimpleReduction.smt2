...
(assert (and (and (and (= l3 l1)) (and (is-Nil l2) (= l2 Nil)) (and (= l3 l1)) (and (= l1 l0)))) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) (and (= l1 l1)))) )
