...
(assert (and (or (and (= l3 l3)) (and (= l2 l1)) (and (= l1 Nil) (is-Nil l1)) (and (= l0 l3)))) )
...
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons l0) (= l0 (Cons cv2 cv3)) (= cv2 (Head l0)) (= cv3 (Tail l0))))) )
