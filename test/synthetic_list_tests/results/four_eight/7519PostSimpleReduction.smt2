...
(assert (and (= l3 Nil) (is-Nil l3)) )
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l3 l2)) (and (= l0 Nil) (is-Nil l0)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))))) )
(assert (and (and (and (= l2 l3)) (and (= l0 l1)) (and (is-Nil l0) (= l0 Nil)) (and (= l2 Nil) (is-Nil l2)))) )
