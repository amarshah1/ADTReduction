...
(assert (and (and (and (= l1 l0)) (and (= l3 l1)) (and (is-Nil l0) (= l0 Nil)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (not (= l3 Nil))) )
(assert (and (not (= l3 Nil))) )
(assert (and (and (and (= l0 l2)) (and (= l3 Nil) (is-Nil l3)) (and (= l0 Nil) (is-Nil l0)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (= l2 l0)) )
