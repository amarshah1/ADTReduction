...
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil l2) (= l2 Nil)) (and (= l0 l0)))) )
(assert (and (is-Nil l3) (= l3 Nil)) )
(assert (and (not (= l1 Nil))) )
(assert (and (= l0 Nil) (is-Nil l0)) )
(assert (and (and (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l2 l3)) (and (= l1 l3)))) )
(assert (and (not (= l1 Nil))) )
