...
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l0 l1)) (and (= l1 Nil) (is-Nil l1)) (and (= l0 l2)))) )
(assert (and (is-Nil l2) (= l2 Nil)) )
(assert (and (and (and (= l2 l2)) (and (= l1 l0)) (and (= l0 Nil) (is-Nil l0)) (and (is-Cons l1) (= l1 (Cons cv2 cv3)) (= cv2 (Head l1)) (= cv3 (Tail l1))))) )
