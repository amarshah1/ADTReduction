...
(assert (and (= l3 Nil) (is-Nil l3)) )
(assert (and (and (and (is-Nil l0) (= l0 Nil)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l0 l3)) (and (= l2 Nil) (is-Nil l2)))) )
...
(assert (and (and (and (is-Cons l0) (= l0 (Cons cv6 cv7)) (= cv6 (Head l0)) (= cv7 (Tail l0))) (and (is-Nil Nil) (= Nil Nil)) (and (= l1 l2)) (and (is-Nil Nil) (= Nil Nil)))) )
