...
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l3 Nil) (is-Nil l3)) (and (is-Cons l0) (= l0 (Cons cv0 cv1)) (= cv0 (Head l0)) (= cv1 (Tail l0))) (and (= l2 Nil) (is-Nil l2)))) )
...
(assert (and (or (and (is-Nil l2) (= l2 Nil)) (and (= l3 l3)) (and (= l3 l3)))) )
(assert (and (not (is-Cons l3))) )
(assert (and (is-Cons Nil) (= Nil (Cons cv8 cv9)) (= cv8 (Head Nil)) (= cv9 (Tail Nil))) )
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l3 Nil) (is-Nil l3)) (and (is-Cons l1) (= l1 (Cons cv10 cv11)) (= cv10 (Head l1)) (= cv11 (Tail l1))) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (is-Cons l1) (= l1 (Cons cv12 cv13)) (= cv12 (Head l1)) (= cv13 (Tail l1))) (and (is-Cons l2) (= l2 (Cons cv14 cv15)) (= cv14 (Head l2)) (= cv15 (Tail l2))) (and (is-Cons l3) (= l3 (Cons cv16 cv17)) (= cv16 (Head l3)) (= cv17 (Tail l3))))) )
