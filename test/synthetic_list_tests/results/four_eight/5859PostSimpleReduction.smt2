...
(assert (and (= l3 l1)) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l2 l0)) (and (= l1 l2)))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l3 l3)))) )
