...
(assert (and (and (and (= l3 l2)) (and (= l2 l1)) (and (= l0 l2)))) )
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l0 l0)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))))) )
(assert (and (= l3 l0)) )
(assert (and (= l3 l2)) )
