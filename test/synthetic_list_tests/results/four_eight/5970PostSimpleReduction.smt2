...
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (is-Nil Nil) (= Nil Nil)) (and (= l2 l0)))) )
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l2 Nil) (is-Nil l2)) (and (= l0 l3)) (and (is-Nil l1) (= l1 Nil)))) )
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l2 l3)))) )
(assert (and (= l3 Nil) (is-Nil l3)) )
(assert (and (or (and (= l3 l2)) (and (is-Nil Nil) (= Nil Nil)) (and (= l2 l1)))) )
