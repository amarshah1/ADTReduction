...
(assert (and (or (and (= l3 l1)) (and (= l3 Nil) (is-Nil l3)) (and (= l2 l0)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l0 Nil) (is-Nil l0)) (and (is-Cons l1) (= l1 (Cons cv4 cv5)) (= cv4 (Head l1)) (= cv5 (Tail l1))))) )
