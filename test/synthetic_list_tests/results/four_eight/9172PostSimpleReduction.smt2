...
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (is-Cons l0) (= l0 (Cons cv0 cv1)) (= cv0 (Head l0)) (= cv1 (Tail l0))) (and (= l0 l3)) (and (= l2 Nil) (is-Nil l2)))) )
...
(assert (and (and (and (= l1 l3)) (and (is-Nil Nil) (= Nil Nil)) (and (= l0 l0)) (and (is-Cons Nil) (= Nil (Cons cv8 cv9)) (= cv8 (Head Nil)) (= cv9 (Tail Nil))))) )
