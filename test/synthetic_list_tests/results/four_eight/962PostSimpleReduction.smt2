...
(assert (and (or (and (is-Nil l0) (= l0 Nil)) (and (= l2 l3)) (and (is-Nil l1) (= l1 Nil)) (and (= l0 l3)))) )
(assert (and (= l3 Nil) (is-Nil l3)) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (= l0 Nil) (is-Nil l0)) )
(assert (and (and (and (= l1 l1)) (and (= l1 Nil) (is-Nil l1)) (and (is-Nil Nil) (= Nil Nil)) (and (= l2 Nil) (is-Nil l2)))) )
