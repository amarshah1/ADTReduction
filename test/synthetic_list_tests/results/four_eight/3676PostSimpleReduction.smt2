...
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l3 l0)) (and (is-Cons l1) (= l1 (Cons cv4 cv5)) (= cv4 (Head l1)) (= cv5 (Tail l1))) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (not (is-Cons Nil))) )
(assert (and (and (and (= l3 l1)) (and (= l3 Nil) (is-Nil l3)) (and (is-Cons Nil) (= Nil (Cons cv6 cv7)) (= cv6 (Head Nil)) (= cv7 (Tail Nil))))) )
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (is-Cons Nil) (= Nil (Cons cv8 cv9)) (= cv8 (Head Nil)) (= cv9 (Tail Nil))))) )
(assert (and (and (and (= l1 l1)) (and (is-Nil l1) (= l1 Nil)) (and (= l0 l1)) (and (= l1 l0)))) )
