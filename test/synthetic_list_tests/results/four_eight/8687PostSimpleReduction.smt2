...
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l3 l3)) (and (= l3 Nil) (is-Nil l3)) (and (is-Nil Nil) (= Nil Nil)))) )
...
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l2 l3)) (and (= l2 Nil) (is-Nil l2)))) )
