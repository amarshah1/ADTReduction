...
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (is-Cons l2) (= l2 (Cons cv0 cv1)) (= cv0 (Head l2)) (= cv1 (Tail l2))) (and (= l3 l3)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (not (= l1 Nil))) )
(assert (and (or (and (= l2 l3)) (and (= l0 l0)) (and (= l1 l3)) (and (is-Cons l0) (= l0 (Cons cv2 cv3)) (= cv2 (Head l0)) (= cv3 (Tail l0))))) )
