...
(assert (and (or (and (is-Cons l2) (= l2 (Cons cv0 cv1)) (= cv0 (Head l2)) (= cv1 (Tail l2))) (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil l0) (= l0 Nil)))) )
(assert (and (not (= l2 l0))) )
(assert (and (= l0 Nil) (is-Nil l0)) )
(assert (and (and (and (= l2 l1)) (and (is-Nil Nil) (= Nil Nil)) (and (= l3 l1)))) )
(assert (and (or (and (= l3 l3)) (and (= l2 l1)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l2 Nil) (is-Nil l2)))) )
