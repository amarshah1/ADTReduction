...
(assert (and (or (and (= l3 l0)) (and (= l2 l3)) (and (= l2 l2)))) )
(assert (and (not (is-Cons Nil))) )
(assert (and (not (= l1 Nil))) )
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l0 Nil) (is-Nil l0)) (and (is-Cons l0) (= l0 (Cons cv6 cv7)) (= cv6 (Head l0)) (= cv7 (Tail l0))))) )
