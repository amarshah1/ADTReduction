...
(assert (and (or (and (is-Cons l0) (= l0 (Cons cv2 cv3)) (= cv2 (Head l0)) (= cv3 (Tail l0))) (and (= l3 Nil) (is-Nil l3)) (and (is-Nil l2) (= l2 Nil)))) )
(assert (and (= l0 Nil) (is-Nil l0)) )
(assert (and (= l3 Nil) (is-Nil l3)) )
(assert (and (= l2 Nil) (is-Nil l2)) )
(assert (and (= l1 Nil) (is-Nil l1)) )
(assert (and (and (and (= l0 l0)) (and (= l3 Nil) (is-Nil l3)) (and (= l2 l0)))) )
