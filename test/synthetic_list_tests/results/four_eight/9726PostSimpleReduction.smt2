...
(assert (and (and (and (= l2 l1)) (and (is-Cons l0) (= l0 (Cons cv0 cv1)) (= cv0 (Head l0)) (= cv1 (Tail l0))) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (not (= l0 Nil))) )
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l1 l2)) (and (is-Nil Nil) (= Nil Nil)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (is-Nil l0) (= l0 Nil)) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l0 Nil) (is-Nil l0)) (and (= l1 Nil) (is-Nil l1)) (and (= l2 l2)))) )
