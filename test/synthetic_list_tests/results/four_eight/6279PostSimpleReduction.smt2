...
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (is-Cons l0) (= l0 (Cons cv0 cv1)) (= cv0 (Head l0)) (= cv1 (Tail l0))) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (= l2 l2)) )
...
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l0 l2)) (and (= l2 l2)))) )
(assert (and (is-Nil l1) (= l1 Nil)) )
(assert (and (is-Cons l1) (= l1 (Cons cv4 cv5)) (= cv4 (Head l1)) (= cv5 (Tail l1))) )
(assert (and (or (and (= l1 l3)) (and (= l1 Nil) (is-Nil l1)) (and (= l1 l1)))) )
