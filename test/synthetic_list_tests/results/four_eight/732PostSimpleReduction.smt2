...
(assert (and (or (and (= l1 l0)) (and (= l1 l1)))) )
...
(assert (and (and (and (= l1 l3)) (and (is-Nil l2) (= l2 Nil)) (and (= l1 Nil) (is-Nil l1)) (and (is-Cons Nil) (= Nil (Cons cv6 cv7)) (= cv6 (Head Nil)) (= cv7 (Tail Nil))))) )
