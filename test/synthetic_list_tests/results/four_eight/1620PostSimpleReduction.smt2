...
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l2 l3)) (and (= l1 l1)))) )
(assert (and (not (is-Cons Nil))) )
(assert (and (is-Cons l3) (= l3 (Cons cv0 cv1)) (= cv0 (Head l3)) (= cv1 (Tail l3))) )
(assert (and (not (= l3 l3))) )
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (is-Cons l1) (= l1 (Cons cv2 cv3)) (= cv2 (Head l1)) (= cv3 (Tail l1))) (and (= l0 l3)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (or (and (is-Nil l1) (= l1 Nil)) (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) (and (is-Nil l1) (= l1 Nil)) (and (= l1 l2)))) )
