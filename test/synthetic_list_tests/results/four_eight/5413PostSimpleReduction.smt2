...
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l2 l2)) (and (= l3 l1)))) )
...
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l0 Nil) (is-Nil l0)) (and (= l1 l0)) (and (= l3 Nil) (is-Nil l3)))) )
