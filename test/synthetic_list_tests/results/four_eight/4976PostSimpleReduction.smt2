...
(assert (and (and (and (= l0 l2)) (and (= l1 Nil) (is-Nil l1)) (and (= l1 Nil) (is-Nil l1)))) )
...
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l3 l1)) (and (is-Nil Nil) (= Nil Nil)) (and (= l2 Nil) (is-Nil l2)))) )
