...
(assert (and (or (and (= l1 l1)) (and (= l0 l2)) (and (= l2 l0)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (is-Cons Nil) (= Nil (Cons cv6 cv7)) (= cv6 (Head Nil)) (= cv7 (Tail Nil))) )
(assert (and (not (is-Nil Nil))) )
(assert (and (= l1 l1)) )
(assert (and (or (and (is-Nil l3) (= l3 Nil)) (and (is-Cons Nil) (= Nil (Cons cv8 cv9)) (= cv8 (Head Nil)) (= cv9 (Tail Nil))) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l2 l0)) (and (= l0 Nil) (is-Nil l0)) (and (is-Nil Nil) (= Nil Nil)))) )
