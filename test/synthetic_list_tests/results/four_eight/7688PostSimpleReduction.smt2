...
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) (and (= l2 l3)))) )
(assert (and (is-Nil l0) (= l0 Nil)) )
(assert (and (not (= l0 l2))) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l1 l3)) (and (= l1 l0)) (and (is-Cons Nil) (= Nil (Cons cv6 cv7)) (= cv6 (Head Nil)) (= cv7 (Tail Nil))))) )
(assert (and (= l2 l2)) )
