...
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (is-Cons Nil) (= Nil (Cons cv6 cv7)) (= cv6 (Head Nil)) (= cv7 (Tail Nil))) (and (is-Cons l1) (= l1 (Cons cv8 cv9)) (= cv8 (Head l1)) (= cv9 (Tail l1))) (and (= l3 Nil) (is-Nil l3)))) )
...
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l1 l0)) (and (is-Cons l1) (= l1 (Cons cv12 cv13)) (= cv12 (Head l1)) (= cv13 (Tail l1))))) )
(assert (and (and (and (is-Cons l3) (= l3 (Cons cv14 cv15)) (= cv14 (Head l3)) (= cv15 (Tail l3))) (and (= l1 l0)) (and (= l3 Nil) (is-Nil l3)))) )
