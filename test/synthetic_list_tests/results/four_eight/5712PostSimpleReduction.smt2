...
(assert (and (and (and (= l3 l2)) (and (= l0 Nil) (is-Nil l0)) (and (= l0 Nil) (is-Nil l0)) (and (= l3 l1)))) )
...
(assert (and (= l3 Nil) (is-Nil l3)) )
(assert (and (and (and (= l2 l1)) (and (is-Cons l0) (= l0 (Cons cv4 cv5)) (= cv4 (Head l0)) (= cv5 (Tail l0))))) )
