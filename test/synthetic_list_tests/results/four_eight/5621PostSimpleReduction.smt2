...
(assert (and (and (and (= l3 l0)) (and (= l3 l3)) (and (= l0 l0)))) )
(assert (and (not (= l3 Nil))) )
(assert (and (not (= l3 l1))) )
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l2 Nil) (is-Nil l2)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l1 l0)))) )
