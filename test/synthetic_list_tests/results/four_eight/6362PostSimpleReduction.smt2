...
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l1 l2)) (and (= l1 l1)))) )
(assert (and (not (= l3 Nil))) )
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) (and (= l0 l3)) (and (= l1 Nil) (is-Nil l1)))) )
