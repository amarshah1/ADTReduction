...
(assert (and (is-Nil l0) (= l0 Nil)) )
(assert (and (and (and (= l1 l0)) (and (= l3 l2)) (and (= l3 Nil) (is-Nil l3)))) )
...
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (is-Nil Nil) (= Nil Nil)) (and (= l1 l0)) (and (is-Nil Nil) (= Nil Nil)))) )
