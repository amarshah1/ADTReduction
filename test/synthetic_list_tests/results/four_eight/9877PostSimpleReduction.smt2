...
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l0 Nil) (is-Nil l0)) (and (is-Cons l0) (= l0 (Cons cv2 cv3)) (= cv2 (Head l0)) (= cv3 (Tail l0))))) )
(assert (and (is-Cons l0) (= l0 (Cons cv4 cv5)) (= cv4 (Head l0)) (= cv5 (Tail l0))) )
(assert (and (not (= l1 Nil))) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l1 l1)) (and (= l3 Nil) (is-Nil l3)) (and (= l1 l0)))) )
