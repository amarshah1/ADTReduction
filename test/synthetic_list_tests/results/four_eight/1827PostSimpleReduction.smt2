...
(assert (and (or (and (= l2 l3)) (and (= l0 Nil) (is-Nil l0)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (is-Cons l3) (= l3 (Cons cv4 cv5)) (= cv4 (Head l3)) (= cv5 (Tail l3))))) )
(assert (and (not (= l1 Nil))) )
(assert (and (= l0 Nil) (is-Nil l0)) )
(assert (and (= l2 Nil) (is-Nil l2)) )
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (= l2 l2)) (and (is-Cons Nil) (= Nil (Cons cv6 cv7)) (= cv6 (Head Nil)) (= cv7 (Tail Nil))) (and (is-Nil Nil) (= Nil Nil)))) )
