...
(assert (and (= l0 l3)) )
(assert (and (or (and (= l0 l1)) (and (= l0 Nil) (is-Nil l0)) (and (is-Nil l3) (= l3 Nil)) (and (= l1 l3)))) )
(assert (and (= l0 Nil) (is-Nil l0)) )
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l2 Nil) (is-Nil l2)) (and (is-Cons l2) (= l2 (Cons cv2 cv3)) (= cv2 (Head l2)) (= cv3 (Tail l2))) (and (= l2 l3)))) )
