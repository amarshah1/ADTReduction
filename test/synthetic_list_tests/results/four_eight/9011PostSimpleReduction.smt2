...
(assert (and (or (and (is-Cons l2) (= l2 (Cons cv2 cv3)) (= cv2 (Head l2)) (= cv3 (Tail l2))) (and (= l3 l1)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil l1) (= l1 Nil)) (and (is-Nil l0) (= l0 Nil)))) )
