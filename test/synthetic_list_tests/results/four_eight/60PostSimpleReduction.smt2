...
(assert (and (or (and (is-Nil l2) (= l2 Nil)) (and (= l0 Nil) (is-Nil l0)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))))) )
...
(assert (and (= l3 l0)) )
(assert (and (or (and (= l0 l2)) (and (is-Nil Nil) (= Nil Nil)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (is-Cons l1) (= l1 (Cons cv4 cv5)) (= cv4 (Head l1)) (= cv5 (Tail l1))) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (= l3 l3)) (and (= l1 Nil) (is-Nil l1)) (and (= l3 l3)))) )
