...
(assert (and (or (and (is-Cons l0) (= l0 (Cons cv0 cv1)) (= cv0 (Head l0)) (= cv1 (Tail l0))) (and (is-Cons l2) (= l2 (Cons cv2 cv3)) (= cv2 (Head l2)) (= cv3 (Tail l2))))) )
(assert (and (= l3 l0)) )
(assert (and (or (and (= l0 l1)) (and (= l0 l0)) (and (= l1 Nil) (is-Nil l1)))) )
