...
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) (and (is-Nil Nil) (= Nil Nil)) (and (= l1 Nil) (is-Nil l1)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l0 l2)) (and (= l0 Nil) (is-Nil l0)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (or (and (= l1 l2)) (and (= l0 Nil) (is-Nil l0)) (and (= l3 l0)) (and (is-Cons Nil) (= Nil (Cons cv6 cv7)) (= cv6 (Head Nil)) (= cv7 (Tail Nil))))) )
(assert (and (= l3 l0)) )
(assert (and (is-Nil l3) (= l3 Nil)) )
(assert (and (or (and (= l3 l0)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (and (and (= l3 l0)) (and (= l1 l3)) (and (= l2 Nil) (is-Nil l2)) (and (is-Cons Nil) (= Nil (Cons cv8 cv9)) (= cv8 (Head Nil)) (= cv9 (Tail Nil))))) )
