...
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l2 l1)) (and (is-Nil l3) (= l3 Nil)))) )
(assert (and (and (and (= l1 l0)) (and (= l2 l0)) (and (is-Cons l0) (= l0 (Cons cv0 cv1)) (= cv0 (Head l0)) (= cv1 (Tail l0))))) )
