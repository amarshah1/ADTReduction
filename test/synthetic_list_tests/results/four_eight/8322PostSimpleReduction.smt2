...
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l2 l1)))) )
...
(assert (and (or (and (is-Nil l2) (= l2 Nil)) (and (= l1 l3)) (and (= l3 l1)))) )
