...
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l3 Nil) (is-Nil l3)) (and (is-Nil l1) (= l1 Nil)) (and (= l1 Nil) (is-Nil l1)))) )
...
(assert (and (or (and (= l2 l1)) (and (= l3 l1)) (and (= l2 Nil) (is-Nil l2)))) )
