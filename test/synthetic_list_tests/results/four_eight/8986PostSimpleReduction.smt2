...
(assert (and (or (and (= l0 l2)) (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))))) )
(assert (and (not (= l1 Nil))) )
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l3 l1)) (and (is-Cons Nil) (= Nil (Cons cv6 cv7)) (= cv6 (Head Nil)) (= cv7 (Tail Nil))))) )
