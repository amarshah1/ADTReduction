...
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l2 l0)) (and (= l1 Nil) (is-Nil l1)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))))) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l1 Nil) (is-Nil l1)) (and (= l3 l3)) (and (= l2 l0)))) )
(assert (and (= l0 l1)) )
(assert (and (not (= l2 Nil))) )
(assert (and (= l3 Nil) (is-Nil l3)) )
(assert (and (and (and (= l0 l2)) (and (= l3 Nil) (is-Nil l3)) (and (= l3 l1)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (= l3 Nil) (is-Nil l3)) )
(assert (and (= l3 l2)) )
