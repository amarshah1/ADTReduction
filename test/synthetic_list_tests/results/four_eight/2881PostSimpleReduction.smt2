...
(assert (and (or (and (= l1 l1)) (and (= l0 Nil) (is-Nil l0)) (and (= l2 l1)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (= l0 Nil) (is-Nil l0)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))))) )
(assert (and (= l2 l3)) )
