...
(assert (and (and (and (is-Nil l1) (= l1 Nil)) (and (is-Cons l2) (= l2 (Cons cv0 cv1)) (= cv0 (Head l2)) (= cv1 (Tail l2))) (and (= l2 Nil) (is-Nil l2)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (= l3 l2)) )
(assert (and (= l2 Nil) (is-Nil l2)) )
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (= l1 l3)) (and (= l0 Nil) (is-Nil l0)) (and (is-Cons l0) (= l0 (Cons cv2 cv3)) (= cv2 (Head l0)) (= cv3 (Tail l0))))) )
