...
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l2 l1)) (and (= l1 l3)))) )
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l2 l2)))) )
(assert (and (= l3 l3)) )
(assert (and (not (= l3 l3))) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l3 Nil) (is-Nil l3)) (and (= l0 l1)) (and (= l2 Nil) (is-Nil l2)))) )
