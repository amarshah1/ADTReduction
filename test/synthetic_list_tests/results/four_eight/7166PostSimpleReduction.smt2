...
(assert (and (and (and (= l1 l1)) (and (is-Cons l0) (= l0 (Cons cv2 cv3)) (= cv2 (Head l0)) (= cv3 (Tail l0))) (and (= l2 Nil) (is-Nil l2)) (and (is-Nil Nil) (= Nil Nil)))) )
...
(assert (and (or (and (= l1 l3)) (and (= l3 Nil) (is-Nil l3)) (and (= l1 l3)))) )
