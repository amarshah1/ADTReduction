...
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (= l2 Nil) (is-Nil l2)) (and (= l1 l1)) (and (is-Nil Nil) (= Nil Nil)))) )
...
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l1 l2)) (and (is-Cons l1) (= l1 (Cons cv2 cv3)) (= cv2 (Head l1)) (= cv3 (Tail l1))))) )
(assert (and (or (and (= l1 l0)) (and (= l1 Nil) (is-Nil l1)) (and (is-Nil Nil) (= Nil Nil)) (and (= l1 l3)))) )
