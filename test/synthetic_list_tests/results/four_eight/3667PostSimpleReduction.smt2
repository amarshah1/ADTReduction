...
(assert (and (and (and (= l1 l2)) (and (is-Cons l0) (= l0 (Cons cv2 cv3)) (= cv2 (Head l0)) (= cv3 (Tail l0))))) )
(assert (and (is-Nil l2) (= l2 Nil)) )
(assert (and (and (and (= l1 l0)) (and (is-Cons l0) (= l0 (Cons cv4 cv5)) (= cv4 (Head l0)) (= cv5 (Tail l0))) (and (= l3 Nil) (is-Nil l3)))) )
...
(assert (and (or (and (= l2 l0)) (and (= l0 Nil) (is-Nil l0)) (and (= l1 l3)) (and (= l3 Nil) (is-Nil l3)))) )
