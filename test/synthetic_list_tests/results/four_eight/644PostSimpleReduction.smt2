...
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (is-Cons l2) (= l2 (Cons cv6 cv7)) (= cv6 (Head l2)) (= cv7 (Tail l2))) (and (is-Cons Nil) (= Nil (Cons cv8 cv9)) (= cv8 (Head Nil)) (= cv9 (Tail Nil))))) )
(assert (and (and (and (is-Cons l2) (= l2 (Cons cv10 cv11)) (= cv10 (Head l2)) (= cv11 (Tail l2))) (and (is-Cons Nil) (= Nil (Cons cv12 cv13)) (= cv12 (Head Nil)) (= cv13 (Tail Nil))) (and (is-Cons Nil) (= Nil (Cons cv14 cv15)) (= cv14 (Head Nil)) (= cv15 (Tail Nil))))) )
