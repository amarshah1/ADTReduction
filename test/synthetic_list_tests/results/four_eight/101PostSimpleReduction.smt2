...
(assert (and (and (and (= l1 l2)) (and (is-Nil Nil) (= Nil Nil)) (and (= l0 l0)))) )
(assert (and (= l1 Nil) (is-Nil l1)) )
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (= l3 l1)) (and (= l2 l2)))) )
(assert (and (or (and (= l3 l2)) (and (= l1 l2)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))))) )
