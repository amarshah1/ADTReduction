...
(assert (and (or (and (= l1 l0)) (and (is-Nil l3) (= l3 Nil)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l2 l2)))) )
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (= l3 l1)))) )
(assert (and (not (= l3 l0))) )
(assert (and (= l3 l1)) )
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l0 Nil) (is-Nil l0)) (and (= l1 l3)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (is-Nil l1) (= l1 Nil)) )
