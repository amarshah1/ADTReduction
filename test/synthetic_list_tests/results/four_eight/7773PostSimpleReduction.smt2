...
(assert (and (or (and (is-Cons l0) (= l0 (Cons cv4 cv5)) (= cv4 (Head l0)) (= cv5 (Tail l0))) (and (is-Nil Nil) (= Nil Nil)) (and (= l0 l0)))) )
(assert (and (is-Nil l1) (= l1 Nil)) )
(assert (and (= l2 l3)) )
(assert (and (not (is-Cons Nil))) )
(assert (and (and (and (= l2 l3)) (and (= l3 Nil) (is-Nil l3)) (and (= l2 Nil) (is-Nil l2)) (and (is-Nil Nil) (= Nil Nil)))) )
