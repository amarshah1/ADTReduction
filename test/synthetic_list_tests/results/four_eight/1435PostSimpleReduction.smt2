...
(assert (and (and (and (= l2 l2)) (and (is-Nil l0) (= l0 Nil)))) )
...
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (is-Nil l0) (= l0 Nil)) (and (is-Nil Nil) (= Nil Nil)) (and (= l0 l1)))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (is-Nil l2) (= l2 Nil)) )
(assert (and (and (and (is-Nil l2) (= l2 Nil)) (and (= l0 l2)) (and (= l0 Nil) (is-Nil l0)))) )
