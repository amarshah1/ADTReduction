...
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l0 l2)) (and (= l2 Nil) (is-Nil l2)) (and (is-Nil Nil) (= Nil Nil)))) )
...
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil Nil) (= Nil Nil)) (and (= l2 l2)) (and (= l1 l0)))) )
