...
(assert (and (and (and (= l0 l3)) (and (= l0 Nil) (is-Nil l0)) (and (is-Cons l2) (= l2 (Cons cv0 cv1)) (= cv0 (Head l2)) (= cv1 (Tail l2))) (and (= l1 l3)))) )
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l2 l0)) (and (is-Nil l0) (= l0 Nil)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) )
(assert (and (= l1 Nil) (is-Nil l1)) )
(assert (and (not (= l3 l3))) )
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l0 l0)) (and (= l2 Nil) (is-Nil l2)) (and (= l1 l2)))) )
