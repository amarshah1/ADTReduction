...
(assert (and (and (and (is-Nil l1) (= l1 Nil)) (and (= l0 l2)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))))) )
...
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l1 l1)) (and (= l2 Nil) (is-Nil l2)) (and (= l0 l2)))) )
(assert (and (or (and (= l0 l1)) (and (= l1 l3)))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
