...
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l0 Nil) (is-Nil l0)) (and (is-Nil l1) (= l1 Nil)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (= l3 Nil) (is-Nil l3)) )
(assert (and (or (and (= l1 l3)) (and (is-Nil Nil) (= Nil Nil)) (and (= l3 Nil) (is-Nil l3)) (and (= l3 Nil) (is-Nil l3)))) )
