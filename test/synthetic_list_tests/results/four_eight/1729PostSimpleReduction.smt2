...
(assert (and (or (and (= l3 l1)) (and (= l2 Nil) (is-Nil l2)) (and (is-Cons l1) (= l1 (Cons cv2 cv3)) (= cv2 (Head l1)) (= cv3 (Tail l1))) (and (= l0 l0)))) )
(assert (and (or (and (= l3 l3)) (and (is-Nil l0) (= l0 Nil)))) )
(assert (and (or (and (= l1 l3)) (and (= l1 Nil) (is-Nil l1)) (and (= l0 l1)))) )
