...
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l1 l1)) (and (is-Nil Nil) (= Nil Nil)) (and (= l3 Nil) (is-Nil l3)))) )
...
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l3 l0)) (and (= l3 Nil) (is-Nil l3)) (and (= l3 Nil) (is-Nil l3)))) )
