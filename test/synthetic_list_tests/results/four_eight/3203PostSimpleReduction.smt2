...
(assert (and (and (and (= l0 l3)) (and (= l3 Nil) (is-Nil l3)) (and (= l3 l2)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (or (and (is-Nil l1) (= l1 Nil)) (and (= l3 Nil) (is-Nil l3)) (and (is-Cons l3) (= l3 (Cons cv0 cv1)) (= cv0 (Head l3)) (= cv1 (Tail l3))))) )
