...
(assert (and (or (and (= l0 l0)) (and (= l1 l2)) (and (= l0 l1)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (= l1 l3)) )
(assert (and (not (= l0 l3))) )
(assert (and (and (and (is-Cons l0) (= l0 (Cons cv0 cv1)) (= cv0 (Head l0)) (= cv1 (Tail l0))) (and (= l2 Nil) (is-Nil l2)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (not (= l2 l2))) )
(assert (and (is-Cons l3) (= l3 (Cons cv2 cv3)) (= cv2 (Head l3)) (= cv3 (Tail l3))) )
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (= l0 l0)) (and (is-Nil l0) (= l0 Nil)))) )
