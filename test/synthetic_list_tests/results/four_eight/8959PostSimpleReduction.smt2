...
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l3 l3)) (and (is-Nil Nil) (= Nil Nil)))) )
...
(assert (and (or (and (= l0 l3)) (and (is-Cons l1) (= l1 (Cons cv8 cv9)) (= cv8 (Head l1)) (= cv9 (Tail l1))) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (or (and (= l2 l2)) (and (= l2 l0)) (and (= l2 Nil) (is-Nil l2)) (and (= l2 Nil) (is-Nil l2)))) )
