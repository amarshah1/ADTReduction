...
(assert (and (or (and (= l3 l2)) (and (= l0 Nil) (is-Nil l0)) (and (= l2 l0)))) )
(assert (and (is-Nil l2) (= l2 Nil)) )
(assert (and (and (and (is-Cons l2) (= l2 (Cons cv0 cv1)) (= cv0 (Head l2)) (= cv1 (Tail l2))) (and (= l3 l1)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))))) )
(assert (and (not (is-Nil Nil))) )
(assert (and (not (is-Cons Nil))) )
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) (and (= l2 Nil) (is-Nil l2)) (and (= l2 l0)))) )
