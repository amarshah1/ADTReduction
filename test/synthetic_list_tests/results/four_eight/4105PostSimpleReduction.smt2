...
(assert (and (and (and (= l2 l0)) (and (= l0 l2)) (and (is-Nil l0) (= l0 Nil)) (and (is-Nil Nil) (= Nil Nil)))) )
...
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l3 Nil) (is-Nil l3)) (and (= l2 Nil) (is-Nil l2)) (and (= l1 l2)))) )
(assert (and (and (and (is-Nil l0) (= l0 Nil)) (and (= l3 l3)) (and (= l3 Nil) (is-Nil l3)))) )
