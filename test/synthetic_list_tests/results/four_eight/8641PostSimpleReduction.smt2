...
(assert (and (or (and (= l0 l0)) (and (= l2 Nil) (is-Nil l2)) (and (= l2 Nil) (is-Nil l2)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (= l1 Nil) (is-Nil l1)) )
(assert (and (= l3 Nil) (is-Nil l3)) )
(assert (and (and (and (= l3 l0)) (and (= l0 l0)) (and (= l3 l3)) (and (= l2 Nil) (is-Nil l2)))) )
