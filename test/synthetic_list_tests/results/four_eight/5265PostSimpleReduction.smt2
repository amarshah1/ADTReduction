...
(assert (and (and (and (= l2 l2)) (and (= l0 Nil) (is-Nil l0)) (and (= l0 l1)))) )
(assert (and (is-Nil l2) (= l2 Nil)) )
(assert (and (is-Nil l1) (= l1 Nil)) )
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l0 Nil) (is-Nil l0)) (and (is-Cons l3) (= l3 (Cons cv0 cv1)) (= cv0 (Head l3)) (= cv1 (Tail l3))))) )
(assert (and (= l1 l0)) )
(assert (and (= l3 Nil) (is-Nil l3)) )
(assert (and (and (and (is-Nil l3) (= l3 Nil)) (and (is-Nil l2) (= l2 Nil)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))))) )
