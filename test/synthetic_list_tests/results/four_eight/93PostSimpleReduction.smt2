...
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l2 l3)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (and (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l1 l1)))) )
(assert (and (not (is-Cons Nil))) )
(assert (and (= l1 l3)) )
(assert (and (not (= l3 l2))) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l1 Nil) (is-Nil l1)) (and (= l2 l1)))) )
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (= l1 Nil) (is-Nil l1)) (and (= l1 Nil) (is-Nil l1)) (and (= l3 Nil) (is-Nil l3)))) )
