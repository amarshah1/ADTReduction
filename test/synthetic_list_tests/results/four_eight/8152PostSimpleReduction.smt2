...
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l2 Nil) (is-Nil l2)) (and (= l0 Nil) (is-Nil l0)) (and (= l1 l0)))) )
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (is-Cons l2) (= l2 (Cons cv2 cv3)) (= cv2 (Head l2)) (= cv3 (Tail l2))) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (= l3 l1)) )
(assert (and (and (and (= l1 l2)) (and (= l1 l1)))) )
(assert (and (and (and (= l0 l2)) (and (= l2 l1)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) (and (= l2 Nil) (is-Nil l2)) (and (= l3 l2)) (and (= l3 Nil) (is-Nil l3)))) )
