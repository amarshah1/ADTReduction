...
(assert (and (and (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l2 l2)) (and (= l2 Nil) (is-Nil l2)) (and (= l2 l1)))) )
(assert (and (= l2 l0)) )
(assert (and (not (is-Cons Nil))) )
(assert (and (is-Nil l1) (= l1 Nil)) )
(assert (and (not (is-Cons Nil))) )
(assert (and (or (and (is-Cons l0) (= l0 (Cons cv2 cv3)) (= cv2 (Head l0)) (= cv3 (Tail l0))) (and (= l1 l2)) (and (= l2 Nil) (is-Nil l2)) (and (is-Nil Nil) (= Nil Nil)))) )
