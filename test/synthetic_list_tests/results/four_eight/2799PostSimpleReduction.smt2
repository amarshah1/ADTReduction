...
(assert (and (or (and (is-Cons l0) (= l0 (Cons cv4 cv5)) (= cv4 (Head l0)) (= cv5 (Tail l0))) (and (= l2 l1)) (and (= l1 l1)) (and (is-Nil l2) (= l2 Nil)))) )
(assert (and (not (= l1 Nil))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (or (and (= l2 l1)) (and (= l3 Nil) (is-Nil l3)) (and (= l3 Nil) (is-Nil l3)) (and (is-Nil l0) (= l0 Nil)))) )
