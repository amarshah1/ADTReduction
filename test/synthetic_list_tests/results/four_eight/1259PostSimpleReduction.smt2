...
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (= l2 l2)) (and (= l1 l3)))) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l2 l2)))) )
