...
(assert (and (or (and (= l0 l0)) (and (= l2 l0)) (and (is-Nil Nil) (= Nil Nil)) (and (= l0 l0)))) )
(assert (and (not (is-Nil Nil))) )
(assert (and (or (and (= l2 l0)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l3 l1)) (and (= l2 Nil) (is-Nil l2)) (and (= l3 Nil) (is-Nil l3)))) )
