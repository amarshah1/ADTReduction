...
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (is-Nil l0) (= l0 Nil)) (and (is-Cons l1) (= l1 (Cons cv0 cv1)) (= cv0 (Head l1)) (= cv1 (Tail l1))) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (or (and (= l3 l2)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (and (and (= l2 l1)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (or (and (= l0 l1)) (and (= l0 l0)) (and (= l0 Nil) (is-Nil l0)))) )
