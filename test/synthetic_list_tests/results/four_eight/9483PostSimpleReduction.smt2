...
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (= l1 Nil) (is-Nil l1)) (and (is-Nil l1) (= l1 Nil)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (= l3 Nil) (is-Nil l3)) )
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l2 l3)) (and (= l2 l1)))) )
