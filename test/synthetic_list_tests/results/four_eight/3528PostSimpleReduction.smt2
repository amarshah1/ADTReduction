...
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l3 Nil) (is-Nil l3)) (and (= l0 Nil) (is-Nil l0)) (and (= l2 l0)))) )
...
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l2 l0)) (and (= l0 Nil) (is-Nil l0)))) )
