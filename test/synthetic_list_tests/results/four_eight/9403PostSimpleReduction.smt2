...
(assert (and (and (and (is-Nil l3) (= l3 Nil)) (and (is-Nil Nil) (= Nil Nil)) (and (= l1 l1)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (= l2 l2)) )
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l2 Nil) (is-Nil l2)) (and (= l2 l2)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (and (and (is-Nil l1) (= l1 Nil)) (and (= l0 Nil) (is-Nil l0)) (and (= l2 l1)))) )
