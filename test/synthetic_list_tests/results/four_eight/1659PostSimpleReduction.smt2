...
(assert (and (or (and (is-Nil l2) (= l2 Nil)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l0 Nil) (is-Nil l0)) (and (= l3 Nil) (is-Nil l3)))) )
...
(assert (and (or (and (= l2 l0)) (and (is-Nil Nil) (= Nil Nil)) (and (= l2 l3)) (and (= l1 l1)))) )
