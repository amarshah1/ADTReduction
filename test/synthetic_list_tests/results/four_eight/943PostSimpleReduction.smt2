...
(assert (and (and (and (is-Nil l0) (= l0 Nil)) (and (is-Nil l2) (= l2 Nil)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (or (and (= l0 l0)) (and (is-Nil Nil) (= Nil Nil)) (and (= l0 l3)) (and (is-Cons l0) (= l0 (Cons cv2 cv3)) (= cv2 (Head l0)) (= cv3 (Tail l0))))) )
