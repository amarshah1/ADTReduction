...
(assert (and (or (and (= l0 l0)) (and (= l0 Nil) (is-Nil l0)) (and (= l2 l1)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l2 Nil) (is-Nil l2)) (and (= l0 Nil) (is-Nil l0)) (and (= l3 l1)))) )
(assert (and (= l2 l0)) )
