...
(assert (and (and (and (= l2 l2)) (and (is-Nil Nil) (= Nil Nil)) (and (= l3 l3)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (not (= l3 Nil))) )
(assert (and (and (and (= l1 l0)) (and (= l1 Nil) (is-Nil l1)) (and (= l2 Nil) (is-Nil l2)) (and (is-Nil l2) (= l2 Nil)))) )
(assert (and (= l3 l2)) )
