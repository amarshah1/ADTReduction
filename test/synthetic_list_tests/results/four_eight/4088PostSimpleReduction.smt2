...
(assert (and (and (and (= l3 l2)) (and (= l3 Nil) (is-Nil l3)) (and (is-Nil l1) (= l1 Nil)))) )
...
(assert (and (= l2 l0)) )
(assert (and (and (and (= l3 l0)) (and (is-Nil l0) (= l0 Nil)) (and (= l0 Nil) (is-Nil l0)) (and (= l1 Nil) (is-Nil l1)))) )
