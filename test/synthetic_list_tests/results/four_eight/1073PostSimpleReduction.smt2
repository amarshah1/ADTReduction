...
(assert (and (and (and (is-Nil l2) (= l2 Nil)) (and (is-Nil l0) (= l0 Nil)) (and (is-Nil Nil) (= Nil Nil)) (and (= l3 l3)))) )
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (is-Nil l1) (= l1 Nil)) (and (= l1 l3)) (and (= l0 l2)))) )
