...
(assert (and (and (and (= l3 l1)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l2 l3)))) )
(assert (and (or (and (= l2 l2)) (and (is-Nil Nil) (= Nil Nil)) (and (= l2 l0)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (= l0 l1)) )
