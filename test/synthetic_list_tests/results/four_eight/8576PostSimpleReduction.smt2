...
(assert (and (and (and (is-Cons l1) (= l1 (Cons cv0 cv1)) (= cv0 (Head l1)) (= cv1 (Tail l1))) (and (= l0 l3)))) )
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l1 l1)) (and (= l0 Nil) (is-Nil l0)) (and (is-Nil l0) (= l0 Nil)))) )
...
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (is-Cons l0) (= l0 (Cons cv4 cv5)) (= cv4 (Head l0)) (= cv5 (Tail l0))) (and (= l3 Nil) (is-Nil l3)))) )
