...
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l2 l1)) (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))))) )
...
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (or (and (is-Cons l3) (= l3 (Cons cv8 cv9)) (= cv8 (Head l3)) (= cv9 (Tail l3))) (and (is-Cons Nil) (= Nil (Cons cv10 cv11)) (= cv10 (Head Nil)) (= cv11 (Tail Nil))) (and (= l1 Nil) (is-Nil l1)))) )
