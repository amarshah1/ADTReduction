...
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (= l3 l0)) (and (is-Nil l1) (= l1 Nil)) (and (is-Cons l2) (= l2 (Cons cv2 cv3)) (= cv2 (Head l2)) (= cv3 (Tail l2))))) )
(assert (and (= l3 Nil) (is-Nil l3)) )
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l0 Nil) (is-Nil l0)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil l0) (= l0 Nil)))) )
