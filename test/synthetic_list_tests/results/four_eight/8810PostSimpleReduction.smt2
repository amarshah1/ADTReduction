...
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l0 l3)) (and (is-Cons l0) (= l0 (Cons cv0 cv1)) (= cv0 (Head l0)) (= cv1 (Tail l0))))) )
(assert (and (= l2 Nil) (is-Nil l2)) )
(assert (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) )
(assert (and (is-Nil l3) (= l3 Nil)) )
(assert (and (is-Nil l3) (= l3 Nil)) )
(assert (and (or (and (= l1 l3)) (and (= l2 Nil) (is-Nil l2)) (and (= l3 Nil) (is-Nil l3)) (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))))) )
