...
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (is-Nil l2) (= l2 Nil)) (and (is-Nil l3) (= l3 Nil)) (and (is-Nil l1) (= l1 Nil)))) )
(assert (and (not (is-Cons Nil))) )
(assert (and (is-Nil l1) (= l1 Nil)) )
(assert (and (not (= l3 Nil))) )
(assert (and (= l0 Nil) (is-Nil l0)) )
(assert (and (or (and (is-Nil l3) (= l3 Nil)) (and (= l0 Nil) (is-Nil l0)) (and (is-Cons l3) (= l3 (Cons cv0 cv1)) (= cv0 (Head l3)) (= cv1 (Tail l3))))) )
(assert (and (= l0 l2)) )
