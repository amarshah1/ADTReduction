...
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (= l3 l3)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l0 Nil) (is-Nil l0)) (and (= l3 l0)) (and (is-Nil l3) (= l3 Nil)))) )
