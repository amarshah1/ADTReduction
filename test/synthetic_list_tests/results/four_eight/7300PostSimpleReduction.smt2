...
(assert (and (or (and (= l2 l3)) (and (is-Cons l3) (= l3 (Cons cv2 cv3)) (= cv2 (Head l3)) (= cv3 (Tail l3))) (and (= l3 l1)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) )
(assert (and (is-Nil l1) (= l1 Nil)) )
(assert (and (= l0 l3)) )
(assert (and (is-Nil l1) (= l1 Nil)) )
(assert (and (or (and (= l3 l3)) (and (is-Nil Nil) (= Nil Nil)) (and (= l0 l1)))) )
