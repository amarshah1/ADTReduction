...
(assert (and (and (and (is-Nil l0) (= l0 Nil)) (and (= l2 Nil) (is-Nil l2)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (not (= l2 Nil))) )
(assert (and (= l3 l0)) )
(assert (and (not (= l0 l0))) )
(assert (and (= l2 l1)) )
(assert (and (= l0 Nil) (is-Nil l0)) )
(assert (and (and (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l2 Nil) (is-Nil l2)) (and (= l3 Nil) (is-Nil l3)) (and (= l2 Nil) (is-Nil l2)))) )
