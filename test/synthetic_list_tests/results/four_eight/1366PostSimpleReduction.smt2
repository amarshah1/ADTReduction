...
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l1 l1)) (and (is-Nil l3) (= l3 Nil)) (and (= l3 l1)))) )
(assert (and (not (is-Cons Nil))) )
(assert (and (not (= l3 l3))) )
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (= l2 l2)) (and (= l2 Nil) (is-Nil l2)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (not (= l1 Nil))) )
(assert (and (and (and (= l1 l1)) (and (= l2 Nil) (is-Nil l2)) (and (= l3 l1)))) )
