...
(assert (and (or (and (is-Cons l2) (= l2 (Cons cv8 cv9)) (= cv8 (Head l2)) (= cv9 (Tail l2))) (and (= l3 l2)))) )
(assert (and (and (and (= l1 l3)) (and (= l2 l1)) (and (is-Cons l2) (= l2 (Cons cv10 cv11)) (= cv10 (Head l2)) (= cv11 (Tail l2))) (and (is-Nil l0) (= l0 Nil)))) )
