...
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l1 l0)) (and (is-Nil Nil) (= Nil Nil)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (and (and (is-Nil l3) (= l3 Nil)) (and (is-Nil l1) (= l1 Nil)) (and (= l1 Nil) (is-Nil l1)) (and (is-Nil Nil) (= Nil Nil)))) )
