...
(assert (and (and (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l0 l2)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (= l2 l1)) )
(assert (and (and (and (= l3 l2)) (and (= l0 Nil) (is-Nil l0)) (and (= l1 Nil) (is-Nil l1)) (and (is-Nil l2) (= l2 Nil)))) )
