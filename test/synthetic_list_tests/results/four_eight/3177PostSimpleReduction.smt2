...
(assert (and (or (and (is-Nil l0) (= l0 Nil)) (and (= l0 Nil) (is-Nil l0)) (and (= l2 Nil) (is-Nil l2)) (and (is-Nil l3) (= l3 Nil)))) )
...
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (= l3 l0)) )
(assert (and (or (and (= l2 l0)) (and (= l2 l3)) (and (= l3 Nil) (is-Nil l3)) (and (= l0 Nil) (is-Nil l0)))) )
