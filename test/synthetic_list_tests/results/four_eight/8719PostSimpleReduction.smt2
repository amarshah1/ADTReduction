...
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l3 Nil) (is-Nil l3)) (and (= l3 Nil) (is-Nil l3)) (and (= l3 Nil) (is-Nil l3)))) )
...
(assert (and (= l2 l3)) )
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (is-Nil l2) (= l2 Nil)) (and (is-Nil l2) (= l2 Nil)) (and (= l3 Nil) (is-Nil l3)))) )
