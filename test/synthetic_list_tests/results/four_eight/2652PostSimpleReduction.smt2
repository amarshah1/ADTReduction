...
(assert (and (and (and (= l1 l2)) (and (is-Nil l2) (= l2 Nil)) (and (= l2 l0)))) )
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l3 l1)) (and (= l0 Nil) (is-Nil l0)))) )
