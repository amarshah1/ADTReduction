...
(assert (and (and (and (= l2 l0)) (and (= l2 l1)) (and (= l1 l3)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (or (and (= l3 l2)) (and (= l1 Nil) (is-Nil l1)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (not (is-Nil Nil))) )
(assert (and (and (and (is-Nil l2) (= l2 Nil)) (and (= l1 Nil) (is-Nil l1)) (and (= l2 Nil) (is-Nil l2)) (and (= l0 l3)))) )
(assert (and (not (is-Nil Nil))) )
(assert (and (= l3 l3)) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
