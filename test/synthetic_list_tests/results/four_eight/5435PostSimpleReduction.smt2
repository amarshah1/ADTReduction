...
(assert (and (and (and (is-Nil l0) (= l0 Nil)) (and (is-Nil l3) (= l3 Nil)) (and (is-Cons l3) (= l3 (Cons cv2 cv3)) (= cv2 (Head l3)) (= cv3 (Tail l3))))) )
(assert (and (and (and (= l0 l0)) (and (= l1 l2)) (and (= l2 l2)) (and (= l2 Nil) (is-Nil l2)))) )
...
(assert (and (or (and (is-Nil l0) (= l0 Nil)) (and (is-Cons Nil) (= Nil (Cons cv8 cv9)) (= cv8 (Head Nil)) (= cv9 (Tail Nil))) (and (is-Nil Nil) (= Nil Nil)))) )
