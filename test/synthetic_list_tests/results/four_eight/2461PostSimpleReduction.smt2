...
(assert (and (and (and (is-Nil l3) (= l3 Nil)) (and (is-Cons l1) (= l1 (Cons cv2 cv3)) (= cv2 (Head l1)) (= cv3 (Tail l1))) (and (is-Nil l1) (= l1 Nil)) (and (= l2 l1)))) )
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil Nil) (= Nil Nil)) (and (= l1 l0)) (and (= l0 Nil) (is-Nil l0)))) )
