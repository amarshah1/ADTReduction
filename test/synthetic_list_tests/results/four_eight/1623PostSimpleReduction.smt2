...
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (or (and (= l3 l0)) (and (is-Cons l3) (= l3 (Cons cv2 cv3)) (= cv2 (Head l3)) (= cv3 (Tail l3))) (and (= l3 Nil) (is-Nil l3)) (and (is-Nil l1) (= l1 Nil)))) )
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (is-Nil l3) (= l3 Nil)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l3 l3)) (and (is-Nil Nil) (= Nil Nil)) (and (= l0 l0)))) )
