...
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (is-Cons l3) (= l3 (Cons cv6 cv7)) (= cv6 (Head l3)) (= cv7 (Tail l3))) (and (= l2 Nil) (is-Nil l2)) (and (is-Nil l1) (= l1 Nil)))) )
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l3 l1)) (and (is-Nil Nil) (= Nil Nil)) (and (= l0 Nil) (is-Nil l0)))) )
