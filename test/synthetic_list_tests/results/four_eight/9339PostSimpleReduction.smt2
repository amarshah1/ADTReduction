...
(assert (and (or (and (= l0 l1)) (and (= l1 Nil) (is-Nil l1)) (and (= l0 l1)))) )
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l0 l0)))) )
(assert (and (and (and (is-Nil l3) (= l3 Nil)) (and (= l3 l2)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l1 Nil) (is-Nil l1)))) )
