...
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil l0) (= l0 Nil)) (and (= l0 Nil) (is-Nil l0)) (and (is-Nil l1) (= l1 Nil)))) )
(assert (and (is-Nil l2) (= l2 Nil)) )
(assert (and (= l1 Nil) (is-Nil l1)) )
(assert (and (not (is-Nil l1))) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l1 l0)) (and (= l3 Nil) (is-Nil l3)) (and (= l1 l1)))) )
(assert (and (= l3 l3)) )
(assert (and (= l0 l0)) )
