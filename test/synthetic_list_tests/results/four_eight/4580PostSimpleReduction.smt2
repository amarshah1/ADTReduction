...
(assert (and (or (and (= l1 l2)) (and (= l2 Nil) (is-Nil l2)) (and (= l2 l0)) (and (= l0 Nil) (is-Nil l0)))) )
...
(assert (and (or (and (= l3 l2)) (and (= l1 Nil) (is-Nil l1)) (and (= l1 Nil) (is-Nil l1)) (and (is-Nil Nil) (= Nil Nil)))) )
