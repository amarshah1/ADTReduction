...
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (is-Nil Nil) (= Nil Nil)) (and (= l2 Nil) (is-Nil l2)) (and (is-Nil l0) (= l0 Nil)))) )
...
(assert (and (and (and (is-Nil l3) (= l3 Nil)) (and (= l1 l1)) (and (= l2 l3)))) )
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l3 Nil) (is-Nil l3)) (and (= l0 l2)) (and (is-Nil Nil) (= Nil Nil)))) )
