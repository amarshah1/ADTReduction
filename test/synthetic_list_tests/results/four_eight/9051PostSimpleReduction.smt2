...
(assert (and (and (and (= l3 l1)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (= l2 l1)) )
(assert (and (and (and (= l2 l3)) (and (= l0 l0)) (and (= l2 Nil) (is-Nil l2)))) )
