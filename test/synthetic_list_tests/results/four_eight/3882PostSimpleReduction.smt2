...
(assert (and (or (and (= l1 l3)) (and (= l3 Nil) (is-Nil l3)) (and (= l3 l0)) (and (is-Nil Nil) (= Nil Nil)))) )
...
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l3 Nil) (is-Nil l3)) (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) (and (= l0 l2)))) )
