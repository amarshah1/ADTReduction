...
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l3 Nil) (is-Nil l3)) (and (is-Nil Nil) (= Nil Nil)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (and (and (= l3 l1)) (and (= l2 Nil) (is-Nil l2)) (and (= l3 l1)) (and (= l0 l0)))) )
