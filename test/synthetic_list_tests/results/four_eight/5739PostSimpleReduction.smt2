...
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (is-Nil l0) (= l0 Nil)))) )
(assert (and (or (and (= l3 l3)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (is-Nil l0) (= l0 Nil)) )
(assert (and (= l3 Nil) (is-Nil l3)) )
(assert (and (= l1 l1)) )
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l2 l1)) (and (= l0 Nil) (is-Nil l0)) (and (= l2 l2)))) )
