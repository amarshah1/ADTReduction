...
(assert (and (or (and (= l1 l2)) (and (is-Nil l1) (= l1 Nil)) (and (= l2 l3)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (or (and (is-Cons l3) (= l3 (Cons cv0 cv1)) (= cv0 (Head l3)) (= cv1 (Tail l3))) (and (= l2 Nil) (is-Nil l2)) (and (is-Nil l3) (= l3 Nil)))) )
