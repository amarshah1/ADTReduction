...
(assert (and (and (and (= l2 l2)) (and (is-Cons l3) (= l3 (Cons cv4 cv5)) (= cv4 (Head l3)) (= cv5 (Tail l3))) (and (is-Nil l1) (= l1 Nil)))) )
(assert (and (and (and (= l1 l1)) (and (is-Nil l3) (= l3 Nil)) (and (= l0 Nil) (is-Nil l0)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (and (and (= l3 l2)) (and (= l1 Nil) (is-Nil l1)) (and (= l1 Nil) (is-Nil l1)))) )
