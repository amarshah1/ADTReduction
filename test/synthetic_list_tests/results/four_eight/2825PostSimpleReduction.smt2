...
(assert (and (or (and (is-Nil l0) (= l0 Nil)) (and (is-Cons l3) (= l3 (Cons cv0 cv1)) (= cv0 (Head l3)) (= cv1 (Tail l3))) (and (= l1 Nil) (is-Nil l1)))) )
...
(assert (and (or (and (= l3 l0)) (and (= l3 l1)) (and (= l3 Nil) (is-Nil l3)))) )
