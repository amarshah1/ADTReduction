...
(assert (and (and (and (= l2 l1)) (and (= l2 l2)) (and (= l3 Nil) (is-Nil l3)) (and (is-Nil l1) (= l1 Nil)))) )
...
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) (and (= l1 Nil) (is-Nil l1)) (and (= l2 l3)))) )
