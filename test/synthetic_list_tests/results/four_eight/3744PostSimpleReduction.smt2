...
(assert (and (or (and (= l1 l1)) (and (= l3 l2)) (and (= l0 l0)) (and (is-Cons l3) (= l3 (Cons cv0 cv1)) (= cv0 (Head l3)) (= cv1 (Tail l3))))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (is-Cons l2) (= l2 (Cons cv2 cv3)) (= cv2 (Head l2)) (= cv3 (Tail l2))) )
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l1 l2)) (and (is-Nil l1) (= l1 Nil)) (and (is-Cons l0) (= l0 (Cons cv4 cv5)) (= cv4 (Head l0)) (= cv5 (Tail l0))))) )
(assert (and (or (and (is-Nil l2) (= l2 Nil)) (and (= l3 Nil) (is-Nil l3)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (or (and (= l3 l0)) (and (= l2 l3)))) )
