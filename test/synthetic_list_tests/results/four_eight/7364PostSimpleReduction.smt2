...
(assert (and (and (and (= l0 l2)) (and (= l2 l2)) (and (= l0 Nil) (is-Nil l0)) (and (= l1 Nil) (is-Nil l1)))) )
...
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l0 Nil) (is-Nil l0)) (and (= l2 l1)))) )
(assert (and (not (= l2 Nil))) )
(assert (and (= l0 Nil) (is-Nil l0)) )
(assert (and (and (and (= l1 l1)) (and (= l2 Nil) (is-Nil l2)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (= l2 l1)) )
