...
(assert (and (and (and (is-Nil l1) (= l1 Nil)) (and (= l0 l1)) (and (= l2 l0)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (= l1 l1)) )
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l3 Nil) (is-Nil l3)) (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (= l1 l0)) )
