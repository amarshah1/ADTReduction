...
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l1 l1)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (not (= l2 Nil))) )
(assert (and (or (and (is-Nil l3) (= l3 Nil)) (and (= l3 Nil) (is-Nil l3)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))))) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l0 l3)) (and (= l0 l2)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (= l2 l0)) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
