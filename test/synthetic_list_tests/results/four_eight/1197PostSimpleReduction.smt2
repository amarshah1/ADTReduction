...
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l1 Nil) (is-Nil l1)) (and (= l3 Nil) (is-Nil l3)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (and (and (= l2 l3)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (= l3 Nil) (is-Nil l3)) )
(assert (and (not (is-Cons l1))) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l3 l1)) (and (is-Nil Nil) (= Nil Nil)))) )
