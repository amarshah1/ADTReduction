...
(assert (and (or (and (is-Nil l1) (= l1 Nil)) (and (= l1 Nil) (is-Nil l1)) (and (= l1 Nil) (is-Nil l1)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))))) )
(assert (and (is-Nil l0) (= l0 Nil)) )
(assert (and (= l2 Nil) (is-Nil l2)) )
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l0 l0)))) )
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l2 l0)) (and (= l0 l3)) (and (= l3 Nil) (is-Nil l3)))) )
