...
(assert (and (and (and (= l1 l0)) (and (is-Cons Nil) (= Nil (Cons cv6 cv7)) (= cv6 (Head Nil)) (= cv7 (Tail Nil))) (and (is-Cons l0) (= l0 (Cons cv8 cv9)) (= cv8 (Head l0)) (= cv9 (Tail l0))) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (is-Cons Nil) (= Nil (Cons cv10 cv11)) (= cv10 (Head Nil)) (= cv11 (Tail Nil))) )
(assert (and (not (is-Nil Nil))) )
(assert (and (or (and (is-Nil l1) (= l1 Nil)) (and (is-Cons l2) (= l2 (Cons cv12 cv13)) (= cv12 (Head l2)) (= cv13 (Tail l2))))) )
