...
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (= l3 l1)) (and (= l3 l3)))) )
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l3 Nil) (is-Nil l3)) (and (is-Nil Nil) (= Nil Nil)) (and (= l3 Nil) (is-Nil l3)))) )
