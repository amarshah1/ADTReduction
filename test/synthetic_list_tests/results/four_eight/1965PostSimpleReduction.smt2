...
(assert (and (or (and (= l0 l0)) (and (= l0 l1)))) )
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil l3) (= l3 Nil)))) )
