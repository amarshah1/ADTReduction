...
(assert (and (and (and (= l0 l2)) (and (is-Nil l0) (= l0 Nil)) (and (= l3 Nil) (is-Nil l3)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (is-Nil l2) (= l2 Nil)) )
(assert (and (not (= l1 l0))) )
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (= l1 l0)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (and (and (= l3 l3)) (and (is-Nil l1) (= l1 Nil)) (and (= l1 Nil) (is-Nil l1)))) )
