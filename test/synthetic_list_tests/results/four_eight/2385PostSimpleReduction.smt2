...
(assert (and (and (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (is-Cons l3) (= l3 (Cons cv2 cv3)) (= cv2 (Head l3)) (= cv3 (Tail l3))) (and (= l0 l2)) (and (is-Nil l3) (= l3 Nil)))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (= l2 l1)) )
(assert (and (= l0 Nil) (is-Nil l0)) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil Nil) (= Nil Nil)) (and (= l1 l0)) (and (= l0 Nil) (is-Nil l0)))) )
