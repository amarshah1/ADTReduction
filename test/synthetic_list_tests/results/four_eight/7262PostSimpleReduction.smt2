...
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l0 Nil) (is-Nil l0)) (and (= l3 l2)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (or (and (= l1 l0)) (and (= l1 Nil) (is-Nil l1)) (and (= l2 l1)) (and (= l0 Nil) (is-Nil l0)))) )
