...
(assert (and (= l2 l3)) )
(assert (and (or (and (is-Nil l2) (= l2 Nil)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l1 Nil) (is-Nil l1)) (and (= l0 l0)))) )
(assert (and (= l3 l3)) )
(assert (and (not (is-Cons l0))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (and (and (= l3 l2)) (and (= l1 l3)) (and (= l0 l0)))) )
