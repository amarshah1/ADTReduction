...
(assert (and (and (and (= l3 l2)) (and (= l2 Nil) (is-Nil l2)) (and (= l2 Nil) (is-Nil l2)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (and (and (= l2 l1)) (and (= l0 Nil) (is-Nil l0)) (and (is-Nil l2) (= l2 Nil)))) )
(assert (and (or (and (= l0 l1)) (and (is-Nil l0) (= l0 Nil)) (and (= l3 l0)))) )
