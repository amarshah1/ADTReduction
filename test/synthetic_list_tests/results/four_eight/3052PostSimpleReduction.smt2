...
(assert (and (and (and (is-Nil l3) (= l3 Nil)) (and (= l0 l0)) (and (= l1 Nil) (is-Nil l1)) (and (= l0 l0)))) )
(assert (and (= l1 l1)) )
...
(assert (and (and (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l1 l3)) (and (is-Nil l0) (= l0 Nil)) (and (= l0 Nil) (is-Nil l0)))) )
