...
(assert (and (= l1 Nil) (is-Nil l1)) )
(assert (and (or (and (= l1 l2)) (and (is-Cons l3) (= l3 (Cons cv0 cv1)) (= cv0 (Head l3)) (= cv1 (Tail l3))) (and (= l1 l2)))) )
(assert (and (not (= l1 Nil))) )
(assert (and (not (= l2 Nil))) )
(assert (and (and (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l2 l0)) (and (= l1 l2)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (or (and (is-Cons l3) (= l3 (Cons cv4 cv5)) (= cv4 (Head l3)) (= cv5 (Tail l3))) (and (= l1 Nil) (is-Nil l1)) (and (is-Nil l0) (= l0 Nil)))) )
