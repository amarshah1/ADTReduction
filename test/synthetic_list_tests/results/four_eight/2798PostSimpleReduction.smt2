...
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (= l3 l3)) (and (= l3 Nil) (is-Nil l3)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l3 Nil) (is-Nil l3)) (and (= l3 l0)) (and (= l3 l1)))) )
(assert (and (= l0 l3)) )
