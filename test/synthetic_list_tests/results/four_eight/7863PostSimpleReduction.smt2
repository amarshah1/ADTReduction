...
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (= l2 Nil) (is-Nil l2)) (and (= l2 l3)))) )
(assert (and (not (= l0 Nil))) )
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (is-Cons l1) (= l1 (Cons cv0 cv1)) (= cv0 (Head l1)) (= cv1 (Tail l1))) (and (= l3 l1)))) )
(assert (and (= l2 Nil) (is-Nil l2)) )
(assert (and (and (and (= l3 l1)) (and (is-Nil Nil) (= Nil Nil)) (and (= l0 l1)))) )
