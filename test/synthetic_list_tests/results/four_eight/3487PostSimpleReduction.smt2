...
(assert (and (or (and (= l0 l2)) (and (= l0 l2)) (and (= l1 Nil) (is-Nil l1)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))))) )
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (= l1 l3)) (and (is-Nil Nil) (= Nil Nil)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (not (is-Cons l3))) )
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l2 l1)))) )
(assert (and (and (and (= l1 l2)) (and (= l1 l1)) (and (= l1 l2)))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (= l1 l0)) )
