...
(assert (and (or (and (is-Nil l2) (= l2 Nil)) (and (= l0 l1)) (and (= l0 Nil) (is-Nil l0)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (= l1 l0)) )
...
(assert (and (or (and (= l0 l2)) (and (= l1 Nil) (is-Nil l1)) (and (is-Nil Nil) (= Nil Nil)) (and (= l1 l3)))) )
