...
(assert (and (is-Nil l1) (= l1 Nil)) )
(assert (and (or (and (is-Nil l2) (= l2 Nil)) (and (= l1 l2)) (and (= l3 Nil) (is-Nil l3)) (and (= l1 l1)))) )
(assert (and (or (and (= l0 l2)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (is-Nil Nil) (= Nil Nil)) (and (= l2 Nil) (is-Nil l2)) (and (is-Cons l2) (= l2 (Cons cv0 cv1)) (= cv0 (Head l2)) (= cv1 (Tail l2))))) )
