...
(assert (and (or (and (= l1 l1)) (and (= l0 Nil) (is-Nil l0)) (and (is-Nil l0) (= l0 Nil)))) )
(assert (and (is-Nil l3) (= l3 Nil)) )
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (is-Nil l2) (= l2 Nil)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (and (and (= l1 l0)) (and (= l0 l3)) (and (= l1 Nil) (is-Nil l1)) (and (is-Cons l2) (= l2 (Cons cv0 cv1)) (= cv0 (Head l2)) (= cv1 (Tail l2))))) )
