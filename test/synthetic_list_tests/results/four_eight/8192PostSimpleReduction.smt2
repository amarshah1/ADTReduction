...
(assert (and (or (and (= l1 l1)) (and (= l3 l3)) (and (= l0 Nil) (is-Nil l0)))) )
...
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l0 l0)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l2 Nil) (is-Nil l2)) (and (is-Nil Nil) (= Nil Nil)) (and (= l2 l0)))) )
