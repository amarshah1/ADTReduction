...
(assert (and (or (and (= l0 l3)) (and (= l0 Nil) (is-Nil l0)) (and (= l0 l3)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (not (is-Nil Nil))) )
(assert (and (or (and (is-Nil l0) (= l0 Nil)) (and (is-Nil l3) (= l3 Nil)) (and (= l3 Nil) (is-Nil l3)) (and (is-Nil Nil) (= Nil Nil)))) )
