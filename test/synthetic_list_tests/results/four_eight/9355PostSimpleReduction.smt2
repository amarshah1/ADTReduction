...
(assert (and (and (and (= l0 l3)) (and (= l2 Nil) (is-Nil l2)) (and (= l3 l0)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (not (is-Nil l0))) )
(assert (and (= l3 l3)) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (not (is-Nil l0))) )
(assert (and (or (and (= l0 l3)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l0 Nil) (is-Nil l0)))) )
