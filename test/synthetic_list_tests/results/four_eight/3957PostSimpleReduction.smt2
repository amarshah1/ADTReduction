...
(assert (and (or (and (is-Nil l1) (= l1 Nil)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l3 l0)) (and (= l2 l3)))) )
(assert (and (not (is-Nil Nil))) )
(assert (and (not (= l3 Nil))) )
(assert (and (is-Nil l2) (= l2 Nil)) )
(assert (and (not (= l3 Nil))) )
(assert (and (= l3 l0)) )
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l2 Nil) (is-Nil l2)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l3 Nil) (is-Nil l3)))) )
