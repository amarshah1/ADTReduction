...
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (is-Cons l1) (= l1 (Cons cv0 cv1)) (= cv0 (Head l1)) (= cv1 (Tail l1))) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (is-Cons l0) (= l0 (Cons cv4 cv5)) (= cv4 (Head l0)) (= cv5 (Tail l0))) )
(assert (and (and (and (= l0 l1)) (and (is-Nil l0) (= l0 Nil)) (and (= l0 l1)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (is-Nil l1) (= l1 Nil)) )
(assert (and (not (= l0 Nil))) )
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l3 l3)) (and (= l3 l0)) (and (= l3 Nil) (is-Nil l3)))) )
