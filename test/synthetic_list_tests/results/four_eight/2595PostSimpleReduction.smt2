...
(assert (and (or (and (= l2 l1)) (and (= l1 l3)) (and (= l3 Nil) (is-Nil l3)) (and (is-Nil l2) (= l2 Nil)))) )
(assert (and (and (and (= l0 l3)) (and (is-Cons l0) (= l0 (Cons cv0 cv1)) (= cv0 (Head l0)) (= cv1 (Tail l0))))) )
...
(assert (and (or (and (= l0 l3)) (and (= l3 Nil) (is-Nil l3)) (and (= l1 l0)))) )
