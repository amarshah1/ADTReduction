...
(assert (and (or (and (= l3 l0)) (and (= l2 l3)) (and (= l3 l0)) (and (is-Nil l3) (= l3 Nil)))) )
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l0 l3)))) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l2 Nil) (is-Nil l2)) (and (= l2 l1)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))))) )
...
(assert (and (or (and (= l1 l2)) (and (= l2 Nil) (is-Nil l2)) (and (= l0 l2)) (and (is-Nil l1) (= l1 Nil)))) )
