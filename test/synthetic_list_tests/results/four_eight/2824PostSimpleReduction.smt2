...
(assert (and (or (and (is-Cons l3) (= l3 (Cons cv2 cv3)) (= cv2 (Head l3)) (= cv3 (Tail l3))) (and (= l2 l2)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (= l0 l0)) )
(assert (and (= l2 l2)) )
(assert (and (is-Nil l0) (= l0 Nil)) )
(assert (and (or (and (is-Nil l3) (= l3 Nil)) (and (= l1 l3)) (and (= l3 l3)))) )
