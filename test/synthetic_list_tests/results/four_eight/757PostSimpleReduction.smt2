...
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l0 l3)) (and (= l2 l3)))) )
...
(assert (and (and (and (is-Cons l3) (= l3 (Cons cv4 cv5)) (= cv4 (Head l3)) (= cv5 (Tail l3))) (and (is-Cons l3) (= l3 (Cons cv6 cv7)) (= cv6 (Head l3)) (= cv7 (Tail l3))) (and (= l2 l3)))) )
