...
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (is-Cons l1) (= l1 (Cons cv0 cv1)) (= cv0 (Head l1)) (= cv1 (Tail l1))) (and (= l0 l2)))) )
(assert (and (= l1 Nil) (is-Nil l1)) )
(assert (and (not (is-Nil Nil))) )
(assert (and (and (and (= l0 l1)) (and (is-Cons l3) (= l3 (Cons cv2 cv3)) (= cv2 (Head l3)) (= cv3 (Tail l3))) (and (= l1 l3)))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (not (= l1 Nil))) )
(assert (and (= l0 l0)) )
(assert (and (or (and (is-Cons l2) (= l2 (Cons cv4 cv5)) (= cv4 (Head l2)) (= cv5 (Tail l2))) (and (is-Cons Nil) (= Nil (Cons cv6 cv7)) (= cv6 (Head Nil)) (= cv7 (Tail Nil))))) )
