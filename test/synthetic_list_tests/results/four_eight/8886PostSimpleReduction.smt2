...
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil l2) (= l2 Nil)) (and (is-Nil l1) (= l1 Nil)))) )
(assert (and (not (= l1 l2))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (= l2 Nil) (is-Nil l2)) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (not (= l2 Nil))) )
(assert (and (and (and (= l0 l3)) (and (= l0 l0)) (and (is-Nil Nil) (= Nil Nil)) (and (= l2 Nil) (is-Nil l2)))) )
