...
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (is-Nil Nil) (= Nil Nil)) (and (= l2 l2)) (and (= l1 l3)))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) )
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l2 l2)) (and (= l3 Nil) (is-Nil l3)) (and (is-Nil l3) (= l3 Nil)))) )
