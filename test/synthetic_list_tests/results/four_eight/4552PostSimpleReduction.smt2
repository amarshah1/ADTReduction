...
(assert (and (= l1 Nil) (is-Nil l1)) )
(assert (and (and (and (= l3 l3)) (and (= l1 l1)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (is-Nil l2) (= l2 Nil)) )
(assert (and (not (= l3 Nil))) )
(assert (and (= l0 Nil) (is-Nil l0)) )
(assert (and (or (and (is-Nil l0) (= l0 Nil)) (and (is-Cons l3) (= l3 (Cons cv0 cv1)) (= cv0 (Head l3)) (= cv1 (Tail l3))) (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))))) )
(assert (and (not (= l3 Nil))) )
