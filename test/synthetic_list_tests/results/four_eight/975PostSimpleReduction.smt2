...
(assert (and (or (and (is-Nil l2) (= l2 Nil)) (and (= l3 Nil) (is-Nil l3)) (and (= l3 l1)))) )
...
(assert (and (and (and (is-Nil l0) (= l0 Nil)) (and (= l0 l2)) (and (= l2 Nil) (is-Nil l2)) (and (= l1 Nil) (is-Nil l1)))) )
