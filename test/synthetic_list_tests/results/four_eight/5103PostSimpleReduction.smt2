...
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons l2) (= l2 (Cons cv2 cv3)) (= cv2 (Head l2)) (= cv3 (Tail l2))) (and (is-Nil l2) (= l2 Nil)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (not (= l1 Nil))) )
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l2 l2)) (and (= l1 l1)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (is-Nil l3) (= l3 Nil)) )
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (is-Nil l3) (= l3 Nil)) )
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l3 l3)) (and (= l2 l3)) (and (= l3 Nil) (is-Nil l3)))) )
