...
(assert (and (and (and (is-Cons l2) (= l2 (Cons cv2 cv3)) (= cv2 (Head l2)) (= cv3 (Tail l2))) (and (= l3 l2)) (and (= l0 Nil) (is-Nil l0)))) )
...
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l3 l1)) (and (= l2 l1)) (and (= l0 l2)))) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l1 Nil) (is-Nil l1)) (and (= l0 l3)) (and (= l3 l3)))) )
