...
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l3 Nil) (is-Nil l3)) (and (= l3 l0)))) )
(assert (and (= l2 l3)) )
...
(assert (and (= l3 l2)) )
(assert (and (and (and (= l2 l1)) (and (= l3 l0)) (and (is-Nil l2) (= l2 Nil)))) )
