...
(assert (and (and (and (is-Nil l0) (= l0 Nil)) (and (= l3 Nil) (is-Nil l3)) (and (= l3 Nil) (is-Nil l3)) (and (= l0 Nil) (is-Nil l0)))) )
...
(assert (and (and (and (is-Nil l0) (= l0 Nil)) (and (= l3 l0)) (and (= l0 Nil) (is-Nil l0)) (and (= l1 l1)))) )
(assert (and (= l1 Nil) (is-Nil l1)) )
