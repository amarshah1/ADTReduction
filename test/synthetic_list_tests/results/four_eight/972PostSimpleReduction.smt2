...
(assert (and (= l3 Nil) (is-Nil l3)) )
(assert (and (= l3 Nil) (is-Nil l3)) )
(assert (and (and (and (= l0 l0)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (or (and (is-Nil l2) (= l2 Nil)) (and (= l2 Nil) (is-Nil l2)) (and (= l0 Nil) (is-Nil l0)) (and (= l2 Nil) (is-Nil l2)))) )
