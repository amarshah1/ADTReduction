...
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (= l2 l0)) (and (= l0 l2)))) )
(assert (and (= l0 l2)) )
...
(assert (and (and (and (= l3 l2)) (and (= l2 Nil) (is-Nil l2)) (and (= l1 l1)))) )
(assert (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) )
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (is-Nil Nil) (= Nil Nil)) (and (= l1 Nil) (is-Nil l1)) (and (= l2 l2)))) )
