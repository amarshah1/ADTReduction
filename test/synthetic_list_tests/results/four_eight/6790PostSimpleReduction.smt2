...
(assert (and (and (and (= l2 l0)) (and (= l0 Nil) (is-Nil l0)) (and (= l2 Nil) (is-Nil l2)) (and (= l3 l0)))) )
(assert (and (and (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l0 Nil) (is-Nil l0)) (and (= l3 l2)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (and (and (is-Cons l1) (= l1 (Cons cv4 cv5)) (= cv4 (Head l1)) (= cv5 (Tail l1))) (and (= l2 l0)))) )
(assert (and (= l0 Nil) (is-Nil l0)) )
(assert (and (and (and (= l0 l1)) (and (= l0 Nil) (is-Nil l0)) (and (= l1 l1)) (and (= l0 Nil) (is-Nil l0)))) )
