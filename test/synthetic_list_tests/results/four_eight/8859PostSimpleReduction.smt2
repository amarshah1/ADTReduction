...
(assert (and (or (and (= l1 l3)) (and (= l2 Nil) (is-Nil l2)) (and (= l3 l2)) (and (is-Nil l0) (= l0 Nil)))) )
(assert (and (= l0 Nil) (is-Nil l0)) )
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l2 Nil) (is-Nil l2)) (and (= l1 Nil) (is-Nil l1)) (and (= l3 l2)))) )
