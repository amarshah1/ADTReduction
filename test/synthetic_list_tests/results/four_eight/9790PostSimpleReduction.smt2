...
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (= l2 l3)) (and (is-Cons l1) (= l1 (Cons cv2 cv3)) (= cv2 (Head l1)) (= cv3 (Tail l1))) (and (is-Cons l1) (= l1 (Cons cv4 cv5)) (= cv4 (Head l1)) (= cv5 (Tail l1))))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
