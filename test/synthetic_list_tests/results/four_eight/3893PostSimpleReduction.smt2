...
(assert (and (and (and (is-Cons l0) (= l0 (Cons cv2 cv3)) (= cv2 (Head l0)) (= cv3 (Tail l0))) (and (= l1 Nil) (is-Nil l1)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))))) )
(assert (and (not (is-Cons Nil))) )
(assert (and (not (= l3 l2))) )
(assert (and (= l3 l1)) )
(assert (and (and (and (= l1 l1)) (and (is-Nil l3) (= l3 Nil)) (and (= l3 l0)))) )
