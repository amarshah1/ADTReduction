...
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l3 l0)) (and (= l3 l3)) (and (= l3 l1)))) )
(assert (and (and (and (= l0 l3)) (and (= l2 Nil) (is-Nil l2)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (or (and (= l0 l1)) (and (= l3 Nil) (is-Nil l3)) (and (is-Nil l0) (= l0 Nil)) (and (= l1 Nil) (is-Nil l1)))) )
