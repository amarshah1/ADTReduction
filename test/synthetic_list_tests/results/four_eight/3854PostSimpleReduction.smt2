...
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l1 l0)) (and (= l2 l2)))) )
(assert (and (not (= l1 l3))) )
(assert (and (= l0 Nil) (is-Nil l0)) )
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil l1) (= l1 Nil)) (and (= l0 Nil) (is-Nil l0)))) )
