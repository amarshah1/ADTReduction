...
(assert (and (or (and (is-Cons l3) (= l3 (Cons cv0 cv1)) (= cv0 (Head l3)) (= cv1 (Tail l3))) (and (= l2 Nil) (is-Nil l2)) (and (= l0 Nil) (is-Nil l0)) (and (= l1 l1)))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (is-Cons l1) (= l1 (Cons cv2 cv3)) (= cv2 (Head l1)) (= cv3 (Tail l1))) )
(assert (and (or (and (= l2 l0)) (and (= l2 l1)))) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l1 l2)) (and (= l0 l1)) (and (= l0 Nil) (is-Nil l0)))) )
