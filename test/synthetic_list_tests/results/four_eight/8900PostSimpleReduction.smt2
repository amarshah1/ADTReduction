...
(assert (and (and (and (= l1 l1)) (and (= l0 l3)) (and (= l0 l1)))) )
(assert (and (not (= l1 Nil))) )
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil l0) (= l0 Nil)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))))) )
