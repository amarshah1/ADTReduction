...
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil l3) (= l3 Nil)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l2 l3)))) )
(assert (and (or (and (= l1 l1)) (and (= l2 Nil) (is-Nil l2)) (and (= l2 l1)) (and (is-Nil Nil) (= Nil Nil)))) )
...
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l2 Nil) (is-Nil l2)) (and (= l3 l0)))) )
