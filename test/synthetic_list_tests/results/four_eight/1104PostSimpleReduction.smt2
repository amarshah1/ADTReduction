...
(assert (and (or (and (is-Nil l0) (= l0 Nil)) (and (= l0 l2)) (and (= l2 l0)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (or (and (= l1 l1)) (and (is-Cons l0) (= l0 (Cons cv2 cv3)) (= cv2 (Head l0)) (= cv3 (Tail l0))) (and (= l2 l0)) (and (= l0 l3)))) )
