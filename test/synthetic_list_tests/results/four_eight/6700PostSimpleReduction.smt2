...
(assert (and (or (and (= l0 l3)) (and (= l3 Nil) (is-Nil l3)) (and (= l1 l1)))) )
...
(assert (and (and (and (is-Cons Nil) (= Nil (Cons cv8 cv9)) (= cv8 (Head Nil)) (= cv9 (Tail Nil))) (and (= l3 Nil) (is-Nil l3)) (and (is-Nil Nil) (= Nil Nil)))) )
