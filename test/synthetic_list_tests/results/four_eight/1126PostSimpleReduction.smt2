...
(assert (and (or (and (= l2 l0)) (and (= l3 l1)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (or (and (= l3 l1)) (and (= l1 l2)) (and (is-Cons Nil) (= Nil (Cons cv6 cv7)) (= cv6 (Head Nil)) (= cv7 (Tail Nil))) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l0 l2)) (and (= l3 Nil) (is-Nil l3)))) )
