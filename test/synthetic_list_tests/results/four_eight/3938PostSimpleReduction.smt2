...
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l0 Nil) (is-Nil l0)) (and (= l3 l2)) (and (is-Nil l2) (= l2 Nil)))) )
(assert (and (and (and (is-Nil l2) (= l2 Nil)) (and (= l1 Nil) (is-Nil l1)) (and (= l2 l3)))) )
(assert (and (= l1 Nil) (is-Nil l1)) )
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l1 l0)) (and (is-Nil l2) (= l2 Nil)) (and (= l0 Nil) (is-Nil l0)))) )
