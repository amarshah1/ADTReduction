...
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l1 Nil) (is-Nil l1)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l1 l3)))) )
(assert (and (= l1 l3)) )
(assert (and (= l0 Nil) (is-Nil l0)) )
(assert (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) )
(assert (and (= l3 l1)) )
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l0 l3)) (and (is-Cons l1) (= l1 (Cons cv4 cv5)) (= cv4 (Head l1)) (= cv5 (Tail l1))))) )
(assert (and (not (= l0 l2))) )
(assert (and (or (and (is-Nil l2) (= l2 Nil)) (and (= l2 l0)))) )
