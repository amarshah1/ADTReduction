...
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l0 l2)) (and (is-Nil l2) (= l2 Nil)) (and (= l3 l2)))) )
...
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) (and (is-Cons l1) (= l1 (Cons cv6 cv7)) (= cv6 (Head l1)) (= cv7 (Tail l1))) (and (is-Nil l0) (= l0 Nil)))) )
(assert (and (or (and (= l2 l1)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (or (and (= l1 l0)) (and (= l3 l2)) (and (is-Nil Nil) (= Nil Nil)))) )
