...
(assert (and (and (and (= l1 l3)) (and (= l0 Nil) (is-Nil l0)) (and (= l1 Nil) (is-Nil l1)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (= l3 l3)) )
(assert (and (and (and (= l2 l0)) (and (= l3 Nil) (is-Nil l3)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (not (is-Cons l1))) )
(assert (and (or (and (= l2 l0)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (or (and (= l0 l3)) (and (= l1 l0)))) )
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l2 l2)) (and (= l1 l2)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l1 Nil) (is-Nil l1)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))))) )
