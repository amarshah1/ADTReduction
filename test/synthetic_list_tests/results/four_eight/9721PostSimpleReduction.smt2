...
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l2 Nil) (is-Nil l2)) (and (is-Nil Nil) (= Nil Nil)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (not (= l3 Nil))) )
(assert (and (not (= l0 Nil))) )
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (is-Nil l1) (= l1 Nil)) (and (= l2 Nil) (is-Nil l2)))) )
