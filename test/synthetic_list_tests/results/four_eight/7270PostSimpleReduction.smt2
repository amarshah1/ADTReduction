...
(assert (and (or (and (= l1 l2)) (and (= l1 l3)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l0 Nil) (is-Nil l0)) (and (= l0 l1)) (and (is-Nil l1) (= l1 Nil)))) )
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (and (and (= l2 l2)) (and (is-Nil l1) (= l1 Nil)) (and (= l3 l1)) (and (= l0 Nil) (is-Nil l0)))) )
