...
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (is-Nil l2) (= l2 Nil)))) )
(assert (and (is-Nil l3) (= l3 Nil)) )
(assert (and (and (and (is-Nil l2) (= l2 Nil)) (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))))) )
(assert (and (not (is-Nil Nil))) )
(assert (and (not (= l2 l3))) )
(assert (and (= l2 Nil) (is-Nil l2)) )
(assert (and (and (and (is-Cons Nil) (= Nil (Cons cv6 cv7)) (= cv6 (Head Nil)) (= cv7 (Tail Nil))) (and (= l1 l0)) (and (= l2 Nil) (is-Nil l2)))) )
