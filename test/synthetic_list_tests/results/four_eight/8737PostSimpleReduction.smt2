...
(assert (and (= l3 l2)) )
(assert (and (or (and (= l3 l1)) (and (= l2 l0)) (and (= l2 Nil) (is-Nil l2)) (and (= l0 l2)))) )
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (is-Nil Nil) (= Nil Nil)) (and (= l3 Nil) (is-Nil l3)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))))) )
(assert (and (and (and (= l1 l0)) (and (= l2 Nil) (is-Nil l2)) (and (= l1 l0)) (and (= l3 l0)))) )
(assert (and (not (= l3 l2))) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l0 l0)) (and (= l2 l1)))) )
