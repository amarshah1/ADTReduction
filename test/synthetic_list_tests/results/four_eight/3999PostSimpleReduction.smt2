...
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l2 Nil) (is-Nil l2)) (and (= l3 l0)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (not (= l3 Nil))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (and (and (= l3 l3)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil l0) (= l0 Nil)) (and (= l0 Nil) (is-Nil l0)))) )
