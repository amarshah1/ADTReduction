...
(assert (and (and (and (= l0 l3)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l0 l0)))) )
(assert (and (= l2 Nil) (is-Nil l2)) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (not (is-Cons l2))) )
(assert (and (not (= l0 Nil))) )
(assert (and (and (and (= l0 l2)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil Nil) (= Nil Nil)))) )
