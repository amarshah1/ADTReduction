...
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (and (and (is-Nil l0) (= l0 Nil)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil Nil) (= Nil Nil)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (not (is-Nil l1))) )
(assert (and (or (and (is-Nil l2) (= l2 Nil)) (and (is-Nil Nil) (= Nil Nil)) (and (= l2 Nil) (is-Nil l2)))) )
