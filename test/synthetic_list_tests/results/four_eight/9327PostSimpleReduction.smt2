...
(assert (and (or (and (= l1 l3)) (and (= l0 Nil) (is-Nil l0)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (= l1 Nil) (is-Nil l1)) )
(assert (and (= l2 Nil) (is-Nil l2)) )
(assert (and (not (is-Nil Nil))) )
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (is-Nil Nil) (= Nil Nil)) (and (= l0 l2)) (and (= l3 Nil) (is-Nil l3)))) )
