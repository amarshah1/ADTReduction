...
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (= l0 l1)) (and (= l0 Nil) (is-Nil l0)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (or (and (= l1 l0)) (and (is-Cons l3) (= l3 (Cons cv6 cv7)) (= cv6 (Head l3)) (= cv7 (Tail l3))) (and (= l3 l0)))) )
