...
(assert (and (or (and (= l2 l2)) (and (= l0 Nil) (is-Nil l0)) (and (= l0 l0)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (not (= l3 Nil))) )
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l0 l0)))) )
(assert (and (is-Nil l2) (= l2 Nil)) )
(assert (and (or (and (is-Nil l2) (= l2 Nil)) (and (is-Nil Nil) (= Nil Nil)) (and (= l2 Nil) (is-Nil l2)) (and (= l3 Nil) (is-Nil l3)))) )
