...
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l0 l2)) (and (is-Nil Nil) (= Nil Nil)) (and (= l2 l3)))) )
(assert (and (= l0 Nil) (is-Nil l0)) )
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (is-Nil l2) (= l2 Nil)) (and (= l0 l0)) (and (= l0 l2)))) )
