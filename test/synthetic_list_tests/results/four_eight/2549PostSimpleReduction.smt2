...
(assert (and (and (and (= l0 l2)) (and (= l2 l1)) (and (= l2 Nil) (is-Nil l2)) (and (is-Nil l3) (= l3 Nil)))) )
(assert (and (and (and (= l0 l0)) (and (= l3 Nil) (is-Nil l3)) (and (= l3 l0)))) )
(assert (and (or (and (is-Cons l1) (= l1 (Cons cv4 cv5)) (= cv4 (Head l1)) (= cv5 (Tail l1))) (and (is-Nil l0) (= l0 Nil)))) )
(assert (and (and (and (= l0 l0)) (and (= l0 Nil) (is-Nil l0)) (and (= l0 l1)))) )
