...
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l0 l1)) (and (= l3 l2)))) )
(assert (and (not (= l2 Nil))) )
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv8 cv9)) (= cv8 (Head Nil)) (= cv9 (Tail Nil))) (and (= l3 Nil) (is-Nil l3)) (and (= l3 l1)))) )
