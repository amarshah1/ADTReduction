...
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l2 Nil) (is-Nil l2)) (and (= l1 l3)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) )
(assert (and (= l0 Nil) (is-Nil l0)) )
(assert (and (not (is-Cons Nil))) )
(assert (and (and (and (= l2 l0)) (and (is-Cons l0) (= l0 (Cons cv2 cv3)) (= cv2 (Head l0)) (= cv3 (Tail l0))))) )
(assert (and (= l0 l0)) )
