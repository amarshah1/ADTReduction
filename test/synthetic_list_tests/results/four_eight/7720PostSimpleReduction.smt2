...
(assert (and (and (and (= l0 l2)) (and (= l1 l3)) (and (= l3 l2)) (and (= l3 l2)))) )
...
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (is-Cons Nil) (= Nil (Cons cv10 cv11)) (= cv10 (Head Nil)) (= cv11 (Tail Nil))))) )
