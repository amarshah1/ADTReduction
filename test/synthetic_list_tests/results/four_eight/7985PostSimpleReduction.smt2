...
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l1 l2)) (and (= l3 l2)) (and (= l1 Nil) (is-Nil l1)))) )
...
(assert (and (= l1 l0)) )
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l0 Nil) (is-Nil l0)) (and (= l2 l3)) (and (is-Nil Nil) (= Nil Nil)))) )
