...
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l0 l2)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (not (= l3 l2))) )
(assert (and (and (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l3 l0)) (and (= l0 l1)))) )
