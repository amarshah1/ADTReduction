...
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l0 l3)) (and (= l1 Nil) (is-Nil l1)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (and (and (= l1 l2)) (and (is-Cons l3) (= l3 (Cons cv2 cv3)) (= cv2 (Head l3)) (= cv3 (Tail l3))))) )
(assert (and (not (= l3 Nil))) )
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l3 Nil) (is-Nil l3)) (and (is-Cons l3) (= l3 (Cons cv4 cv5)) (= cv4 (Head l3)) (= cv5 (Tail l3))) (and (is-Cons Nil) (= Nil (Cons cv6 cv7)) (= cv6 (Head Nil)) (= cv7 (Tail Nil))))) )
