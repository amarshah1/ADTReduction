...
(assert (and (and (and (is-Nil l1) (= l1 Nil)) (and (= l0 l2)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (and (and (is-Nil l1) (= l1 Nil)) (and (is-Cons Nil) (= Nil (Cons cv6 cv7)) (= cv6 (Head Nil)) (= cv7 (Tail Nil))))) )
(assert (and (is-Nil l2) (= l2 Nil)) )
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (is-Nil Nil) (= Nil Nil)) (and (= l0 Nil) (is-Nil l0)) (and (= l3 l1)))) )
