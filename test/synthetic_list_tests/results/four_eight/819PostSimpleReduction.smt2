...
(assert (and (or (and (= l3 l1)) (and (= l2 Nil) (is-Nil l2)) (and (= l2 l2)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (not (is-Nil Nil))) )
(assert (and (or (and (is-Cons l3) (= l3 (Cons cv4 cv5)) (= cv4 (Head l3)) (= cv5 (Tail l3))) (and (= l1 Nil) (is-Nil l1)) (and (is-Cons l3) (= l3 (Cons cv6 cv7)) (= cv6 (Head l3)) (= cv7 (Tail l3))) (and (is-Cons l2) (= l2 (Cons cv8 cv9)) (= cv8 (Head l2)) (= cv9 (Tail l2))))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
