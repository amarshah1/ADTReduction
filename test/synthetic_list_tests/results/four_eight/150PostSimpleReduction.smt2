...
(assert (and (and (and (is-Cons l2) (= l2 (Cons cv2 cv3)) (= cv2 (Head l2)) (= cv3 (Tail l2))) (and (is-Nil Nil) (= Nil Nil)) (and (= l3 l0)) (and (= l3 l1)))) )
(assert (and (= l2 l1)) )
(assert (and (or (and (= l2 l0)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (is-Cons l3) (= l3 (Cons cv4 cv5)) (= cv4 (Head l3)) (= cv5 (Tail l3))) (and (= l2 l1)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (is-Nil l2) (= l2 Nil)) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l0 Nil) (is-Nil l0)) (and (= l1 l3)))) )
