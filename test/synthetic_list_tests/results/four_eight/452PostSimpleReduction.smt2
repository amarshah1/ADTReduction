...
(assert (and (or (and (is-Nil l0) (= l0 Nil)) (and (= l3 Nil) (is-Nil l3)) (and (is-Nil l2) (= l2 Nil)))) )
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (is-Cons l1) (= l1 (Cons cv0 cv1)) (= cv0 (Head l1)) (= cv1 (Tail l1))) (and (is-Cons l1) (= l1 (Cons cv2 cv3)) (= cv2 (Head l1)) (= cv3 (Tail l1))) (and (= l2 Nil) (is-Nil l2)))) )
