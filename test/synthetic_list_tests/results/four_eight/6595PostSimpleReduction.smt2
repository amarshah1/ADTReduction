...
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (is-Cons l3) (= l3 (Cons cv6 cv7)) (= cv6 (Head l3)) (= cv7 (Tail l3))) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (or (and (is-Nil l3) (= l3 Nil)) (and (= l0 l1)) (and (is-Nil l3) (= l3 Nil)) (and (= l2 Nil) (is-Nil l2)))) )
