...
(assert (and (and (and (is-Cons l3) (= l3 (Cons cv2 cv3)) (= cv2 (Head l3)) (= cv3 (Tail l3))) (and (= l2 Nil) (is-Nil l2)) (and (= l0 l2)))) )
(assert (and (or (and (= l1 l1)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l2 Nil) (is-Nil l2)) (and (= l1 Nil) (is-Nil l1)) (and (= l2 l1)))) )
(assert (and (or (and (is-Cons l1) (= l1 (Cons cv4 cv5)) (= cv4 (Head l1)) (= cv5 (Tail l1))) (and (is-Cons l0) (= l0 (Cons cv6 cv7)) (= cv6 (Head l0)) (= cv7 (Tail l0))) (and (= l2 l2)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (is-Cons Nil) (= Nil (Cons cv8 cv9)) (= cv8 (Head Nil)) (= cv9 (Tail Nil))) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (or (and (is-Cons l3) (= l3 (Cons cv10 cv11)) (= cv10 (Head l3)) (= cv11 (Tail l3))) (and (is-Nil Nil) (= Nil Nil)))) )
