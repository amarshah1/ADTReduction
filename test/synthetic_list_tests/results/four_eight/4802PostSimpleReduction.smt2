...
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l1 l2)) (and (= l0 Nil) (is-Nil l0)) (and (is-Nil l3) (= l3 Nil)))) )
...
(assert (and (and (and (= l2 l1)) (and (is-Cons l3) (= l3 (Cons cv4 cv5)) (= cv4 (Head l3)) (= cv5 (Tail l3))) (and (is-Nil l0) (= l0 Nil)) (and (is-Nil l3) (= l3 Nil)))) )
