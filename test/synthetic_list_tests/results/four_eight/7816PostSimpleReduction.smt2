...
(assert (and (or (and (is-Cons l2) (= l2 (Cons cv4 cv5)) (= cv4 (Head l2)) (= cv5 (Tail l2))) (and (= l0 Nil) (is-Nil l0)) (and (is-Nil l2) (= l2 Nil)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (and (and (= l3 l0)) (and (= l0 Nil) (is-Nil l0)) (and (is-Nil l0) (= l0 Nil)) (and (is-Cons Nil) (= Nil (Cons cv6 cv7)) (= cv6 (Head Nil)) (= cv7 (Tail Nil))))) )
