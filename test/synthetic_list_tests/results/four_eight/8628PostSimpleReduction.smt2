...
(assert (and (= l1 l1)) )
(assert (and (or (and (= l0 l1)) (and (is-Cons l2) (= l2 (Cons cv0 cv1)) (= cv0 (Head l2)) (= cv1 (Tail l2))) (and (= l0 l0)) (and (is-Nil l3) (= l3 Nil)))) )
(assert (and (and (and (= l1 l2)) (and (is-Nil l2) (= l2 Nil)))) )
...
(assert (and (or (and (= l3 l2)) (and (is-Nil Nil) (= Nil Nil)) (and (= l3 l0)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv6 cv7)) (= cv6 (Head Nil)) (= cv7 (Tail Nil))) (and (is-Cons l1) (= l1 (Cons cv8 cv9)) (= cv8 (Head l1)) (= cv9 (Tail l1))) (and (= l1 Nil) (is-Nil l1)) (and (= l3 Nil) (is-Nil l3)))) )
