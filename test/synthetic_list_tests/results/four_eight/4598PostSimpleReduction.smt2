...
(assert (and (or (and (= l2 l3)) (and (= l2 l1)) (and (is-Nil l2) (= l2 Nil)))) )
...
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (= l0 Nil) (is-Nil l0)) (and (= l1 Nil) (is-Nil l1)) (and (= l0 Nil) (is-Nil l0)))) )
