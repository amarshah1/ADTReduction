...
(assert (and (or (and (= l0 l2)) (and (= l2 l1)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l2 l2)) (and (= l1 Nil) (is-Nil l1)))) )
