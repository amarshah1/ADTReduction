...
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l2 l1)) (and (= l0 Nil) (is-Nil l0)) (and (= l3 l2)))) )
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (is-Cons l1) (= l1 (Cons cv0 cv1)) (= cv0 (Head l1)) (= cv1 (Tail l1))) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (= l2 Nil) (is-Nil l2)) )
(assert (and (is-Nil l2) (= l2 Nil)) )
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l3 Nil) (is-Nil l3)) (and (= l0 l1)))) )
