...
(assert (and (and (and (= l0 l3)) (and (= l3 Nil) (is-Nil l3)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))))) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l0 Nil) (is-Nil l0)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (is-Nil l1) (= l1 Nil)) )
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (is-Nil l2) (= l2 Nil)) (and (= l2 l3)))) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l2 l2)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))))) )
