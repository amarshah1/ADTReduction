...
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l2 Nil) (is-Nil l2)) (and (= l1 l0)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))))) )
...
(assert (and (or (and (= l2 l0)) (and (= l3 l1)) (and (= l0 l3)) (and (= l2 Nil) (is-Nil l2)))) )
