...
(assert (and (and (and (is-Cons l0) (= l0 (Cons cv2 cv3)) (= cv2 (Head l0)) (= cv3 (Tail l0))) (and (= l3 l3)) (and (= l1 l1)))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (= l1 Nil) (is-Nil l1)) )
(assert (and (not (= l0 l0))) )
(assert (and (= l1 Nil) (is-Nil l1)) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (and (and (= l2 l1)) (and (= l2 Nil) (is-Nil l2)) (and (is-Nil Nil) (= Nil Nil)) (and (= l2 Nil) (is-Nil l2)))) )
