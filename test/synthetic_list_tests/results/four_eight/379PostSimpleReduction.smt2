...
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l0 l0)) (and (= l2 l0)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l0 Nil) (is-Nil l0)) (and (= l2 Nil) (is-Nil l2)) (and (= l3 l3)))) )
...
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (= l1 Nil) (is-Nil l1)) (and (is-Nil l0) (= l0 Nil)) (and (= l2 Nil) (is-Nil l2)))) )
