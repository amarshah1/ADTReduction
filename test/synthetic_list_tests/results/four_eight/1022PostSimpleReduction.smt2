...
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (= l2 l3)) (and (= l2 Nil) (is-Nil l2)) (and (= l2 l1)))) )
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (is-Nil Nil) (= Nil Nil)) (and (= l2 Nil) (is-Nil l2)) (and (is-Nil Nil) (= Nil Nil)))) )
