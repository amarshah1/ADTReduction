...
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (is-Cons l0) (= l0 (Cons cv4 cv5)) (= cv4 (Head l0)) (= cv5 (Tail l0))) (and (is-Nil l3) (= l3 Nil)))) )
(assert (and (= l2 Nil) (is-Nil l2)) )
(assert (and (not (is-Nil Nil))) )
(assert (and (is-Nil l1) (= l1 Nil)) )
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l0 l2)) (and (= l3 l1)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (and (and (is-Nil l2) (= l2 Nil)) (and (is-Nil l3) (= l3 Nil)) (and (= l1 Nil) (is-Nil l1)) (and (= l1 l3)))) )
