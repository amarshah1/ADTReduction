...
(assert (and (and (and (= l3 l3)) (and (= l3 l1)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (or (and (is-Cons l2) (= l2 (Cons cv4 cv5)) (= cv4 (Head l2)) (= cv5 (Tail l2))) (and (= l3 l0)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (= l1 l0)) )
