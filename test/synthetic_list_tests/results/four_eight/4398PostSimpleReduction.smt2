...
(assert (and (= l3 l3)) )
(assert (and (and (and (= l3 l2)) (and (is-Cons l1) (= l1 (Cons cv0 cv1)) (= cv0 (Head l1)) (= cv1 (Tail l1))) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (not (is-Nil l2))) )
(assert (and (= l1 l3)) )
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l2 l0)) (and (is-Nil l0) (= l0 Nil)) (and (is-Nil l2) (= l2 Nil)))) )
