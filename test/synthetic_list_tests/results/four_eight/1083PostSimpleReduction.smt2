...
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l0 l2)) (and (= l1 l1)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (and (and (is-Nil l0) (= l0 Nil)) (and (is-Nil l0) (= l0 Nil)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))))) )
