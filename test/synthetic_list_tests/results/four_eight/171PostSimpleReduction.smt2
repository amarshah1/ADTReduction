...
(assert (and (or (and (= l1 l3)) (and (is-Nil Nil) (= Nil Nil)) (and (= l1 l2)) (and (= l2 l2)))) )
(assert (and (is-Nil l1) (= l1 Nil)) )
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (= l3 Nil) (is-Nil l3)) (and (is-Nil Nil) (= Nil Nil)) (and (= l1 l1)))) )
