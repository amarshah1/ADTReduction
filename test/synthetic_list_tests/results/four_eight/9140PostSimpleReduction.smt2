...
(assert (and (and (and (= l2 l3)) (and (is-Cons l1) (= l1 (Cons cv0 cv1)) (= cv0 (Head l1)) (= cv1 (Tail l1))) (and (is-Nil Nil) (= Nil Nil)))) )
...
(assert (and (or (and (= l1 l2)) (and (is-Nil l3) (= l3 Nil)) (and (= l0 Nil) (is-Nil l0)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) )
(assert (and (= l3 Nil) (is-Nil l3)) )
(assert (and (not (is-Cons Nil))) )
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (= l3 l2)) (and (= l2 l2)))) )
