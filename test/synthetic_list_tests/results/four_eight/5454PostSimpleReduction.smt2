...
(assert (and (or (and (= l0 l1)) (and (= l2 l2)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (and (and (is-Nil l3) (= l3 Nil)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (is-Nil l3) (= l3 Nil)))) )
(assert (and (not (is-Nil Nil))) )
(assert (and (or (and (is-Nil l1) (= l1 Nil)) (and (is-Nil l3) (= l3 Nil)) (and (= l0 Nil) (is-Nil l0)) (and (= l2 l3)))) )
