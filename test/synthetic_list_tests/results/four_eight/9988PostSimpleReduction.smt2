...
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l3 l3)))) )
(assert (and (or (and (= l0 l1)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (and (and (= l0 l0)) (and (= l2 Nil) (is-Nil l2)) (and (is-Nil Nil) (= Nil Nil)) (and (= l1 l0)))) )
