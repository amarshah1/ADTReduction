...
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (is-Nil l1) (= l1 Nil)) (and (= l2 Nil) (is-Nil l2)) (and (= l1 l0)))) )
(assert (and (not (= l0 l2))) )
(assert (and (not (= l0 Nil))) )
(assert (and (and (and (= l3 l2)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (and (and (is-Nil l0) (= l0 Nil)) (and (= l3 l2)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (= l3 l1)) )
