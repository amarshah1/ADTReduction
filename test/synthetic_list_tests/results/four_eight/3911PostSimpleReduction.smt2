...
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l1 l3)) (and (= l1 l3)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (is-Nil l0) (= l0 Nil)) )
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l2 l1)) (and (= l2 Nil) (is-Nil l2)))) )
