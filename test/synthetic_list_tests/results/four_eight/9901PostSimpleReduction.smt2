...
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (is-Cons l2) (= l2 (Cons cv2 cv3)) (= cv2 (Head l2)) (= cv3 (Tail l2))) (and (= l2 l0)))) )
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (= l2 l0)) (and (= l2 l0)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (and (and (= l1 l3)) (and (is-Cons l1) (= l1 (Cons cv4 cv5)) (= cv4 (Head l1)) (= cv5 (Tail l1))) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (or (and (= l0 l2)) (and (= l3 l2)) (and (= l1 l2)) (and (= l1 Nil) (is-Nil l1)))) )
