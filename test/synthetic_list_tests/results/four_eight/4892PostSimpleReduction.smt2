...
(assert (and (or (and (is-Nil l2) (= l2 Nil)) (and (is-Nil Nil) (= Nil Nil)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l0 Nil) (is-Nil l0)) (and (= l3 l2)))) )
(assert (and (not (= l2 l0))) )
(assert (and (= l1 Nil) (is-Nil l1)) )
(assert (and (not (= l1 Nil))) )
(assert (and (or (and (= l1 l2)) (and (is-Cons l0) (= l0 (Cons cv0 cv1)) (= cv0 (Head l0)) (= cv1 (Tail l0))))) )
