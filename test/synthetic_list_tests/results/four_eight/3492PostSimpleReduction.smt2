...
(assert (and (and (and (= l1 l0)) (and (= l3 l3)) (and (is-Nil Nil) (= Nil Nil)) (and (= l3 l2)))) )
...
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv8 cv9)) (= cv8 (Head Nil)) (= cv9 (Tail Nil))) (and (= l1 Nil) (is-Nil l1)))) )
