...
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) (and (= l1 l3)) (and (= l1 Nil) (is-Nil l1)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (= l3 l2)) )
(assert (and (not (= l3 Nil))) )
(assert (and (and (and (= l3 l3)) (and (= l1 l3)) (and (= l3 l1)))) )
