...
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l0 Nil) (is-Nil l0)) (and (is-Nil l0) (= l0 Nil)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (not (= l0 Nil))) )
(assert (and (or (and (= l1 l1)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil l1) (= l1 Nil)))) )
...
(assert (and (or (and (= l3 l3)) (and (= l0 l3)) (and (= l1 Nil) (is-Nil l1)) (and (= l1 Nil) (is-Nil l1)))) )
