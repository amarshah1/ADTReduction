...
(assert (and (or (and (= l1 l3)) (and (= l0 Nil) (is-Nil l0)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (not (is-Cons Nil))) )
(assert (and (= l3 Nil) (is-Nil l3)) )
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (= l2 l1)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (= l2 l1)) )
