...
(assert (and (and (and (= l0 l1)) (and (= l3 l1)) (and (= l1 Nil) (is-Nil l1)))) )
...
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil l3) (= l3 Nil)))) )
