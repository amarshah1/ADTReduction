...
(assert (and (and (and (= l0 l2)) (and (= l2 l0)) (and (= l2 Nil) (is-Nil l2)) (and (= l2 l0)))) )
(assert (and (= l3 l3)) )
(assert (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) )
(assert (and (= l3 Nil) (is-Nil l3)) )
(assert (and (not (is-Nil Nil))) )
(assert (and (and (and (= l1 l1)) (and (= l0 Nil) (is-Nil l0)) (and (= l3 l0)) (and (= l0 l0)))) )
(assert (and (and (and (is-Cons l2) (= l2 (Cons cv2 cv3)) (= cv2 (Head l2)) (= cv3 (Tail l2))) (and (= l2 l2)) (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))))) )
