...
(assert (and (or (and (is-Nil l3) (= l3 Nil)) (and (= l2 l2)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))))) )
(assert (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) )
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l2 l0)) (and (= l1 Nil) (is-Nil l1)) (and (= l0 l1)))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
