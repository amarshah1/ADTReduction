...
(assert (and (and (and (is-Nil l1) (= l1 Nil)) (and (= l1 l2)) (and (= l1 Nil) (is-Nil l1)))) )
...
(assert (and (or (and (= l0 l3)) (and (= l2 Nil) (is-Nil l2)) (and (is-Nil l0) (= l0 Nil)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))))) )
