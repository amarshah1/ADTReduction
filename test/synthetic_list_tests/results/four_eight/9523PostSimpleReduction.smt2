...
(assert (and (or (and (= l3 l1)) (and (is-Nil l0) (= l0 Nil)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l3 l0)) (and (= l0 l1)))) )
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l3 Nil) (is-Nil l3)) (and (= l0 l3)))) )
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l0 Nil) (is-Nil l0)) (and (= l2 Nil) (is-Nil l2)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (not (is-Cons Nil))) )
(assert (and (or (and (= l1 l0)) (and (= l1 l1)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l2 l1)) (and (is-Nil Nil) (= Nil Nil)) (and (= l2 l2)))) )
