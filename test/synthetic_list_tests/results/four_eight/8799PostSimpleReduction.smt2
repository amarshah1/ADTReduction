...
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l3 l2)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))))) )
...
(assert (and (and (and (= l2 l1)) (and (= l0 Nil) (is-Nil l0)) (and (= l1 l3)))) )
