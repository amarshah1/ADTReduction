...
(assert (and (and (and (is-Nil l1) (= l1 Nil)) (and (= l2 l2)) (and (= l2 l2)))) )
(assert (and (= l1 l2)) )
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (= l3 Nil) (is-Nil l3)) (and (is-Cons l0) (= l0 (Cons cv0 cv1)) (= cv0 (Head l0)) (= cv1 (Tail l0))))) )
