...
(assert (and (and (and (= l2 l0)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l2 Nil) (is-Nil l2)) (and (is-Nil l0) (= l0 Nil)))) )
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l3 l3)) (and (= l0 l3)) (and (= l1 Nil) (is-Nil l1)))) )
