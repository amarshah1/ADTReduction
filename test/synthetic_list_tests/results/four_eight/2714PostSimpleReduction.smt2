...
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l1 l0)) (and (is-Nil l1) (= l1 Nil)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l3 l2)) (and (= l0 Nil) (is-Nil l0)) (and (= l0 l2)))) )
...
(assert (and (or (and (= l1 l3)) (and (= l1 l0)) (and (is-Nil l1) (= l1 Nil)) (and (is-Nil Nil) (= Nil Nil)))) )
