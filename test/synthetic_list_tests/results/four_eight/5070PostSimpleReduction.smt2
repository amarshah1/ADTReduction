...
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (= l3 l1)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (= l3 l2)))) )
(assert (and (is-Nil l3) (= l3 Nil)) )
(assert (and (= l3 Nil) (is-Nil l3)) )
(assert (and (= l2 l3)) )
(assert (and (and (and (= l1 l3)) (and (= l3 l1)) (and (= l3 l1)))) )
