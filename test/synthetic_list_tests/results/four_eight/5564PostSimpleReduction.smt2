...
(assert (and (and (and (= l2 l0)) (and (is-Nil l1) (= l1 Nil)) (and (= l2 l0)) (and (= l2 l1)))) )
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l1 Nil) (is-Nil l1)) (and (is-Nil Nil) (= Nil Nil)) (and (= l3 l0)))) )
