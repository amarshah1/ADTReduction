...
(assert (and (and (and (= l0 l2)) (and (= l1 Nil) (is-Nil l1)) (and (= l1 l2)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (is-Cons l3) (= l3 (Cons cv2 cv3)) (= cv2 (Head l3)) (= cv3 (Tail l3))) )
(assert (and (or (and (is-Nil l0) (= l0 Nil)) (and (= l1 Nil) (is-Nil l1)) (and (is-Nil l3) (= l3 Nil)) (and (= l1 Nil) (is-Nil l1)))) )
