...
(assert (and (or (and (is-Nil l0) (= l0 Nil)) (and (= l2 l2)))) )
(assert (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) )
(assert (and (is-Nil l1) (= l1 Nil)) )
(assert (and (not (= l3 Nil))) )
(assert (and (= l0 l3)) )
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (= l3 l0)) (and (is-Cons l1) (= l1 (Cons cv2 cv3)) (= cv2 (Head l1)) (= cv3 (Tail l1))) (and (= l0 Nil) (is-Nil l0)))) )
