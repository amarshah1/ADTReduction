...
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l3 l2)) (and (= l0 Nil) (is-Nil l0)) (and (= l2 l0)))) )
(assert (and (is-Cons l3) (= l3 (Cons cv2 cv3)) (= cv2 (Head l3)) (= cv3 (Tail l3))) )
(assert (and (= l2 l1)) )
(assert (and (and (and (= l0 l2)) (and (= l2 Nil) (is-Nil l2)) (and (= l1 Nil) (is-Nil l1)) (and (= l3 l0)))) )
