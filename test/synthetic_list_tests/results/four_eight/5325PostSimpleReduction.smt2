...
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (= l1 l2)) (and (is-Nil l0) (= l0 Nil)))) )
(assert (and (not (is-Cons l0))) )
(assert (and (= l3 l1)) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (is-Nil l1) (= l1 Nil)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil Nil) (= Nil Nil)))) )
