...
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l2 l2)) (and (= l2 Nil) (is-Nil l2)) (and (= l1 l3)))) )
(assert (and (and (and (is-Nil l3) (= l3 Nil)) (and (= l1 l2)) (and (= l0 l2)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (or (and (is-Nil l0) (= l0 Nil)) (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) (and (is-Cons l1) (= l1 (Cons cv6 cv7)) (= cv6 (Head l1)) (= cv7 (Tail l1))) (and (= l0 l3)))) )
(assert (and (or (and (is-Cons Nil) (= Nil (Cons cv8 cv9)) (= cv8 (Head Nil)) (= cv9 (Tail Nil))) (and (= l0 Nil) (is-Nil l0)) (and (= l0 l3)) (and (= l1 l1)))) )
