...
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (and (and (= l0 l0)) (and (= l2 l3)))) )
(assert (and (and (and (= l1 l1)) (and (= l3 Nil) (is-Nil l3)) (and (= l2 l0)))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (and (and (= l0 l0)) (and (= l3 Nil) (is-Nil l3)) (and (= l0 Nil) (is-Nil l0)))) )
