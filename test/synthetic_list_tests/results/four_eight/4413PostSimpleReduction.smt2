...
(assert (and (= l0 l1)) )
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (is-Nil Nil) (= Nil Nil)) (and (= l2 l3)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (and (and (= l2 l3)) (and (= l1 l2)) (and (= l2 Nil) (is-Nil l2)) (and (= l1 l2)))) )
