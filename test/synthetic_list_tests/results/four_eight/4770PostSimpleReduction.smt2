...
(assert (and (or (and (= l3 l3)) (and (= l0 l3)) (and (= l3 l2)) (and (= l0 Nil) (is-Nil l0)))) )
...
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (is-Cons Nil) (= Nil (Cons cv6 cv7)) (= cv6 (Head Nil)) (= cv7 (Tail Nil))) (and (is-Cons l0) (= l0 (Cons cv8 cv9)) (= cv8 (Head l0)) (= cv9 (Tail l0))))) )
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons l1) (= l1 (Cons cv10 cv11)) (= cv10 (Head l1)) (= cv11 (Tail l1))))) )
