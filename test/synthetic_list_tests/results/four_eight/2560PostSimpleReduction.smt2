...
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons l0) (= l0 (Cons cv0 cv1)) (= cv0 (Head l0)) (= cv1 (Tail l0))) (and (= l0 Nil) (is-Nil l0)))) )
...
(assert (and (or (and (= l2 l0)) (and (= l1 Nil) (is-Nil l1)) (and (= l1 l3)) (and (= l1 Nil) (is-Nil l1)))) )
