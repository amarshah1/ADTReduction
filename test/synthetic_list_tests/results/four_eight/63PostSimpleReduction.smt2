...
(assert (and (= l1 l2)) )
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (is-Cons l3) (= l3 (Cons cv0 cv1)) (= cv0 (Head l3)) (= cv1 (Tail l3))) (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil l2) (= l2 Nil)))) )
(assert (and (= l0 Nil) (is-Nil l0)) )
(assert (and (and (and (= l1 l1)) (and (= l0 l2)))) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l3 l1)) (and (= l0 Nil) (is-Nil l0)) (and (is-Nil Nil) (= Nil Nil)))) )
