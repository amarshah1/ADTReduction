...
(assert (and (and (and (= l0 l2)) (and (= l3 l3)) (and (= l2 l1)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (not (= l0 l3))) )
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (= l0 Nil) (is-Nil l0)) (and (= l3 Nil) (is-Nil l3)) (and (= l3 l1)))) )
