...
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l3 l1)) (and (= l1 l2)))) )
(assert (and (not (= l1 Nil))) )
(assert (and (not (= l1 Nil))) )
(assert (and (or (and (= l3 l0)) (and (= l0 Nil) (is-Nil l0)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (is-Nil Nil) (= Nil Nil)))) )
