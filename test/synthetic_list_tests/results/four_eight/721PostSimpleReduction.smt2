...
(assert (and (= l2 l3)) )
(assert (and (or (and (= l2 Nil) (is-Nil l2)) (and (= l1 Nil) (is-Nil l1)) (and (= l0 Nil) (is-Nil l0)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (is-Cons l0) (= l0 (Cons cv2 cv3)) (= cv2 (Head l0)) (= cv3 (Tail l0))) )
(assert (and (or (and (is-Nil l3) (= l3 Nil)) (and (= l2 l0)) (and (= l2 Nil) (is-Nil l2)))) )
(assert (and (and (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))) (and (is-Nil Nil) (= Nil Nil)) (and (= l0 l3)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (= l3 l2)) )
