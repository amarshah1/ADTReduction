...
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (= l3 l0)) (and (is-Nil Nil) (= Nil Nil)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (is-Cons l1) (= l1 (Cons cv4 cv5)) (= cv4 (Head l1)) (= cv5 (Tail l1))) )
(assert (and (is-Nil Nil) (= Nil Nil)) )
(assert (and (is-Nil l1) (= l1 Nil)) )
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (= l2 Nil) (is-Nil l2)) (and (= l0 l1)) (and (= l2 Nil) (is-Nil l2)))) )
