...
(assert (and (or (and (= l1 l0)) (and (= l3 Nil) (is-Nil l3)) (and (is-Cons l0) (= l0 (Cons cv0 cv1)) (= cv0 (Head l0)) (= cv1 (Tail l0))))) )
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l0 l1)))) )
(assert (and (= l0 Nil) (is-Nil l0)) )
(assert (and (is-Nil l3) (= l3 Nil)) )
(assert (and (or (and (= l2 l0)) (and (is-Nil l3) (= l3 Nil)) (and (= l2 Nil) (is-Nil l2)) (and (is-Nil Nil) (= Nil Nil)))) )
