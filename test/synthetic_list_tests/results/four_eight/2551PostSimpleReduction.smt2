...
(assert (and (or (and (= l0 l3)) (and (= l2 l2)) (and (= l1 l3)))) )
(assert (and (and (and (= l1 l3)) (and (= l0 l2)) (and (= l1 l1)) (and (= l0 l3)))) )
(assert (and (is-Nil l3) (= l3 Nil)) )
(assert (and (and (and (= l2 l0)) (and (= l3 Nil) (is-Nil l3)) (and (= l3 Nil) (is-Nil l3)) (and (is-Nil l2) (= l2 Nil)))) )
(assert (and (not (is-Cons Nil))) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil Nil) (= Nil Nil)) (and (= l1 l0)) (and (= l3 Nil) (is-Nil l3)))) )
