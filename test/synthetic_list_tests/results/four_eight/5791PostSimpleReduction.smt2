...
(assert (and (= l3 l3)) )
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (= l3 l3)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons Nil) (= Nil (Cons cv4 cv5)) (= cv4 (Head Nil)) (= cv5 (Tail Nil))))) )
(assert (and (and (and (is-Nil l1) (= l1 Nil)) (and (= l2 l1)))) )
