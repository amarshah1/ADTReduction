...
(assert (and (and (and (is-Cons l2) (= l2 (Cons cv0 cv1)) (= cv0 (Head l2)) (= cv1 (Tail l2))) (and (= l2 l3)) (and (= l2 Nil) (is-Nil l2)))) )
...
(assert (and (= l3 l0)) )
(assert (and (or (and (is-Cons l1) (= l1 (Cons cv4 cv5)) (= cv4 (Head l1)) (= cv5 (Tail l1))) (and (= l2 Nil) (is-Nil l2)) (and (= l0 l2)))) )
(assert (and (= l0 l0)) )
