...
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons l1) (= l1 (Cons cv2 cv3)) (= cv2 (Head l1)) (= cv3 (Tail l1))) (and (is-Nil Nil) (= Nil Nil)))) )
...
(assert (and (or (and (= l2 l1)) (and (= l1 l3)) (and (= l1 Nil) (is-Nil l1)) (and (= l1 l2)))) )
