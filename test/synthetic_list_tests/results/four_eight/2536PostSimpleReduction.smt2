...
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l1 l1)) (and (= l0 l3)))) )
(assert (and (or (and (= l3 l0)) (and (= l1 l0)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (or (and (= l3 Nil) (is-Nil l3)) (and (= l2 Nil) (is-Nil l2)) (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))))) )
(assert (and (or (and (= l1 l3)) (and (= l3 l3)) (and (= l2 Nil) (is-Nil l2)))) )
