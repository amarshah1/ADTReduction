...
(assert (and (and (and (is-Cons l3) (= l3 (Cons cv2 cv3)) (= cv2 (Head l3)) (= cv3 (Tail l3))) (and (= l2 Nil) (is-Nil l2)) (and (= l1 l2)) (and (= l0 l1)))) )
(assert (and (= l1 l1)) )
(assert (and (is-Nil l1) (= l1 Nil)) )
(assert (and (and (and (= l3 l3)) (and (= l1 Nil) (is-Nil l1)) (and (= l3 l0)))) )
