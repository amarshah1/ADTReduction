...
(assert (and (or (and (= l3 l1)) (and (= l1 l0)) (and (= l0 l3)) (and (= l3 Nil) (is-Nil l3)))) )
(assert (and (not (is-Nil Nil))) )
(assert (and (= l2 l0)) )
(assert (and (= l0 l1)) )
(assert (and (not (is-Nil Nil))) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l2 Nil) (is-Nil l2)) (and (= l2 Nil) (is-Nil l2)) (and (= l1 Nil) (is-Nil l1)))) )
