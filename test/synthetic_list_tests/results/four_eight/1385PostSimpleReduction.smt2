...
(assert (and (and (and (= l3 l2)) (and (= l0 Nil) (is-Nil l0)) (and (= l0 l3)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (and (and (= l2 l0)) (and (is-Cons l3) (= l3 (Cons cv0 cv1)) (= cv0 (Head l3)) (= cv1 (Tail l3))) (and (is-Cons l0) (= l0 (Cons cv2 cv3)) (= cv2 (Head l0)) (= cv3 (Tail l0))))) )
(assert (and (= l1 Nil) (is-Nil l1)) )
(assert (and (is-Cons l2) (= l2 (Cons cv4 cv5)) (= cv4 (Head l2)) (= cv5 (Tail l2))) )
(assert (and (not (= l3 l3))) )
(assert (and (or (and (is-Nil l0) (= l0 Nil)) (and (is-Cons l1) (= l1 (Cons cv6 cv7)) (= cv6 (Head l1)) (= cv7 (Tail l1))))) )
