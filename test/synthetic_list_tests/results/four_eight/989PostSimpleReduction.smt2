...
(assert (and (and (and (= l3 Nil) (is-Nil l3)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l0 l2)) (and (= l1 Nil) (is-Nil l1)))) )
...
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (is-Cons l2) (= l2 (Cons cv6 cv7)) (= cv6 (Head l2)) (= cv7 (Tail l2))) (and (= l3 Nil) (is-Nil l3)))) )
