...
(assert (and (or (and (= l1 l0)) (and (= l3 l2)) (and (is-Nil l0) (= l0 Nil)))) )
(assert (and (is-Cons l1) (= l1 (Cons cv4 cv5)) (= cv4 (Head l1)) (= cv5 (Tail l1))) )
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (is-Cons Nil) (= Nil (Cons cv6 cv7)) (= cv6 (Head Nil)) (= cv7 (Tail Nil))) (and (= l3 l1)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (is-Cons l1) (= l1 (Cons cv8 cv9)) (= cv8 (Head l1)) (= cv9 (Tail l1))) )
(assert (and (or (and (= l1 l2)) (and (= l3 l1)) (and (is-Cons Nil) (= Nil (Cons cv10 cv11)) (= cv10 (Head Nil)) (= cv11 (Tail Nil))) (and (= l2 l3)))) )
