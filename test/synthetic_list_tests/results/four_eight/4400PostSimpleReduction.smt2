...
(assert (and (and (and (= l2 Nil) (is-Nil l2)) (and (is-Nil l0) (= l0 Nil)) (and (= l2 Nil) (is-Nil l2)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))))) )
(assert (and (or (and (is-Nil l3) (= l3 Nil)) (and (is-Nil l3) (= l3 Nil)) (and (= l1 l0)) (and (= l3 l2)))) )
