...
(assert (and (or (and (= l1 l1)) (and (= l2 Nil) (is-Nil l2)) (and (= l3 l1)) (and (= l0 l2)))) )
(assert (and (= l2 Nil) (is-Nil l2)) )
(assert (and (= l3 l0)) )
(assert (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) )
(assert (and (and (and (= l0 l1)) (and (= l0 Nil) (is-Nil l0)) (and (= l1 Nil) (is-Nil l1)) (and (is-Nil Nil) (= Nil Nil)))) )
