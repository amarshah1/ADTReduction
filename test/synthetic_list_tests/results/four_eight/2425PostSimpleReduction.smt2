...
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l3 l2)) (and (is-Cons l0) (= l0 (Cons cv0 cv1)) (= cv0 (Head l0)) (= cv1 (Tail l0))))) )
...
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (= l2 Nil) (is-Nil l2)) (and (is-Cons l1) (= l1 (Cons cv8 cv9)) (= cv8 (Head l1)) (= cv9 (Tail l1))) (and (= l1 Nil) (is-Nil l1)))) )
