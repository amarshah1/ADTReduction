...
(assert (and (or (and (= l3 l3)) (and (is-Cons Nil) (= Nil (Cons cv10 cv11)) (= cv10 (Head Nil)) (= cv11 (Tail Nil))) (and (is-Cons Nil) (= Nil (Cons cv12 cv13)) (= cv12 (Head Nil)) (= cv13 (Tail Nil))) (and (is-Cons l0) (= l0 (Cons cv14 cv15)) (= cv14 (Head l0)) (= cv15 (Tail l0))))) )
