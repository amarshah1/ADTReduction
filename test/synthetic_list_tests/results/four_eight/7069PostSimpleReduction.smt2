...
(assert (and (and (and (= l2 l3)) (and (= l1 Nil) (is-Nil l1)) (and (is-Nil Nil) (= Nil Nil)) (and (= l1 Nil) (is-Nil l1)))) )
(assert (and (= l1 l3)) )
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l2 Nil) (is-Nil l2)) (and (is-Cons Nil) (= Nil (Cons cv0 cv1)) (= cv0 (Head Nil)) (= cv1 (Tail Nil))) (and (is-Nil l2) (= l2 Nil)))) )
(assert (and (not (= l3 Nil))) )
(assert (and (= l0 l2)) )
(assert (and (or (and (= l1 l0)) (and (= l3 l0)) (and (= l1 l2)) (and (= l3 Nil) (is-Nil l3)))) )
