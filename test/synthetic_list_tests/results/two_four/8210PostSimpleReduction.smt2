...
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (= l1 Nil) (is-Nil l1)) (and (is-Nil l1) (= l1 Nil)) (and (= l1 l1)))) )
(assert (and (= l1 Nil) (is-Nil l1)) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l0 Nil) (is-Nil l0)) (and (= l0 Nil) (is-Nil l0)) (and (= l1 Nil) (is-Nil l1)))) )
