...
(assert (and (or (and (is-Cons l0) (= l0 (Cons cv0 cv1)) (= cv0 (Head l0)) (= cv1 (Tail l0))) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (is-Nil l0) (= l0 Nil)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (or (and (= l0 Nil) (is-Nil l0)) (and (= l0 l1)) (and (is-Nil Nil) (= Nil Nil)))) )
