...
(assert (and (and (and (= l1 l1)) (and (is-Nil Nil) (= Nil Nil)) (and (= l0 l0)) (and (= l1 Nil) (is-Nil l1)))) )
...
(assert (and (or (and (is-Cons l0) (= l0 (Cons cv4 cv5)) (= cv4 (Head l0)) (= cv5 (Tail l0))) (and (= l1 Nil) (is-Nil l1)) (and (is-Cons Nil) (= Nil (Cons cv6 cv7)) (= cv6 (Head Nil)) (= cv7 (Tail Nil))))) )
