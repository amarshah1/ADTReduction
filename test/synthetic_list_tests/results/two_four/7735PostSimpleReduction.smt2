...
(assert (and (and (and (= l1 l1)) (and (= l1 l0)) (and (= l1 Nil) (is-Nil l1)))) )
...
(assert (and (or (and (is-Nil l1) (= l1 Nil)) (and (= l1 Nil) (is-Nil l1)) (and (is-Nil Nil) (= Nil Nil)) (and (= l1 Nil) (is-Nil l1)))) )
