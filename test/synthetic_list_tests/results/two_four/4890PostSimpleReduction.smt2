...
(assert (and (and (and (= l0 Nil) (is-Nil l0)) (and (= l0 l1)) (and (= l0 l1)) (and (= l0 l1)))) )
(assert (and (is-Cons l0) (= l0 (Cons cv0 cv1)) (= cv0 (Head l0)) (= cv1 (Tail l0))) )
(assert (and (or (and (is-Nil Nil) (= Nil Nil)) (and (= l1 Nil) (is-Nil l1)) (and (is-Cons l1) (= l1 (Cons cv2 cv3)) (= cv2 (Head l1)) (= cv3 (Tail l1))) (and (= l1 l0)))) )
