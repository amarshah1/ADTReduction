...
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (is-Nil Nil) (= Nil Nil)) (and (= l0 l1)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (and (and (= l0 l1)) (and (= l0 l1)) (and (= l1 Nil) (is-Nil l1)) (and (is-Nil Nil) (= Nil Nil)))) )
