...
(assert (and (and (and (= l0 l1)) (and (is-Nil l0) (= l0 Nil)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (and (and (is-Cons l1) (= l1 (Cons cv0 cv1)) (= cv0 (Head l1)) (= cv1 (Tail l1))) (and (= l1 Nil) (is-Nil l1)) (and (is-Nil Nil) (= Nil Nil)))) )
