...
(assert (and (or (and (= l1 Nil) (is-Nil l1)) (and (= l1 Nil) (is-Nil l1)) (and (= l1 Nil) (is-Nil l1)) (and (is-Nil l0) (= l0 Nil)))) )
(assert (and (and (and (= l1 Nil) (is-Nil l1)) (and (= l1 l1)))) )
(assert (and (or (and (= l0 l0)) (and (is-Nil l1) (= l1 Nil)) (and (= l1 l0)))) )
