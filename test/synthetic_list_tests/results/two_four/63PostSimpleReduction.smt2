...
(assert (and (and (and (= l1 l1)) (and (= l1 l0)) (and (= l1 Nil) (is-Nil l1)) (and (= l0 Nil) (is-Nil l0)))) )
(assert (and (not (= l1 Nil))) )
(assert (and (= l1 Nil) (is-Nil l1)) )
(assert (and (and (and (= l1 l0)) (and (is-Nil l1) (= l1 Nil)) (and (is-Nil l1) (= l1 Nil)) (and (= l1 l0)))) )
