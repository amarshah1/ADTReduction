...
(assert (and (and (and (= l1 l0)) (and (= l1 l0)) (and (is-Nil Nil) (= Nil Nil)))) )
(assert (and (and (and (is-Nil Nil) (= Nil Nil)) (and (is-Cons Nil) (= Nil (Cons cv2 cv3)) (= cv2 (Head Nil)) (= cv3 (Tail Nil))) (and (= l1 l1)) (and (= l0 Nil) (is-Nil l0)))) )
